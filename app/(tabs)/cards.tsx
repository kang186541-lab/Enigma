...
import { useLanguage, NativeLanguage, LearningTargetLanguage, getEffectiveLearningLanguage, toNativeLearning } from "@/context/LanguageContext";
...
const BEGINNER_CARDS_BY_LANG: Record<LearningTargetLanguage, FlashCard[]> = {
  ...
  /* ── ARABIC (user is learning Egyptian Arabic, ar-EG) ──── */
  arabic: [
    /* ── A1 Beginner (Egyptian colloquial / Cairene) ── */
    { word: "أَهْلًا", emoji: "👋", pronunciation: "ahlan",
      meanings: { korean: "이집트에서 가장 흔하게 쓰는 친근한 인사말이에요.", english: "Hi / Hello — the most common friendly greeting in Egyptian Arabic.", spanish: "Hola — el saludo amistoso más común en árabe egipcio.", indonesian: "Halo — sapaan ramah yang paling umum dalam bahasa Arab Mesir." },
      example: "أَهْلًا، كَيْفَ حالُكَ؟ (ahlan, kayfa ḥāluka?)",
      exampleTranslation: { korean: "안녕, 잘 지내?", english: "Hi, how are you?", spanish: "Hola, ¿cómo estás?", indonesian: "Halo, apa kabar?" }, speechLang: "ar-EG" },

    { word: "شُكْرًا", emoji: "🙏", pronunciation: "shokran",
      meanings: { korean: "고마움을 표현할 때 쓰는 말이에요.", english: "Thank you — used to express gratitude.", spanish: "Gracias — se usa para expresar agradecimiento.", indonesian: "Terima kasih — dipakai untuk menyatakan rasa syukur." },
      example: "شُكْرًا جِدًّا عَلَى مُساعَدَتِكَ (shukran jiddan ʿalā musāʿadatika)",
      exampleTranslation: { korean: "도와줘서 정말 고마워요.", english: "Thank you so much for your help.", spanish: "Muchas gracias por tu ayuda.", indonesian: "Terima kasih banyak atas bantuanmu." }, speechLang: "ar-EG" },

    { word: "لَو سَمَحْتَ", emoji: "🤝", pronunciation: "law samaḥta",
      meanings: { korean: "정중하게 부탁하거나 양해를 구할 때 쓰는 '저기요/부탁해요'예요.", english: "Please / Excuse me — used to make a polite request or get attention.", spanish: "Por favor / Disculpa — para pedir algo con cortesía o llamar la atención.", indonesian: "Tolong / Permisi — dipakai untuk meminta sesuatu dengan sopan atau menarik perhatian." },
      example: "لَو سَمَحْتَ، ساعِدْني فِي حَمْلِ هٰذِهِ الحَقيبَة (law samaḥta, sāʿidnī fī ḥamli hādhihi l-ḥaqība)",
      exampleTranslation: { korean: "저기요, 이 가방 드는 것 좀 도와주세요.", english: "Please help me carry this bag.", spanish: "Por favor, ayúdame a llevar esta bolsa.", indonesian: "Tolong bantu saya membawa tas ini." }, speechLang: "ar-EG" },

    { word: "آسِف", emoji: "🙇", pronunciation: "aasef",
      meanings: { korean: "사과하거나 미안함을 표현할 때 쓰는 말이에요.", english: "Sorry — used to apologize or express regret.", spanish: "Perdón / Lo siento — para disculparse o expresar arrepentimiento.", indonesian: "Maaf — dipakai untuk meminta maaf atau menyatakan penyesalan." },
      example: "آسِف، أَنا تَأَخَّرْتُ اليَوْمَ (āsif, anā taʾakhkhartu l-yawma)",
      exampleTranslation: { korean: "미안해요, 오늘 늦었어요.", english: "Sorry, I am late today.", spanish: "Perdón, hoy llego tarde.", indonesian: "Maaf, saya terlambat hari ini." }, speechLang: "ar-EG" },

    { word: "صَباح الخَيْر", emoji: "☀️", pronunciation: "ṣabāḥa l-khayr",
      meanings: { korean: "이집트식 아침 인사예요 — 상대는 'صباح النور'로 답해요.", english: "Good morning — a cheerful Egyptian morning greeting; the reply is 'sabah el-noor'.", spanish: "Buenos días — un alegre saludo matutino egipcio; se responde 'sabah el-noor'.", indonesian: "Selamat pagi — sapaan pagi yang ceria khas Mesir; dibalas dengan 'sabah el-noor'." },
      example: "صَباح الخَيْر! هَلْ نِمْتَ جَيِّدًا؟ (ṣabāḥa l-khayr! hal nimta jayyidan?)",
      exampleTranslation: { korean: "좋은 아침! 잘 잤어?", english: "Good morning! Did you sleep well?", spanish: "¡Buenos días! ¿Dormiste bien?", indonesian: "Selamat pagi! Apakah kamu tidur nyenyak?" }, speechLang: "ar-EG" },

    { word: "مَساء الخَيْر", emoji: "🌙", pronunciation: "masāʾa l-khayr",
      meanings: { korean: "저녁이나 밤에 하는 이집트식 인사예요.", english: "Good evening — an Egyptian greeting used in the evening or at night.", spanish: "Buenas noches — un saludo egipcio que se usa por la tarde o noche.", indonesian: "Selamat malam — sapaan khas Mesir yang dipakai pada sore atau malam hari." },
      example: "مَساء الخَيْر، أَراكَ غَدًا (masāʾa l-khayr, arāka ghadan)",
      exampleTranslation: { korean: "좋은 저녁이에요, 내일 봐요.", english: "Good evening, see you tomorrow.", spanish: "Buenas noches, hasta mañana.", indonesian: "Selamat malam, sampai jumpa besok." }, speechLang: "ar-EG" },

    { word: "نَعَم", emoji: "✅", pronunciation: "naʿam",
      meanings: { korean: "긍정이나 동의를 나타내는 '응/네'예요 (구어체).", english: "Yes / Yeah — the colloquial way to agree or confirm.", spanish: "Sí — la forma coloquial de estar de acuerdo o confirmar.", indonesian: "Ya — cara santai untuk menyetujui atau membenarkan." },
      example: "نَعَم، أُريدُ أَنْ آتِيَ مَعَكَ (naʿam, urīdu an ātiya maʿaka)",
      exampleTranslation: { korean: "응, 너랑 같이 갈래.", english: "Yes, I want to come with you.", spanish: "Sí, quiero ir contigo.", indonesian: "Ya, saya mau ikut denganmu." }, speechLang: "ar-EG" },

    { word: "لا", emoji: "🚫", pronunciation: "lā",
      meanings: { korean: "부정이나 거절을 나타내는 '아니'예요 (구어체).", english: "No — the colloquial way to refuse or negate.", spanish: "No — la forma coloquial de rechazar o negar.", indonesian: "Tidak — cara santai untuk menolak atau menyangkal." },
      example: "لا، أَنا لا أُحِبُّ القَهْوَة (lā, anā lā uḥibbu l-qahwa)",
      exampleTranslation: { korean: "아니, 나는 커피 안 좋아해.", english: "No, I do not like coffee.", spanish: "No, no me gusta el café.", indonesian: "Tidak, saya tidak suka kopi." }, speechLang: "ar-EG" },

    { word: "ماء", emoji: "💧", pronunciation: "māʾ",
      meanings: { korean: "모든 생명에 꼭 필요한 맑은 액체, 물이에요 (이집트 구어).", english: "Water — the clear liquid essential for all life (Egyptian colloquial).", spanish: "Agua — el líquido transparente esencial para toda la vida (coloquial egipcio).", indonesian: "Air — cairan bening yang penting bagi semua kehidupan (bahasa Arab Mesir)." },
      example: "هَلْ يُمْكِنُني كَأْسُ ماء، لَو سَمَحْتَ؟ (hal yumkinunī kaʾsu māʾ, law samaḥta?)",
      exampleTranslation: { korean: "물 한 잔 주실 수 있어요?", english: "Could I have a glass of water, please?", spanish: "¿Me das un vaso de agua, por favor?", indonesian: "Boleh minta segelas air?" }, speechLang: "ar-EG" },

    { word: "يَأْكُل", emoji: "🍴", pronunciation: "yaʾkul",
      meanings: { korean: "음식을 씹고 삼키는 행동, 먹다예요.", english: "To eat — the action of chewing and swallowing food.", spanish: "Comer — la acción de masticar e ingerir alimentos.", indonesian: "Makan — tindakan mengunyah dan menelan makanan." },
      example: "أُحِبُّ أَنْ آكُلَ الكُشَري (uḥibbu an ākula l-kushari)",
      exampleTranslation: { korean: "나는 코샤리 먹는 걸 좋아해.", english: "I love eating koshari.", spanish: "Me encanta comer koshari.", indonesian: "Saya suka makan koshari." }, speechLang: "ar-EG" },

    { word: "يَشْرَب", emoji: "🥤", pronunciation: "yashrab",
      meanings: { korean: "액체를 마시는 행동, 마시다예요.", english: "To drink — to take a liquid into your mouth.", spanish: "Beber — llevar un líquido a la boca.", indonesian: "Minum — memasukkan cairan ke dalam mulut." },
      example: "يَجِبُ أَنْ تَشْرَبَ الماء كُلَّ يَوْم (yajibu an tashraba l-māʾ kulla yawm)",
      exampleTranslation: { korean: "매일 물을 마셔야 해.", english: "You have to drink water every day.", spanish: "Tienes que beber agua todos los días.", indonesian: "Kamu harus minum air setiap hari." }, speechLang: "ar-EG" },

    { word: "خُبز", emoji: "🍚", pronunciation: "khubz",
      meanings: { korean: "이집트 사람들의 주식인 빵이에요 ('생명'이란 뜻도 있어요).", english: "Bread — the staple food of Egyptians (the word also means 'life').", spanish: "Pan — el alimento básico de los egipcios (la palabra también significa 'vida').", indonesian: "Roti — makanan pokok orang Mesir (kata ini juga berarti 'kehidupan')." },
      example: "نَأْكُلُ الخُبْزَ البَلَدِيَّ كُلَّ يَوْم (naʾkulu l-khubza l-baladiyya kulla yawm)",
      exampleTranslation: { korean: "우리는 매일 발라디 빵을 먹어요.", english: "We eat baladi bread every day.", spanish: "Comemos pan baladi todos los días.", indonesian: "Kami makan roti baladi setiap hari." }, speechLang: "ar-EG" },

    { word: "بَيْت", emoji: "🏠", pronunciation: "bayt",
      meanings: { korean: "사람들이 사는 집이에요.", english: "House / Home — the building where you live.", spanish: "Casa — el edificio donde vives.", indonesian: "Rumah — bangunan tempat kamu tinggal." },
      example: "بَيْتُنا فيهِ حَديقَة جَميلَة (baytunā fīhi ḥadīqa jamīla)",
      exampleTranslation: { korean: "우리 집에는 예쁜 정원이 있어요.", english: "Our house has a lovely garden.", spanish: "Nuestra casa tiene un jardín bonito.", indonesian: "Rumah kami punya taman yang indah." }, speechLang: "ar-EG" },

    { word: "مَدْرَسَة", emoji: "🏫", pronunciation: "madrasa",
      meanings: { korean: "학생들이 공부하는 곳, 학교예요.", english: "School — the place where students learn and study.", spanish: "Escuela — el lugar donde los estudiantes aprenden y estudian.", indonesian: "Sekolah — tempat para siswa belajar dan menuntut ilmu." },
      example: "الأَطْفالُ يَذْهَبونَ إِلى المَدْرَسَة كُلَّ صَباح (al-aṭfālu yadhhabūna ilā l-madrasa kulla ṣabāḥ)",
      exampleTranslation: { korean: "아이들은 매일 아침 학교에 가요.", english: "The kids go to school every morning.", spanish: "Los niños van a la escuela cada mañana.", indonesian: "Anak-anak pergi ke sekolah setiap pagi." }, speechLang: "ar-EG" },

    { word: "عائِلَة", emoji: "👨‍👩‍👧‍👦", pronunciation: "ʿāʾila",
      meanings: { korean: "함께 살거나 피로 이어진 사람들의 모임, 가족이에요.", english: "Family — a group of people related by blood or living together.", spanish: "Familia — grupo de personas unidas por sangre o que viven juntas.", indonesian: "Keluarga — sekelompok orang yang terikat hubungan darah atau tinggal bersama." },
      example: "العائِلَة تَجْتَمِعُ كُلَّ إِجازَة (al-ʿāʾila tajtamiʿu kulla ijāza)",
      exampleTranslation: { korean: "가족은 휴일마다 모여요.", english: "The family gathers every holiday.", spanish: "La familia se reúne cada feriado.", indonesian: "Keluarga berkumpul setiap hari libur." }, speechLang: "ar-EG" },

    { word: "صَديق", emoji: "🤝", pronunciation: "ṣadīq",
      meanings: { korean: "서로 좋아하고 함께 시간을 보내는 친구예요.", english: "Friend — someone you like and enjoy spending time with.", spanish: "Amigo — alguien que te agrada y con quien disfrutas pasar tiempo.", indonesian: "Teman — seseorang yang kamu sukai dan senang menghabiskan waktu bersamanya." },
      example: "صَديقي طَيِّب وَلَطيف جِدًّا (ṣadīqī ṭayyib wa-laṭīf jiddan)",
      exampleTranslation: { korean: "내 친구는 정말 착하고 친절해.", english: "My friend is kind and very nice.", spanish: "Mi amigo es bueno y muy amable.", indonesian: "Teman saya baik dan sangat ramah." }, speechLang: "ar-EG" },

    { word: "أُمّ", emoji: "👩", pronunciation: "umm",
      meanings: { korean: "엄마를 부르는 다정한 말이에요 (이집트 일상어).", english: "Mom — the affectionate everyday word for one's mother in Egypt.", spanish: "Mamá — la palabra cariñosa y cotidiana para la madre en Egipto.", indonesian: "Ibu / Mama — sebutan akrab sehari-hari untuk ibu di Mesir." },
      example: "أُمّي تَطْبُخُ طَعامًا لَذيذًا (ummī taṭbukhu ṭaʿāman ladhīdhan)",
      exampleTranslation: { korean: "엄마는 맛있는 음식을 만들어요.", english: "Mom cooks delicious food.", spanish: "Mamá cocina comida deliciosa.", indonesian: "Mama memasak makanan yang lezat." }, speechLang: "ar-EG" },

    { word: "أَب", emoji: "👨", pronunciation: "ab",
      meanings: { korean: "아빠를 부르는 다정한 말이에요 (이집트 일상어).", english: "Dad — the affectionate everyday word for one's father in Egypt.", spanish: "Papá — la palabra cariñosa y cotidiana para el padre en Egipto.", indonesian: "Ayah / Papa — sebutan akrab sehari-hari untuk ayah di Mesir." },
      example: "أَبي يَعْمَلُ فِي مَكْتَب (abī yaʿmalu fī maktab)",
      exampleTranslation: { korean: "아빠는 사무실에서 일해요.", english: "Dad works in an office.", spanish: "Papá trabaja en una oficina.", indonesian: "Ayah bekerja di sebuah kantor." }, speechLang: "ar-EG" },

    { word: "كَلْب", emoji: "🐶", pronunciation: "kalb",
      meanings: { korean: "사람과 함께 사는 반려동물, 개예요.", english: "Dog — a pet that lives with people as a companion.", spanish: "Perro — mascota que convive con las personas como compañero.", indonesian: "Anjing — hewan peliharaan yang hidup bersama manusia sebagai teman." },
      example: "هٰذا الكَلْبُ يُحِبُّ أَنْ يَلْعَبَ فِي الحَديقَة (hādhā l-kalbu yuḥibbu an yalʿaba fī l-ḥadīqa)",
      exampleTranslation: { korean: "그 개는 정원에서 노는 걸 좋아해.", english: "That dog likes to play in the garden.", spanish: "A ese perro le gusta jugar en el jardín.", indonesian: "Anjing itu suka bermain di taman." }, speechLang: "ar-EG" },

    { word: "قِطَّة", emoji: "🐱", pronunciation: "qiṭṭa",
      meanings: { korean: "독립적이고 우아한 반려동물, 고양이예요.", english: "Cat — an independent and graceful pet.", spanish: "Gato — mascota independiente y elegante.", indonesian: "Kucing — hewan peliharaan yang mandiri dan anggun." },
      example: "القِطَّة نائِمَة عَلى الأَريكَة (al-qiṭṭa nāʾima ʿalā l-arīka)",
      exampleTranslation: { korean: "고양이가 소파 위에서 자고 있어요.", english: "The cat is sleeping on the sofa.", spanish: "El gato está durmiendo en el sofá.", indonesian: "Kucing itu tidur di atas sofa." }, speechLang: "ar-EG" },

    { word: "كِتاب", emoji: "📖", pronunciation: "kitāb",
      meanings: { korean: "읽기 위해 묶은 종이 묶음, 책이에요.", english: "Book — pages bound together for reading.", spanish: "Libro — páginas encuadernadas para leer.", indonesian: "Buku — halaman-halaman yang dijilid untuk dibaca." },
      example: "أَنا أَقْرَأُ كِتابًا جَميلًا (anā aqraʾu kitāban jamīlan)",
      exampleTranslation: { korean: "나는 재미있는 책을 읽고 있어.", english: "I am reading a nice book.", spanish: "Estoy leyendo un libro bonito.", indonesian: "Saya sedang membaca buku yang bagus." }, speechLang: "ar-EG" },

    { word: "واحِد", emoji: "1️⃣", pronunciation: "wāḥid",
      meanings: { korean: "숫자 1을 뜻해요.", english: "One — the number 1.", spanish: "Uno — el número 1.", indonesian: "Satu — angka 1." },
      example: "عِنْدي أُخْت واحِدَة فَقَط (ʿindī ukht wāḥida faqaṭ)",
      exampleTranslation: { korean: "나는 여동생이 딱 한 명 있어.", english: "I only have one sister.", spanish: "Solo tengo una hermana.", indonesian: "Saya hanya punya satu saudara perempuan." }, speechLang: "ar-EG" },

    { word: "اِثْنان", emoji: "2️⃣", pronunciation: "ithnān",
      meanings: { korean: "숫자 2를 뜻해요.", english: "Two — the number 2.", spanish: "Dos — el número 2.", indonesian: "Dua — angka 2." },
      example: "طَلَبْنا اثْنَيْنِ مِنَ الشّاي (ṭalabnā thnayni mina sh-shāy)",
      exampleTranslation: { korean: "우리는 차 두 잔을 시켰어.", english: "We ordered two teas.", spanish: "Pedimos dos tés.", indonesian: "Kami memesan dua teh." }, speechLang: "ar-EG" },

    { word: "ثَلاثَة", emoji: "3️⃣", pronunciation: "thalātha",
      meanings: { korean: "숫자 3을 뜻해요.", english: "Three — the number 3.", spanish: "Tres — el número 3.", indonesian: "Tiga — angka 3." },
      example: "هُناكَ ثَلاثَةُ كُتُب عَلى الطّاوِلَة (hunāka thalāthatu kutub ʿalā ṭ-ṭāwila)",
      exampleTranslation: { korean: "탁자 위에 책 세 권이 있어.", english: "There are three books on the table.", spanish: "Hay tres libros sobre la mesa.", indonesian: "Ada tiga buku di atas meja." }, speechLang: "ar-EG" },

    { word: "كَبير", emoji: "🐘", pronunciation: "kabīr",
      meanings: { korean: "크기나 규모가 큰 것을 뜻해요.", english: "Big / Large — great in size or amount.", spanish: "Grande — de gran tamaño o cantidad.", indonesian: "Besar — besar dalam ukuran atau jumlah." },
      example: "هُمْ يَسْكُنونَ فِي بَيْت كَبير (hum yaskunūna fī bayt kabīr)",
      exampleTranslation: { korean: "그들은 큰 집에 살아.", english: "They live in a big house.", spanish: "Viven en una casa grande.", indonesian: "Mereka tinggal di rumah yang besar." }, speechLang: "ar-EG" },

    { word: "صَغير", emoji: "🐭", pronunciation: "ṣaghīr",
      meanings: { korean: "크기나 규모가 작은 것을 뜻해요.", english: "Small / Little — not big; of little size.", spanish: "Pequeño — no grande; de poco tamaño.", indonesian: "Kecil — tidak besar; berukuran kecil." },
      example: "عِنْدَهُ شَقَّة صَغيرَة لٰكِنَّها مُريحَة (ʿindahu shaqqa ṣaghīra lākinnahā murīḥa)",
      exampleTranslation: { korean: "그는 작지만 아늑한 아파트가 있어.", english: "He has a small but cozy apartment.", spanish: "Tiene un apartamento pequeño pero acogedor.", indonesian: "Dia punya apartemen kecil tapi nyaman." }, speechLang: "ar-EG" },

    { word: "جَيِّد", emoji: "👍", pronunciation: "jayyid",
      meanings: { korean: "좋거나 괜찮은 것을 표현하는 말이에요 (이집트 구어).", english: "Good / Nice — of good quality; fine (Egyptian colloquial).", spanish: "Bueno / Bien — de buena calidad; está bien (coloquial egipcio).", indonesian: "Bagus / Baik — berkualitas baik; oke (bahasa Arab Mesir)." },
      example: "الجَوُّ اليَوْمَ جَيِّد جِدًّا (al-jawwu l-yawma jayyid jiddan)",
      exampleTranslation: { korean: "오늘 날씨가 정말 좋아.", english: "The weather today is very nice.", spanish: "El clima de hoy es muy bueno.", indonesian: "Cuaca hari ini sangat bagus." }, speechLang: "ar-EG" },

    { word: "لَذيذ", emoji: "😋", pronunciation: "ladhīdh",
      meanings: { korean: "음식이 맛있다고 표현할 때 써요.", english: "Delicious / Tasty — used to say food tastes great.", spanish: "Delicioso / Rico — para decir que la comida sabe muy bien.", indonesian: "Lezat / Enak — dipakai untuk menyatakan makanan terasa enak." },
      example: "طَعامُ أُمّي لَذيذ جِدًّا (ṭaʿāmu ummī ladhīdh jiddan)",
      exampleTranslation: { korean: "엄마 요리는 정말 맛있어.", english: "Mom's cooking is very delicious.", spanish: "La comida de mamá es muy rica.", indonesian: "Masakan mama sangat lezat." }, speechLang: "ar-EG" },

    { word: "أَحْمَر", emoji: "🔴", pronunciation: "aḥmar",
      meanings: { korean: "피나 불의 색깔, 빨강이에요.", english: "Red — the color of blood or fire.", spanish: "Rojo — el color de la sangre o el fuego.", indonesian: "Merah — warna darah atau api." },
      example: "الوَرْدُ الأَحْمَرُ جَميل جِدًّا (al-wardu l-aḥmaru jamīl jiddan)",
      exampleTranslation: { korean: "빨간 장미는 정말 예뻐.", english: "Red roses are very beautiful.", spanish: "Las rosas rojas son muy hermosas.", indonesian: "Bunga mawar merah sangat indah." }, speechLang: "ar-EG" },

    { word: "أَزْرَق", emoji: "🔵", pronunciation: "azraq",
      meanings: { korean: "하늘이나 바다의 색깔, 파랑이에요.", english: "Blue — the color of the sky or the sea.", spanish: "Azul — el color del cielo o el mar.", indonesian: "Biru — warna langit atau laut." },
      example: "السَّماءُ اليَوْمَ زَرْقاءُ صافِيَة (as-samāʾu l-yawma zarqāʾu ṣāfiya)",
      exampleTranslation: { korean: "오늘 하늘은 맑은 파란색이야.", english: "The sky today is clear blue.", spanish: "El cielo de hoy es azul despejado.", indonesian: "Langit hari ini biru cerah." }, speechLang: "ar-EG" },

    { word: "اليَوْم", emoji: "📅", pronunciation: "al-yawm",
      meanings: { korean: "바로 지금의 날, 오늘이에요 (이집트 구어).", english: "Today — this present day (Egyptian colloquial).", spanish: "Hoy — el día presente (coloquial egipcio).", indonesian: "Hari ini — hari yang sedang berlangsung sekarang (bahasa Arab Mesir)." },
      example: "اليَوْمَ أَذْهَبُ إِلى السّوق (al-yawma adhhabu ilā s-sūq)",
      exampleTranslation: { korean: "오늘 나는 시장에 가.", english: "Today I am going to the market.", spanish: "Hoy voy al mercado.", indonesian: "Hari ini saya pergi ke pasar." }, speechLang: "ar-EG" },

    { word: "غَدًا", emoji: "🌅", pronunciation: "ghadan",
      meanings: { korean: "오늘 다음 날, 내일이에요 (이집트 구어).", english: "Tomorrow — the day after today (Egyptian colloquial).", spanish: "Mañana — el día después de hoy (coloquial egipcio).", indonesian: "Besok — hari setelah hari ini (bahasa Arab Mesir)." },
      example: "غَدًا سَنَتَقابَلُ مَرَّةً أُخْرى (ghadan sanataqābalu marratan ukhrā)",
      exampleTranslation: { korean: "내일 우리 또 만날 거야.", english: "Tomorrow we will meet again.", spanish: "Mañana nos veremos de nuevo.", indonesian: "Besok kita akan bertemu lagi." }, speechLang: "ar-EG" },

    { word: "يَذْهَب", emoji: "🚶", pronunciation: "yadhhab",
      meanings: { korean: "어떤 장소로 이동하거나 가는 행동이에요.", english: "To go — to move or head toward a place.", spanish: "Ir — desplazarse o dirigirse hacia un lugar.", indonesian: "Pergi — berpindah atau menuju suatu tempat." },
      example: "أَذْهَبُ إِلى العَمَلِ بِالحافِلَة (adhhabu ilā l-ʿamali bi-l-ḥāfila)",
      exampleTranslation: { korean: "나는 버스를 타고 회사에 가.", english: "I go to work by bus.", spanish: "Voy al trabajo en autobús.", indonesian: "Saya pergi ke kantor naik bus." }, speechLang: "ar-EG" },

    { word: "يَنام", emoji: "😴", pronunciation: "yanām",
      meanings: { korean: "몸과 마음이 쉬는 수면 상태, 자다예요.", english: "To sleep — the natural rest state of body and mind.", spanish: "Dormir — el estado natural de descanso del cuerpo y la mente.", indonesian: "Tidur — keadaan istirahat alami tubuh dan pikiran." },
      example: "أَحْتاجُ أَنْ أَنامَ مُبَكِّرًا هٰذِهِ اللَّيْلَة (aḥtāju an anāma mubakkiran hādhihi l-layla)",
      exampleTranslation: { korean: "오늘 밤엔 일찍 자야 해.", english: "I need to sleep early tonight.", spanish: "Necesito dormir temprano esta noche.", indonesian: "Saya perlu tidur lebih awal malam ini." }, speechLang: "ar-EG" },

    { word: "حُبّ", emoji: "❤️", pronunciation: "ḥubb",
      meanings: { korean: "누군가나 무언가에 대한 깊은 사랑이에요.", english: "Love — a deep feeling of affection for someone or something.", spanish: "Amor — un sentimiento profundo de afecto por alguien o algo.", indonesian: "Cinta — perasaan kasih sayang yang mendalam pada seseorang atau sesuatu." },
      example: "أُحِبُّ عائِلَتي كَثيرًا (uḥibbu ʿāʾilatī kathīran)",
      exampleTranslation: { korean: "나는 우리 가족을 정말 사랑해.", english: "I love my family very much.", spanish: "Amo mucho a mi familia.", indonesian: "Saya sangat mencintai keluarga saya." }, speechLang: "ar-EG" },

    { word: "سَعيد", emoji: "😊", pronunciation: "saʿīd",
      meanings: { korean: "기쁘고 흐뭇한 감정 상태예요 (이집트 구어로 '행복한').", english: "Happy / Glad — feeling content and pleased (Egyptian colloquial).", spanish: "Feliz / Contento — sentirse satisfecho y a gusto (coloquial egipcio).", indonesian: "Senang / Bahagia — merasa puas dan gembira (bahasa Arab Mesir)." },
      example: "أَنا سَعيد بِأَنّي رَأَيْتُكَ (anā saʿīd bi-annī raʾaytuka)",
      exampleTranslation: { korean: "너를 만나서 기뻐.", english: "I am happy to see you.", spanish: "Estoy contento de verte.", indonesian: "Saya senang bertemu denganmu." }, speechLang: "ar-EG" },

    { word: "حَزين", emoji: "😢", pronunciation: "ḥazīn",
      meanings: { korean: "슬프거나 속상한 감정이에요 (이집트 구어).", english: "Sad / Upset — feeling unhappy or sorrowful (Egyptian colloquial).", spanish: "Triste / Disgustado — sentirse infeliz o afligido (coloquial egipcio).", indonesian: "Sedih / Kesal — merasa tidak bahagia atau berduka (bahasa Arab Mesir)." },
      example: "هُوَ حَزين لِأَنَّهُ أَضاعَ قِطَّتَهُ (huwa ḥazīn li-annahu aḍāʿa qiṭṭatahu)",
      exampleTranslation: { korean: "그는 고양이를 잃어버려서 슬퍼해.", english: "He is sad because he lost his cat.", spanish: "Está triste porque perdió a su gato.", indonesian: "Dia sedih karena kehilangan kucingnya." }, speechLang: "ar-EG" },

    { word: "بِكَمْ", emoji: "💰", pronunciation: "bikam",
      meanings: { korean: "가격을 물을 때 쓰는 '얼마예요?'예요 (이집트 구어).", english: "How much (does it cost)? — used to ask a price (Egyptian colloquial).", spanish: "¿Cuánto cuesta? — para preguntar el precio (coloquial egipcio).", indonesian: "Berapa harganya? — dipakai untuk menanyakan harga (bahasa Arab Mesir)." },
      example: "بِكَمْ هٰذِهِ الفاكِهَة؟ (bikam hādhihi l-fākiha?)",
      exampleTranslation: { korean: "이 과일은 얼마예요?", english: "How much is this fruit?", spanish: "¿Cuánto cuesta esta fruta?", indonesian: "Berapa harga buah ini?" }, speechLang: "ar-EG" },

    { word: "أَيْنَ", emoji: "📍", pronunciation: "ayna",
      meanings: { korean: "장소를 물을 때 쓰는 '어디?'예요 (이집트 구어).", english: "Where? — used to ask about a location (Egyptian colloquial).", spanish: "¿Dónde? — para preguntar por un lugar (coloquial egipcio).", indonesian: "Di mana? — dipakai untuk menanyakan suatu tempat (bahasa Arab Mesir)." },
      example: "أَيْنَ الحَمّام، لَو سَمَحْتَ؟ (ayna l-ḥammām, law samaḥta?)",
      exampleTranslation: { korean: "화장실이 어디예요?", english: "Where is the toilet, please?", spanish: "¿Dónde está el baño, por favor?", indonesian: "Di mana toiletnya?" }, speechLang: "ar-EG" },

    { word: "مَعَ السَّلامَة", emoji: "👋", pronunciation: "maʿa s-salāma",
      meanings: { korean: "헤어질 때 하는 작별 인사 '안녕히 가세요'예요.", english: "Goodbye — a friendly farewell in Egyptian Arabic.", spanish: "Adiós — una despedida amistosa en árabe egipcio.", indonesian: "Selamat tinggal — ucapan perpisahan yang ramah dalam bahasa Arab Mesir." },
      example: "مَعَ السَّلامَة، أَراكَ الأُسْبوعَ القادِم (maʿa s-salāma, arāka l-usbūʿa l-qādim)",
      exampleTranslation: { korean: "안녕히 가세요, 다음 주에 봐요!", english: "Goodbye, see you next week!", spanish: "Adiós, ¡hasta la próxima semana!", indonesian: "Selamat tinggal, sampai jumpa minggu depan!" }, speechLang: "ar-EG" },
  ],
...
const ADVANCED_CARDS: Record<LearningTargetLanguage, FlashCard[]> = {
  /* ── INDONESIAN A2 ──────────────────────────────────────── */
  indonesian: [
  ...
  /* ── ARABIC A2 (Egyptian colloquial / Cairene) ──────────── */
  arabic: [
    { word: "يَزور", emoji: "🚪", pronunciation: "yazūr",
      meanings: { korean: "다른 사람의 집이나 장소를 찾아가는 것, 방문하다예요.", english: "To visit — to go and spend time at someone's home or a place.", spanish: "Visitar — ir y pasar tiempo en casa de alguien o en un lugar.", indonesian: "Berkunjung — pergi dan menghabiskan waktu di rumah seseorang atau suatu tempat." },
      example: "هٰذا الأُسْبوعَ سَنَزورُ بَيْتَ الجَدَّة (hādhā l-usbūʿa sanazūru bayta l-jadda)",
      exampleTranslation: { korean: "이번 주에 우리는 할머니 댁을 방문할 거야.", english: "This week we will visit grandma's house.", spanish: "Esta semana visitaremos la casa de la abuela.", indonesian: "Minggu ini kami akan berkunjung ke rumah nenek." }, speechLang: "ar-EG" },

    { word: "يُساعِد", emoji: "🤲", pronunciation: "yusāʿid",
      meanings: { korean: "다른 사람을 돕거나 거드는 것, 돕다예요.", english: "To help — to make things easier or possible for someone.", spanish: "Ayudar — hacer las cosas más fáciles o posibles para alguien.", indonesian: "Membantu — meringankan atau memungkinkan sesuatu bagi orang lain." },
      example: "هُوَ دائِمًا يُساعِدُ صَديقَهُ الَّذي يُعاني (huwa dāʾiman yusāʿidu ṣadīqahu lladhī yuʿānī)",
      exampleTranslation: { korean: "그는 힘들어하는 친구를 항상 도와줘.", english: "He always helps his friend who is struggling.", spanish: "Siempre ayuda a su amigo que está pasando dificultades.", indonesian: "Dia selalu membantu temannya yang sedang kesulitan." }, speechLang: "ar-EG" },

    { word: "مَشْغول", emoji: "🏃", pronunciation: "mashghūl",
      meanings: { korean: "할 일이 많아 바쁜 상태예요.", english: "Busy — having a lot to do; occupied with many tasks.", spanish: "Ocupado — con muchas cosas que hacer; lleno de tareas.", indonesian: "Sibuk — memiliki banyak hal untuk dikerjakan; penuh kegiatan." },
      example: "أَنا مَشْغول جِدًّا بِالعَمَلِ هٰذا الأُسْبوع (anā mashghūl jiddan bi-l-ʿamali hādhā l-usbūʿ)",
      exampleTranslation: { korean: "나는 이번 주에 일 때문에 정말 바빠.", english: "I am very busy with work this week.", spanish: "Estoy muy ocupado con el trabajo esta semana.", indonesian: "Saya sangat sibuk dengan pekerjaan minggu ini." }, speechLang: "ar-EG" },

    { word: "مُهِمّ", emoji: "⭐", pronunciation: "muhimm",
      meanings: { korean: "크게 가치 있거나 의미 있는 것, 중요한이에요.", english: "Important — having great value or significance.", spanish: "Importante — que tiene gran valor o significado.", indonesian: "Penting — memiliki nilai atau makna yang besar." },
      example: "مِنَ المُهِمِّ جِدًّا أَنْ تَتَمَرَّنَ عَلى اللُّغَةِ كُلَّ يَوْم (mina l-muhimmi jiddan an tatamarrana ʿalā l-lughati kulla yawm)",
      exampleTranslation: { korean: "매일 언어를 연습하는 게 정말 중요해.", english: "It is very important to practice the language every day.", spanish: "Es muy importante practicar el idioma cada día.", indonesian: "Sangat penting untuk berlatih bahasa setiap hari." }, speechLang: "ar-EG" },

    { word: "خِبْرَة", emoji: "🧭", pronunciation: "khibra",
      meanings: { korean: "직접 겪으며 얻은 지식이나 경험이에요.", english: "Experience — knowledge or skill gained from doing something.", spanish: "Experiencia — conocimiento o habilidad adquiridos al hacer algo.", indonesian: "Pengalaman — pengetahuan atau keterampilan yang diperoleh dari melakukan sesuatu." },
      example: "كانَتْ هٰذِهِ الرِّحْلَةُ خِبْرَةً لا تُنْسى (kānat hādhihi r-riḥlatu khibra lā tunsā)",
      exampleTranslation: { korean: "그 여행은 잊을 수 없는 경험이었어.", english: "That trip was an unforgettable experience.", spanish: "Ese viaje fue una experiencia inolvidable.", indonesian: "Perjalanan itu adalah pengalaman yang tak terlupakan." }, speechLang: "ar-EG" },

    { word: "مُخْتَلِف", emoji: "🔄", pronunciation: "mukhtalif",
      meanings: { korean: "같지 않거나 다른 종류의 것, 다른이에요.", english: "Different — not the same; unlike others.", spanish: "Diferente — no igual; a diferencia de los demás.", indonesian: "Berbeda — tidak sama; tidak seperti yang lain." },
      example: "كُلُّ مَنْطِقَةٍ لَها تَقاليدُ مُخْتَلِفَة (kullu manṭiqa lahā taqālīdu mukhtalifa)",
      exampleTranslation: { korean: "모든 지역은 서로 다른 전통을 가지고 있어.", english: "Every region has different traditions.", spanish: "Cada región tiene tradiciones diferentes.", indonesian: "Setiap daerah memiliki tradisi yang berbeda." }, speechLang: "ar-EG" },

    { word: "رُبَّما", emoji: "🤔", pronunciation: "rubbamā",
      meanings: { korean: "확실하지 않지만 가능성이 있는 '아마/혹시'예요.", english: "Maybe / Perhaps — expressing that something could happen.", spanish: "Quizás / Tal vez — para expresar que algo podría suceder.", indonesian: "Mungkin — menyatakan bahwa sesuatu bisa saja terjadi." },
      example: "رُبَّما تُمْطِرُ غَدًا (rubbamā tumṭiru ghadan)",
      exampleTranslation: { korean: "아마 내일 비가 올 거야.", english: "Maybe it will rain tomorrow.", spanish: "Quizás llueva mañana.", indonesian: "Mungkin besok akan turun hujan." }, speechLang: "ar-EG" },

    { word: "فِي الحَقيقَة", emoji: "💡", pronunciation: "fi l-ḥaqīqa",
      meanings: { korean: "사실이나 진실을 강조할 때 쓰는 '사실은'이에요.", english: "Actually / In fact — used to emphasize the truth of something.", spanish: "En realidad / De hecho — para enfatizar la verdad de algo.", indonesian: "Sebenarnya — dipakai untuk menegaskan kebenaran sesuatu." },
      example: "فِي الحَقيقَةِ أَنا لا أَعْرِفُ الإِجابَة (fi l-ḥaqīqati anā lā aʿrifu l-ijāba)",
      exampleTranslation: { korean: "사실 나는 그 답을 몰라.", english: "Actually, I do not know the answer.", spanish: "En realidad, no sé la respuesta.", indonesian: "Sebenarnya saya tidak tahu jawabannya." }, speechLang: "ar-EG" },

    { word: "فَخور", emoji: "🦁", pronunciation: "fakhūr",
      meanings: { korean: "자신이나 남의 성취에 깊이 만족하는 감정, 자랑스러운이에요.", english: "Proud — feeling deep satisfaction from achievements.", spanish: "Orgulloso — sentir satisfacción profunda por los logros.", indonesian: "Bangga — merasakan kepuasan mendalam atas suatu pencapaian." },
      example: "أَنا فَخور بِكَ جِدًّا لِأَنَّكَ لَمْ تَيْأَسْ أَبَدًا (anā fakhūr bika jiddan li-annaka lam tayʾas abadan)",
      exampleTranslation: { korean: "절대 포기하지 않은 네가 정말 자랑스러워.", english: "I am very proud of you for never giving up.", spanish: "Estoy muy orgulloso de ti por no rendirte nunca.", indonesian: "Saya sangat bangga padamu karena tidak pernah menyerah." }, speechLang: "ar-EG" },

    { word: "قَلِق", emoji: "😟", pronunciation: "qaliq",
      meanings: { korean: "무언가 잘못될까봐 불안한 감정, 걱정스러운이에요 (이집트 구어).", english: "Worried — feeling anxious about something that might go wrong (Egyptian colloquial).", spanish: "Preocupado — sentirse ansioso por algo que podría salir mal (coloquial egipcio).", indonesian: "Khawatir — merasa cemas akan sesuatu yang mungkin tidak beres (bahasa Arab Mesir)." },
      example: "الأُمُّ قَلِقَةٌ لِأَنَّ ابْنَها لَمْ يَعُدْ بَعْد (al-ummu qaliqa li-anna bnahā lam yaʿud baʿd)",
      exampleTranslation: { korean: "엄마는 아이가 아직 안 돌아와서 걱정해.", english: "Mom is worried because her son hasn't come home yet.", spanish: "Mamá está preocupada porque su hijo aún no ha vuelto a casa.", indonesian: "Ibu khawatir karena anaknya belum pulang." }, speechLang: "ar-EG" },

    { word: "حائِر", emoji: "😕", pronunciation: "ḥāʾir",
      meanings: { korean: "이해 못 하거나 결정 못 하는 혼란스러운 상태예요.", english: "Confused — unable to understand or decide; puzzled.", spanish: "Confundido — incapaz de entender o decidir; desconcertado.", indonesian: "Bingung — tidak mampu memahami atau menentukan; kebingungan." },
      example: "أَنا حائِر فِي الِاخْتِيارِ بَيْنَ هٰذَيْنِ الِاثْنَيْن (anā ḥāʾir fi l-ikhtiyāri bayna hādhayni l-ithnayn)",
      exampleTranslation: { korean: "나는 이 둘 중에 고르기가 어려워.", english: "I am confused about choosing between these two.", spanish: "Estoy confundido al elegir entre estos dos.", indonesian: "Saya bingung memilih antara keduanya." }, speechLang: "ar-EG" },

    { word: "رائِع", emoji: "🔍", pronunciation: "rāʾiʿ",
      meanings: { korean: "너무 멋지거나 흥미로워서 반하게 만드는 것이에요 (이집트 구어 '죽여주는/끝내주는').", english: "Amazing / Awesome — so good it 'drives you crazy' (Egyptian colloquial praise).", spanish: "Increíble / Genial — tan bueno que 'te vuelve loco' (elogio coloquial egipcio).", indonesian: "Keren / Memukau — begitu bagus sampai 'bikin gila' (pujian khas Mesir)." },
      example: "تاريخُ مِصْرَ طَويل وَرائِع (tārīkhu miṣra ṭawīl wa-rāʾiʿ)",
      exampleTranslation: { korean: "이집트의 역사는 길고 정말 흥미진진해.", english: "The history of Egypt is long and amazing.", spanish: "La historia de Egipto es larga e increíble.", indonesian: "Sejarah Mesir panjang dan memukau." }, speechLang: "ar-EG" },

    { word: "لِقاء", emoji: "🤗", pronunciation: "liqāʾ",
      meanings: { korean: "사랑하는 사람들이 함께 모여 어울리는 따뜻한 모임이에요 — 이집트 문화에서 소중히 여겨요.", english: "A get-together — the warm gathering of loved ones, deeply cherished in Egyptian culture.", spanish: "Una reunión — el cálido encuentro de seres queridos, muy apreciado en la cultura egipcia.", indonesian: "Kumpul-kumpul — pertemuan hangat orang-orang tercinta yang sangat dihargai dalam budaya Mesir." },
      example: "لِقاءُ العائِلَةِ أَجْمَلُ شَيْء فِي الدُّنْيا (liqāʾu l-ʿāʾilati ajmalu shayʾ fi d-dunyā)",
      exampleTranslation: { korean: "가족이 함께 모이는 시간은 세상에서 가장 좋은 거야.", english: "A family get-together is the best thing in the world.", spanish: "La reunión familiar es lo mejor del mundo.", indonesian: "Kumpul keluarga adalah hal terbaik di dunia." }, speechLang: "ar-EG" },

    { word: "لا بَأْس", emoji: "🤷", pronunciation: "lā baʾs",
      meanings: { korean: "'괜찮아 / 신경 쓰지 마'라는 위로와 양해의 말이에요 — 이집트 일상에서 정말 자주 써요.", english: "Never mind / It's okay — a hugely common Egyptian word to comfort, console, or excuse.", spanish: "No pasa nada / Tranquilo — una palabra egipcia muy común para consolar o disculpar.", indonesian: "Tidak apa-apa / Sudahlah — kata Mesir yang sangat umum untuk menghibur atau memaklumi." },
      example: "لا بَأْس، المَرَّةُ القادِمَةُ سَتَكونُ أَفْضَل (lā baʾs, al-marratu l-qādimatu satakūnu afḍal)",
      exampleTranslation: { korean: "괜찮아, 다음엔 더 잘 될 거야.", english: "Never mind, next time will be better.", spanish: "No pasa nada, la próxima vez será mejor.", indonesian: "Tidak apa-apa, lain kali akan lebih baik." }, speechLang: "ar-EG" },
  ],
  /* ── ENGLISH B1+ Advanced ───────────────────────────────── */
  english: [
...
export default function CardsScreen() {
  ...
  // The SRS engine + learner-profile machinery (srsCardsToFlashCards,
  // loadCardPractice, handoff) is keyed by a guaranteed NATIVE language, so
  // an "arabic" target is coerced to a native default for those paths.
  const lang: NativeLanguage = toNativeLearning(native, getEffectiveLearningLanguage(native, learningLanguage));
  // The static beginner/advanced decks (BEGINNER_CARDS_BY_LANG / ADVANCED_CARDS)
  // now include an authored Arabic deck, so the static-deck lookups use the
  // full learning target (Arabic passes through instead of being coerced).
  const deckLang: LearningTargetLanguage = getEffectiveLearningLanguage(native, learningLanguage);
  ...
  const allCards = deckType === "beginner" ? BEGINNER_CARDS_BY_LANG[deckLang] : ADVANCED_CARDS[deckLang];
  ...
  const loadSession = useCallback(async () => {
    try {
      ...
      const validDeckWords = new Set([
        ...BEGINNER_CARDS_BY_LANG[deckLang].map((c) => c.word),
        ...ADVANCED_CARDS[deckLang].map((c) => c.word),
      ]);
  ...
  }, [deckType, lang, deckLang, nativeLang, allCards]);
