...
const BEGINNER_CARDS_BY_LANG: Record<LearningTargetLanguage, FlashCard[]> = {
  ...
  arabic: [
    ...
    { word: "أَهْلًا", emoji: "👋", pronunciation: "ahlan",
      ...
      example: "أَهْلًا، إِزَّيَّك؟ (ahlan, ezzayyak?)",
    ...
    { word: "شُكْرًا", emoji: "🙏", pronunciation: "shokran",
      ...
      example: "شُكْرًا جَدًّا عَلَى مُسَاعْدِتَك (shokran geddan 3ala mosa3detak)",
    ...
    { word: "لَو سَمَحْت", emoji: "🤝", pronunciation: "law samaht",
      ...
      example: "لَو سَمَحْت، سَاعِدْنِي أَشِيل الشَّنْطَة دِي (law samaht, sa3edni asheel el-shanta di)",
    ...
    { word: "آسِف", emoji: "🙇", pronunciation: "aasef",
      ...
      example: "آسِف، أَنَا اِتْأَخَّرْت النَّهَارْدَه (aasef, ana et2akhart el-naharda)",
    ...
    { word: "صَبَاح الْخِير", emoji: "☀️", pronunciation: "sabah el-kheer",
      ...
      example: "صَبَاح الْخِير! نِمْت كْوَيِّس؟ (sabah el-kheer! nemt kwayyes?)",
    ...
    { word: "مَسَاء الْخِير", emoji: "🌙", pronunciation: "masaa el-kheer",
      ...
      example: "مَسَاء الْخِير، أَشُوفَك بُكْرَه (masaa el-kheer, ashoofak bokra)",
    ...
    { word: "أَيْوَه", emoji: "✅", pronunciation: "aywa",
      ...
      example: "أَيْوَه، عَايِز أَجِي مَعَاك (aywa, 3aayez agi ma3aak)",
    ...
    { word: "لأ", emoji: "🚫", pronunciation: "la2",
      ...
      example: "لأ، أَنَا مِش بَحِبّ الْقَهْوَة (la2, ana mish baheb el-2ahwa)",
    ...
    { word: "مَيَّة", emoji: "💧", pronunciation: "mayya",
      ...
      example: "مُمْكِن كُبَّايِة مَيَّة لَو سَمَحْت؟ (momken kobbayet mayya law samaht?)",
    ...
    { word: "يَاكُل", emoji: "🍴", pronunciation: "yaakol",
      ...
      example: "بَحِبّ آكُل كُشَرِي (baheb aakol koshari)",
    ...
    { word: "يِشْرَب", emoji: "🥤", pronunciation: "yeshrab",
      ...
      example: "لَازِم تِشْرَب مَيَّة كُلّ يُوم (lazem teshrab mayya koll yom)",
    ...
    { word: "عِيش", emoji: "🍚", pronunciation: "3eesh",
      ...
      example: "بِنَاكُل عِيش بَلَدِي كُلّ يُوم (benaakol 3eesh balady koll yom)",
    ...
    { word: "بِيت", emoji: "🏠", pronunciation: "beet",
      ...
      example: "بِيتْنَا فِيه جِنِينَة حِلْوَة (beetna feeh geneena helwa)",
    ...
    { word: "مَدْرَسَة", emoji: "🏫", pronunciation: "madrasa",
      ...
      example: "الْعِيَال بِيرُوحُوا الْمَدْرَسَة كُلّ الصُّبْح (el-3eyal beyroohoo el-madrasa koll el-sobh)",
    ...
    { word: "عِيلَة", emoji: "👨‍👩‍👧‍👦", pronunciation: "3eela",
      ...
      example: "الْعِيلَة بِتِتْجَمَّع كُلّ أَجَازَة (el-3eela betetgamma3 koll agaza)",
    ...
    { word: "صَاحِب", emoji: "🤝", pronunciation: "saheb",
      ...
      example: "صَاحْبِي طَيِّب وَلَطِيف أَوِي (sahbi tayyeb we lateef awi)",
    ...
    { word: "مَامَا", emoji: "👩", pronunciation: "mama",
      ...
      example: "مَامَا بِتِطْبُخ أَكْل لَذِيذ (mama betetbokh akl lazeez)",
    ...
    { word: "بَابَا", emoji: "👨", pronunciation: "baba",
      ...
      example: "بَابَا بِيِشْتَغَل فِي مَكْتَب (baba beyeshtaghal fi maktab)",
    ...
    { word: "كَلْب", emoji: "🐶", pronunciation: "kalb",
      ...
      example: "الْكَلْب دَه بِيِحِبّ يِلْعَب فِي الْجِنِينَة (el-kalb da beyeheb yel3ab fi el-geneena)",
    ...
    { word: "قُطَّة", emoji: "🐱", pronunciation: "2otta",
      ...
      example: "الْقُطَّة نَايْمَة عَلَى الْكَنَبَة (el-2otta nayma 3ala el-kanaba)",
    ...
    { word: "كِتَاب", emoji: "📖", pronunciation: "ketab",
      ...
      example: "أَنَا بَقْرَا كِتَاب حِلْو (ana ba2ra ketab helw)",
    ...
    { word: "تَلَاتَة", emoji: "3️⃣", pronunciation: "talata",
      meanings: { korean: "숫자 3을 뜻해요.", english: "Three — the number 3.", spanish: "Tres — el número 3.", indonesian: "Tiga — angka 3." },
      example: "فِيه تَلَاتَة كُتُب عَ التَّرابِيزَة (feeh talata kotob 3a el-tarabeza)",
    ...
    { word: "كِبِير", emoji: "🐘", pronunciation: "kebeer",
      ...
      example: "هُمَّ سَاكْنِين فِي بِيت كِبِير (homma sakneen fi beet kebeer)",
    ...
    { word: "صُغَيَّر", emoji: "🐭", pronunciation: "soghayyar",
      ...
      example: "عَنْدُه شَقَّة صُغَيَّرَة بَس مُرِيحَة (3andoh sha22a soghayyara bas mureeha)",
    ...
    { word: "كْوَيِّس", emoji: "👍", pronunciation: "kwayyes",
      ...
      example: "الْجَوّ النَّهَارْدَه كْوَيِّس أَوِي (el-gaw el-naharda kwayyes awi)",
    ...
    { word: "لَذِيذ", emoji: "😋", pronunciation: "lazeez",
      ...
      example: "أَكْل مَامَا لَذِيذ أَوِي (akl mama lazeez awi)",
    ...
    { word: "أَحْمَر", emoji: "🔴", pronunciation: "ahmar",
      ...
      example: "الْوَرْد الْأَحْمَر حِلْو أَوِي (el-ward el-ahmar helw awi)",
    ...
    { word: "أَزْرَق", emoji: "🔵", pronunciation: "azra2",
      ...
      example: "السَّمَا النَّهَارْدَه زَرْقَا صَافْيَة (el-sama el-naharda zar2a safya)",
    ...
    { word: "النَّهَارْدَه", emoji: "📅", pronunciation: "el-naharda",
      ...
      example: "النَّهَارْدَه رَايِح السُّوق (el-naharda rayeh el-soo2)",
    ...
    { word: "بُكْرَه", emoji: "🌅", pronunciation: "bokra",
      ...
      example: "بُكْرَه هَنِتْقَابِل تَانِي (bokra hanet2abel tani)",
    ...
    { word: "يِرُوح", emoji: "🚶", pronunciation: "yerooh",
      ...
      example: "بَرُوح الشُّغْل بِالْأُتُوبِيس (barooh el-shoghl bel-otobees)",
    ...
    { word: "يِنَام", emoji: "😴", pronunciation: "yenaam",
      ...
      example: "مُحْتَاج أَنَام بَدْرِي اللِّيلَة دِي (mehtag anam badri el-leela di)",
    ...
    { word: "حُبّ", emoji: "❤️", pronunciation: "hobb",
      ...
      example: "بَحِبّ عِيلْتِي أَوِي (baheb 3eelti awi)",
    ...
    { word: "مَبْسُوط", emoji: "😊", pronunciation: "mabsoot",
      ...
      example: "أَنَا مَبْسُوط إِنِّي شُفْتَك (ana mabsoot enni sheftak)",
    ...
    { word: "زَعْلَان", emoji: "😢", pronunciation: "za3laan",
      ...
      example: "هُوَّ زَعْلَان عَشَان ضَيَّع قُطْتُه (howwa za3laan 3ashan dayya3 2otto)",
    ...
    { word: "بِكَام", emoji: "💰", pronunciation: "bekaam",
      ...
      example: "الْفَاكْهَة دِي بِكَام؟ (el-fakha di bekaam?)",
    ...
    { word: "فِين", emoji: "📍", pronunciation: "feen",
      ...
      example: "الْحَمَّام فِين، لَو سَمَحْت؟ (el-hammam feen, law samaht?)",
    ...
    { word: "مَع السَّلَامَة", emoji: "👋", pronunciation: "ma3 el-salama",
      ...
      example: "مَع السَّلَامَة، أَشُوفَك الْأُسْبُوع الْجَاي (ma3 el-salama, ashoofak el-osboo3 el-gay)",
...
const ADVANCED_CARDS: Record<LearningTargetLanguage, FlashCard[]> = {
  ...
  arabic: [
    { word: "يِزُور", emoji: "🚪", pronunciation: "yezoor",
      ...
      example: "الْأُسْبُوع دَه هَنْزُور بِيت تِيتَة (el-osboo3 da hanzoor beet teta)",
    ...
    { word: "يِسَاعِد", emoji: "🤲", pronunciation: "yesa3ed",
      ...
      example: "هُوَّ دَايْمًا بِيِسَاعِد صَاحْبُه اللِّي تَعْبَان (howwa dayman beyesa3ed sahbo elli ta3baan)",
    ...
    { word: "مَشْغُول", emoji: "🏃", pronunciation: "mashghool",
      meanings: { korean: "할 일이 많아 바쁜 상태예요.", english: "Busy — having a lot to do; occupied with many tasks.", spanish: "Ocupado — con muchas cosas que hacer; lleno de tareas.", indonesian: "Sibuk — memiliki banyak hal untuk dikerjakan; penuh kegiatan." },
      example: "أَنَا مَشْغُول أَوِي بِالشُّغْل الْأُسْبُوع دَه (ana mashghool awi bel-shoghl el-osboo3 da)",
    ...
    { word: "مُهِمّ", emoji: "⭐", pronunciation: "mohemm",
      ...
      example: "مُهِمّ جِدًّا إِنَّك تِتْمَرَّن عَ اللُّغَة كُلّ يُوم (mohemm geddan ennak tetmarran 3a el-logha koll yom)",
    ...
    { word: "خِبْرَة", emoji: "🧭", pronunciation: "khebra",
      ...
      example: "الرِّحْلَة دِي كَانِت خِبْرَة مَتِتْنِسِيش (el-rehla di kanet khebra matetneseesh)",
    ...
    { word: "مُخْتَلِف", emoji: "🔄", pronunciation: "mokhtalef",
      ...
      example: "كُلّ مَنْطِقَة لِيهَا تَقَالِيد مُخْتَلِفَة (koll mante2a leeha ta2aleed mokhtalefa)",
    ...
    { word: "يِمْكِن", emoji: "🤔", pronunciation: "yemken",
      ...
      example: "يِمْكِن تِمَطَّر بُكْرَه (yemken temattar bokra)",
    ...
    { word: "فِي الْحَقِيقَة", emoji: "💡", pronunciation: "fel-ha2ee2a",
      ...
      example: "فِي الْحَقِيقَة أَنَا مِش عَارِف الْإِجَابَة (fel-ha2ee2a ana mish 3aaref el-egaba)",
    ...
    { word: "فَخُور", emoji: "🦁", pronunciation: "fakhoor",
      ...
      example: "أَنَا فَخُور بِيك جِدًّا إِنَّك مَيِئِسْتِش أَبَدًا (ana fakhoor beek geddan ennak maye2estesh abadan)",
    ...
    { word: "قَلْقَان", emoji: "😟", pronunciation: "2al2aan",
      ...
      example: "مَامَا قَلْقَانَة عَشَان اِبْنَهَا لِسَّه مَرَجَعْش (mama 2al2aana 3ashan ebnaha lessa maraga3sh)",
    ...
    { word: "مِحْتَار", emoji: "😕", pronunciation: "mehtaar",
      ...
      example: "أَنَا مِحْتَار أَخْتَار بِين الِاتْنِين دُول (ana mehtaar akhtaar been el-etneen dol)",
    ...
    { word: "يِجَنِّن", emoji: "🔍", pronunciation: "yegannen",
      ...
      example: "تَارِيخ مَصْر طَوِيل وَيِجَنِّن (tareekh masr taweel we yegannen)",
    ...
    { word: "لَمَّة", emoji: "🤗", pronunciation: "lamma",
      ...
      example: "لَمِّة الْعِيلَة أَحْلَى حَاجَة فِي الدُّنْيَا (lammet el-3eela ahla haga fel-donya)",
    ...
    { word: "مَعْلِش", emoji: "🤷", pronunciation: "ma3lesh",
      ...
      example: "مَعْلِش، الْمَرَّة الْجَايَّة هَتِبْقَى أَحْسَن (ma3lesh, el-marra el-gayya hateb2a ahsan)",
