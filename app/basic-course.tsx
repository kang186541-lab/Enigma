...
const COURSES: Record<string, CourseData> = {
  ...
  arabic: {
    stepNames: ["الحُرُوف (al-ḥurūf)", "كَلِمَات أَساسِيَّة (kalimāt)", "تَحِيَّات (taḥiyyāt)", "أَنْهَيْنا! (anhaynā!)"],
    lang: "ar-EG",
    lingoTips: [
      "اِسْمَع ثُمَّ اُكْتُب الحَرْف! 🦊 (ismaʿ thumma uktub al-ḥarf!)",
      "اُنْقُر على كُلّ بِطاقة لِتَرى المَعْنى! 🦊 (unqur ʿalā kull biṭāqa li-tarā l-maʿnā!)",
      "اِسْمَع وقُلْ بِصَوْت عالٍ! 🦊 (ismaʿ wa-qul bi-ṣawt ʿālin!)",
      "أَنْهَيْت الدَّوْرة الأَساسِيَّة! 🦊🎉 (anhayt ad-dawra l-asāsiyya!)",
    ],
    // 28 letters of the Arabic alphabet. `char` = the isolated letter form,
    // `roman` = Modern Standard Arabic (fuṣḥā) sound value, `tip` = MSA letter
    // name (with harakat) + a sound cue and an example MSA word. ج = 'j', ق = 'q'.
    chars: [
      { char: "ا", roman: "a / ā",  tip: "أَلِف (alif) · صَوت 'ā' الطَّوِيل — مِثْل 'باب' (bāb) 🚪" },
      { char: "ب", roman: "b",      tip: "باء (bāʾ) · مِثْل 'b' — مِثْل 'بَيْت' (bayt) 🏠" },
      { char: "ت", roman: "t",      tip: "تاء (tāʾ) · مِثْل 't' — مِثْل 'تُفّاحة' (tuffāḥa) 🍎" },
      { char: "ث", roman: "th",     tip: "ثاء (thāʾ) · مِثْل 'th' في 'think' — مِثْل 'ثَلاثة' (thalātha) 3️⃣" },
      { char: "ج", roman: "j",      tip: "جِيم (jīm) · مِثْل 'j' في 'jam' — مِثْل 'جَميل' (jamīl) 😍" },
      { char: "ح", roman: "ḥ",      tip: "حاء (ḥāʾ) · 'h' قَوِيّة مِن الحَلْق — مِثْل 'حَبيب' (ḥabīb) ❤️" },
      { char: "خ", roman: "kh",     tip: "خاء (khāʾ) · مِثْل 'ch' الأَلْمانِيّة — مِثْل 'خُبْز' (khubz) 🍞" },
      { char: "د", roman: "d",      tip: "دال (dāl) · مِثْل 'd' — مِثْل 'دُنْيا' (dunyā) 🌍" },
      { char: "ذ", roman: "dh",     tip: "ذال (dhāl) · مِثْل 'th' في 'this' — مِثْل 'ذَهَب' (dhahab) 🥇" },
      { char: "ر", roman: "r",      tip: "راء (rāʾ) · 'r' مُكَرَّرة — مِثْل 'رَجُل' (rajul) 🚶" },
      { char: "ز", roman: "z",      tip: "زاي (zāy) · مِثْل 'z' — مِثْل 'زَمان' (zamān) ⏳" },
      { char: "س", roman: "s",      tip: "سِين (sīn) · مِثْل 's' — مِثْل 'سَلام' (salām) ✌️" },
      { char: "ش", roman: "sh",     tip: "شِين (shīn) · مِثْل 'sh' — مِثْل 'شُكْرًا' (shukran) 🙏" },
      { char: "ص", roman: "ṣ",      tip: "صاد (ṣād) · 's' مُفَخَّمة — مِثْل 'صُبْح' (ṣubḥ) 🌅" },
      { char: "ض", roman: "ḍ",      tip: "ضاد (ḍād) · 'd' مُفَخَّمة — مِثْل 'ضَوْء' (ḍawʾ) 💡" },
      { char: "ط", roman: "ṭ",      tip: "طاء (ṭāʾ) · 't' مُفَخَّمة — مِثْل 'طَيِّب' (ṭayyib) 👌" },
      { char: "ظ", roman: "ẓ",      tip: "ظاء (ẓāʾ) · 'dh' مُفَخَّمة — مِثْل 'ظَريف' (ẓarīf) 😎" },
      { char: "ع", roman: "ʿ",      tip: "عِين (ʿayn) · صَوت مِن الحَلْق — مِثْل 'عَيْن' (ʿayn) 👁️" },
      { char: "غ", roman: "gh",     tip: "غِين (ghayn) · مِثْل غَرْغَرة خَفيفة — مِثْل 'غالي' (ghālī) 💎" },
      { char: "ف", roman: "f",      tip: "فاء (fāʾ) · مِثْل 'f' — مِثْل 'فيل' (fīl) 🐘" },
      { char: "ق", roman: "q",      tip: "قاف (qāf) · 'q' مِن أَقْصى الحَلْق — مِثْل 'قَلْب' (qalb) 💗" },
      { char: "ك", roman: "k",      tip: "كاف (kāf) · مِثْل 'k' — مِثْل 'كِتاب' (kitāb) 📖" },
      { char: "ل", roman: "l",      tip: "لام (lām) · مِثْل 'l' — مِثْل 'لَيْمون' (laymūn) 🍋" },
      { char: "م", roman: "m",      tip: "مِيم (mīm) · مِثْل 'm' — مِثْل 'ماء' (māʾ) 💧" },
      { char: "ن", roman: "n",      tip: "نُون (nūn) · مِثْل 'n' — مِثْل 'نَهار' (nahār) ☀️" },
      { char: "ه", roman: "h",      tip: "هاء (hāʾ) · 'h' خَفيفة — مِثْل 'هُنا' (hunā) 📍" },
      { char: "و", roman: "w / ū",  tip: "واو (wāw) · 'w' أو 'ū' — مِثْل 'وَلَد' (walad) 👦" },
      { char: "ي", roman: "y / ī",  tip: "ياء (yāʾ) · 'y' أو 'ī' — مِثْل 'يَوْم' (yawm) 📅" },
    ],
    words: [
      { word: "أَهْلًا",      meaning: { ko: "안녕하세요",  en: "Hello",      es: "Hola",      id: "Sapaan" },        emoji: "👋" },
      { word: "شُكْرًا",      meaning: { ko: "감사합니다",  en: "Thank you",  es: "Gracias",   id: "Ungkapan terima kasih" }, emoji: "🙏" },
      { word: "نَعَم",        meaning: { ko: "네",          en: "Yes",        es: "Sí",        id: "Jawaban setuju" }, emoji: "✅" },
      { word: "لا",           meaning: { ko: "아니요",      en: "No",         es: "No",        id: "Jawaban menolak" }, emoji: "❌" },
      { word: "ماء",          meaning: { ko: "물",          en: "Water",      es: "Agua",      id: "Air" },           emoji: "💧" },
      { word: "أَكْل",        meaning: { ko: "먹다",        en: "Eat",        es: "Comer",     id: "Makan" },         emoji: "🍽️" },
      { word: "بَيْت",        meaning: { ko: "집",          en: "House",      es: "Casa",      id: "Rumah" },         emoji: "🏠" },
      { word: "مَدْرَسة",     meaning: { ko: "학교",        en: "School",     es: "Escuela",   id: "Sekolah" },       emoji: "🏫" },
      { word: "حُبّ",         meaning: { ko: "사랑",        en: "Love",       es: "Amor",      id: "Cinta" },         emoji: "❤️" },
      { word: "صَديق",        meaning: { ko: "친구",        en: "Friend",     es: "Amigo",     id: "Teman" },         emoji: "🤝" },
    ],
    greetings: [
      { phrase: "كَيْفَ حالُك؟",       meaning: { ko: "안녕하세요! (잘 지내요?)",  en: "How are you?",      es: "¿Cómo estás?",       id: "Apa kabar?" },              usage: { ko: "누군가에게 인사할 때",     en: "When greeting someone",     es: "Al saludar a alguien",      id: "Saat menyapa seseorang" } },
      { phrase: "شُكْرًا جَزيلًا",     meaning: { ko: "감사합니다!",  en: "Thank you very much!",  es: "¡Muchas gracias!",    id: "Terima kasih banyak!" },    usage: { ko: "감사를 표현할 때",         en: "To show gratitude",         es: "Para mostrar gratitud",     id: "Untuk menyampaikan terima kasih" } },
      ...
      { phrase: "لَو سَمَحْت",         meaning: { ko: "실례합니다.",  en: "Excuse me / Please.",  es: "Perdón / Por favor.",  id: "Permisi" },                 usage: { ko: "정중히 주의를 끌 때",      en: "To get attention politely", es: "Para llamar la atención",   id: "Untuk menarik perhatian dengan sopan" } },
    ],
  },
};
