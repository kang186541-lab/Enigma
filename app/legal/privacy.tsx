...
const T: Record<string, Record<LangKey, string>> = {
  ...
  intro_b: {
    ...
    id: "LinguaAI (\"Layanan\") adalah aplikasi pembelajaran yang membantu penutur bahasa Indonesia mempelajari bahasa Inggris dan Spanyol (dan sebaliknya). Kebijakan Privasi ini menjelaskan, sesuai dengan Undang-Undang Perlindungan Informasi Pribadi Korea (PIPA), Peraturan Perlindungan Data Umum Uni Eropa (GDPR), dan peraturan lain yang berlaku, data apa yang kami kumpulkan, bagaimana kami menggunakannya, serta bagaimana kami menyimpan dan menghapusnya. Mohon baca dengan saksama sebelum menggunakan Layanan.",
  },
