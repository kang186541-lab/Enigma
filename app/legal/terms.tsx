...
const T: Record<string, Record<LangKey, string>> = {
  ...
  ai_b: {
    ko: "본 서비스의 튜터 응답, 첨삭, 발음 평가, 회화 예문, 번역, 손글씨·이미지 인식 등은 설정된 제3자 AI 제공자(예: DeepSeek, OpenAI, Anthropic Claude, Google Gemini), Microsoft Azure Speech, Google Text-to-Speech 등을 통해 자동 생성됩니다. 인공지능 출력은 (i) 항상 정확하다고 보증할 수 없으며 (ii) 학습·참고용 정보일 뿐 의료, 법률, 재정 등 전문적 자문이 아닙니다. 회원은 AI 출력의 사실 여부를 스스로 확인할 책임이 있으며, 회사는 AI 출력의 부정확성으로 인한 손해에 대해 본 약관 \"제11조 책임의 제한\"의 범위 내에서 책임을 부담합니다.",
    en: "Tutor replies, corrections, pronunciation scores, conversation examples, translations, handwriting/image recognition, and similar features rely on configured third-party AI providers (for example DeepSeek, OpenAI, Anthropic Claude, or Google Gemini), Microsoft Azure Speech, and Google Text-to-Speech. AI output (i) is not guaranteed to be accurate and (ii) is provided for learning and informational purposes only — it is not medical, legal, financial, or other professional advice. You are responsible for independently verifying the AI's output. We are responsible for AI inaccuracies only to the extent set out in Section 11 below.",
    es: "Las respuestas del tutor, correcciones, evaluaciones de pronunciación, ejemplos de conversación, traducciones, reconocimiento de escritura a mano/imagen y funciones similares dependen de proveedores de IA de terceros configurados (por ejemplo DeepSeek, OpenAI, Anthropic Claude o Google Gemini), Microsoft Azure Speech y Google Text-to-Speech. La salida de la IA (i) no se garantiza precisa y (ii) tiene fines educativos e informativos — no es asesoramiento médico, legal, financiero ni profesional. Eres responsable de verificar de forma independiente la salida. Nuestra responsabilidad por errores de la IA se rige por la Sección 11.",
    id: "Balasan tutor, koreksi, skor pengucapan, contoh percakapan, terjemahan, pengenalan tulisan tangan/gambar, dan fitur serupa mengandalkan penyedia AI pihak ketiga yang dikonfigurasi (misalnya DeepSeek, OpenAI, Anthropic Claude, atau Google Gemini), Microsoft Azure Speech, dan Google Text-to-Speech. Keluaran AI (i) tidak dijamin akurat dan (ii) disediakan hanya untuk tujuan pembelajaran dan informasi — bukan nasihat medis, hukum, finansial, atau profesional lainnya. Kamu bertanggung jawab memverifikasi sendiri keluaran AI. Tanggung jawab kami atas ketidakakuratan AI hanya sebatas yang diatur dalam Pasal 11 di bawah.",
  },
  ...
  thirdparty_b: {
    ko: "서비스는 Supabase, DeepSeek/OpenAI/Anthropic/Google 등 AI 제공자, Azure, Google Cloud, Vercel, Railway, Expo 등 제3자 인프라 위에서 운영됩니다. 회원이 본 서비스를 이용함으로써 해당 제3자 서비스 약관도 부수적으로 적용될 수 있습니다. 제3자 서비스의 장애·정책 변경으로 인한 일시적 기능 제한은 회사가 합리적으로 통제할 수 없으며, 회사는 그에 따른 책임을 본 약관에 명시된 범위 내에서만 부담합니다.",
    en: "The Service runs on third-party infrastructure including Supabase, AI providers such as DeepSeek/OpenAI/Anthropic/Google, Azure, Google Cloud, Vercel, Railway, and Expo. Your use of the Service may also be subject to their terms. Temporary limitations caused by outages or policy changes at those providers are outside our reasonable control; our liability for them is limited to the scope set out in these Terms.",
    es: "El Servicio se ejecuta sobre infraestructura de terceros como Supabase, proveedores de IA como DeepSeek/OpenAI/Anthropic/Google, Azure, Google Cloud, Vercel, Railway y Expo. Tu uso también puede quedar sujeto a sus términos. Las limitaciones temporales por incidencias o cambios de política de esos proveedores quedan fuera de nuestro control razonable; nuestra responsabilidad por ellas se limita a lo previsto en estos Términos.",
    id: "Layanan berjalan di atas infrastruktur pihak ketiga termasuk Supabase, penyedia AI seperti DeepSeek/OpenAI/Anthropic/Google, Azure, Google Cloud, Vercel, Railway, dan Expo. Penggunaanmu atas Layanan juga dapat tunduk pada ketentuan mereka. Pembatasan sementara akibat gangguan atau perubahan kebijakan pada penyedia tersebut berada di luar kendali wajar kami; tanggung jawab kami atas hal itu terbatas pada lingkup yang diatur dalam Ketentuan ini.",
  },
