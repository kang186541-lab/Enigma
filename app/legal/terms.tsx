...
const T: Record<string, Record<LangKey, string>> = {
  title:        { ko: "이용약관",                                 en: "Terms of Service",                       es: "Términos de Servicio" },
  ...
  intro_h:      { ko: "1. 약관의 적용",                            en: "1. Scope and Acceptance",                es: "1. Ámbito y Aceptación" },
  intro_b: {
  ...
  account_h:    { ko: "2. 계정 및 인증",                          en: "2. Account and Sign-In",                 es: "2. Cuenta y Acceso" },
  account_b: {
  ...
  age_h:        { ko: "3. 이용 자격 및 미성년자",                 en: "3. Eligibility and Minors",              es: "3. Requisitos y Menores" },
  age_b: {
  ...
  service_h:    { ko: "4. 서비스의 내용",                         en: "4. The Service",                         es: "4. El Servicio" },
  service_b: {
  ...
  ai_h:         { ko: "5. AI 생성 콘텐츠에 관한 고지",            en: "5. AI-Generated Content Disclaimer",     es: "5. Aviso sobre el Contenido Generado por IA" },
  ai_b: {
  ...
  use_h:        { ko: "6. 이용자의 의무 및 허용 범위",            en: "6. Acceptable Use",                       es: "6. Uso Aceptable" },
  use_b: {
  ...
  ip_h:         { ko: "7. 지식재산권",                            en: "7. Intellectual Property",               es: "7. Propiedad Intelectual" },
  ip_b: {
  ...
  paid_h:       { ko: "8. 유료 서비스 및 청약철회 (전자상거래법)",  en: "8. Paid Plans and Right to Withdraw",  es: "8. Planes de Pago y Derecho de Desistimiento" },
  paid_b: {
  ...
  thirdparty_h: { ko: "9. 제3자 서비스",                          en: "9. Third-Party Services",                es: "9. Servicios de Terceros" },
  thirdparty_b: {
  ...
  termination_h:{ ko: "10. 이용계약의 해지 및 정지",              en: "10. Termination and Suspension",         es: "10. Resolución y Suspensión" },
  termination_b: {
  ...
  liability_h:  { ko: "11. 책임의 제한 및 면책",                  en: "11. Limitation of Liability",            es: "11. Limitación de Responsabilidad" },
  liability_b: {
  ...
  indem_h:      { ko: "12. 면책 보장",                            en: "12. Indemnity",                          es: "12. Indemnidad" },
  indem_b: {
  ...
  modify_h:     { ko: "13. 약관의 변경",                          en: "13. Changes to these Terms",             es: "13. Cambios en estos Términos" },
  modify_b: {
  ...
  law_h:        { ko: "14. 준거법 및 분쟁 해결",                  en: "14. Governing Law and Disputes",         es: "14. Ley Aplicable y Disputas" },
  law_b: {
  ...
  misc_h:       { ko: "15. 기타",                                 en: "15. Miscellaneous",                      es: "15. Disposiciones Generales" },
  misc_b: {
  ...
  contact_h:    { ko: "16. 문의",                                 en: "16. Contact",                            es: "16. Contacto" },
  contact_b: {
