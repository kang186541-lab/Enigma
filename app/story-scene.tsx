  ...
  london: {
    ...
    sequence: [
        ...
        questions: [
          {
            ...
            meaning: { en: "a greeting when you meet someone", ko: "누군가를 만날 때 하는 인사", es: "un saludo cuando conoces a alguien", id: "sapaan saat bertemu seseorang", ar: "تَحِيَّة لَمَّا تِقَابِل حَدّ" },
            wrong: [
              ...
              { en: "an apology for a mistake", ko: "실수에 대한 사과", es: "una disculpa por un error", id: "permintaan maaf atas kesalahan", ar: "اِعْتِذَار عَنْ غَلْطَة" },
              { en: "a request for help", ko: "도움 요청", es: "una petición de ayuda", id: "permintaan bantuan", ar: "طَلَب مُسَاعْدَة" },
            ],
          },
          {
      ...
      },
      {
        ...
        textId: "Pintu itu tidak punya lubang kunci. Ellis menyebutnya kunci ucapan. Ia hanya terbuka saat seorang penutur memberinya sebuah kalimat dengan kebutuhan, arah, dan sebuah nama. Sedikit dramatis, ya. Beliau memang selalu begitu.",
        textIdMix: "Pintu itu tidak punya lubang kunci. Ellis menyebutnya kunci ucapan. Ia butuh sebuah sentence dengan need, direction, dan name.",
      },
      {
        kind: "clue",
        symbol: "🚪",
        ...
        questions: [
          {
            ...
            hints: {
              h1: {
                ...
                ar: "التَّرْتِيب مُهِمّ. الجُمْلَة لَازِم تِبْدَأ بِتَحِيَّة.",
              },
              h2: {
              ...
              h3: {
                ...
                ar: "جُمْلِة الإِجَابَة: Hello. Help me. Where is Dr. Ellis?",
              },
            },
            storyReason: {
            ...
            storyConsequence: {
              ...
              ar: "شَظِيِّة الحَجَر بِتُقَع جُوَّه نُور رُودِي.",
            },
            doorImage: ch1BossDoorImg,
          },
        ],
        hints: {
          h1: { ko: "Boss Spell은 네 조각이야 — 인사, 도움 요청, 위치 질문, 이름", en: "The Boss Spell has four pieces — greeting, help, location question, name", es: "El Boss Spell tiene cuatro piezas — saludo, ayuda, pregunta de lugar, nombre", id: "Boss Spell punya empat potongan — sapaan, bantuan, pertanyaan lokasi, nama", ar: "تَعْوِيذِة المُوَاجَهَة أَرْبَع قِطَع — تَحِيَّة، طَلَب مُسَاعْدَة، سُؤَال عَنْ مَكَان، اسْم" },
          h2: { ko: "Hello → Help me → Where is → Dr. Ellis", en: "Hello → Help me → Where is → Dr. Ellis", es: "Hola → Ayúdame → Dónde está → Dra. Ellis", id: "Hello → Help me → Where is → Dr. Ellis", ar: "Hello ← Help me ← Where is ← Dr. Ellis" },
          h3: { ko: "정답 문장: Hello. Help me. Where is Dr. Ellis?", en: "Answer sentence: Hello. Help me. Where is Dr. Ellis?", es: "Frase correcta: Hello. Help me. Where is Dr. Ellis?", id: "Kalimat jawaban: Hello. Help me. Where is Dr. Ellis?", ar: "جُمْلِة الإِجَابَة: Hello. Help me. Where is Dr. Ellis?" },
        },
      },
      {
        kind: "scene",
    ...
    sequence: [
        ...
        hints: {
          h1: {
            ...
            byLearning: {
              ...
              english: { ko: "영어 시장 표현: How much is this?, delicious, goodbye", en: "English market phrases: How much is this?, delicious, goodbye", es: "Frases del mercado en inglés: How much is this?, delicious, goodbye", id: "Frasa pasar dalam bahasa Inggris: How much is this?, delicious, goodbye", ar: "تَعْبِيرَات السُّوق بِالإِنْجِلِيزِي: How much is this?, delicious, goodbye" },
              indonesian: { ko: "인도네시아어 시장 표현: Berapa harganya?, lezat, selamat tinggal", en: "Indonesian market phrases: Berapa harganya?, lezat, selamat tinggal", es: "Frases del mercado en indonesio: Berapa harganya?, lezat, selamat tinggal", id: "Frasa pasar dalam bahasa Indonesia: Berapa harganya?, lezat, selamat tinggal", ar: "تَعْبِيرَات السُّوق بِالإِنْدُونِيسِي: Berapa harganya?, lezat, selamat tinggal" },
            },
          },
          h2: {
            ...
            byLearning: {
              ...
              english: { ko: "'How much is this?'=가격 묻기, 'delicious'=맛있는, 'goodbye'=작별", en: "'How much is this?'=asking price, 'delicious'=tasty, 'goodbye'=farewell", es: "'How much is this?'=precio, 'delicious'=sabroso, 'goodbye'=despedida", id: "'How much is this?'=menanyakan harga, 'delicious'=lezat, 'goodbye'=perpisahan", ar: "'How much is this?'=تِسْأَل عَنِ السِّعْر، 'delicious'=لَذِيذ، 'goodbye'=وَدَاع" },
              indonesian: { ko: "'Berapa harganya?'=가격 묻기, 'lezat'=맛있는, 'selamat tinggal'=작별", en: "'Berapa harganya?'=asking price, 'lezat'=tasty, 'selamat tinggal'=farewell", es: "'Berapa harganya?'=precio, 'lezat'=sabroso, 'selamat tinggal'=despedida", id: "'Berapa harganya?'=menanyakan harga, 'lezat'=lezat, 'selamat tinggal'=perpisahan", ar: "'Berapa harganya?'=تِسْأَل عَنِ السِّعْر، 'lezat'=لَذِيذ، 'selamat tinggal'=وَدَاع" },
            },
          },
          h3: {
            ...
            ar: "How much is this?=تِسْأَل عَنِ السِّعْر / delicious=لَذِيذ / goodbye=وَدَاع",
            byLearning: {
              spanish: { ko: "¿Cuánto cuesta esto?=가격 / delicioso=맛 / adiós=작별", en: "¿Cuánto cuesta esto?=price / delicioso=taste / adiós=farewell", es: "¿Cuánto cuesta esto?=precio / delicioso=sabor / adiós=despedida", id: "¿Cuánto cuesta esto?=harga / delicioso=rasa / adiós=perpisahan", ar: "¿Cuánto cuesta esto?=سِعْر / delicioso=طَعْم / adiós=وَدَاع" },
              korean:  { ko: "이거 얼마예요?=가격 / 맛있는=맛 / 안녕히 계세요=작별", en: "이거 얼마예요?=price / 맛있는=taste / 안녕히 계세요=farewell", es: "이거 얼마예요?=precio / 맛있는=sabor / 안녕히 계세요=despedida", id: "이거 얼마예요?=harga / 맛있는=rasa / 안녕히 계세요=perpisahan", ar: "이거 얼마예요?=سِعْر / 맛있는=طَعْم / 안녕히 계세요=وَدَاع" },
              english: { ko: "How much is this?=가격 / delicious=맛 / goodbye=작별", en: "How much is this?=price / delicious=taste / goodbye=farewell", es: "How much is this?=precio / delicious=sabor / goodbye=despedida", id: "How much is this?=harga / delicious=rasa / goodbye=perpisahan", ar: "How much is this?=سِعْر / delicious=طَعْم / goodbye=وَدَاع" },
              indonesian: { ko: "Berapa harganya?=가격 / lezat=맛 / selamat tinggal=작별", en: "Berapa harganya?=price / lezat=taste / selamat tinggal=farewell", es: "Berapa harganya?=precio / lezat=sabor / selamat tinggal=despedida", id: "Berapa harganya?=harga / lezat=rasa / selamat tinggal=perpisahan", ar: "Berapa harganya?=سِعْر / lezat=طَعْم / selamat tinggal=وَدَاع" },
            },
          },
        },
      },
        ...
        hints: {
          h1: {
            ...
            byLearning: {
              ...
              english: { ko: "'Good morning'으로 인사하고 'please'로 주문해봐", en: "Greet with 'Good morning' and order with 'please'", es: "Saluda con 'Good morning' y pide con 'please'", id: "Sapa dengan 'Good morning' dan pesan dengan 'please'", ar: "سَلِّم بِـ 'Good morning' وَاطْلُب بِـ 'please'" },
              indonesian: { ko: "'Selamat pagi'로 인사하고 'tolong'으로 주문해봐", en: "Greet with 'Selamat pagi' and order with 'tolong'", es: "Saluda con 'Selamat pagi' y pide con 'tolong'", id: "Sapa dengan 'Selamat pagi' dan pesan dengan 'tolong'", ar: "سَلِّم بِـ 'Selamat pagi' وَاطْلُب بِـ 'tolong'" },
            },
          },
          h2: {
          ...
          h3: {
            ...
            ar: "اطْلُب بِالشَّكْل ده: 'Good morning! ... please. How much is it?'",
            byLearning: {
              spanish: { ko: "'¡Buenos días! ... por favor. ¿Cuánto es?' 형식으로 주문해", en: "Order: '¡Buenos días! ... por favor. ¿Cuánto es?'", es: "Pide: '¡Buenos días! ... por favor. ¿Cuánto es?'", id: "Pesan: '¡Buenos días! ... por favor. ¿Cuánto es?'", ar: "اطْلُب: '¡Buenos días! ... por favor. ¿Cuánto es?'" },
              korean:  { ko: "'좋은 아침이에요! 커피 주세요. 얼마예요?' 형식으로 주문해", en: "Order: '좋은 아침이에요! 커피 주세요. 얼마예요?'", es: "Pide: '좋은 아침이에요! 커피 주세요. 얼마예요?'", id: "Pesan: '좋은 아침이에요! 커피 주세요. 얼마예요?'", ar: "اطْلُب: '좋은 아침이에요! 커피 주세요. 얼마예요?'" },
              english: { ko: "'Good morning! I would like coffee, please. How much is it?' 형식으로 주문해", en: "Order: 'Good morning! I would like coffee, please. How much is it?'", es: "Pide: 'Good morning! I would like coffee, please. How much is it?'", id: "Pesan: 'Good morning! I would like coffee, please. How much is it?'", ar: "اطْلُب: 'Good morning! I would like coffee, please. How much is it?'" },
              indonesian: { ko: "'Selamat pagi! Saya mau kopi, tolong. Berapa harganya?' 형식으로 주문해", en: "Order: 'Selamat pagi! Saya mau kopi, tolong. Berapa harganya?'", es: "Pide: 'Selamat pagi! Saya mau kopi, tolong. Berapa harganya?'", id: "Pesan: 'Selamat pagi! Saya mau kopi, tolong. Berapa harganya?'", ar: "اطْلُب: 'Selamat pagi! Saya mau kopi, tolong. Berapa harganya?'" },
            },
          },
        },
      },
      ...
      },
      {
        ...
        questions: [
          ...
          {
            instruction: { en: "Carlos's last cry:", ko: "카를로스의 마지막 외침:", es: "El último grito de Carlos:", id: "Teriakan terakhir Carlos:", ar: "آخِر زَعِيق لِكَارْلُوس:" },
            words: [
              { en: "Help", ko: "도와주세요", es: "Ayuda", id: "Tolong", ar: "النَّجْدَة" },
              { en: "Please", ko: "제발", es: "Por favor", id: "Kumohon", ar: "مِنْ فَضْلَك" },
              { en: "help me", ko: "도와줘요", es: "ayúdame", id: "tolong aku", ar: "سَاعِدْنِي" },
            ],
            answerOrder: [0, 1, 2],
          },
        ],
        hints: {
          h1: {
            ...
            byLearning: {
              ...
              english: { ko: "카를로스의 외침: Hello, I need help, Where is the bathroom?", en: "Carlos's cries: Hello, I need help, Where is the bathroom?", es: "Los gritos de Carlos: Hello, I need help, Where is the bathroom?", id: "Teriakan Carlos: Hello, I need help, Where is the bathroom?", ar: "زَعِيق كَارْلُوس: Hello, I need help, Where is the bathroom?" },
              indonesian: { ko: "카를로스의 외침: Halo, Saya butuh bantuan, Di mana kamar mandi?", en: "Carlos's cries: Halo, Saya butuh bantuan, Di mana kamar mandi?", es: "Los gritos de Carlos: Halo, Saya butuh bantuan, Di mana kamar mandi?", id: "Teriakan Carlos: Halo, Saya butuh bantuan, Di mana kamar mandi?", ar: "زَعِيق كَارْلُوس: Halo, Saya butuh bantuan, Di mana kamar mandi?" },
            },
          },
          h2: {
            ko: "영어 어순: 주어 → 동사 → 목적어",
            ...
            ar: "تَرْتِيب الكَلَام بِالإِنْجِلِيزِي: فَاعِل ← فِعْل ← مَفْعُول",
            byLearning: {
              spanish: { ko: "스페인어 어순: 주어 → 동사 → 목적어 (Hola → Necesito → ayuda)", en: "Spanish word order: Subject → Verb → Object (Hola → Necesito → ayuda)", es: "Orden en español: Sujeto → Verbo → Objeto (Hola → Necesito → ayuda)", id: "Urutan kata bahasa Spanyol: Subjek → Kata Kerja → Objek (Hola → Necesito → ayuda)", ar: "تَرْتِيب الكَلَام بِالإِسْبَانِي: فَاعِل ← فِعْل ← مَفْعُول (Hola → Necesito → ayuda)" },
              korean:  { ko: "한국어 어순: 주어 → 목적어 → 동사 (안녕하세요 → 도움이 → 필요해요)", en: "Korean word order: Subject → Object → Verb (안녕하세요 → 도움이 → 필요해요)", es: "Orden en coreano: Sujeto → Objeto → Verbo (안녕하세요 → 도움이 → 필요해요)", id: "Urutan kata bahasa Korea: Subjek → Objek → Kata Kerja (안녕하세요 → 도움이 → 필요해요)", ar: "تَرْتِيب الكَلَام بِالكُورِي: فَاعِل ← مَفْعُول ← فِعْل (안녕하세요 → 도움이 → 필요해요)" },
              english: { ko: "영어 어순: 주어 → 동사 → 목적어 (Hello → I need → help)", en: "English word order: Subject → Verb → Object (Hello → I need → help)", es: "Orden en inglés: Sujeto → Verbo → Objeto (Hello → I need → help)", id: "Urutan kata bahasa Inggris: Subjek → Kata Kerja → Objek (Hello → I need → help)", ar: "تَرْتِيب الكَلَام بِالإِنْجِلِيزِي: فَاعِل ← فِعْل ← مَفْعُول (Hello → I need → help)" },
              indonesian: { ko: "인도네시아어 어순: 주어 → 동사 → 목적어 (Halo → Saya butuh → bantuan)", en: "Indonesian word order: Subject → Verb → Object (Halo → Saya butuh → bantuan)", es: "Orden en indonesio: Sujeto → Verbo → Objeto (Halo → Saya butuh → bantuan)", id: "Urutan kata bahasa Indonesia: Subjek → Kata Kerja → Objek (Halo → Saya butuh → bantuan)", ar: "تَرْتِيب الكَلَام بِالإِنْدُونِيسِي: فَاعِل ← فِعْل ← مَفْعُول (Halo → Saya butuh → bantuan)" },
            },
          },
          h3: {
            ...
            ar: "١: Hello, I need help / ٢: Where is the bathroom / ٣: Help, Please help me",
            byLearning: {
              spanish: { ko: "1: Hola, Necesito ayuda / 2: Dónde está el baño / 3: Ayuda, Por favor ayúdame", en: "1: Hola, Necesito ayuda / 2: Dónde está el baño / 3: Ayuda, Por favor ayúdame", es: "1: Hola, Necesito ayuda / 2: Dónde está el baño / 3: Ayuda, Por favor ayúdame", id: "1: Hola, Necesito ayuda / 2: Dónde está el baño / 3: Ayuda, Por favor ayúdame", ar: "١: Hola, Necesito ayuda / ٢: Dónde está el baño / ٣: Ayuda, Por favor ayúdame" },
              korean:  { ko: "1: 안녕하세요, 도움이 필요해요 / 2: 화장실이 어디에요 / 3: 도와주세요, 제발 도와줘요", en: "1: 안녕하세요, 도움이 필요해요 / 2: 화장실이 어디에요 / 3: 도와주세요, 제발 도와줘요", es: "1: 안녕하세요, 도움이 필요해요 / 2: 화장실이 어디에요 / 3: 도와주세요, 제발 도와줘요", id: "1: 안녕하세요, 도움이 필요해요 / 2: 화장실이 어디에요 / 3: 도와주세요, 제발 도와줘요", ar: "١: 안녕하세요, 도움이 필요해요 / ٢: 화장실이 어디에요 / ٣: 도와주세요, 제발 도와줘요" },
              english: { ko: "1: Hello, I need help / 2: Where is the bathroom / 3: Help, Please help me", en: "1: Hello, I need help / 2: Where is the bathroom / 3: Help, Please help me", es: "1: Hello, I need help / 2: Where is the bathroom / 3: Help, Please help me", id: "1: Hello, I need help / 2: Where is the bathroom / 3: Help, Please help me", ar: "١: Hello, I need help / ٢: Where is the bathroom / ٣: Help, Please help me" },
              indonesian: { ko: "1: Halo, Saya butuh bantuan / 2: Di mana kamar mandi / 3: Tolong, Kumohon tolong aku", en: "1: Halo, Saya butuh bantuan / 2: Di mana kamar mandi / 3: Tolong, Kumohon tolong aku", es: "1: Halo, Saya butuh bantuan / 2: Di mana kamar mandi / 3: Tolong, Kumohon tolong aku", id: "1: Halo, Saya butuh bantuan / 2: Di mana kamar mandi / 3: Tolong, Kumohon tolong aku", ar: "١: Halo, Saya butuh bantuan / ٢: Di mana kamar mandi / ٣: Tolong, Kumohon tolong aku" },
            },
          },
        },
      },
        ...
        questions: [
          ...
          },
          {
            ...
            wrong: [
              ...
              { en: "an office building", ko: "사무실 건물", es: "un edificio de oficinas", id: "gedung perkantoran", ar: "مَبْنَى مَكَاتِب" },
            ],
          },
          {
      ...
      },
      {
        ...
        hints: {
          h1: {
            ...
            ar: "فِي التَّاكْسِي، اِسْتَخْدِم المَكَان + please + اِسْأَل عَنِ السِّعْر. مَعَ الحَارِس، عَرَّف بِنَفْسَك",
            byLearning: {
              korean: { ko: "택시에서는 장소 + 주세요 + 가격을 물어야 해. 경비원에게는 자기소개를 해야 해", en: "In a taxi, use place + 주세요 + ask the price. For the guard, introduce yourself", es: "En un taxi, usa lugar + 주세요 + pregunta el precio. Al guardia, preséntate", id: "Di taksi, gunakan tempat + 주세요 + tanyakan harganya. Pada penjaga, perkenalkan dirimu", ar: "فِي التَّاكْسِي، اِسْتَخْدِم المَكَان + 주세요 + اِسْأَل عَنِ السِّعْر. مَعَ الحَارِس، عَرَّف بِنَفْسَك" },
              spanish: { ko: "택시에서는 장소 + por favor + 가격을 물어야 해. 경비원에게는 자기소개를 해야 해", en: "In a taxi, use place + por favor + ask the price. For the guard, introduce yourself", es: "En un taxi, usa lugar + por favor + pregunta el precio. Al guardia, preséntate", id: "Di taksi, gunakan tempat + por favor + tanyakan harganya. Pada penjaga, perkenalkan dirimu", ar: "فِي التَّاكْسِي، اِسْتَخْدِم المَكَان + por favor + اِسْأَل عَنِ السِّعْر. مَعَ الحَارِس، عَرَّف بِنَفْسَك" },
              english: { ko: "택시에서는 장소 + please + 가격을 물어야 해. 경비원에게는 자기소개를 해야 해", en: "In a taxi, use place + please + ask the price. For the guard, introduce yourself", es: "En un taxi, usa lugar + please + pregunta el precio. Al guardia, preséntate", id: "Di taksi, gunakan tempat + please + tanyakan harganya. Pada penjaga, perkenalkan dirimu", ar: "فِي التَّاكْسِي، اِسْتَخْدِم المَكَان + please + اِسْأَل عَنِ السِّعْر. مَعَ الحَارِس، عَرَّف بِنَفْسَك" },
              indonesian: { ko: "택시에서는 장소 + tolong + 가격을 물어야 해. 경비원에게는 자기소개를 해야 해", en: "In a taxi, use place + tolong + ask the price. For the guard, introduce yourself", es: "En un taxi, usa lugar + tolong + pregunta el precio. Al guardia, preséntate", id: "Di taksi, gunakan tempat + tolong + tanyakan harganya. Pada penjaga, perkenalkan dirimu", ar: "فِي التَّاكْسِي، اِسْتَخْدِم المَكَان + tolong + اِسْأَل عَنِ السِّعْر. مَعَ الحَارِس، عَرَّف بِنَفْسَك" },
            },
          },
          h2: {
      ...
      },
      {
        ...
        hints: {
          ...
          h3: {
            ...
            ar: "التَّرْكِيب: Excuse me(تَحِيَّة) → where is(سُؤَال) → the old(صِفَة) → door(مَكَان) → turn left(اِتِّجَاه) → please(أَدَب)",
            byLearning: {
              spanish: { ko: "구조: Disculpe → dónde está → la vieja → puerta → gire a → la izquierda", en: "Structure: Disculpe → dónde está → la vieja → puerta → gire a → la izquierda", es: "Estructura: Disculpe → dónde está → la vieja → puerta → gire a → la izquierda", id: "Struktur: Disculpe → dónde está → la vieja → puerta → gire a → la izquierda", ar: "التَّرْكِيب: Disculpe → dónde está → la vieja → puerta → gire a → la izquierda" },
              korean:  { ko: "구조: 실례합니다 → 어디에 → 오래된 → 문이 → 왼쪽으로 → 주세요", en: "Structure: 실례합니다 → 어디에 → 오래된 → 문이 → 왼쪽으로 → 주세요", es: "Estructura: 실례합니다 → 어디에 → 오래된 → 문이 → 왼쪽으로 → 주세요", id: "Struktur: 실례합니다 → 어디에 → 오래된 → 문이 → 왼쪽으로 → 주세요", ar: "التَّرْكِيب: 실례합니다 → 어디에 → 오래된 → 문이 → 왼쪽으로 → 주세요" },
              english: { ko: "구조: Excuse me → where is → the old → door → turn left → please", en: "Structure: Excuse me → where is → the old → door → turn left → please", es: "Estructura: Excuse me → where is → the old → door → turn left → please", id: "Struktur: Excuse me → where is → the old → door → turn left → please", ar: "التَّرْكِيب: Excuse me → where is → the old → door → turn left → please" },
              indonesian: { ko: "구조: Permisi → di mana → yang tua → pintu → belok kiri → tolong", en: "Structure: Permisi → di mana → yang tua → pintu → belok kiri → tolong", es: "Estructura: Permisi → di mana → yang tua → pintu → belok kiri → tolong", id: "Struktur: Permisi → di mana → yang tua → pintu → belok kiri → tolong", ar: "التَّرْكِيب: Permisi → di mana → yang tua → pintu → belok kiri → tolong" },
            },
          },
        },
      },
        ...
        questions: [
          {
            ...
            clues: [
              ...
              { en: "'안녕히 계세요' — 'Goodbye'", ko: "'안녕히 계세요' — 작별 인사", es: "'안녕히 계세요' — 'Adiós'", id: "'안녕히 계세요' — ucapan perpisahan", ar: "'안녕히 계세요' — كِلْمِة وَدَاع" },
              { en: "'저는 미스터 블랙입니다' — 'I am Mr. Black'", ko: "'저는 미스터 블랙입니다' — 자기소개", es: "'저는 미스터 블랙입니다' — 'Soy Mr. Black'", id: "'저는 미스터 블랙입니다' — perkenalan diri", ar: "'저는 미스터 블랙입니다' — تَعْرِيف بِالنَّفْس" },
            ],
            answerIdx: 1,
          },
        ],
        ...
        questions: [
          {
            ...
            wrong: [
              ...
              { en: "a police station", ko: "경찰서", es: "una estación de policía", id: "kantor polisi", ar: "قِسْم شُرْطَة" },
            ],
          },
          {
            ...
            wrong: [
              ...
              { en: "a building entrance", ko: "건물 입구", es: "una entrada de edificio", id: "pintu masuk gedung", ar: "مَدْخَل مَبْنَى" },
            ],
          },
          {
            ...
            wrong: [
              ...
              { en: "a formal letter", ko: "공식 서한", es: "una carta formal", id: "surat resmi", ar: "خِطَاب رَسْمِي" },
            ],
          },
        ],
        hints: {
      ...
      },
      {
        ...
        hints: {
          ...
          h3: {
            ...
            ar: "Hello = بِدَايِة أَيّ كَلَام / Thank you = شُكْر / Are you okay? = اِهْتِمَام وَقَلَق",
            byLearning: {
              spanish: { ko: "Hola = 모든 대화의 시작 / Gracias = 감사 표현 / ¿Estás bien? = 관심과 걱정", en: "Hola = start of every conversation / Gracias = gratitude / ¿Estás bien? = caring and concern", es: "Hola = inicio de conversación / Gracias = gratitud / ¿Estás bien? = cuidado y preocupación", id: "Hola = awal setiap percakapan / Gracias = rasa terima kasih / ¿Estás bien? = perhatian dan kepedulian", ar: "Hola = بِدَايِة أَيّ كَلَام / Gracias = شُكْر / ¿Estás bien? = اِهْتِمَام وَقَلَق" },
              korean: { ko: "안녕하세요 = 모든 대화의 시작 / 감사합니다 = 감사 표현 / 괜찮으세요? = 관심과 걱정", en: "안녕하세요 = start of every conversation / 감사합니다 = gratitude / 괜찮으세요? = caring and concern", es: "안녕하세요 = inicio de conversación / 감사합니다 = gratitud / 괜찮으세요? = cuidado y preocupación", id: "안녕하세요 = awal setiap percakapan / 감사합니다 = rasa terima kasih / 괜찮으세요? = perhatian dan kepedulian", ar: "안녕하세요 = بِدَايِة أَيّ كَلَام / 감사합니다 = شُكْر / 괜찮으세요? = اِهْتِمَام وَقَلَق" },
              english: { ko: "Hello = 모든 대화의 시작 / Thank you = 감사 표현 / Are you okay? = 관심과 걱정", en: "Hello = start of every conversation / Thank you = gratitude / Are you okay? = caring and concern", es: "Hello = inicio de conversación / Thank you = gratitud / Are you okay? = cuidado y preocupación", id: "Hello = awal setiap percakapan / Thank you = rasa terima kasih / Are you okay? = perhatian dan kepedulian", ar: "Hello = بِدَايِة أَيّ كَلَام / Thank you = شُكْر / Are you okay? = اِهْتِمَام وَقَلَق" },
              indonesian: { ko: "Halo = 모든 대화의 시작 / Terima kasih = 감사 표현 / Kamu baik-baik saja? = 관심과 걱정", en: "Halo = start of every conversation / Terima kasih = gratitude / Kamu baik-baik saja? = caring and concern", es: "Halo = inicio de conversación / Terima kasih = gratitud / Kamu baik-baik saja? = cuidado y preocupación", id: "Halo = awal setiap percakapan / Terima kasih = rasa terima kasih / Kamu baik-baik saja? = perhatian dan kepedulian", ar: "Halo = بِدَايِة أَيّ كَلَام / Terima kasih = شُكْر / Kamu baik-baik saja? = اِهْتِمَام وَقَلَق" },
            },
          },
        },
      },
...
const MADRID_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Recover the First Colors", ko: "첫 색을 되찾기", es: "Recuperar los primeros colores", id: "Pulihkan Warna Pertama", ar: "اِسْتَرْجِع أَوَّل الأَلْوَان" },
      context: {
        ...
        ar: "إِيزَابِيل تَحْتَاج كَلِمَات الشُّعُور وَاللَّوْن قَبْل أَنْ تَسْتَطِيع أَنْ تَشْرَح مَاذَا كَانَ كَارْلُوس يُرَمِّم.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          ...
          meaning: { en: "a warm bright color", ko: "따뜻하고 선명한 색", es: "un color cálido y vivo", id: "warna hangat yang cerah", ar: "لَوْن دَافِئ وَزَاهٍ" },
          wrong: [
            { en: "a place", ko: "장소", es: "un lugar", id: "sebuah tempat", ar: "مَكَان" },
            { en: "a price", ko: "가격", es: "un precio", id: "sebuah harga", ar: "سِعْر" },
            { en: "a goodbye", ko: "작별 인사", es: "una despedida", id: "ucapan perpisahan", ar: "وَدَاع" },
          ],
        },
        {
          word: { en: "color", ko: "색", es: "color", id: "warna", ar: "لَوْن" },
          meaning: { en: "what the festival is losing", ko: "축제가 잃어가는 것", es: "lo que el festival está perdiendo", id: "apa yang sedang hilang dari festival", ar: "مَا يَفْقِدُه المِهْرَجَان" },
          wrong: [
            { en: "a guard's name", ko: "경비원의 이름", es: "el nombre de un guardia", id: "nama seorang penjaga", ar: "اِسْم حَارِس" },
            { en: "a ticket", ko: "표", es: "un billete", id: "sebuah tiket", ar: "تَذْكَرَة" },
            { en: "a locked door", ko: "잠긴 문", es: "una puerta cerrada", id: "pintu terkunci", ar: "بَاب مُغْلَق" },
          ],
        },
      ],
      hints: {
        h1: { ko: "이번 장은 색과 감정이 핵심이에요.", en: "This chapter is about color and feeling.", es: "Este capítulo trata de color y emoción.", id: "Bab ini berkisah tentang warna dan perasaan.", ar: "هٰذَا الفَصْل عَنِ اللَّوْن وَالشُّعُور." },
        h2: { ko: "red와 color는 광장의 시각 단서와 연결돼요.", en: "red and color connect to what you see in the plaza.", es: "red y color conectan con lo que ves en la plaza.", id: "red dan color berkaitan dengan apa yang kamu lihat di plaza.", ar: "red وَ color مُرْتَبِطَانِ بِمَا تَرَاه فِي السَّاحَة.", byLearning: { english: { ko: "red, color 같은 단어는 광장의 시각 단서와 연결돼요.", en: "red and color connect to what you see in the plaza.", es: "red y color conectan con lo que ves en la plaza.", id: "red dan color berkaitan dengan apa yang kamu lihat di plaza.", ar: "red وَ color مُرْتَبِطَانِ بِمَا تَرَاه فِي السَّاحَة." }, korean: { ko: "빨간색, 색 같은 단어는 광장의 시각 단서와 연결돼요.", en: "Words like 빨간색 and 색 connect to what you see in the plaza.", es: "Palabras como 빨간색 y 색 conectan con lo que ves en la plaza.", id: "Kata seperti 빨간색 dan 색 berkaitan dengan apa yang kamu lihat di plaza.", ar: "كَلِمَات مِثْل 빨간색 وَ 색 مُرْتَبِطَة بِمَا تَرَاه فِي السَّاحَة." }, spanish: { ko: "rojo, color 같은 단어는 광장의 시각 단서와 연결돼요.", en: "rojo and color connect to what you see in the plaza.", es: "rojo y color conectan con lo que ves en la plaza.", id: "rojo dan color berkaitan dengan apa yang kamu lihat di plaza.", ar: "rojo وَ color مُرْتَبِطَانِ بِمَا تَرَاه فِي السَّاحَة." }, indonesian: { ko: "merah, warna 같은 단어는 광장의 시각 단서와 연결돼요.", en: "merah and warna connect to what you see in the plaza.", es: "merah y warna conectan con lo que ves en la plaza.", id: "merah dan warna berkaitan dengan apa yang kamu lihat di plaza.", ar: "merah وَ warna مُرْتَبِطَانِ بِمَا تَرَاه فِي السَّاحَة." } } },
        h3: { ko: "red는 빨간색, color는 광장이 잃어가는 색이에요.", en: "red is the warm color; color is what the plaza is losing.", es: "red es el color cálido; color es lo que la plaza pierde.", id: "red itu warna hangat; color itu yang hilang dari plaza.", ar: "red هُوَ اللَّوْن الدَّافِئ؛ color هُوَ مَا تَفْقِدُه السَّاحَة." },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Speak With Feeling", ko: "감정으로 말하기", es: "Hablar con emoción", id: "Berbicara dengan Perasaan", ar: "تَكَلَّم بِشُعُور" },
      context: {
        ...
        ar: "يَسْتَطِيع دُون مِيجِيل أَنْ يُرْشِدَك إِلَى المَسْرَح المُغْلَق إِذَا أَجَبْتَ بِشُعُور، لَا بِمَعْلُومَة فَقَط.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Don Miguel asks: 'When the music returns, what do you feel?'", ko: "돈 미겔이 묻습니다: '음악이 돌아오면 무엇을 느끼나?'", es: "Don Miguel pregunta: 'Cuando vuelva la música, ¿qué sientes?'", id: "Don Miguel bertanya: 'Saat musik kembali, apa yang kamu rasakan?'", ar: "يَسْأَل دُون مِيجِيل: 'عِنْدَمَا تَعُود المُوسِيقَى، بِمَاذَا تَشْعُر؟'" },
          context: { en: "Choose a feeling, not a price or a direction.", ko: "가격이나 방향이 아니라 감정을 고르세요.", es: "Elige un sentimiento, no un precio ni una dirección.", id: "Pilih sebuah perasaan, bukan harga atau arah.", ar: "اِخْتَر شُعُورًا، لَا سِعْرًا وَلَا اِتِّجَاهًا." },
          answer: { en: "I am happy.", ko: "저는 행복해요.", es: "Estoy feliz.", id: "Saya senang.", ar: "أَنَا سَعِيد." },
          wrong: [
            { en: "How much is it?", ko: "이거 얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَمْ؟" },
            { en: "Goodbye.", ko: "안녕히 가세요.", es: "Adiós.", id: "Selamat tinggal.", ar: "مَعَ السَّلَامَة." },
          ],
        },
        {
          prompt: { en: "He points to the gray stage: 'What was it, before the color left?'", ko: "그가 회색 무대를 가리킵니다: '색이 사라지기 전, 저건 무엇이었나?'", es: "Señala el escenario gris: '¿Qué era antes de perder el color?'", id: "Ia menunjuk panggung kelabu itu: 'Dulu seperti apa, sebelum warnanya hilang?'", ar: "يُشِير إِلَى المَسْرَح الرَّمَادِيّ: 'كَيْفَ كَانَ شَكْلُه، قَبْلَ أَنْ يَذْهَبَ اللَّوْن؟'" },
          context: { en: "Give a simple description.", ko: "간단한 묘사를 말하세요.", es: "Da una descripción sencilla.", id: "Berikan deskripsi sederhana.", ar: "قُلْ وَصْفًا بَسِيطًا." },
          answer: { en: "It is beautiful.", ko: "정말 아름다워요.", es: "Es hermoso.", id: "Itu indah.", ar: "هٰذَا جَمِيل." },
          wrong: [
            { en: "Bread please.", ko: "빵 주세요.", es: "Pan, por favor.", id: "Minta roti.", ar: "خُبْز مِنْ فَضْلِك." },
            { en: "Where is Dr. Ellis?", ko: "엘리스 박사님은 어디 있어요?", es: "¿Dónde está la Dra. Ellis?", id: "Di mana Dr. Ellis?", ar: "أَيْنَ الدُّكْتُورَة إِلِيس؟" },
          ],
        },
        {
          prompt: { en: "Isabel needs the exact place. Ask for it.", ko: "이사벨은 정확한 장소가 필요합니다. 물어보세요.", es: "Isabel necesita el lugar exacto. Pregunta por él.", id: "Isabel butuh tempat yang tepat. Tanyakanlah.", ar: "تَحْتَاج إِيزَابِيل المَكَان بِالضَّبْط. اِسْأَل عَنْه." },
          context: { en: "Use the location question from the festival clue.", ko: "축제 단서에서 나온 위치 질문을 사용하세요.", es: "Usa la pregunta de lugar de la pista del festival.", id: "Gunakan pertanyaan lokasi dari petunjuk festival itu.", ar: "اِسْتَخْدِم سُؤَال المَكَان مِنْ دَلِيل المِهْرَجَان." },
          answer: { en: "Where is the festival?", ko: "축제는 어디에서 열려요?", es: "¿Dónde es el festival?", id: "Di mana festivalnya?", ar: "أَيْنَ المِهْرَجَان؟" },
          wrong: [
            { en: "Thank you.", ko: "감사합니다.", es: "Gracias.", id: "Terima kasih.", ar: "شُكْرًا." },
            { en: "I am Carlos.", ko: "저는 카를로스예요.", es: "Soy Carlos.", id: "Saya Carlos.", ar: "أَنَا كَارْلُوس." },
          ],
        },
      ],
      hints: {
        h1: { ko: "감정, 묘사, 위치 질문 순서로 생각하세요.", en: "Think feeling, description, then location question.", es: "Piensa en emoción, descripción y pregunta de lugar.", id: "Pikirkan urutannya: perasaan, deskripsi, lalu pertanyaan lokasi.", ar: "فَكِّر بِالتَّرْتِيب: شُعُور، وَصْف، ثُمَّ سُؤَال عَنِ المَكَان." },
        h2: { ko: "happy는 감정, beautiful은 묘사예요.", en: "happy is feeling; beautiful is description.", es: "happy es emoción; beautiful es descripción.", id: "happy adalah perasaan; beautiful adalah deskripsi.", ar: "happy شُعُور؛ beautiful وَصْف." },
        h3: { ko: "정답 흐름: I am happy / It is beautiful / Where is the festival?", en: "Answer flow: I am happy / It is beautiful / Where is the festival?", es: "Flujo correcto: I am happy / It is beautiful / Where is the festival?", id: "Alur jawaban: I am happy / It is beautiful / Where is the festival?", ar: "تَرْتِيب الإِجَابَة: I am happy / It is beautiful / Where is the festival?" },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find Carlos's Last Trace", ko: "카를로스의 마지막 흔적 찾기", es: "Encontrar el último rastro de Carlos", id: "Temukan Jejak Terakhir Carlos", ar: "اِبْحَثْ عَنْ آخِر أَثَر لِكَارْلُوس" },
      context: {
        ...
        ar: "فِي مَسْرَح المِهْرَجَان ثَلَاثَة أَدِلَّة. وَاحِد مِنْهَا يُثْبِت أَيْنَ اخْتَفَى كَارْلُوس.",
      },
      pType: "investigation",
      quizContract: "deduction",
      tprsStage: 3,
      ...
      questions: [
        {
          prompt: { en: "Which evidence points to Carlos's exact disappearance point?", ko: "어떤 증거가 카를로스가 사라진 정확한 지점을 가리키나요?", es: "¿Qué evidencia señala el punto exacto donde desapareció Carlos?", id: "Bukti mana yang menunjuk titik pasti hilangnya Carlos?", ar: "أَيُّ دَلِيل يُشِير إِلَى مَكَان اخْتِفَاء كَارْلُوس بِالضَّبْط؟" },
          clues: [
            { en: "A paintbrush still wet with red paint beside the stage speaker.", ko: "무대 스피커 옆에 놓인, 아직 빨간 물감이 마르지 않은 붓.", es: "Un pincel aún mojado con pintura roja junto al altavoz del escenario.", id: "Sebuah kuas yang masih basah oleh cat merah di samping pengeras suara panggung.", ar: "فُرْشَاة دِهَان لَا تَزَال مُبَلَّلَة بِطِلَاء أَحْمَر بِجَانِب سَمَّاعَة المَسْرَح." },
            { en: "A food receipt from a nearby cafe.", ko: "근처 카페의 영수증.", es: "Un recibo de una cafetería cercana.", id: "Struk makanan dari kafe di dekat sana.", ar: "فَاتُورَة طَعَام مِنْ مَقْهًى قَرِيب." },
            { en: "A gray paper flower from the festival decorations.", ko: "축제 장식에서 떨어진 회색 종이꽃.", es: "Una flor de papel gris de la decoración del festival.", id: "Bunga kertas kelabu dari hiasan festival.", ar: "وَرْدَة وَرَقِيَّة رَمَادِيَّة مِنْ زِينَة المِهْرَجَان." },
          ],
          answerIdx: 0,
        },
      ],
      hints: {
        h1: { ko: "카를로스는 복원가예요. 그가 쓰던 도구를 찾으세요.", en: "Carlos is a restorer. Look for the tool he used.", es: "Carlos es restaurador. Busca la herramienta que usaba.", id: "Carlos adalah seorang pemulih. Cari alat yang ia gunakan.", ar: "كَارْلُوس مُرَمِّم. اِبْحَثْ عَنِ الأَدَاة الَّتِي كَانَ يَسْتَخْدِمُهَا." },
        h2: { ko: "붓과 빨간색은 깃발 회복과 연결돼요.", en: "The brush and red paint connect to the restored flag.", es: "El pincel y la pintura roja conectan con la bandera restaurada.", id: "Kuas dan cat merah itu berkaitan dengan bendera yang dipulihkan.", ar: "الفُرْشَاة وَالطِّلَاء الأَحْمَر مُرْتَبِطَانِ بِالعَلَم الَّذِي رُمِّمَ." },
        h3: { ko: "정답: 스피커 옆의 빨간 붓.", en: "Answer: the red paintbrush beside the speaker.", es: "Respuesta: el pincel rojo junto al altavoz.", id: "Jawaban: kuas merah di samping pengeras suara.", ar: "الإِجَابَة: فُرْشَاة الدِّهَان الحَمْرَاء بِجَانِب السَّمَّاعَة." },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Madrid Boss Spell", ko: "마드리드 보스 주문", es: "Hechizo Jefe de Madrid", id: "Mantra Bos Madrid", ar: "تَعْوِيذَة زَعِيم مَدْرِيد" },
      context: { en: "Speak the festival back into shape.", ko: "축제가 다시 형태를 되찾도록 말하세요.", es: "Devuelve la forma al festival con tus palabras.", id: "Ucapkan agar festival kembali ke wujudnya.", ar: "تَكَلَّمْ لِتُعِيدَ المِهْرَجَان إِلَى شَكْلِه." },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          instruction: { en: "Place each spell-piece on the sealed stage.", ko: "주문 조각을 봉인된 무대 위에 순서대로 놓으세요.", es: "Coloca cada pieza del hechizo sobre el escenario sellado.", id: "Letakkan setiap potongan mantra pada panggung tersegel.", ar: "ضَعْ كُلَّ قِطْعَة تَعْوِيذَة عَلَى المَسْرَح المُغْلَق." },
          hints: {
            h1: { ko: "순서가 중요해요. 먼저 감정을 말하세요.", en: "The order matters. Begin with the feeling.", es: "El orden importa. Empieza con el sentimiento.", id: "Urutannya penting. Mulailah dengan perasaan.", ar: "التَّرْتِيب مُهِمّ. اِبْدَأ بِالشُّعُور." },
            h2: { ko: "그다음은 장소 질문이에요: Where is + the festival.", en: "Next comes the place question: Where is + the festival.", es: "Después va la pregunta de lugar: Where is + the festival.", id: "Berikutnya pertanyaan tempat: Where is + the festival.", ar: "ثُمَّ يَأْتِي سُؤَال المَكَان: Where is + the festival." },
            h3: { ko: "정답 문장: I am happy. Where is the festival? It is beautiful.", en: "Answer sentence: I am happy. Where is the festival? It is beautiful.", es: "Frase correcta: I am happy. Where is the festival? It is beautiful.", id: "Kalimat jawaban: I am happy. Where is the festival? It is beautiful.", ar: "جُمْلَة الإِجَابَة: I am happy. Where is the festival? It is beautiful." },
          },
          storyReason: { en: "Open the sealed stage to reach Carlos and the Madrid Stone fragment.", ko: "봉인된 무대를 열어 카를로스와 마드리드 스톤 파편에 닿으세요.", es: "Abre el escenario sellado para alcanzar a Carlos y el fragmento de la Piedra de Madrid.", id: "Buka panggung tersegel untuk mencapai Carlos dan pecahan Batu Madrid.", ar: "اِفْتَحِ المَسْرَح المُغْلَق لِتَصِلَ إِلَى كَارْلُوس وَشَظِيَّة حَجَر مَدْرِيد." },
          storyConsequence: { en: "The first red spark becomes a full dance step.", ko: "첫 빨간 불꽃이 온전한 춤 동작으로 이어집니다.", es: "La primera chispa roja se convierte en un paso de baile completo.", id: "Percik merah pertama menjadi satu langkah tarian yang utuh.", ar: "تُصْبِح أَوَّل شَرَارَة حَمْرَاء خُطْوَة رَقْص كَامِلَة." },
          doorImage: ch2BossStageImg,
        },
      ],
      hints: {
        h1: { ko: "Boss Spell은 감정, 위치 질문, 묘사로 이루어져요.", en: "The Boss Spell uses feeling, location, and description.", es: "El Boss Spell usa emoción, lugar y descripción.", id: "Mantra Bos memakai perasaan, lokasi, dan deskripsi.", ar: "تَعْوِيذَة الزَّعِيم تَسْتَخْدِم الشُّعُور وَالمَكَان وَالوَصْف." },
        h2: { ko: "I am happy. Where is + the festival? It is beautiful.", en: "I am happy. Where is + the festival? It is beautiful.", es: "I am happy. Where is + the festival? It is beautiful.", id: "I am happy. Where is + the festival? It is beautiful.", ar: "I am happy. Where is + the festival? It is beautiful." },
        h3: { ko: "정답 문장: I am happy. Where is the festival? It is beautiful.", en: "Answer sentence: I am happy. Where is the festival? It is beautiful.", es: "Frase correcta: I am happy. Where is the festival? It is beautiful.", id: "Kalimat jawaban: I am happy. Where is the festival? It is beautiful.", ar: "جُمْلَة الإِجَابَة: I am happy. Where is the festival? It is beautiful." },
      },
    },
    {
    ...
    },
    {
      ...
      textEs: "*respirando con fuerza* Podía oír a todos, pero cada palabra volvía pulida, suave, vacía. Isabel. Gracias. Pensé que nadie encontraría el color.",
      textEsMix: "*respirando con fuerza* Podía oír a todos, pero cada word volvía smooth y empty. Isabel. Gracias. Pensé que nadie encontraría el color.",
...
const SEOUL_V21_STORY: Story = {
  ...
  sequence: [
      ...
      questions: [
        {
          ...
          meaning: { en: "a polite hello", ko: "정중한 인사", es: "un saludo formal", id: "sapaan yang sopan", ar: "سَلَام مُؤَدَّب" },
          wrong: [
            { en: "casual bye", ko: "반말 작별", es: "despedida casual", id: "ucapan perpisahan santai", ar: "وَدَاع عَادِي" },
            { en: "a price question", ko: "가격 질문", es: "pregunta de precio", id: "pertanyaan harga", ar: "سُؤَال عَنِ السِّعْر" },
            { en: "a place name", ko: "장소 이름", es: "nombre de lugar", id: "nama tempat", ar: "اِسْم مَكَان" },
          ],
        },
        {
          word: { en: "감사합니다", ko: "감사합니다", es: "감사합니다", id: "감사합니다", ar: "감사합니다" },
          meaning: { en: "polite thank you", ko: "정중한 감사", es: "gracias formal", id: "ucapan terima kasih yang sopan", ar: "شُكْر مُؤَدَّب" },
          wrong: [
            { en: "informal help", ko: "반말 도움 요청", es: "ayuda informal", id: "permintaan tolong yang santai", ar: "طَلَب مُسَاعْدَة عَادِي" },
            { en: "left turn", ko: "왼쪽으로 돌기", es: "girar a la izquierda", id: "belok kiri", ar: "لِفّ شِمَال" },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Choose the Polite Reply", ko: "정중한 대답 고르기", es: "Elige la respuesta formal", id: "Pilih Jawaban yang Sopan", ar: "اِخْتَار الرَّدّ المُؤَدَّب" },
      context: {
      ...
      questions: [
        ...
        },
        {
          ...
          wrong: [
            { en: "도와줘", ko: "도와줘", es: "도와줘", id: "도와줘", ar: "도와줘" },
            { en: "Help", ko: "Help", es: "Help", id: "Help", ar: "Help" },
          ],
        },
      ],
      hints: {
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Build the Korean Order", ko: "한국어 어순 만들기", es: "Construir el orden coreano", id: "Susun Tata Urutan Korea", ar: "كَوِّن التَّرْتِيب الكُورِي" },
      context: {
        ...
        ar: "سُوجِين عَايْزَاك تِحُطّ أَجْزَاء الجُمْلَة بِالتَّرْتِيب الكُورِي.",
      },
      pType: "sentence-builder",
      tprsStage: 3,
      ...
      questions: [
        {
          instruction: { en: "Build: I go to the museum.", ko: "문장을 만드세요: 저는 박물관에 가요.", es: "Construye: Voy al museo.", id: "Susun: Saya pergi ke museum.", ar: "كَوِّن: أَنَا رَايِح المَتْحَف." },
          words: [
            { en: "저는", ko: "저는", es: "저는", id: "저는", ar: "저는" },
            { en: "박물관에", ko: "박물관에", es: "박물관에", id: "박물관에", ar: "박물관에" },
            { en: "가요", ko: "가요", es: "가요", id: "가요", ar: "가요" },
          ],
          answerOrder: [0, 1, 2],
        },
        {
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Find the Ordered Clue", ko: "순서가 맞는 단서 찾기", es: "Encontrar la pista ordenada", id: "Temukan Petunjuk yang Berurutan", ar: "لَاقِي الدَّلِيل المُرَتَّب" },
      context: {
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 5,
      title: { en: "Seoul Boss Spell", ko: "서울 보스 주문", es: "Hechizo Jefe de Seúl", id: "Mantra Bos Seoul", ar: "تَعْوِيذِة زَعِيم سِيُول" },
      context: {
      ...
      questions: [
        {
          ...
          hints: {
            h1: {
              ...
              ar: "اِخْتَار الصِّيَغ المُؤَدَّبَة. الكَلَام العَادِي مَبْيِنْفَعْش مَعَ البَوَّابَة دِي.",
            },
            h2: {
              ...
              ar: "التَّرْتِيب: 안녕하세요 → 도와주세요 → 박물관은 → 어디예요?",
            },
            h3: {
              ...
              ar: "الجُمْلَة الصَّح: 안녕하세요. 도와주세요. 박물관은 어디예요?",
            },
          },
          storyReason: {
      ...
      hints: {
        h1: { ko: "반말 distractor를 피하세요: 안녕 / 도와줘 / 어디야?", en: "Avoid the informal distractors: 안녕 / 도와줘 / 어디야?", es: "Evita los distractores informales: 안녕 / 도와줘 / 어디야?", id: "Hindari pengecoh santai: 안녕 / 도와줘 / 어디야?", ar: "اِبْعِد عَنِ المُشَتِّتَات العَادِيَّة: 안녕 / 도와줘 / 어디야?" },
        h2: { ko: "정중한 순서: 안녕하세요. 도와주세요. 박물관은 어디예요?", en: "Polite order: 안녕하세요. 도와주세요. 박물관은 어디예요?", es: "Orden formal: 안녕하세요. 도와주세요. 박물관은 어디예요?", id: "Urutan sopan: 안녕하세요. 도와주세요. 박물관은 어디예요?", ar: "التَّرْتِيب المُؤَدَّب: 안녕하세요. 도와주세요. 박물관은 어디예요?" },
        h3: { ko: "정답 문장: 안녕하세요. 도와주세요. 박물관은 어디예요?", en: "Answer sentence: 안녕하세요. 도와주세요. 박물관은 어디예요?", es: "Frase correcta: 안녕하세요. 도와주세요. 박물관은 어디예요?", id: "Kalimat jawaban: 안녕하세요. 도와주세요. 박물관은 어디예요?", ar: "جُمْلِة الإِجَابَة: 안녕하세요. 도와주세요. 박물관은 어디예요?" },
      },
    },
    {
      kind: "scene",
...
const CAIRO_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Recover the Written Record", ko: "쓰인 기록 복원", es: "Recuperar el registro escrito", id: "Pulihkan Catatan Tertulis", ar: "اِسْتَرْجِعِ السِّجِلَّ المَكْتُوب" },
      context: {
        ...
        ar: "تَحْتَاج أَمِيرَة كَلِمَات الأَرْشِيف الأُولَى قَبْلَ أَنْ تَسْتَطِيعَ فَتْحَ مِلَفّ إِلِيس.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          word: { en: "record", ko: "기록", es: "registro", id: "catatan", ar: "سِجِلّ" },
          meaning: { en: "proof that something happened", ko: "어떤 일이 있었다는 증거", es: "prueba de que algo ocurrió", id: "bukti bahwa sesuatu pernah terjadi", ar: "دَلِيل عَلَى أَنَّ شَيْئًا قَدْ حَدَث" },
          wrong: [
            { en: "a festival color", ko: "축제의 색", es: "un color de festival", id: "warna festival", ar: "لَوْن مِنْ أَلْوَان المِهْرَجَان" },
            { en: "a taxi direction", ko: "택시 방향", es: "una dirección de taxi", id: "arah taksi", ar: "اِتِّجَاه سَيَّارَة أُجْرَة" },
            { en: "a casual greeting", ko: "가벼운 인사", es: "un saludo casual", id: "sapaan santai", ar: "تَحِيَّة عَادِيَّة" },
          ],
        },
        {
          word: { en: "remember", ko: "기억하다", es: "recordar", id: "mengingat", ar: "يَتَذَكَّر" },
          meaning: { en: "to keep something in your mind", ko: "무언가를 마음속에 간직하다", es: "guardar algo en la mente", id: "menyimpan sesuatu di dalam pikiran", ar: "أَنْ تَحْتَفِظَ بِشَيْءٍ فِي ذِهْنِك" },
          wrong: [
            { en: "to erase a page", ko: "페이지를 지우다", es: "borrar una página", id: "menghapus sebuah halaman", ar: "أَنْ تَمْحُوَ صَفْحَة" },
            { en: "to ask a price", ko: "가격을 묻다", es: "preguntar un precio", id: "menanyakan harga", ar: "أَنْ تَسْأَلَ عَنِ السِّعْر" },
            { en: "to turn left", ko: "왼쪽으로 돌다", es: "girar a la izquierda", id: "belok kiri", ar: "أَنْ تَنْعَطِفَ يَسَارًا" },
          ],
        },
        {
          word: { en: "wrote", ko: "썼다", es: "escribió", id: "menulis (lampau)", ar: "كَتَبَ" },
          meaning: { en: "put words on paper, in the past", ko: "예전에 종이에 글을 남긴 것", es: "puso palabras en papel, en el pasado", id: "menaruh kata di atas kertas, di masa lalu", ar: "وَضَعَ كَلِمَاتٍ عَلَى وَرَق، فِي المَاضِي" },
          wrong: [
            { en: "erased the page", ko: "페이지를 지운 것", es: "borró la página", id: "menghapus halaman", ar: "مَحَا الصَّفْحَة" },
            { en: "a place in Seoul", ko: "서울의 장소", es: "un lugar en Seúl", id: "sebuah tempat di Seoul", ar: "مَكَان فِي سِيُول" },
            { en: "a type of food", ko: "음식 종류", es: "un tipo de comida", id: "jenis makanan", ar: "نَوْع مِنَ الطَّعَام" },
          ],
        },
        {
          word: { en: "lullaby", ko: "자장가", es: "nana", id: "nina bobo", ar: "تَهْوِيدَة" },
          meaning: { en: "a gentle song sung to a child", ko: "아이에게 불러주는 부드러운 노래", es: "una canción suave para dormir a un niño", id: "lagu lembut yang dinyanyikan untuk seorang anak", ar: "أُغْنِيَة هَادِئَة تُغَنَّى لِطِفْل" },
          wrong: [
            { en: "a museum lock", ko: "박물관 자물쇠", es: "una cerradura de museo", id: "kunci museum", ar: "قُفْل مَتْحَف" },
            { en: "a cold signal", ko: "차가운 신호", es: "una señal fría", id: "sinyal yang dingin", ar: "إِشَارَة بَارِدَة" },
            { en: "a train ticket", ko: "기차표", es: "un billete de tren", id: "tiket kereta", ar: "تَذْكَرَة قِطَار" },
          ],
        },
      ],
      hints: {
        h1: { ko: "이번 장은 기록과 과거 시제예요.", en: "This chapter is about records and past tense.", es: "Este capítulo trata de registros y pasado.", id: "Bab ini berkisah tentang catatan dan bentuk lampau.", ar: "هٰذَا الفَصْل عَنِ السِّجِلَّات وَصِيغَة المَاضِي." },
        h2: { ko: "Ellis가 이미 적어 두었어요 — 이미 일어난 일이에요.", en: "Ellis already wrote it down — it already happened.", es: "Ellis ya lo escribió — ya ocurrió.", id: "Ellis sudah menuliskannya — itu sudah terjadi.", ar: "إِلِيس كَتَبَتْهَا بِالفِعْل — هٰذَا الأَمْر قَدْ حَدَثَ بِالفِعْل." },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Answer With Memory", ko: "기억으로 답하기", es: "Responder con memoria", id: "Jawab dengan Ingatan", ar: "أَجِبْ بِالذَّاكِرَة" },
      context: {
        ...
        ar: "يَتَكَلَّم حَسَن بِشَظَايَا مِنْ ذِكْرَيَاتِه. اِخْتَرِ الإِجَابَة الَّتِي تُحَافِظ عَلَى المَاضِي، لَا النُّسْخَة المَيِّتَة.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Hassan asks what survives when a page is erased.", ko: "하산은 페이지가 지워진 뒤 무엇이 남는지 묻습니다.", es: "Hassan pregunta qué sobrevive cuando se borra una página.", id: "Hassan bertanya apa yang bertahan ketika sebuah halaman dihapus.", ar: "يَسْأَل حَسَن مَا الَّذِي يَبْقَى عِنْدَمَا تُمْحَى صَفْحَة." },
          context: { en: "Answer from memory.", ko: "기억으로 답하세요.", es: "Responde desde la memoria.", id: "Jawablah dari ingatan.", ar: "أَجِبْ مِنْ ذَاكِرَتِك." },
          answer: { en: "I remember.", ko: "저는 기억해요.", es: "Yo recuerdo.", id: "Saya ingat.", ar: "أَنَا أَتَذَكَّر." },
          wrong: [
            { en: "I forget.", ko: "저는 잊어버려요.", es: "Yo olvido.", id: "Saya lupa.", ar: "أَنَا أَنْسَى." },
            { en: "How much?", ko: "얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَمْ؟" },
          ],
        },
        {
          prompt: { en: "Amira shows a note in Ellis's handwriting. What do you say?", ko: "아미라가 엘리스의 필체로 된 메모를 보여줍니다. 뭐라고 말할까요?", es: "Amira muestra una nota con la letra de Ellis. ¿Qué dices?", id: "Amira menunjukkan catatan dengan tulisan tangan Ellis. Apa yang kamu katakan?", ar: "تُرِيك أَمِيرَة وَرَقَة بِخَطِّ يَدِ إِلِيس. مَاذَا تَقُول؟" },
          context: { en: "Use past tense.", ko: "과거 시제를 쓰세요.", es: "Usa el pasado.", id: "Gunakan bentuk lampau.", ar: "اِسْتَخْدِم صِيغَة المَاضِي." },
          answer: { en: "She wrote about it.", ko: "그녀가 그것에 대해 썼어요.", es: "Ella escribió sobre eso.", id: "Dia menulis tentang itu.", ar: "هِيَ كَتَبَتْ عَنْه." },
          wrong: [
            { en: "She writes about it.", ko: "그녀가 그것에 대해 써요.", es: "Ella escribe sobre eso.", id: "Dia menulis tentang itu sekarang.", ar: "هِيَ تَكْتُب عَنْه." },
            { en: "She is happy.", ko: "그녀는 행복해요.", es: "Ella está feliz.", id: "Dia bahagia.", ar: "هِيَ سَعِيدَة." },
          ],
        },
        {
          prompt: { en: "Hassan hums one surviving line of the lullaby.", ko: "하산이 살아남은 자장가 한 줄을 흥얼거립니다.", es: "Hassan tararea una línea sobreviviente de la nana.", id: "Hassan menyenandungkan satu baris nina bobo yang bertahan.", ar: "يُدَنْدِن حَسَن سَطْرًا وَاحِدًا بَقِيَ مِنَ التَّهْوِيدَة." },
          context: { en: "Describe what it was.", ko: "그것이 어땠는지 말하세요.", es: "Describe cómo era.", id: "Gambarkan dulu seperti apa.", ar: "صِفْ كَيْفَ كَانَتْ." },
          answer: { en: "It was beautiful.", ko: "그것은 아름다웠어요.", es: "Era hermosa.", id: "Itu indah.", ar: "كَانَتْ جَمِيلَة." },
          wrong: [
            { en: "It is a taxi.", ko: "그것은 택시예요.", es: "Es un taxi.", id: "Itu taksi.", ar: "هٰذِهِ سَيَّارَة أُجْرَة." },
            { en: "Bread please.", ko: "빵 주세요.", es: "Pan, por favor.", id: "Tolong, roti.", ar: "خُبْز مِنْ فَضْلِك." },
          ],
        },
      ],
      hints: {
        h1: { ko: "과거를 말할 때 was / wrote를 써요.", en: "Use was / wrote when speaking about the past.", es: "Usa was / wrote para hablar del pasado.", id: "Gunakan was / wrote saat berbicara tentang masa lalu.", ar: "اِسْتَخْدِم was / wrote عِنْدَمَا تَتَكَلَّم عَنِ المَاضِي." },
        h2: { ko: "She writes는 현재, She wrote는 과거예요.", en: "She writes is present; She wrote is past.", es: "She writes es presente; She wrote es pasado.", id: "She writes itu kini; She wrote itu lampau.", ar: "She writes مُضَارِع؛ وَ She wrote مَاضٍ." },
        h3: { ko: "정답 흐름: I remember / She wrote about it / It was beautiful", en: "Answer flow: I remember / She wrote about it / It was beautiful", es: "Flujo correcto: I remember / She wrote about it / It was beautiful", id: "Alur jawaban: I remember / She wrote about it / It was beautiful", ar: "تَسَلْسُل الإِجَابَة: I remember / She wrote about it / It was beautiful" },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find Ellis's Page", ko: "엘리스의 페이지 찾기", es: "Encontrar la página de Ellis", id: "Temukan Halaman Ellis", ar: "اِعْثُرْ عَلَى صَفْحَة إِلِيس" },
      context: {
        ...
        ar: "بَقِيَتْ ثَلَاثَة أَشْيَاء فِي الأَرْشِيف. وَاحِدَة فَقَطْ مِنْهَا هِيَ صَفْحَة يَوْمِيَّات إِلِيس الحَقِيقِيَّة.",
      },
      pType: "investigation",
      quizContract: "deduction",
      tprsStage: 3,
      ...
      questions: [
        {
          prompt: { en: "Which item is Ellis's true journal page?", ko: "어느 물건이 엘리스의 진짜 일지 페이지인가요?", es: "¿Qué objeto es la página verdadera del diario de Ellis?", id: "Benda mana yang merupakan halaman jurnal asli Ellis?", ar: "أَيُّ شَيْءٍ مِنْهَا هُوَ صَفْحَة يَوْمِيَّات إِلِيس الحَقِيقِيَّة؟" },
          clues: [
            { en: "A clean typed summary where every sentence is perfect and no one sounds afraid.", ko: "모든 문장이 완벽하고 아무도 두려워하지 않는 것처럼 보이는 깨끗한 요약문.", es: "Un resumen limpio donde cada frase es perfecta y nadie parece tener miedo.", id: "Ringkasan ketik yang bersih, setiap kalimatnya sempurna dan tak ada yang terdengar takut.", ar: "مُلَخَّص مَطْبُوع وَنَظِيف، كُلُّ جُمْلَة فِيهِ كَامِلَة وَلَا أَحَدَ يَبْدُو خَائِفًا." },
            { en: "A torn journal page: 'I was here. I spoke. I mattered.' Beside it, a lullaby copied in three uneven hands.", ko: "찢어진 일지 페이지: 'I was here. I spoke. I mattered.' 그 옆에는 세 가지 다른 손글씨로 베껴 쓴 자장가.", es: "Una página rota: 'I was here. I spoke. I mattered.' Al lado, una nana copiada por tres manos distintas.", id: "Halaman jurnal yang robek: 'I was here. I spoke. I mattered.' Di sampingnya, sebuah nina bobo yang disalin oleh tiga tulisan tangan berbeda.", ar: "صَفْحَة يَوْمِيَّات مُمَزَّقَة: 'I was here. I spoke. I mattered.' وَبِجَانِبِهَا تَهْوِيدَة مَنْقُولَة بِثَلَاثَة خُطُوطِ يَدٍ مُخْتَلِفَة." },
            { en: "A blank hospital form stamped with a machine translation seal.", ko: "기계 번역 도장이 찍힌 빈 병원 양식.", es: "Un formulario hospitalario en blanco con un sello de traducción automática.", id: "Formulir rumah sakit kosong yang dicap segel terjemahan mesin.", ar: "اِسْتِمَارَة مُسْتَشْفًى فَارِغَة مَخْتُومَة بِخَتْمِ تَرْجَمَة آلِيَّة." },
          ],
          answerIdx: 1,
        },
      ],
      hints: {
        h1: { ko: "진짜 기록은 완벽하지 않아도 사람의 흔적이 있어요.", en: "The true record has human traces, even if it is imperfect.", es: "El registro verdadero tiene huellas humanas, aunque sea imperfecto.", id: "Catatan yang asli memiliki jejak manusia, meski tak sempurna.", ar: "السِّجِلّ الحَقِيقِيّ فِيهِ أَثَر إِنْسَانِيّ، حَتَّى لَوْ كَانَ غَيْرَ كَامِل." },
        h2: { ko: "Lock 문장: I was here. I spoke. I mattered.", en: "Lock line: I was here. I spoke. I mattered.", es: "Línea clave: I was here. I spoke. I mattered.", id: "Baris kunci: I was here. I spoke. I mattered.", ar: "سَطْر القُفْل: I was here. I spoke. I mattered." },
        h3: { ko: "정답은 찢어진 엘리스 일지 페이지예요.", en: "The answer is the torn Ellis journal page.", es: "La respuesta es la página rota del diario de Ellis.", id: "Jawabannya adalah halaman jurnal Ellis yang robek.", ar: "الإِجَابَة هِيَ صَفْحَة يَوْمِيَّات إِلِيس المُمَزَّقَة." },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Cairo Boss Spell", ko: "카이로 보스 주문", es: "Hechizo Jefe de El Cairo", id: "Mantra Bos Kairo", ar: "تَعْوِيذَة زَعِيم القَاهِرَة" },
      context: {
        ...
        ar: "اِسْتَخْدِم كَلِمَات إِلِيس لِتُعِيدَ مَا ضَاع.",
      },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          hints: {
            h1: {
              ...
              ar: "اِسْتَخْدِم صِيغَة المَاضِي. إِلِيس كَتَبَتْهَا بِالفِعْل.",
            },
            h2: {
              ...
              ar: "She writes مُضَارِع؛ وَ She wrote مَاضٍ.",
            },
            h3: {
              ...
              ar: "الإِجَابَة: I remember. She wrote the lullaby. Where is the record?",
            },
          },
          storyReason: {
            ...
            ar: "بَاب الأَرْشِيف مُغْلَق. كَلِمَات إِلِيس تَسْتَطِيع فَتْحَه.",
          },
          storyConsequence: {
            ...
            ar: "كُلُّ سَطْرٍ يُعِيد نَقْشًا وَاحِدًا عَلَى الجِدَار. تُصْبِح يَوْمِيَّات إِلِيس كَامِلَة مِنْ جَدِيد.",
          },
          doorImage: ch4BossArchiveImg,
        },
      ],
      hints: {
        h1: { ko: "기억으로 시작하세요: I remember.", en: "Start with memory: I remember.", es: "Empieza con la memoria: I remember.", id: "Mulailah dengan ingatan: I remember.", ar: "اِبْدَأ بِالذَّاكِرَة: I remember." },
        h2: { ko: "현재형 She writes가 아니라 과거형 She wrote예요.", en: "Use past tense She wrote, not present tense She writes.", es: "Usa el pasado She wrote, no el presente She writes.", id: "Gunakan bentuk lampau She wrote, bukan bentuk kini She writes.", ar: "اِسْتَخْدِم المَاضِي She wrote، لَا المُضَارِع She writes." },
        h3: { ko: "정답 문장: I remember. She wrote the lullaby. Where is the record?", en: "Answer sentence: I remember. She wrote the lullaby. Where is the record?", es: "Frase correcta: I remember. She wrote the lullaby. Where is the record?", id: "Kalimat jawaban: I remember. She wrote the lullaby. Where is the record?", ar: "جُمْلَة الإِجَابَة: I remember. She wrote the lullaby. Where is the record?" },
      },
    },
    {
      kind: "scene",
...
const BABEL_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Open the Connection Gate", ko: "연결의 관문 열기", es: "Abrir la puerta de conexión", id: "Buka Gerbang Koneksi", ar: "اِفْتَحْ بَوَّابَة التَّوَاصُل" },
      context: {
        ...
        ar: "بَوَّابَة بَابِل الأُولَى تُصْغِي لِكَلِمَاتٍ آتِيَة مِنْ كُلِّ مَدِينَة.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          word: { en: "Hello", ko: "Hello", es: "Hello", id: "Hello", ar: "Hello" },
          meaning: { en: "a greeting that starts a connection", ko: "연결을 시작하는 인사", es: "un saludo que inicia una conexión", id: "sapaan yang memulai sebuah koneksi", ar: "تَحِيَّة يَبْدَأ بِهَا التَّوَاصُل" },
          wrong: [
            { en: "a machine command", ko: "기계 명령", es: "un comando de máquina", id: "perintah mesin", ar: "أَمْر لِآلَة" },
            { en: "a final goodbye", ko: "마지막 작별", es: "una despedida final", id: "perpisahan terakhir", ar: "وَدَاع أَخِير" },
            { en: "a hidden coordinate", ko: "숨겨진 좌표", es: "una coordenada oculta", id: "koordinat tersembunyi", ar: "إِحْدَاثِيّ مَخْفِيّ" },
          ],
        },
        {
          word: { en: "Gracias", ko: "Gracias", es: "Gracias", id: "Gracias", ar: "Gracias" },
          meaning: { en: "Spanish for thank you", ko: "스페인어 감사 표현", es: "gracias en español", id: "terima kasih dalam bahasa Spanyol", ar: "'شُكْرًا' بِالإِسْبَانِيَّة" },
          wrong: [
            { en: "Korean for palace", ko: "궁궐을 뜻하는 한국어", es: "coreano para palacio", id: "bahasa Korea untuk istana", ar: "'قَصْر' بِالكُورِيَّة" },
            { en: "Welsh for water", ko: "물을 뜻하는 웨일스어", es: "galés para agua", id: "bahasa Wales untuk air", ar: "'مَاء' بِالوِيلْزِيَّة" },
            { en: "Arabic for record", ko: "기록을 뜻하는 아랍어", es: "árabe para registro", id: "bahasa Arab untuk catatan", ar: "'سِجِلّ' بِالعَرَبِيَّة" },
          ],
        },
        {
          word: { en: "안녕하세요", ko: "안녕하세요", es: "안녕하세요", id: "안녕하세요", ar: "안녕하세요" },
          meaning: { en: "polite Korean greeting", ko: "정중한 한국어 인사", es: "saludo formal en coreano", id: "sapaan Korea yang sopan", ar: "تَحِيَّة كُورِيَّة مُؤَدَّبَة" },
          wrong: [
            { en: "casual command", ko: "반말 명령", es: "mandato informal", id: "perintah santai", ar: "أَمْر عَادِيّ غَيْر رَسْمِيّ" },
            { en: "a color word", ko: "색깔 단어", es: "una palabra de color", id: "kata warna", ar: "كَلِمَة لَوْن" },
            { en: "a place name", ko: "장소 이름", es: "un nombre de lugar", id: "nama tempat", ar: "اِسْم مَكَان" },
          ],
        },
        {
          word: { en: "Salaam", ko: "Salaam", es: "Salaam", id: "Salaam", ar: "Salaam" },
          meaning: { en: "a greeting of peace", ko: "평화를 담은 인사", es: "un saludo de paz", id: "sapaan yang membawa kedamaian", ar: "تَحِيَّة فِيهَا سَلَام" },
          wrong: [
            { en: "a stone pedestal", ko: "돌 받침대", es: "un pedestal de piedra", id: "alas batu", ar: "قَاعِدَة حَجَر" },
            { en: "a erased page", ko: "지워진 페이지", es: "una página borrada", id: "halaman yang terhapus", ar: "صَفْحَة مَمْسُوحَة" },
            { en: "a tower floor", ko: "탑의 층", es: "un piso de la torre", id: "lantai menara", ar: "طَابِق مِنْ طَوَابِق البُرْج" },
          ],
        },
      ],
      hints: {
        h1: { ko: "각 도시는 자기 방식으로 인사를 남겼어요.", en: "Each city left a greeting in its own way.", es: "Cada ciudad dejó un saludo a su manera.", id: "Setiap kota meninggalkan sapaan dengan caranya sendiri.", ar: "كُلُّ مَدِينَة تَرَكَتْ تَحِيَّة عَلَى طَرِيقَتِهَا." },
        h2: { ko: "Connection은 같은 말이 아니라 서로 다른 말이 만나는 순간이에요.", en: "Connection is not one word. It is different words meeting.", es: "La conexión no es una palabra única. Es cuando se encuentran palabras distintas.", id: "Connection bukan satu kata. Ia adalah saat kata-kata yang berbeda bertemu.", ar: "التَّوَاصُل لَيْسَ كَلِمَة وَاحِدَة. إِنَّهُ لَحْظَة تَلَاقِي الكَلِمَاتِ المُخْتَلِفَة." },
        h3: { ko: "Hello / Gracias / 안녕하세요 / Salaam", en: "Hello / Gracias / 안녕하세요 / Salaam", es: "Hello / Gracias / 안녕하세요 / Salaam", id: "Hello / Gracias / 안녕하세요 / Salaam", ar: "Hello / Gracias / 안녕하세요 / Salaam" },
      },
    },
    {
      kind: "clue",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Hold the Allies Together", ko: "동료들을 붙잡기", es: "Mantener unidos a los aliados", id: "Pertahankan Para Sekutu", ar: "اِجْمَعْ رِفَاقَك مَعًا" },
      context: {
        ...
        ar: "البَوَّابَة الثَّانِيَة تُهَاجِم الشَّكّ. اِخْتَرِ الرَّدّ الَّذِي يُبْقِي كُلَّ رَفِيقٍ مَعَك.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Sujin says the Korean order feels fragile.", ko: "수진이 한국어 어순이 흔들리는 것 같다고 말합니다.", es: "Sujin dice que el orden coreano se siente frágil.", id: "Sujin berkata urutan kata bahasa Korea terasa rapuh.", ar: "تَقُول سُوجِين إِنَّ تَرْتِيب الكُورِيَّة تَشْعُر بِأَنَّهُ ضَعِيف." },
          context: { en: "Answer with presence.", ko: "함께 있다는 말로 답하세요.", es: "Responde con presencia.", id: "Jawablah dengan kehadiran.", ar: "أَجِبْ بِأَنَّكَ مَوْجُود مَعَهَا." },
          answer: { en: "I am here.", ko: "저 여기 있어요.", es: "Aquí estoy.", id: "Aku di sini.", ar: "أَنَا هُنَا." },
          wrong: [
            { en: "I forget.", ko: "저는 잊어버려요.", es: "Yo olvido.", id: "Aku lupa.", ar: "أَنَا أَنْسَى." },
            { en: "How much?", ko: "얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَمْ؟" },
          ],
        },
        {
          prompt: { en: "Mira's recovered voice trembles for the first time.", ko: "Mira의 회복된 목소리가 처음으로 떨립니다.", es: "La voz recuperada de Mira tiembla por primera vez.", id: "Suara Mira yang pulih bergetar untuk pertama kalinya.", ar: "صَوْت مِيرَا الَّذِي عَادَ يَرْتَعِش لِأَوَّلِ مَرَّة." },
          context: { en: "Tell her she is not a script.", ko: "그녀가 대본이 아니라고 말해 주세요.", es: "Dile que no es un guion.", id: "Katakan padanya bahwa ia bukan sebuah naskah.", ar: "قُلْ لَهَا إِنَّهَا لَيْسَتْ نَصًّا مَكْتُوبًا." },
          answer: { en: "I see you.", ko: "저는 당신이 보여요.", es: "Te veo.", id: "Aku melihatmu.", ar: "أَنَا أَرَاكِ." },
          wrong: [
            { en: "You are perfect.", ko: "당신은 완벽해요.", es: "Eres perfecta.", id: "Kamu sempurna.", ar: "أَنْتِ كَامِلَة." },
            { en: "Read faster.", ko: "더 빨리 읽어요.", es: "Lee más rápido.", id: "Baca lebih cepat.", ar: "اِقْرَئِي أَسْرَع." },
          ],
        },
        {
          prompt: { en: "The gate divides the group into separate echoes.", ko: "관문이 동료들을 따로따로 울리는 메아리로 나눕니다.", es: "La puerta divide al grupo en ecos separados.", id: "Gerbang itu memecah kelompok menjadi gema-gema yang terpisah.", ar: "البَوَّابَة تُقَسِّم المَجْمُوعَة إِلَى أَصْدَاء مُنْفَصِلَة." },
          context: { en: "Use the plural truth.", ko: "함께라는 진실을 말하세요.", es: "Usa la verdad plural.", id: "Gunakan kebenaran jamak.", ar: "اِسْتَخْدِم حَقِيقَة الجَمْع." },
          answer: { en: "We are together.", ko: "우리는 함께예요.", es: "Estamos juntos.", id: "Kita bersama.", ar: "نَحْنُ مَعًا." },
          wrong: [
            { en: "I am alone.", ko: "저는 혼자예요.", es: "Estoy solo.", id: "Aku sendirian.", ar: "أَنَا وَحْدِي." },
            { en: "The words are enough.", ko: "말이면 충분해요.", es: "Las palabras bastan.", id: "Kata-kata sudah cukup.", ar: "الكَلِمَات تَكْفِي." },
          ],
        },
      ],
      hints: {
        h1: { ko: "Babel은 사람들을 혼자라고 느끼게 해요.", en: "Babel tries to make people feel alone.", es: "Babel intenta hacer que la gente se sienta sola.", id: "Babel berusaha membuat orang merasa sendirian.", ar: "يُحَاوِل بَابِل أَنْ يَجْعَلَ النَّاسَ يَشْعُرُونَ بِأَنَّهُمْ وَحْدَهُم." },
        h2: { ko: "I / you / we 순서로 넓어져요.", en: "The answers widen: I / you / we.", es: "Las respuestas se amplían: I / you / we.", id: "Jawabannya meluas: I / you / we.", ar: "الإِجَابَات تَتَّسِع: I / you / we." },
        h3: { ko: "I am here / I see you / We are together", en: "I am here / I see you / We are together", es: "I am here / I see you / We are together", id: "I am here / I see you / We are together", ar: "I am here / I see you / We are together" },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find the Memory Stone", ko: "기억의 돌 찾기", es: "Encontrar la piedra de memoria", id: "Temukan Batu Memori", ar: "اِعْثُرْ عَلَى حَجَر الذِّكْرَى" },
      context: {
        ...
        ar: "ثَلَاث ذِكْرَيَات تَتَرَدَّد فِي الغُرْفَة. وَاحِدَة فَقَطْ مِنْهَا تُحَوِّل الحُزْن إِلَى حَقِيقَة، لَا إِلَى سَيْطَرَة.",
      },
      pType: "investigation",
      quizContract: "deduction",
      tprsStage: 3,
      ...
      questions: [
        {
          prompt: { en: "Which memory should Rudy hold up to Mr. Black?", ko: "루디가 Mr. Black에게 어떤 기억을 내밀어야 할까요?", es: "¿Qué recuerdo debe mostrar Rudy a Mr. Black?", id: "Kenangan mana yang harus Rudy tunjukkan kepada Mr. Black?", ar: "أَيُّ ذِكْرَى يَنْبَغِي لِرُودِي أَنْ يَرْفَعَهَا أَمَامَ مِسْتَر بْلَاك؟" },
          clues: [
            { en: "A perfect Universal Code transcript with every sentence corrected.", ko: "모든 문장이 수정된 완벽한 Universal Code 기록.", es: "Una transcripción perfecta del Código Universal con cada frase corregida.", id: "Transkrip Universal Code yang sempurna dengan setiap kalimat dikoreksi.", ar: "نُسْخَة كَامِلَة مِنْ نَصِّ الـ Universal Code وَكُلُّ جُمْلَة فِيهَا مُصَحَّحَة." },
            { en: "Ellis's torn journal page: 'I was here. I spoke. I mattered.' Beside it, a Welsh lullaby copied by hand.", ko: "Ellis의 찢어진 일지 페이지: 'I was here. I spoke. I mattered.' 그 옆에는 손으로 베껴 쓴 웨일스 자장가.", es: "La página rota de Ellis: 'I was here. I spoke. I mattered.' Al lado, una nana galesa copiada a mano.", id: "Halaman jurnal Ellis yang robek: 'I was here. I spoke. I mattered.' Di sampingnya, sebuah lagu nina bobo Wales yang disalin dengan tangan.", ar: "صَفْحَة مُمَزَّقَة مِنْ يَوْمِيَّات إِلِيس: 'I was here. I spoke. I mattered.' وَبِجَانِبِهَا تَهْوِيدَة وِيلْزِيَّة مَنْقُولَة بِخَطِّ اليَد." },
            { en: "A tower blueprint that marks every gate as efficient.", ko: "모든 관문을 효율적이라고 표시한 탑 설계도.", es: "Un plano de la torre que marca cada puerta como eficiente.", id: "Cetak biru menara yang menandai setiap gerbang sebagai efisien.", ar: "رَسْم هَنْدَسِيّ لِلبُرْج يُعَلِّم عَلَى كُلِّ بَوَّابَة بِأَنَّهَا كَفْؤَة." },
          ],
          answerIdx: 1,
        },
      ],
      hints: {
        h1: { ko: "Memory는 완벽한 문장이 아니라 사람의 흔적에 반응해요.", en: "Memory responds to human traces, not perfect sentences.", es: "Memory responde a huellas humanas, no a frases perfectas.", id: "Memory menanggapi jejak manusia, bukan kalimat yang sempurna.", ar: "الذِّكْرَى تَتَجَاوَب مَعَ آثَارِ البَشَر، لَا مَعَ الجُمَلِ الكَامِلَة." },
        h2: { ko: "Ch4에서 회수한 Ellis 일지를 떠올려요.", en: "Remember Ellis's journal from Ch4.", es: "Recuerda el diario de Ellis de Ch4.", id: "Ingat jurnal Ellis dari Bab 4.", ar: "تَذَكَّرْ يَوْمِيَّات إِلِيس الَّتِي اسْتَرْجَعْنَاهَا فِي الفَصْلِ الرَّابِع." },
        h3: { ko: "정답은 Ellis의 찢어진 일지 페이지예요.", en: "The answer is Ellis's torn journal page.", es: "La respuesta es la página rota del diario de Ellis.", id: "Jawabannya adalah halaman jurnal Ellis yang robek.", ar: "الإِجَابَة هِيَ صَفْحَة يَوْمِيَّات إِلِيس المُمَزَّقَة." },
      },
    },
    {
      kind: "clue",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Final Boss Spell", ko: "최종 보스 주문", es: "Hechizo Jefe Final", id: "Mantra Bos Terakhir", ar: "تَعْوِيذَة الزَّعِيم الأَخِيرَة" },
      context: {
        ...
        ar: "قُلِ الفَرْقَ بَيْنَ الكَلِمَاتِ وَلِمَاذَا قِيلَتْ.",
      },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          instruction: {
            ...
            ar: "قُلِ الشَّيْءَ الَّذِي لَمْ يَسْتَطِعِ الـ Universal Code أَنْ يَحْمِلَهُ أَبَدًا.",
          },
          hints: {
            h1: {
              ...
              ar: "اِفْصِلِ الكَلِمَاتِ عَنِ السَّبَب.",
            },
            h2: {
              ...
              ar: "translated هُوَ السَّطْح؛ وَ couldn't translate هُوَ القَلْب.",
            },
            h3: {
              ...
              ar: "الإِجَابَة: You translated the words. You couldn't translate why she said them.",
            },
          },
          storyReason: {
            ...
            ar: "قَلْبُ بَابِل مَخْتُوم بِتَرْجَمَةٍ كَامِلَة. المَعْنَى وَحْدَهُ هُوَ الَّذِي يَسْتَطِيع فَتْحَه.",
          },
          storyConsequence: {
            ...
            ar: "كُلُّ سَطْرٍ يُحَرِّر طَبَقَةً مِنَ الـ Universal Code. وَتَنْكَسِر دَائِرَة الأَحْجَار السَّبْعَة الأَخِيرَة.",
          },
          doorImage: ch5BossCoreImg,
        },
      ],
      hints: {
        h1: { ko: "단어 자체가 아니라 그 말을 한 이유를 말해야 해요.", en: "You need the reason she spoke, not only the words.", es: "Necesitas la razón por la que habló, no solo las palabras.", id: "Kamu butuh alasan ia berbicara, bukan hanya kata-katanya.", ar: "أَنْتَ بِحَاجَةٍ إِلَى السَّبَبِ الَّذِي جَعَلَهَا تَتَكَلَّم، لَا الكَلِمَاتِ فَقَط." },
        h2: { ko: "You translated the words 다음에 You couldn't translate why...", en: "First: You translated the words. Then: You couldn't translate why...", es: "Primero: You translated the words. Luego: You couldn't translate why...", id: "Pertama: You translated the words. Lalu: You couldn't translate why...", ar: "أَوَّلًا: You translated the words. ثُمَّ: You couldn't translate why..." },
        h3: { ko: "정답 문장: You translated the words. You couldn't translate why she said them.", en: "Answer sentence: You translated the words. You couldn't translate why she said them.", es: "Frase correcta: You translated the words. You couldn't translate why she said them.", id: "Kalimat jawaban: You translated the words. You couldn't translate why she said them.", ar: "جُمْلَة الإِجَابَة: You translated the words. You couldn't translate why she said them." },
      },
    },
    {
      kind: "scene",
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        ...
        <Text style={styles.puzzleType}>{lang === "korean" ? "단어 매칭" : lang === "spanish" ? "Relacionar palabras" : lang === "indonesian" ? "Cocokkan kata" : lang === "arabic" ? "وصّل الكلمات" : "Word Matching"}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>{lang === "korean" ? "이 단어의 뜻은?" : lang === "spanish" ? "¿Qué significa?" : lang === "indonesian" ? "Apa artinya ini?" : lang === "arabic" ? "ده معناه إيه؟" : "What does this mean?"}</Text>
...
function FillBlankPuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  const ko = lang === "korean"; const es = lang === "spanish"; const id = lang === "indonesian"; const ar = lang === "arabic";
  const [idx, setIdx] = useState(0);
  const [selected, setSelected] = useState<string | null>(null);
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>PUZZLE {idx + 1}/{puzzle.questions.length}</EmojiText>
        <Text style={styles.puzzleType}>{ko ? "빈칸 채우기" : es ? "Completar espacios" : id ? "Isi bagian kosong" : ar ? "املا الفراغ" : "Fill in the Blank"}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>{ko ? "빈칸에 알맞은 단어는?" : es ? "¿Qué palabra completa la frase?" : id ? "Kata mana yang mengisi bagian kosong?" : ar ? "أنهي كلمة تملا الفراغ؟" : "Which word fills the blank?"}</Text>
      ...
      {hasQHints && (
        ...
        >
          <Text style={styles.sharedHintBtnText}>
            {ko ? `힌트 보기 (${hintLevel}/${allQHints.length})` : es ? `Ver pistas (${hintLevel}/${allQHints.length})` : id ? `Petunjuk (${hintLevel}/${allQHints.length})` : ar ? `تلميحات (${hintLevel}/${allQHints.length})` : `Hints (${hintLevel}/${allQHints.length})`}
          </Text>
        </Pressable>
      )}
      {!confirmed ? (
        <Pressable style={[styles.puzzleConfirmBtn, { opacity: selected ? 1 : 0.5 }]} onPress={handleConfirm} disabled={!selected}>
          <Text style={styles.puzzleConfirmText}>{ko ? "확인" : es ? "Confirmar" : id ? "Konfirmasi" : ar ? "أكّد" : "Confirm"}</Text>
        </Pressable>
      ) : (
          ...
          <Pressable style={styles.hintOverlay} onPress={() => setHintVisible(false)}>
            <Pressable style={styles.hintNotebook} onPress={() => {}}>
              <View style={styles.hintNotebookHeader}>
                <EmojiText style={styles.hintNotebookTitle}>{ko ? "수사 노트" : es ? "Cuaderno de Detective" : id ? "Catatan Detektif" : ar ? "دفتر التحقيق" : "Detective's Notebook"}</EmojiText>
                  ...
                  <View key={i} style={styles.hintRow}>
                    {isUnlocked ? (
                      <View style={styles.hintUnlocked}>
                        <Text style={styles.hintLabel}>{ko ? `힌트 ${i + 1}` : es ? `Pista ${i + 1}` : id ? `Petunjuk ${i + 1}` : ar ? `تلميح ${i + 1}` : `Hint ${i + 1}`}</Text>
                      ...
                      <Pressable style={styles.hintLocked} onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium); setHintLevel(i + 1); }}>
                        ...
                        <Text style={styles.hintLockedText}>{ko ? `힌트 ${i + 1} 열기` : es ? `Abrir pista ${i + 1}` : id ? `Buka petunjuk ${i + 1}` : ar ? `افتح تلميح ${i + 1}` : `Unlock Hint ${i + 1}`}</Text>
                      </Pressable>
                    ) : (
                      <View style={[styles.hintLocked, { opacity: 0.4 }]}>
                        <View style={styles.hintLockMark} />
                        <Text style={styles.hintLockedText}>{ko ? `힌트 ${i + 1}` : es ? `Pista ${i + 1}` : id ? `Petunjuk ${i + 1}` : ar ? `تلميح ${i + 1}` : `Hint ${i + 1}`}</Text>
                      </View>
                    )}
                  </View>
                );
              })}
              <Text style={styles.hintFooter}>{ko ? "이전 힌트를 먼저 열어야 해요" : es ? "Desbloquea las pistas en orden" : id ? "Buka petunjuk secara berurutan" : ar ? "افتح التلميحات بالترتيب" : "Unlock hints in order"}</Text>
            </Pressable>
          </Pressable>
        </Modal>
      )}
...
function DialogueChoicePuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>PUZZLE {idx + 1}/{puzzle.questions.length}</EmojiText>
        <Text style={styles.puzzleType}>{lang === "korean" ? "대화 선택" : lang === "spanish" ? "Elección de diálogo" : lang === "indonesian" ? "Pilih dialog" : lang === "arabic" ? "اختار الرد" : "Dialogue Choice"}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>{tri(q.prompt, lang)}</Text>
        <Text style={styles.puzzleContext}>{tri(q.context, lang)}</Text>
        <Text style={styles.puzzleChooseHint}>{lang === "korean" ? "↓ 올바른 대답을 선택하세요" : lang === "spanish" ? "↓ Elige la respuesta correcta" : lang === "indonesian" ? "↓ Pilih jawaban yang benar" : lang === "arabic" ? "↓ اختار الرد الصح" : "↓ Choose the correct response"}</Text>
      </View>
      <View style={styles.puzzleOptions}>
        {options[idx].map((opt, i) => {
          const isSelected = selected === opt;
      ...
      {!confirmed ? (
        <Pressable style={[styles.puzzleConfirmBtn, { opacity: selected ? 1 : 0.5 }]} onPress={handleConfirm} disabled={!selected}>
          <Text style={styles.puzzleConfirmText}>{lang === "korean" ? "확인" : lang === "spanish" ? "Confirmar" : lang === "indonesian" ? "Konfirmasi" : lang === "arabic" ? "أكّد" : "Confirm"}</Text>
        </Pressable>
      ) : (
        <Pressable style={styles.puzzleConfirmBtn} onPress={handleNext}>
...
function SentenceBuilderPuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>PUZZLE {idx + 1}/{puzzle.questions.length}</EmojiText>
        <Text style={styles.puzzleType}>{lang === "korean" ? "문장 만들기" : lang === "spanish" ? "Construir oraciones" : lang === "indonesian" ? "Susun kalimat" : lang === "arabic" ? "كوّن الجملة" : "Sentence Builder"}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        ...
        <Text style={styles.puzzleType}>{lang === "korean" ? "단서 조사" : lang === "spanish" ? "Investigar pistas" : lang === "indonesian" ? "Analisis bukti" : lang === "arabic" ? "تحليل الأدلة" : "Evidence Analysis"}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>{tri(q.prompt, lang)}</Text>
        <Text style={styles.puzzleChooseHint}>{lang === "korean" ? "↓ 핵심 증거를 선택하세요" : lang === "spanish" ? "↓ Selecciona la evidencia clave" : lang === "indonesian" ? "↓ Pilih bukti kunci" : lang === "arabic" ? "↓ اختار الدليل المهم" : "↓ Select the key evidence"}</Text>
      </View>
      ...
      {!confirmed ? (
        <Pressable style={[styles.puzzleConfirmBtn, { opacity: selected !== null ? 1 : 0.5 }]} onPress={handleConfirm} disabled={selected === null}>
          <Text style={styles.puzzleConfirmText}>{lang === "korean" ? "증거 제출" : lang === "spanish" ? "Presentar evidencia" : lang === "indonesian" ? "Kirim bukti" : lang === "arabic" ? "قدّم الدليل" : "Submit Evidence"}</Text>
        </Pressable>
      ) : (
        <Pressable style={styles.puzzleConfirmBtn} onPress={handleNext}>
          <Text style={styles.puzzleConfirmText}>
...
function CipherPuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  const correctAnswer = learningLang === "spanish" ? q.answer.es
    ...
    : learningLang === "arabic" ? (q.answer.ar ?? q.answer.en)
    : q.answer.en;
  ...
  const nativeTranslation = lang === "korean" ? q.answer.ko
    ...
    : lang === "arabic" ? (q.answer.ar ?? q.answer.en)
    : q.answer.en;
  const hintText = lang === "korean" ? q.hint.ko : lang === "spanish" ? q.hint.es : lang === "indonesian" ? (q.hint.id ?? q.hint.en) : lang === "arabic" ? (q.hint.ar ?? q.hint.en) : q.hint.en;
  ...
  function getHints() {
    ...
    return [
      ...
      ko ? `예: ${firstLetter} → ${decodedFirst}`
        ...
        : ar ? `مثال: ${firstLetter} → ${decodedFirst}`
  ...
  if (showResult) {
    ...
    if (!isCorrect) {
      ...
      return (
        <View style={styles.puzzleBox}>
          <View style={styles.puzzleHeaderRow}>
            <EmojiText style={styles.puzzleNum}>{ko ? "암호를 해독하라!" : es ? "¡Descifra el código!" : id ? "Pecahkan sandinya!" : ar ? "فُكّ الشيفرة!" : "Decode the Cipher!"}</EmojiText>
      ...
      <View style={styles.puzzleBox}>
        ...
        <View style={styles.cipherExplainBox}>
          <Text style={styles.cipherExplainLabel}>
            {ko ? "해설:" : es ? "Explicación:" : id ? "Penjelasan:" : ar ? "الشرح:" : "Explanation:"}
          </Text>
        ...
        <Text style={styles.cipherXpText}>
          {ko ? "+50 XP 획득!" : es ? "¡+50 XP obtenidos!" : id ? "+50 XP didapat!" : ar ? "كسبت +50 XP!" : "+50 XP earned!"}
        </Text>
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>{lang === "korean" ? "암호를 해독하라!" : lang === "spanish" ? "¡Descifra el código!" : lang === "indonesian" ? "Pecahkan sandinya!" : lang === "arabic" ? "فُكّ الشيفرة!" : "Decode the Cipher!"}</EmojiText>
        <Text style={styles.puzzleType}>{idx + 1}/{puzzle.questions.length}</Text>
      </View>
      ...
      <View style={styles.cipherWordCard}>
        <Text style={styles.cipherCardLabel}>
          {lang === "korean" ? "암호" : lang === "spanish" ? "Cifrado" : lang === "indonesian" ? "Sandi" : lang === "arabic" ? "الشيفرة" : "Cipher"}
        </Text>
        <Text style={styles.cipherEncoded}>{encodedWord}</Text>
        <View style={styles.cipherCardDivider} />
        <Text style={styles.cipherCardLabel}>
          {lang === "korean" ? "단서" : lang === "spanish" ? "Pista" : lang === "indonesian" ? "Petunjuk" : lang === "arabic" ? "الدليل" : "Clue"}
        </Text>
          ...
          <Pressable style={styles.hintNotebook} onPress={() => {}}>
            ...
            <View style={styles.hintNotebookHeader}>
              <Text style={styles.hintNotebookTitle}>
                {lang === "korean" ? "수사 노트" : lang === "spanish" ? "Cuaderno de Detective" : lang === "indonesian" ? "Catatan Detektif" : lang === "arabic" ? "دفتر التحقيق" : "Detective's Notebook"}
              </Text>
              <Pressable onPress={() => setShowHintModal(false)} style={styles.hintCloseBtn}>
                <Text style={styles.hintCloseBtnText}>X</Text>
              </Pressable>
                  ...
                  {isUnlocked ? (
                    <View style={styles.hintUnlocked}>
                      <Text style={styles.hintLabel}>
                        {lang === "korean" ? `힌트 ${i + 1}` : lang === "spanish" ? `Pista ${i + 1}` : lang === "indonesian" ? `Petunjuk ${i + 1}` : lang === "arabic" ? `تلميح ${i + 1}` : `Hint ${i + 1}`}
                      </Text>
                      <Text style={styles.hintText}>{hint}</Text>
                    </View>
                  ) : isNext ? (
                    ...
                    >
                      ...
                      <Text style={styles.hintLockedText}>
                        {lang === "korean" ? `힌트 ${i + 1} 열기` : lang === "spanish" ? `Abrir pista ${i + 1}` : lang === "indonesian" ? `Buka petunjuk ${i + 1}` : lang === "arabic" ? `افتح تلميح ${i + 1}` : `Unlock Hint ${i + 1}`}
                      </Text>
                    </Pressable>
                  ) : (
                    <View style={[styles.hintLocked, { opacity: 0.4 }]}>
            ...
            <Text style={styles.hintFooter}>
              {lang === "korean" ? "이전 힌트를 먼저 열어야 해요" : lang === "spanish" ? "Desbloquea las pistas en orden" : lang === "indonesian" ? "Buka petunjuk secara berurutan" : lang === "arabic" ? "افتح التلميحات بالترتيب" : "Unlock hints in order"}
            </Text>
          </Pressable>
        </Pressable>
      </Modal>
...
function WordTypingPuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  const targetWord = learningLang === "spanish" ? q.word.es
                   ...
                   : learningLang === "arabic" ? (q.word.ar ?? q.word.en)
                   : q.word.en;
  const targetLangLabel = learningLang === "spanish"
    ? (lang === "korean" ? "스페인어" : lang === "spanish" ? "español" : lang === "indonesian" ? "bahasa Spanyol" : lang === "arabic" ? "الإسبانية" : "Spanish")
    : learningLang === "korean"
    ? (lang === "korean" ? "한국어" : lang === "spanish" ? "coreano" : lang === "indonesian" ? "bahasa Korea" : lang === "arabic" ? "الكورية" : "Korean")
    : (lang === "korean" ? "영어" : lang === "spanish" ? "inglés" : lang === "indonesian" ? "bahasa Inggris" : lang === "arabic" ? "الإنجليزية" : "English");
  const meaning = lang === "korean" ? q.opts[q.answerIdx].ko
                ...
                : lang === "arabic" ? (q.opts[q.answerIdx].ar ?? q.opts[q.answerIdx].en)
  ...
  function getFeedbackText(): string {
    ...
    if (!answerResult.correct) {
      return lang === "korean" ? `오답. 정답: ${targetWord}`
           ...
           : lang === "arabic" ? `غلط. الإجابة: ${targetWord}`
    ...
    if (answerResult.accentDiff) {
      return lang === "korean" ? `정답! 참고: 올바른 표기는 ${targetWord}입니다`
           ...
           : lang === "arabic" ? `صح! ملحوظة: الكتابة الصحيحة هي ${targetWord}`
    ...
    if (answerResult.isVariant) {
      return lang === "korean" ? `정답! 참고: 표준 표기는 ${targetWord}입니다`
           ...
           : lang === "arabic" ? `صح! ملحوظة: الكتابة المعيارية هي ${targetWord}`
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>✍️ {lang === "korean" ? "단어 입력" : lang === "spanish" ? "Escribe la palabra" : lang === "indonesian" ? "Ketik kata" : lang === "arabic" ? "اكتب الكلمة" : "Word Typing"}</EmojiText>
        <Text style={styles.puzzleType}>{idx + 1}/{puzzle.questions.length}</Text>
      </View>
      ...
      <View style={styles.puzzleWordCard}>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", marginTop: 10, gap: 5 }}>
          ...
          <Text style={{ fontFamily: F.body, fontSize: 11, color: C.goldDim, width: "100%", textAlign: "center", marginTop: 5 }}>
            {targetWord.length} {lang === "korean" ? "글자" : lang === "spanish" ? "letras" : lang === "indonesian" ? "huruf" : lang === "arabic" ? "حروف" : "letters"}
          </Text>
        </View>
      </View>
      ...
      <TextInput
        ...
        placeholder={lang === "korean" ? `${targetLangLabel} 단어를 입력하세요...` : lang === "spanish" ? `Escribe en ${targetLangLabel}...` : lang === "indonesian" ? `Ketik kata ${targetLangLabel}...` : lang === "arabic" ? `اكتب كلمة ${targetLangLabel}...` : `Type the ${targetLangLabel} word...`}
    ...
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <Text style={styles.puzzleNum}>
          {ko ? "손으로 쓰기" : es ? "Escritura a mano" : id ? "Tulis Kata" : ar ? "اكتب الكلمة بإيدك" : "Write the Word"}
        </Text>
        <Text style={styles.puzzleType}>{idx + 1}/{puzzle.questions.length}</Text>
      </View>
      ...
      <Text style={styles.hwInstruction}>
        {ko ? "이 단어를 손가락으로 써보세요:" : es ? "Escribe esta palabra con el dedo:" : id ? "Tulis kata ini dengan jarimu:" : ar ? "اكتب الكلمة دي بصباعك:" : "Write this word with your finger:"}
      </Text>
      ...
      >
        ...
        {allPaths.length === 0 && currentPath.length === 0 && (
          <Text style={styles.hwPlaceholder}>
            {ko ? "여기에 쓰세요..." : es ? "Escribe aquí..." : id ? "Tulis di sini..." : ar ? "اكتب هنا..." : "Write here..."}
          </Text>
        )}
      </View>
      ...
      {feedback === "good" && (
        <View style={styles.pronFeedbackGood}>
          <Text style={styles.pronFeedbackText}>
            {ko ? "잘 썼어요!" : es ? "¡Excelente escritura!" : id ? "Tulisan bagus!" : ar ? "خطك جميل!" : "Great handwriting!"}
          </Text>
        </View>
      )}
      {feedback === "retry" && (
        <View style={styles.pronFeedbackRetry}>
          <Text style={styles.pronFeedbackText}>
            {ko ? "다시 써보세요." : es ? "Inténtalo de nuevo." : id ? "Coba lagi." : ar ? "اكتبها تاني." : "Try again."}
          </Text>
          <Pressable style={styles.pronSkipBtn} onPress={advanceNext}>
            <Text style={styles.pronSkipText}>
              {ko ? "그냥 넘어가기" : es ? "Continuar" : id ? "Lewati" : ar ? "تخطّى" : "Skip"}
            </Text>
          </Pressable>
        </View>
      )}
      ...
      <View style={styles.hwBtnRow}>
        <Pressable style={[styles.hwBtn, styles.hwClearBtn]} onPress={clearCanvas}>
          ...
          <Text style={[styles.hwBtnText, { color: C.gold }]}>
            {ko ? "지우기" : es ? "Borrar" : id ? "Hapus" : ar ? "امسح" : "Clear"}
          </Text>
        </Pressable>
        <Pressable
          ...
          {recognizing ? (
            ...
            <>
              ...
              <Text style={[styles.hwBtnText, { color: C.bg1 }]}>
                {ko ? "제출" : es ? "Enviar" : id ? "Kirim" : ar ? "ابعت" : "Submit"}
              </Text>
            </>
          )}
        </Pressable>
...
function WritingMissionPuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  const q = puzzle.questions[idx];
  const targetWord = learningLang === "korean" ? q.word.ko : learningLang === "spanish" ? q.word.es : learningLang === "indonesian" ? (q.word.id ?? q.word.en) : learningLang === "arabic" ? (q.word.ar ?? q.word.en) : q.word.en;
  const displayWord = lang === "korean" ? q.word.ko : lang === "spanish" ? q.word.es : lang === "indonesian" ? (q.word.id ?? q.word.en) : lang === "arabic" ? (q.word.ar ?? q.word.en) : q.word.en;
  const hintText = q.hint ? (lang === "korean" ? q.hint.ko : lang === "spanish" ? q.hint.es : lang === "indonesian" ? (q.hint.id ?? q.hint.en) : lang === "arabic" ? (q.hint.ar ?? q.hint.en) : q.hint.en) : null;
  ...
  function getFeedbackText(): string {
    ...
    if (!answerResult.correct) {
      return lang === "korean" ? `정답: ${targetWord}`
           ...
           : lang === "arabic" ? `الإجابة: ${targetWord}`
           : `Answer: ${targetWord}`;
    }
    if (answerResult.isVariant) {
      return lang === "korean" ? `정답! 참고: 표준 표기는 ${targetWord}입니다`
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>{lang === "korean" ? "쓰기 미션" : lang === "spanish" ? "Misión de escritura" : lang === "indonesian" ? "Misi Menulis" : lang === "arabic" ? "مهمة كتابة" : "Writing Mission"}</EmojiText>
        <Text style={styles.puzzleType}>{idx + 1}/{puzzle.questions.length}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>
...
function WordPuzzlePuzzle({ puzzle, lang, learningLang, onSolved, onResetHints }: {
  ...
  const q = puzzle.questions[idx];
  const scrambledText = learningLang === "korean" ? q.scrambled.ko : learningLang === "spanish" ? q.scrambled.es : learningLang === "indonesian" ? (q.scrambled.id ?? q.scrambled.en) : learningLang === "arabic" ? (q.scrambled.ar ?? q.scrambled.en) : q.scrambled.en;
  const correctWord = learningLang === "korean" ? q.word.ko : learningLang === "spanish" ? q.word.es : learningLang === "indonesian" ? (q.word.id ?? q.word.en) : learningLang === "arabic" ? (q.word.ar ?? q.word.en) : q.word.en;
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>{lang === "korean" ? "단어 맞추기" : lang === "spanish" ? "Ordenar letras" : lang === "indonesian" ? "Susun Kata" : lang === "arabic" ? "رتّب الكلمة" : "Word Unscramble"}</EmojiText>
        <Text style={styles.puzzleType}>{idx + 1}/{puzzle.questions.length}</Text>
      </View>
      <View style={styles.puzzleWordCard}>
        <Text style={styles.puzzleWordLabel}>
...
function FallbackPuzzle({ lang, onSolved }: { lang: string; onSolved: () => void }) {
  ...
  const questions = [
    { q: lang === "korean" ? "'Hello'는 무슨 뜻인가요?" : lang === "spanish" ? "¿Qué significa 'Hello'?" : lang === "indonesian" ? "Apa arti 'Hello'?" : lang === "arabic" ? "'Hello' معناها إيه؟" : "What does 'Bonjour' mean?",
      opts: lang === "korean" ? ["안녕하세요", "감사합니다", "죄송합니다", "잘 자요"] : lang === "spanish" ? ["Hola", "Gracias", "Lo siento", "Buenas noches"] : lang === "indonesian" ? ["Halo", "Terima kasih", "Maaf", "Selamat malam"] : lang === "arabic" ? ["أهلاً", "شكراً", "آسف", "تصبح على خير"] : ["Hello", "Thank you", "Sorry", "Good night"],
      answer: 0 },
  ];
  const q = questions[0];
  ...
  return (
    <View style={styles.puzzleBox}>
      <View style={styles.puzzleHeaderRow}>
        <EmojiText style={styles.puzzleNum}>{lang === "korean" ? "퀴즈" : lang === "spanish" ? "Quiz" : lang === "indonesian" ? "Kuis" : lang === "arabic" ? "كويز" : "Quick Quiz"}</EmojiText>
      </View>
      <View style={styles.puzzleWordCard}>
  ...
  return (
    <View style={styles.clueReveal}>
      <Animated.View style={[styles.clueRevealCard, { transform: [{ scale }] }]}>
        <EmojiText style={styles.clueRevealBadge}>{lang === "korean" ? "단서 발견!" : lang === "spanish" ? "¡Pista Descubierta!" : lang === "indonesian" ? "Petunjuk Ditemukan!" : lang === "arabic" ? "لقيت دليل!" : "Clue Discovered!"}</EmojiText>
  ...
  return (
    <ScrollView contentContainerStyle={styles.completionScroll} showsVerticalScrollIndicator={false}>
      <Animated.View style={[styles.completionCard, { transform: [{ scale }] }]}>
        ...
        <Text style={styles.completionTitle}>{lang === "korean" ? "챕터 완료!" : lang === "spanish" ? "¡Capítulo Completado!" : lang === "indonesian" ? "Bab Selesai!" : lang === "arabic" ? "خلّصت الفصل!" : "Chapter Complete!"}</Text>
        ...
        <Pressable style={styles.completionHomeBtn} onPress={() => router.replace("/(tabs)/story" as any)}>
          <Text style={styles.completionHomeBtnText}>{lang === "korean" ? "스토리 목록으로" : lang === "spanish" ? "Lista de capítulos" : lang === "indonesian" ? "Kembali ke Peta Cerita" : lang === "arabic" ? "ارجع لخريطة القصة" : "Back to Story Map"}</Text>
        </Pressable>
      </Animated.View>
    </ScrollView>
  );
...
export default function StoryScene() {
  ...
  const lang: string = nativeLanguage ?? "english";
  ...
  function advance() {
    ...
    if (currentItem?.kind === "scene" && currentItem.idiomRef) {
      ...
      if (idiomEntry) {
        const tl = learningLang === "korean" ? "ko" : learningLang === "spanish" ? "es" : learningLang === "indonesian" ? "id" : learningLang === "arabic" ? "ar" : "en";
  ...
  function getCharName(char: (typeof story.characters)[0]) {
    ...
    if (lang === "arabic" && char.nameAr) return char.nameAr;
    return char.name;
  }
      ...
      <Animated.View style={[styles.contentArea, { opacity: fadeAnim }]}>
          ...
          >
            ...
            >
              <Text style={styles.narrationBtnText}>
                {typingDone
                  ? (lang === "korean" ? "다음" : lang === "spanish" ? "Siguiente" : lang === "indonesian" ? "Lanjut" : lang === "arabic" ? "التالي" : "Next")
                  : (lang === "korean" ? "전체 보기" : lang === "spanish" ? "Mostrar todo" : lang === "indonesian" ? "Tampilkan semua" : lang === "arabic" ? "اعرض الكل" : "Show all")}
              </Text>
        ...
        {item.kind === "puzzle" && (() => {
          ...
          const headerText = item.pType === "writing-mission"
            ? (ko ? `${(item as any).title?.ko || "말하기 미션"}` : es ? `${(item as any).title?.es || "Misión de habla"}` : id ? `${(item as any).title?.id || (item as any).title?.en || "Misi Berbicara"}` : ar ? `${(item as any).title?.ar || (item as any).title?.en || "مهمة كلام"}` : `${(item as any).title?.en || "Speaking Mission"}`)
            : ko
            ...
            : ar
            ? `لغز ${item.puzzleNum}: ثبت مهاراتك في اللغة`
                ...
                {hasSharedHints && (
                  ...
                  >
                    <View style={styles.sharedHintContent}>
                      ...
                      <Text style={styles.sharedHintBtnText}>
                        {ko ? `힌트 보기 (${sharedHintLevel}/${totalHints})` : es ? `Ver pistas (${sharedHintLevel}/${totalHints})` : id ? `Petunjuk (${sharedHintLevel}/${totalHints})` : ar ? `تلميحات (${sharedHintLevel}/${totalHints})` : `Hints (${sharedHintLevel}/${totalHints})`}
                      </Text>
                    </View>
                  </Pressable>
                )}
                    ...
                    <Pressable style={styles.hintNotebook} onPress={() => {}}>
                      <View style={styles.hintNotebookHeader}>
                        <View style={styles.hintNotebookTitleRow}>
                          ...
                          <Text style={styles.hintNotebookTitle}>{ko ? "수사 노트" : es ? "Cuaderno de Detective" : id ? "Catatan Detektif" : ar ? "دفتر التحقيق" : "Detective's Notebook"}</Text>
                        </View>
