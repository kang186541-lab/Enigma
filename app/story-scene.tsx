...
const MADRID_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Recover the First Colors", ko: "첫 색을 되찾기", es: "Recuperar los primeros colores", id: "Pulihkan Warna Pertama", ar: "رَجَّع أَوِّل أَلْوَان" },
      context: {
        ...
        ar: "إِيزَابِيل مِحْتَاجَة كَلِمَات الإِحْسَاس وَاللَّوْن قَبْل مَا تِقْدَر تِشْرَح كَارْلُوس كَانْ بِيِرَمِّم إِيه.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          ...
          meaning: { en: "a warm bright color", ko: "따뜻하고 선명한 색", es: "un color cálido y vivo", id: "warna hangat yang cerah", ar: "لَوْن دَافِي وَزَاهِي" },
          wrong: [
        ...
        },
        {
          ...
          meaning: { en: "what the festival is losing", ko: "축제가 잃어가는 것", es: "lo que el festival está perdiendo", id: "apa yang sedang hilang dari festival", ar: "اللِّي المُولِد بِيِخْسَرُه" },
          wrong: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Speak With Feeling", ko: "감정으로 말하기", es: "Hablar con emoción", id: "Berbicara dengan Perasaan", ar: "اِتْكَلِّم بِإِحْسَاس" },
      context: {
        ...
        ar: "دُون مِيجِيل يِقْدَر يِوَدِّيك لِلمَسْرَح المِقْفُول لَوْ رَدِّيت بِإِحْسَاس، مِش بِمَعْلُومَة وَبَسّ.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Don Miguel asks: 'When the music returns, what do you feel?'", ko: "돈 미겔이 묻습니다: '음악이 돌아오면 무엇을 느끼나?'", es: "Don Miguel pregunta: 'Cuando vuelva la música, ¿qué sientes?'", id: "Don Miguel bertanya: 'Saat musik kembali, apa yang kamu rasakan?'", ar: "دُون مِيجِيل بِيِسْأَل: 'لَمَّا المُوسِيقَى تِرْجَع، تِحِسّ بِإِيه؟'" },
          context: { en: "Choose a feeling, not a price or a direction.", ko: "가격이나 방향이 아니라 감정을 고르세요.", es: "Elige un sentimiento, no un precio ni una dirección.", id: "Pilih sebuah perasaan, bukan harga atau arah.", ar: "اِخْتَار إِحْسَاس، مِش سِعْر وَلَا اِتِّجَاه." },
          answer: { en: "I am happy.", ko: "저는 행복해요.", es: "Estoy feliz.", id: "Saya senang.", ar: "أَنَا مَبْسُوط." },
          wrong: [
            { en: "How much is it?", ko: "이거 얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَام؟" },
            { en: "Goodbye.", ko: "안녕히 가세요.", es: "Adiós.", id: "Selamat tinggal.", ar: "مَعَ السَّلَامَة." },
          ],
        },
        {
          prompt: { en: "He points to the gray stage: 'What was it, before the color left?'", ko: "그가 회색 무대를 가리킵니다: '색이 사라지기 전, 저건 무엇이었나?'", es: "Señala el escenario gris: '¿Qué era antes de perder el color?'", id: "Ia menunjuk panggung kelabu itu: 'Dulu seperti apa, sebelum warnanya hilang?'", ar: "بِيِشَاوِر عَلَى المَسْرَح الرُّمَادِي: 'كَانْ شَكْلُه إِيه، قَبْل مَا اللَّوْن يِرُوح؟'" },
          context: { en: "Give a simple description.", ko: "간단한 묘사를 말하세요.", es: "Da una descripción sencilla.", id: "Berikan deskripsi sederhana.", ar: "قُول وَصْف بَسِيط." },
          answer: { en: "It is beautiful.", ko: "정말 아름다워요.", es: "Es hermoso.", id: "Itu indah.", ar: "ده جَمِيل." },
          wrong: [
            { en: "Bread please.", ko: "빵 주세요.", es: "Pan, por favor.", id: "Minta roti.", ar: "عِيش مِنْ فَضْلَك." },
            { en: "Where is Dr. Ellis?", ko: "엘리스 박사님은 어디 있어요?", es: "¿Dónde está la Dra. Ellis?", id: "Di mana Dr. Ellis?", ar: "فِين الدُّكْتُورَة إِلِيس؟" },
          ],
        },
        {
          prompt: { en: "Isabel needs the exact place. Ask for it.", ko: "이사벨은 정확한 장소가 필요합니다. 물어보세요.", es: "Isabel necesita el lugar exacto. Pregunta por él.", id: "Isabel butuh tempat yang tepat. Tanyakanlah.", ar: "إِيزَابِيل مِحْتَاجَة المَكَان بِالظَّبْط. اِسْأَل عَلِيه." },
          context: { en: "Use the location question from the festival clue.", ko: "축제 단서에서 나온 위치 질문을 사용하세요.", es: "Usa la pregunta de lugar de la pista del festival.", id: "Gunakan pertanyaan lokasi dari petunjuk festival itu.", ar: "اِسْتَخْدِم سُؤَال المَكَان اللِّي مِنْ دَلِيل المُولِد." },
          answer: { en: "Where is the festival?", ko: "축제는 어디에서 열려요?", es: "¿Dónde es el festival?", id: "Di mana festivalnya?", ar: "فِين المُولِد؟" },
          wrong: [
            { en: "Thank you.", ko: "감사합니다.", es: "Gracias.", id: "Terima kasih.", ar: "شُكْراً." },
            { en: "I am Carlos.", ko: "저는 카를로스예요.", es: "Soy Carlos.", id: "Saya Carlos.", ar: "أَنَا كَارْلُوس." },
          ],
        },
      ],
      hints: {
        h1: { ko: "감정, 묘사, 위치 질문 순서로 생각하세요.", en: "Think feeling, description, then location question.", es: "Piensa en emoción, descripción y pregunta de lugar.", id: "Pikirkan urutannya: perasaan, deskripsi, lalu pertanyaan lokasi.", ar: "فَكَّر بِالتَّرْتِيب: إِحْسَاس، وَصْف، وَبَعْدِين سُؤَال عَنِ المَكَان." },
        h2: { ko: "happy는 감정, beautiful은 묘사예요.", en: "happy is feeling; beautiful is description.", es: "happy es emoción; beautiful es descripción.", id: "happy adalah perasaan; beautiful adalah deskripsi.", ar: "happy إِحْسَاس؛ beautiful وَصْف." },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find Carlos's Last Trace", ko: "카를로스의 마지막 흔적 찾기", es: "Encontrar el último rastro de Carlos", id: "Temukan Jejak Terakhir Carlos", ar: "دَوَّر عَلَى آخِر أَثَر لِكَارْلُوس" },
      context: {
      ...
      questions: [
        {
          prompt: { en: "Which evidence points to Carlos's exact disappearance point?", ko: "어떤 증거가 카를로스가 사라진 정확한 지점을 가리키나요?", es: "¿Qué evidencia señala el punto exacto donde desapareció Carlos?", id: "Bukti mana yang menunjuk titik pasti hilangnya Carlos?", ar: "أَنْهِي دَلِيل بِيْشَاوِر عَلَى مَكَان اخْتِفَا كَارْلُوس بِالظَّبْط؟" },
          clues: [
            { en: "A paintbrush still wet with red paint beside the stage speaker.", ko: "무대 스피커 옆에 놓인, 아직 빨간 물감이 마르지 않은 붓.", es: "Un pincel aún mojado con pintura roja junto al altavoz del escenario.", id: "Sebuah kuas yang masih basah oleh cat merah di samping pengeras suara panggung.", ar: "فُرْشِة دِهَان لِسَّه مَبْلُولَة بِبُويَة حَمْرَا جَنْب سَمَّاعِة المَسْرَح." },
            { en: "A food receipt from a nearby cafe.", ko: "근처 카페의 영수증.", es: "Un recibo de una cafetería cercana.", id: "Struk makanan dari kafe di dekat sana.", ar: "فَاتُورِة أَكْل مِنْ كَافِيه قُرَيِّب." },
            { en: "A gray paper flower from the festival decorations.", ko: "축제 장식에서 떨어진 회색 종이꽃.", es: "Una flor de papel gris de la decoración del festival.", id: "Bunga kertas kelabu dari hiasan festival.", ar: "وَرْدَة وَرَق رُمَادِي مِنْ زِينِة المُولِد." },
          ],
          answerIdx: 0,
        },
      ],
      hints: {
        h1: { ko: "카를로스는 복원가예요. 그가 쓰던 도구를 찾으세요.", en: "Carlos is a restorer. Look for the tool he used.", es: "Carlos es restaurador. Busca la herramienta que usaba.", id: "Carlos adalah seorang pemulih. Cari alat yang ia gunakan.", ar: "كَارْلُوس مُرَمِّم. دَوَّر عَلَى العِدَّة اللِّي كَانْ بِيِسْتَخْدِمْهَا." },
        h2: { ko: "붓과 빨간색은 깃발 회복과 연결돼요.", en: "The brush and red paint connect to the restored flag.", es: "El pincel y la pintura roja conectan con la bandera restaurada.", id: "Kuas dan cat merah itu berkaitan dengan bendera yang dipulihkan.", ar: "الفُرْشَة وَالبُويَة الحَمْرَا مَرْبُوطِين بِالعَلَم اللِّي اِتْرَمِّم." },
        h3: { ko: "정답: 스피커 옆의 빨간 붓.", en: "Answer: the red paintbrush beside the speaker.", es: "Respuesta: el pincel rojo junto al altavoz.", id: "Jawaban: kuas merah di samping pengeras suara.", ar: "الإِجَابَة: فُرْشِة الدِّهَان الحَمْرَا جَنْب السَّمَّاعَة." },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Madrid Boss Spell", ko: "마드리드 보스 주문", es: "Hechizo Jefe de Madrid", id: "Mantra Bos Madrid", ar: "تَعْوِيذِة زَعِيم مَدْرِيد" },
      context: { en: "Speak the festival back into shape.", ko: "축제가 다시 형태를 되찾도록 말하세요.", es: "Devuelve la forma al festival con tus palabras.", id: "Ucapkan agar festival kembali ke wujudnya.", ar: "اِتْكَلِّم عَشَان تِرَجَّع المُولِد لِشَكْلُه." },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          instruction: { en: "Place each spell-piece on the sealed stage.", ko: "주문 조각을 봉인된 무대 위에 순서대로 놓으세요.", es: "Coloca cada pieza del hechizo sobre el escenario sellado.", id: "Letakkan setiap potongan mantra pada panggung tersegel.", ar: "حُطّ كُلّ قِطْعِة تَعْوِيذَة عَلَى المَسْرَح المِقْفُول." },
          hints: {
            h1: { ko: "순서가 중요해요. 먼저 감정을 말하세요.", en: "The order matters. Begin with the feeling.", es: "El orden importa. Empieza con el sentimiento.", id: "Urutannya penting. Mulailah dengan perasaan.", ar: "التَّرْتِيب مُهِمّ. اِبْدَأ بِالإِحْسَاس." },
            h2: { ko: "그다음은 장소 질문이에요: Where is + the festival.", en: "Next comes the place question: Where is + the festival.", es: "Después va la pregunta de lugar: Where is + the festival.", id: "Berikutnya pertanyaan tempat: Where is + the festival.", ar: "بَعْد كده سُؤَال المَكَان: Where is + the festival." },
            h3: { ko: "정답 문장: I am happy. Where is the festival? It is beautiful.", en: "Answer sentence: I am happy. Where is the festival? It is beautiful.", es: "Frase correcta: I am happy. Where is the festival? It is beautiful.", id: "Kalimat jawaban: I am happy. Where is the festival? It is beautiful.", ar: "جُمْلِة الإِجَابَة: I am happy. Where is the festival? It is beautiful." },
          },
          storyReason: { en: "Open the sealed stage to reach Carlos and the Madrid Stone fragment.", ko: "봉인된 무대를 열어 카를로스와 마드리드 스톤 파편에 닿으세요.", es: "Abre el escenario sellado para alcanzar a Carlos y el fragmento de la Piedra de Madrid.", id: "Buka panggung tersegel untuk mencapai Carlos dan pecahan Batu Madrid.", ar: "اِفْتَح المَسْرَح المِقْفُول عَشَان تُوصَل لِكَارْلُوس وَشَظِيِّة حَجَر مَدْرِيد." },
          storyConsequence: { en: "The first red spark becomes a full dance step.", ko: "첫 빨간 불꽃이 온전한 춤 동작으로 이어집니다.", es: "La primera chispa roja se convierte en un paso de baile completo.", id: "Percik merah pertama menjadi satu langkah tarian yang utuh.", ar: "أَوِّل شَرَارَة حَمْرَا بِتِبْقَى خُطْوِة رَقْص كَامْلَة." },
          doorImage: ch2BossStageImg,
        },
      ],
      hints: {
        h1: { ko: "Boss Spell은 감정, 위치 질문, 묘사로 이루어져요.", en: "The Boss Spell uses feeling, location, and description.", es: "El Boss Spell usa emoción, lugar y descripción.", id: "Mantra Bos memakai perasaan, lokasi, dan deskripsi.", ar: "تَعْوِيذِة الزَّعِيم بِتِسْتَخْدِم الإِحْسَاس وَالمَكَان وَالوَصْف." },
...
const CAIRO_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Recover the Written Record", ko: "쓰인 기록 복원", es: "Recuperar el registro escrito", id: "Pulihkan Catatan Tertulis", ar: "اِسْتَرْجِع السِّجِلّ المَكْتُوب" },
      context: {
        ...
        ar: "أَمِيرَة مِحْتَاجَة كَلِمَات الأَرْشِيف الأُولَانِيَّة قَبْل مَا تِقْدَر تِفْتَح مِلَفّ إِلِيس.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          ...
          meaning: { en: "proof that something happened", ko: "어떤 일이 있었다는 증거", es: "prueba de que algo ocurrió", id: "bukti bahwa sesuatu pernah terjadi", ar: "دَلِيل إِنّ حَاجَة حَصَلِت" },
          wrong: [
            { en: "a festival color", ko: "축제의 색", es: "un color de festival", id: "warna festival", ar: "لَوْن مِنْ أَلْوَان المُولِد" },
            { en: "a taxi direction", ko: "택시 방향", es: "una dirección de taxi", id: "arah taksi", ar: "اِتِّجَاه تَاكْسِي" },
            { en: "a casual greeting", ko: "가벼운 인사", es: "un saludo casual", id: "sapaan santai", ar: "سَلَام عَادِي" },
          ],
        },
        {
          word: { en: "remember", ko: "기억하다", es: "recordar", id: "mengingat", ar: "يِفْتِكِر" },
          meaning: { en: "to keep something in your mind", ko: "무언가를 마음속에 간직하다", es: "guardar algo en la mente", id: "menyimpan sesuatu di dalam pikiran", ar: "إِنَّك تِحْتِفِظ بِحَاجَة فِي دِمَاغَك" },
          wrong: [
            { en: "to erase a page", ko: "페이지를 지우다", es: "borrar una página", id: "menghapus sebuah halaman", ar: "إِنَّك تِمْسَح صَفْحَة" },
            { en: "to ask a price", ko: "가격을 묻다", es: "preguntar un precio", id: "menanyakan harga", ar: "إِنَّك تِسْأَل عَنِ السِّعْر" },
            { en: "to turn left", ko: "왼쪽으로 돌다", es: "girar a la izquierda", id: "belok kiri", ar: "إِنَّك تِخُشّ شِمَال" },
          ],
        },
        {
        ...
        {
          word: { en: "lullaby", ko: "자장가", es: "nana", id: "nina bobo", ar: "تَهْلِيلَة" },
          meaning: { en: "a gentle song sung to a child", ko: "아이에게 불러주는 부드러운 노래", es: "una canción suave para dormir a un niño", id: "lagu lembut yang dinyanyikan untuk seorang anak", ar: "أُغْنِيَّة هَادْيَة بِتِتْغَنِّي لِطِفْل" },
          wrong: [
            { en: "a museum lock", ko: "박물관 자물쇠", es: "una cerradura de museo", id: "kunci museum", ar: "قُفْل مَتْحَف" },
            { en: "a cold signal", ko: "차가운 신호", es: "una señal fría", id: "sinyal yang dingin", ar: "إِشَارَة بَارْدَة" },
            { en: "a train ticket", ko: "기차표", es: "un billete de tren", id: "tiket kereta", ar: "تَذْكَرِة قَطْر" },
          ],
        },
      ],
      hints: {
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Answer With Memory", ko: "기억으로 답하기", es: "Responder con memoria", id: "Jawab dengan Ingatan", ar: "رُدّ بِالذَّاكِرَة" },
      context: {
        ...
        ar: "حَسَن بِيِتْكَلِّم بِشَظَايَا مِنْ ذِكْرَيَاتُه. اِخْتَار الإِجَابَة اللِّي بِتْحَافِظ عَلَى المَاضِي، مِش النُّسْخَة المَيِّتَة.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Hassan asks what survives when a page is erased.", ko: "하산은 페이지가 지워진 뒤 무엇이 남는지 묻습니다.", es: "Hassan pregunta qué sobrevive cuando se borra una página.", id: "Hassan bertanya apa yang bertahan ketika sebuah halaman dihapus.", ar: "حَسَن بِيِسْأَل إِيه اللِّي بِيِفْضَل لَمَّا صَفْحَة تِتْمِسِح." },
          context: { en: "Answer from memory.", ko: "기억으로 답하세요.", es: "Responde desde la memoria.", id: "Jawablah dari ingatan.", ar: "رُدّ مِنْ ذَاكِرْتَك." },
          answer: { en: "I remember.", ko: "저는 기억해요.", es: "Yo recuerdo.", id: "Saya ingat.", ar: "أَنَا فَاكِر." },
          wrong: [
            { en: "I forget.", ko: "저는 잊어버려요.", es: "Yo olvido.", id: "Saya lupa.", ar: "أَنَا نَاسِي." },
            { en: "How much?", ko: "얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَام؟" },
          ],
        },
        {
          prompt: { en: "Amira shows a note in Ellis's handwriting. What do you say?", ko: "아미라가 엘리스의 필체로 된 메모를 보여줍니다. 뭐라고 말할까요?", es: "Amira muestra una nota con la letra de Ellis. ¿Qué dices?", id: "Amira menunjukkan catatan dengan tulisan tangan Ellis. Apa yang kamu katakan?", ar: "أَمِيرَة بِتْوَرِّيك وَرَقَة بِخَطّ إِيد إِلِيس. هَتْقُول إِيه؟" },
          context: { en: "Use past tense.", ko: "과거 시제를 쓰세요.", es: "Usa el pasado.", id: "Gunakan bentuk lampau.", ar: "اِسْتَخْدِم صِيغِة المَاضِي." },
          answer: { en: "She wrote about it.", ko: "그녀가 그것에 대해 썼어요.", es: "Ella escribió sobre eso.", id: "Dia menulis tentang itu.", ar: "هِيَّ كَتَبِت عَنُّه." },
          wrong: [
            { en: "She writes about it.", ko: "그녀가 그것에 대해 써요.", es: "Ella escribe sobre eso.", id: "Dia menulis tentang itu sekarang.", ar: "هِيَّ بِتِكْتِب عَنُّه." },
            { en: "She is happy.", ko: "그녀는 행복해요.", es: "Ella está feliz.", id: "Dia bahagia.", ar: "هِيَّ مَبْسُوطَة." },
          ],
        },
        {
          prompt: { en: "Hassan hums one surviving line of the lullaby.", ko: "하산이 살아남은 자장가 한 줄을 흥얼거립니다.", es: "Hassan tararea una línea sobreviviente de la nana.", id: "Hassan menyenandungkan satu baris nina bobo yang bertahan.", ar: "حَسَن بِيِدَنْدِن سَطْر وَاحِد فِضِل مِنِ التَّهْلِيلَة." },
          context: { en: "Describe what it was.", ko: "그것이 어땠는지 말하세요.", es: "Describe cómo era.", id: "Gambarkan dulu seperti apa.", ar: "اِوْصِف كَانِتْ عَامْلَة إِزَّاي." },
          answer: { en: "It was beautiful.", ko: "그것은 아름다웠어요.", es: "Era hermosa.", id: "Itu indah.", ar: "كَانِت حِلْوَة." },
          wrong: [
            { en: "It is a taxi.", ko: "그것은 택시예요.", es: "Es un taxi.", id: "Itu taksi.", ar: "دَه تَاكْسِي." },
            { en: "Bread please.", ko: "빵 주세요.", es: "Pan, por favor.", id: "Tolong, roti.", ar: "عَيْش لَوْ سَمَحْت." },
          ],
        },
      ],
      hints: {
        h1: { ko: "과거를 말할 때 was / wrote를 써요.", en: "Use was / wrote when speaking about the past.", es: "Usa was / wrote para hablar del pasado.", id: "Gunakan was / wrote saat berbicara tentang masa lalu.", ar: "اِسْتَخْدِم was / wrote لَمَّا تِتْكَلِّم عَنِ المَاضِي." },
        h2: { ko: "She writes는 현재, She wrote는 과거예요.", en: "She writes is present; She wrote is past.", es: "She writes es presente; She wrote es pasado.", id: "She writes itu kini; She wrote itu lampau.", ar: "She writes دِي مُضَارِع؛ وَ She wrote دِي مَاضِي." },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find Ellis's Page", ko: "엘리스의 페이지 찾기", es: "Encontrar la página de Ellis", id: "Temukan Halaman Ellis", ar: "اِلْقَى صَفْحِة إِلِيس" },
      context: {
      ...
      questions: [
        {
          prompt: { en: "Which item is Ellis's true journal page?", ko: "어느 물건이 엘리스의 진짜 일지 페이지인가요?", es: "¿Qué objeto es la página verdadera del diario de Ellis?", id: "Benda mana yang merupakan halaman jurnal asli Ellis?", ar: "أَنْهِي حَاجَة فِيهُم هِيَّ صَفْحِة يُومِيَّات إِلِيس الحَقِيقِيَّة؟" },
          clues: [
            { en: "A clean typed summary where every sentence is perfect and no one sounds afraid.", ko: "모든 문장이 완벽하고 아무도 두려워하지 않는 것처럼 보이는 깨끗한 요약문.", es: "Un resumen limpio donde cada frase es perfecta y nadie parece tener miedo.", id: "Ringkasan ketik yang bersih, setiap kalimatnya sempurna dan tak ada yang terdengar takut.", ar: "مُلَخَّص مَطْبُوع وَنِضِيف، كُلّ جُمْلَة فِيه كَامْلَة وَمَحَدِّش بَايِن عَلِيه إِنُّه خَايِف." },
            { en: "A torn journal page: 'I was here. I spoke. I mattered.' Beside it, a lullaby copied in three uneven hands.", ko: "찢어진 일지 페이지: 'I was here. I spoke. I mattered.' 그 옆에는 세 가지 다른 손글씨로 베껴 쓴 자장가.", es: "Una página rota: 'I was here. I spoke. I mattered.' Al lado, una nana copiada por tres manos distintas.", id: "Halaman jurnal yang robek: 'I was here. I spoke. I mattered.' Di sampingnya, sebuah nina bobo yang disalin oleh tiga tulisan tangan berbeda.", ar: "صَفْحِة يُومِيَّات مَقْطُوعَة: 'I was here. I spoke. I mattered.' وَجَنْبَهَا تَهْلِيلَة مَنْقُولَة بِتَلَات خُطُوط إِيد مُخْتِلْفَة." },
            { en: "A blank hospital form stamped with a machine translation seal.", ko: "기계 번역 도장이 찍힌 빈 병원 양식.", es: "Un formulario hospitalario en blanco con un sello de traducción automática.", id: "Formulir rumah sakit kosong yang dicap segel terjemahan mesin.", ar: "اِسْتِمَارِة مُسْتَشْفَى فَاضْيَة مَخْتُومَة بِخَتْم تَرْجَمَة آلِيَّة." },
          ],
          answerIdx: 1,
        },
      ],
      hints: {
        h1: { ko: "진짜 기록은 완벽하지 않아도 사람의 흔적이 있어요.", en: "The true record has human traces, even if it is imperfect.", es: "El registro verdadero tiene huellas humanas, aunque sea imperfecto.", id: "Catatan yang asli memiliki jejak manusia, meski tak sempurna.", ar: "السِّجِلّ الحَقِيقِي فِيه أَثَر إِنْسَانِي، حَتَّى لَوْ مِش كَامِل." },
        ...
        h3: { ko: "정답은 찢어진 엘리스 일지 페이지예요.", en: "The answer is the torn Ellis journal page.", es: "La respuesta es la página rota del diario de Ellis.", id: "Jawabannya adalah halaman jurnal Ellis yang robek.", ar: "الإِجَابَة هِيَّ صَفْحِة يُومِيَّات إِلِيس المَقْطُوعَة." },
      },
    },
    {
      kind: "scene",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Cairo Boss Spell", ko: "카이로 보스 주문", es: "Hechizo Jefe de El Cairo", id: "Mantra Bos Kairo", ar: "تَعْوِيذِة بُوس القَاهِرَة" },
      context: {
        ...
        ar: "اِسْتَخْدِم كَلِمَات إِلِيس عَشَان تِرَجَّع اللِّي ضَاع.",
      },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          hints: {
            h1: {
              ...
              ar: "اِسْتَخْدِم صِيغِة المَاضِي. إِلِيس كَتَبِتْهَا خَلَاص.",
            },
            h2: {
              ...
              ar: "She writes دِي مُضَارِع؛ وَ She wrote دِي مَاضِي.",
            },
            h3: {
          ...
          storyReason: {
            ...
            ar: "بَاب الأَرْشِيف مَخْتُوم. كَلِمَات إِلِيس تِقْدَر تِفْتَحُه.",
          },
          storyConsequence: {
            ...
            ar: "كُلّ سَطْر بِيِرَجَّع نَقْش وَاحِد عَلَى الحِيطَة. يُومِيَّات إِلِيس بِتِبْقَى كَامْلَة تَانِي.",
          },
      ...
      hints: {
        ...
        h2: { ko: "현재형 She writes가 아니라 과거형 She wrote예요.", en: "Use past tense She wrote, not present tense She writes.", es: "Usa el pasado She wrote, no el presente She writes.", id: "Gunakan bentuk lampau She wrote, bukan bentuk kini She writes.", ar: "اِسْتَخْدِم المَاضِي She wrote، مِش المُضَارِع She writes." },
        h3: { ko: "정답 문장: I remember. She wrote the lullaby. Where is the record?", en: "Answer sentence: I remember. She wrote the lullaby. Where is the record?", es: "Frase correcta: I remember. She wrote the lullaby. Where is the record?", id: "Kalimat jawaban: I remember. She wrote the lullaby. Where is the record?", ar: "جُمْلِة الإِجَابَة: I remember. She wrote the lullaby. Where is the record?" },
      },
    },
    {
      kind: "scene",
...
const BABEL_V21_STORY: Story = {
  ...
  sequence: [
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 1,
      title: { en: "Open the Connection Gate", ko: "연결의 관문 열기", es: "Abrir la puerta de conexión", id: "Buka Gerbang Koneksi", ar: "اِفْتَح بَوَّابِة التَّوَاصُل" },
      context: {
        ...
        ar: "بَوَّابِة بَابِل الأُولَى بِتِسْمَع لِكَلِمَات جَايَّة مِنْ كُلّ مَدِينَة.",
      },
      pType: "word-match",
      tprsStage: 1,
      ...
      questions: [
        {
          ...
          meaning: { en: "a greeting that starts a connection", ko: "연결을 시작하는 인사", es: "un saludo que inicia una conexión", id: "sapaan yang memulai sebuah koneksi", ar: "تَحِيَّة بِتِبْدَأ بِيهَا تَوَاصُل" },
          wrong: [
            { en: "a machine command", ko: "기계 명령", es: "un comando de máquina", id: "perintah mesin", ar: "أَمْر لِمَكَنَة" },
            { en: "a final goodbye", ko: "마지막 작별", es: "una despedida final", id: "perpisahan terakhir", ar: "وَدَاع أَخِير" },
            { en: "a hidden coordinate", ko: "숨겨진 좌표", es: "una coordenada oculta", id: "koordinat tersembunyi", ar: "إِحْدَاثِي مَخْفِي" },
          ],
        },
        {
          word: { en: "Gracias", ko: "Gracias", es: "Gracias", id: "Gracias", ar: "Gracias" },
          meaning: { en: "Spanish for thank you", ko: "스페인어 감사 표현", es: "gracias en español", id: "terima kasih dalam bahasa Spanyol", ar: "'شُكْراً' بِالإِسْبَانِي" },
          wrong: [
            { en: "Korean for palace", ko: "궁궐을 뜻하는 한국어", es: "coreano para palacio", id: "bahasa Korea untuk istana", ar: "'قَصْر' بِالكُورِي" },
            { en: "Welsh for water", ko: "물을 뜻하는 웨일스어", es: "galés para agua", id: "bahasa Wales untuk air", ar: "'مَيَّة' بِالوِيلْزِي" },
            { en: "Arabic for record", ko: "기록을 뜻하는 아랍어", es: "árabe para registro", id: "bahasa Arab untuk catatan", ar: "'سِجِلّ' بِالعَرَبِي" },
          ],
        },
        {
          word: { en: "안녕하세요", ko: "안녕하세요", es: "안녕하세요", id: "안녕하세요", ar: "안녕하세요" },
          ...
          wrong: [
            { en: "casual command", ko: "반말 명령", es: "mandato informal", id: "perintah santai", ar: "أَمْر عَادِي مِشْ رَسْمِي" },
            { en: "a color word", ko: "색깔 단어", es: "una palabra de color", id: "kata warna", ar: "كِلْمِة لَوْن" },
        ...
        },
        {
          ...
          wrong: [
            { en: "a stone pedestal", ko: "돌 받침대", es: "un pedestal de piedra", id: "alas batu", ar: "قَاعْدِة حَجَر" },
            { en: "a erased page", ko: "지워진 페이지", es: "una página borrada", id: "halaman yang terhapus", ar: "صَفْحَة مَمْسُوحَة" },
            { en: "a tower floor", ko: "탑의 층", es: "un piso de la torre", id: "lantai menara", ar: "دُور مِنْ أَدْوَار البُرْج" },
          ],
        },
      ],
      hints: {
        h1: { ko: "각 도시는 자기 방식으로 인사를 남겼어요.", en: "Each city left a greeting in its own way.", es: "Cada ciudad dejó un saludo a su manera.", id: "Setiap kota meninggalkan sapaan dengan caranya sendiri.", ar: "كُلّ مَدِينَة سَابِتْ تَحِيَّة عَلَى طَرِيقْتَهَا." },
        h2: { ko: "Connection은 같은 말이 아니라 서로 다른 말이 만나는 순간이에요.", en: "Connection is not one word. It is different words meeting.", es: "La conexión no es una palabra única. Es cuando se encuentran palabras distintas.", id: "Connection bukan satu kata. Ia adalah saat kata-kata yang berbeda bertemu.", ar: "التَّوَاصُل مِشْ كِلْمَة وَاحْدَة. دَه لَحْظِة مَا الكَلِمَات المُخْتَلِفَة بِتِتْقَابِل." },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 2,
      title: { en: "Hold the Allies Together", ko: "동료들을 붙잡기", es: "Mantener unidos a los aliados", id: "Pertahankan Para Sekutu", ar: "خَلِّي صُحَابَك مَعَ بَعْض" },
      context: {
        ...
        ar: "البَوَّابَة التَّانْيَة بِتْهَاجِم الشَّكّ. اِخْتَار الرَّدّ اللِّي يِخَلِّي كُلّ صَاحِب فَاضِل مَعَاك.",
      },
      pType: "dialogue-choice",
      tprsStage: 2,
      ...
      questions: [
        {
          prompt: { en: "Sujin says the Korean order feels fragile.", ko: "수진이 한국어 어순이 흔들리는 것 같다고 말합니다.", es: "Sujin dice que el orden coreano se siente frágil.", id: "Sujin berkata urutan kata bahasa Korea terasa rapuh.", ar: "سُوجِين بِتْقُول إِنّ تَرْتِيب الكُورِي حَاسِسَاه ضَعِيف." },
          context: { en: "Answer with presence.", ko: "함께 있다는 말로 답하세요.", es: "Responde con presencia.", id: "Jawablah dengan kehadiran.", ar: "رُدّ بِإِنَّك مَوْجُود مَعَاهَا." },
          answer: { en: "I am here.", ko: "저 여기 있어요.", es: "Aquí estoy.", id: "Aku di sini.", ar: "أَنَا هِنَا." },
          wrong: [
            { en: "I forget.", ko: "저는 잊어버려요.", es: "Yo olvido.", id: "Aku lupa.", ar: "أَنَا بَنْسَى." },
            { en: "How much?", ko: "얼마예요?", es: "¿Cuánto cuesta?", id: "Berapa harganya?", ar: "بِكَام؟" },
          ],
        },
        {
          prompt: { en: "Mira's recovered voice trembles for the first time.", ko: "Mira의 회복된 목소리가 처음으로 떨립니다.", es: "La voz recuperada de Mira tiembla por primera vez.", id: "Suara Mira yang pulih bergetar untuk pertama kalinya.", ar: "صَوْت مِيرَا اللِّي رِجِع بِيِرْعِش لِأَوِّل مَرَّة." },
          context: { en: "Tell her she is not a script.", ko: "그녀가 대본이 아니라고 말해 주세요.", es: "Dile que no es un guion.", id: "Katakan padanya bahwa ia bukan sebuah naskah.", ar: "قُولّهَا إِنَّهَا مِشْ نَصّ مَكْتُوب." },
          answer: { en: "I see you.", ko: "저는 당신이 보여요.", es: "Te veo.", id: "Aku melihatmu.", ar: "أَنَا شَايِفِك." },
          wrong: [
            { en: "You are perfect.", ko: "당신은 완벽해요.", es: "Eres perfecta.", id: "Kamu sempurna.", ar: "إِنْتِ كَامْلَة." },
            { en: "Read faster.", ko: "더 빨리 읽어요.", es: "Lee más rápido.", id: "Baca lebih cepat.", ar: "اِقْرِي أَسْرَع." },
          ],
        },
        {
          prompt: { en: "The gate divides the group into separate echoes.", ko: "관문이 동료들을 따로따로 울리는 메아리로 나눕니다.", es: "La puerta divide al grupo en ecos separados.", id: "Gerbang itu memecah kelompok menjadi gema-gema yang terpisah.", ar: "البَوَّابَة بِتْقَسَّم المَجْمُوعَة لِأَصْدَاء مِنْفَصْلَة." },
          context: { en: "Use the plural truth.", ko: "함께라는 진실을 말하세요.", es: "Usa la verdad plural.", id: "Gunakan kebenaran jamak.", ar: "اِسْتَخْدِم حَقِيقِة الجَمْع." },
          answer: { en: "We are together.", ko: "우리는 함께예요.", es: "Estamos juntos.", id: "Kita bersama.", ar: "إِحْنَا مَعَ بَعْض." },
          wrong: [
            { en: "I am alone.", ko: "저는 혼자예요.", es: "Estoy solo.", id: "Aku sendirian.", ar: "أَنَا لِوَحْدِي." },
            { en: "The words are enough.", ko: "말이면 충분해요.", es: "Las palabras bastan.", id: "Kata-kata sudah cukup.", ar: "الكَلِمَات تِكْفِي." },
          ],
        },
      ],
      hints: {
        h1: { ko: "Babel은 사람들을 혼자라고 느끼게 해요.", en: "Babel tries to make people feel alone.", es: "Babel intenta hacer que la gente se sienta sola.", id: "Babel berusaha membuat orang merasa sendirian.", ar: "بَابِل بِيِحَاوِل يِخَلِّي النَّاس يِحِسُّوا إِنُّهُم لِوَحْدُهُم." },
        h2: { ko: "I / you / we 순서로 넓어져요.", en: "The answers widen: I / you / we.", es: "Las respuestas se amplían: I / you / we.", id: "Jawabannya meluas: I / you / we.", ar: "الإِجَابَات بِتِتْوَسَّع: I / you / we." },
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 3,
      title: { en: "Find the Memory Stone", ko: "기억의 돌 찾기", es: "Encontrar la piedra de memoria", id: "Temukan Batu Memori", ar: "لاقِي حَجَر الذِّكْرَى" },
      context: {
      ...
      questions: [
        {
          prompt: { en: "Which memory should Rudy hold up to Mr. Black?", ko: "루디가 Mr. Black에게 어떤 기억을 내밀어야 할까요?", es: "¿Qué recuerdo debe mostrar Rudy a Mr. Black?", id: "Kenangan mana yang harus Rudy tunjukkan kepada Mr. Black?", ar: "أَنْهِي ذِكْرَى المَفْرُوض رُودِي يِرْفَعْهَا قُدَّام مِسْتَر بْلَاك؟" },
          clues: [
            { en: "A perfect Universal Code transcript with every sentence corrected.", ko: "모든 문장이 수정된 완벽한 Universal Code 기록.", es: "Una transcripción perfecta del Código Universal con cada frase corregida.", id: "Transkrip Universal Code yang sempurna dengan setiap kalimat dikoreksi.", ar: "نَسْخَة كَامْلَة مِنْ نَصّ الـ Universal Code وَكُلّ جُمْلَة فِيهَا مِتْصَلَّحَة." },
            { en: "Ellis's torn journal page: 'I was here. I spoke. I mattered.' Beside it, a Welsh lullaby copied by hand.", ko: "Ellis의 찢어진 일지 페이지: 'I was here. I spoke. I mattered.' 그 옆에는 손으로 베껴 쓴 웨일스 자장가.", es: "La página rota de Ellis: 'I was here. I spoke. I mattered.' Al lado, una nana galesa copiada a mano.", id: "Halaman jurnal Ellis yang robek: 'I was here. I spoke. I mattered.' Di sampingnya, sebuah lagu nina bobo Wales yang disalin dengan tangan.", ar: "صَفْحَة مِقَطَّعَة مِنْ يُومِيَّات إِلِيس: 'I was here. I spoke. I mattered.' وَجَنْبَهَا تَهْلِيلَة وِيلْزِيَّة مَنْقُولَة بِخَطّ الإِيد." },
            { en: "A tower blueprint that marks every gate as efficient.", ko: "모든 관문을 효율적이라고 표시한 탑 설계도.", es: "Un plano de la torre que marca cada puerta como eficiente.", id: "Cetak biru menara yang menandai setiap gerbang sebagai efisien.", ar: "رَسْم هَنْدَسِي لِلبُرْج بِيِعَلِّم عَلَى كُلّ بَوَّابَة إِنَّهَا كَفْؤَة." },
          ],
          answerIdx: 1,
        },
      ],
      hints: {
        h1: { ko: "Memory는 완벽한 문장이 아니라 사람의 흔적에 반응해요.", en: "Memory responds to human traces, not perfect sentences.", es: "Memory responde a huellas humanas, no a frases perfectas.", id: "Memory menanggapi jejak manusia, bukan kalimat yang sempurna.", ar: "الذِّكْرَى بِتِتْجَاوِب مَعَ آثَار البَنِي آدَمِين، مِشْ مَعَ الجُمَل الكَامْلَة." },
        h2: { ko: "Ch4에서 회수한 Ellis 일지를 떠올려요.", en: "Remember Ellis's journal from Ch4.", es: "Recuerda el diario de Ellis de Ch4.", id: "Ingat jurnal Ellis dari Bab 4.", ar: "اِفْتِكِر يُومِيَّات إِلِيس اللِّي رِجِّعْنَاهَا فِي الفَصْل الرَّابِع." },
        h3: { ko: "정답은 Ellis의 찢어진 일지 페이지예요.", en: "The answer is Ellis's torn journal page.", es: "La respuesta es la página rota del diario de Ellis.", id: "Jawabannya adalah halaman jurnal Ellis yang robek.", ar: "الإِجَابَة هِيَّ صَفْحِة يُومِيَّات إِلِيس المِقَطَّعَة." },
      },
    },
    {
      kind: "clue",
    ...
    },
    {
      kind: "puzzle",
      puzzleNum: 4,
      title: { en: "Final Boss Spell", ko: "최종 보스 주문", es: "Hechizo Jefe Final", id: "Mantra Bos Terakhir", ar: "تَعْوِيذِة الزَّعِيم الأَخِيرَة" },
      context: {
        ...
        ar: "قُول الفَرْق بِين الكَلِمَات وَلِيه اِتْقَالِت.",
      },
      pType: "boss-spell",
      tprsStage: 4,
      ...
      questions: [
        {
          ...
          instruction: {
            ...
            ar: "قُول الحَاجَة اللِّي الـ Universal Code مَا قِدِرْش يِشِيلْهَا أَبَداً.",
          },
          hints: {
            h1: {
              ...
              ar: "فَصِّل الكَلِمَات عَنِ السَّبَب.",
            },
            h2: {
              ...
              ar: "translated دَه السَّطْح؛ وَ couldn't translate دَه القَلْب.",
            },
            h3: {
          ...
          storyReason: {
            ...
            ar: "قَلْب بَابِل مَخْتُوم بِتَرْجَمَة كَامْلَة. المَعْنَى بَسّ هُوَّ اللِّي يِقْدَر يِفْتَحُه.",
          },
          storyConsequence: {
            ...
            ar: "كُلّ سَطْر بِيِفُكّ طَبْقَة مِنَ الـ Universal Code. وَدَايْرِة السَّبَع حَجَرَات الأَخِيرَة بِتِتْقَطَع.",
          },
          doorImage: ch5BossCoreImg,
        },
      ],
      hints: {
        h1: { ko: "단어 자체가 아니라 그 말을 한 이유를 말해야 해요.", en: "You need the reason she spoke, not only the words.", es: "Necesitas la razón por la que habló, no solo las palabras.", id: "Kamu butuh alasan ia berbicara, bukan hanya kata-katanya.", ar: "إِنْتَ مِحْتَاج السَّبَب اللِّي خَلَّاهَا تِتْكَلِّم، مِشْ الكَلِمَات وَبَسّ." },
        h2: { ko: "You translated the words 다음에 You couldn't translate why...", en: "First: You translated the words. Then: You couldn't translate why...", es: "Primero: You translated the words. Luego: You couldn't translate why...", id: "Pertama: You translated the words. Lalu: You couldn't translate why...", ar: "الأَوِّل: You translated the words. وَبَعْدِين: You couldn't translate why..." },
        h3: { ko: "정답 문장: You translated the words. You couldn't translate why she said them.", en: "Answer sentence: You translated the words. You couldn't translate why she said them.", es: "Frase correcta: You translated the words. You couldn't translate why she said them.", id: "Kalimat jawaban: You translated the words. You couldn't translate why she said them.", ar: "جُمْلِة الإِجَابَة: You translated the words. You couldn't translate why she said them." },
      },
    },
    {
      kind: "scene",
