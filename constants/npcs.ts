export interface NPC {
  ...
  voice: {
    ...
    indonesian: { voice: string; lang: string };
    arabic:     { voice: string; lang: string };
  };
...
export const NPC_REL_LEVELS = {
  stranger: { min: 0,  max: 30,  label: "Stranger",  labelKo: "낯선사람", labelEs: "Extraño",  labelId: "Orang asing", color: "#9CA3AF", heart: "🩶", inputHint: "Choose your response" },
  familiar: { min: 30, max: 60,  label: "Familiar",  labelKo: "아는사이",  labelEs: "Conocido",  labelId: "Kenalan",     color: "#60A5FA", heart: "💙", inputHint: "Choose or type freely" },
  friendly: { min: 60, max: 80,  label: "Friendly",  labelKo: "친근함",   labelEs: "Amigable",  labelId: "Akrab",       color: "#34D399", heart: "💚", inputHint: "Free conversation" },
  close:    { min: 80, max: 101, label: "Close",     labelKo: "친한친구", labelEs: "Cercano",   labelId: "Dekat",       color: "#F59E0B", heart: "💝", inputHint: "Special bond unlocked" },
} as const;
...
export function getRelLabel(tier: RelationshipTier, lang: string): string {
  ...
  if (lang === "indonesian") return level.labelId;
  return level.label;
}
...
export const NPCS: NPC[] = [
  ...
  // ── Tier 1: Survival ────────────────────────────────────────────────────
  {
    ...
    voice: {
      ...
      indonesian: { voice: "id-ID-GadisNeural",   lang: "id-ID" },
      arabic:     { voice: "ar-EG-SalmaNeural",   lang: "ar-EG" },
    },
  ...
  },
  {
    ...
    voice: {
      ...
      indonesian: { voice: "id-ID-ArdiNeural",        lang: "id-ID" },
      arabic:     { voice: "ar-EG-ShakirNeural",      lang: "ar-EG" },
    },
    ssmlStyle: { style: "friendly", degree: "1.2" },
  },
  {
  ...
  },
  {
    ...
    scenarioId: "Toko Ponsel / Kartu SIM",
  ...
  },
  {
    ...
    scenarioKo: "바 / 술집",
    scenarioEs: "Bar",
    scenarioId: "Bar / Tempat Nongkrong",
  ...
  // ── Tier 2: Functioning ─────────────────────────────────────────────────
  {
    ...
    scenarioId: "Pesan Antar / Telepon",
  ...
  },
  {
    ...
    scenarioId: "Cari Tempat Tinggal",
  ...
  },
  {
    ...
    scenarioId: "Kantor Pemerintah / Visa",
