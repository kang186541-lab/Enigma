...
export const LESSON_CONTENT_UNIT4: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_19: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَيْنَ مَحَطّة المِترو؟", speechLang: "ar-EG", meaning: { ko: "ayna maḥaṭṭat al-mitro? · 지하철역이 어디에 있나요?", en: "ayna maḥaṭṭat al-mitro? · Where is the subway station?", es: "ayna maḥaṭṭat al-mitro? · ¿Dónde está la estación de metro?", id: "ayna maḥaṭṭat al-mitro? · Di mana stasiun kereta bawah tanah?" } },
        { text: "المَقْهى بِجانِب المَتْحَف.", speechLang: "ar-EG", meaning: { ko: "al-maqhā bijānib al-matḥaf · 카페가 박물관 근처에 있어요.", en: "al-maqhā bijānib al-matḥaf · The cafe is near the museum.", es: "al-maqhā bijānib al-matḥaf · El café está cerca del museo.", id: "al-maqhā bijānib al-matḥaf · Kafenya dekat museum." } },
        { text: "هَلْ هُناكَ صَيْدَلِيّة قَريبة مِن هُنا؟", speechLang: "ar-EG", meaning: { ko: "hal hunāka ṣaydaliyya qarība min hunā? · 근처에 약국이 있나요?", en: "hal hunāka ṣaydaliyya qarība min hunā? · Is there a pharmacy nearby?", es: "hal hunāka ṣaydaliyya qarība min hunā? · ¿Hay una farmacia cerca?", id: "hal hunāka ṣaydaliyya qarība min hunā? · Apakah ada apotek di dekat sini?" } },
        { text: "كَمْ تَبْعُدُ؟", speechLang: "ar-EG", meaning: { ko: "kam tabʿudu? · 얼마나 멀어요?", en: "kam tabʿudu? · How far is it?", es: "kam tabʿudu? · ¿A qué distancia está?", id: "kam tabʿudu? · Berapa jauh dari sini?" }, recallRound: true },
        { text: "حَوالي خَمْس دَقائِق مَشْيًا.", speechLang: "ar-EG", meaning: { ko: "ḥawālī khams daqāʾiq mashyan · 걸어서 5분 정도예요.", en: "ḥawālī khams daqāʾiq mashyan · It's about five minutes on foot.", es: "ḥawālī khams daqāʾiq mashyan · Está a unos cinco minutos a pie.", id: "ḥawālī khams daqāʾiq mashyan · Sekitar lima menit jalan kaki." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "장소 찾기: 'أَيْنَ ___؟'(ayna ___?, 표준어 '어디') / 존재 확인: 'هَلْ هُناكَ ___ قَريب؟'(hal hunāka ___ qarīb?) / 거리: 'كَمْ تَبْعُدُ؟'(kam tabʿudu?) → 'حَوالي ___ دَقائِق مَشْيًا'(ḥawālī ___ daqāʾiq mashyan)", en: "Location: 'أَيْنَ ___؟' (ayna ___?, MSA 'where') / Existence: 'هَلْ هُناكَ ___ قَريب؟' (hal hunāka ___ qarīb?, literally 'is there a nearby ___?') / Distance: 'كَمْ تَبْعُدُ؟' (kam tabʿudu?, 'how far is it?') → answer 'حَوالي ___ دَقائِق مَشْيًا' (ḥawālī ___ daqāʾiq mashyan, 'about ___ minutes on foot')", es: "Ubicación: 'أَيْنَ ___؟' (ayna ___?, 'dónde' en árabe estándar) / Existencia: 'هَلْ هُناكَ ___ قَريب؟' (hal hunāka ___ qarīb?) / Distancia: 'كَمْ تَبْعُدُ؟' (kam tabʿudu?) → respuesta 'حَوالي ___ دَقائِق مَشْيًا' (ḥawālī ___ daqāʾiq mashyan)" },
          examples: { ko: "أَيْنَ أَقْرَب مُسْتَشْفى؟ (ayna aqrab mustashfā? · 가장 가까운 병원이 어디예요?)\nهَلْ هُناكَ مَتْجَر قَريب؟ (hal hunāka matjar qarīb? · 근처에 편의점 있나요?)\nحَوالي رُبْع ساعة بِالحافِلة. (ḥawālī rubʿ sāʿa bil-ḥāfila · 버스로 15분 정도예요.)", en: "أَيْنَ أَقْرَب مُسْتَشْفى؟ (ayna aqrab mustashfā? · Where is the nearest hospital?)\nهَلْ هُناكَ مَتْجَر قَريب؟ (hal hunāka matjar qarīb? · Is there a convenience store nearby?)\nحَوالي رُبْع ساعة بِالحافِلة. (ḥawālī rubʿ sāʿa bil-ḥāfila · About fifteen minutes by bus.)", es: "أَيْنَ أَقْرَب مُسْتَشْفى؟ (ayna aqrab mustashfā? · ¿Dónde está el hospital más cercano?)\nهَلْ هُناكَ مَتْجَر قَريب؟ (hal hunāka matjar qarīb? · ¿Hay una tienda cerca?)\nحَوالي رُبْع ساعة بِالحافِلة. (ḥawālī rubʿ sāʿa bil-ḥāfila · Unos quince minutos en autobús.)" },
          mistakes: { ko: "❌ مَحَطّة المِترو وين؟ (장소 표현이 어색해요)\n✅ أَيْنَ مَحَطّة المِترو؟ (ayna maḥaṭṭat al-mitro — 표준어는 'أَيْنَ'로 물어요!)\n💬 이집트 구어로는 'فين/feen' 이지만 표준어는 'أَيْنَ/ayna' ✓\n\n❌ المَقْهى قَريب المَتْحَف. (전치사 مِن 빠짐)\n✅ المَقْهى بِجانِب المَتْحَف. (al-maqhā bijānib al-matḥaf — '옆에'는 'بِجانِب'!)\n💬 이집트 구어로는 'جَنْب/ganb' 이지만 표준어는 'بِجانِب/bijānib' ✓", en: "❌ مَحَطّة المِترو وين؟ (awkward word order for the question)\n✅ أَيْنَ مَحَطّة المِترو؟ (ayna maḥaṭṭat al-mitro — MSA asks with 'أَيْنَ'!)\n💬 In Egyptian dialect it's 'فين/feen', but MSA is 'أَيْنَ/ayna' ✓\n\n❌ المَقْهى قَريب المَتْحَف. (missing preposition مِن)\n✅ المَقْهى بِجانِب المَتْحَف. (al-maqhā bijānib al-matḥaf — 'next to' is 'بِجانِب'!)\n💬 In Egyptian dialect it's 'جَنْب/ganb', but MSA is 'بِجانِب/bijānib' ✓", es: "❌ مَحَطّة المِترو وين؟ (orden de palabras poco natural)\n✅ أَيْنَ مَحَطّة المِترو؟ (ayna maḥaṭṭat al-mitro — ¡el árabe estándar pregunta con 'أَيْنَ'!)\n💬 En dialecto egipcio es 'فين/feen', pero en árabe estándar es 'أَيْنَ/ayna' ✓\n\n❌ المَقْهى قَريب المَتْحَف. (falta la preposición مِن)\n✅ المَقْهى بِجانِب المَتْحَف. (al-maqhā bijānib al-matḥaf — 'al lado de' es 'بِجانِب')\n💬 En dialecto egipcio es 'جَنْب/ganb', pero en árabe estándar es 'بِجانِب/bijānib' ✓" },
          rudyTip: { ko: "낯선 도시에서 길 찾기의 핵심은 세 마디야! 'أَيْنَ؟'(ayna? 어디?), 'هَلْ هُناكَ ___؟'(hal hunāka ___? 있나요?), 'كَمْ تَبْعُدُ؟'(kam tabʿudu? 얼마나 멀어요?). 표준어 이 세 개면 어디서든 길을 찾을 수 있어!", en: "Three little phrases to survive any city: 'أَيْنَ؟' (ayna? where?), 'هَلْ هُناكَ ___؟' (hal hunāka ___? is there?), 'كَمْ تَبْعُدُ؟' (kam tabʿudu? how far?). Master these three MSA phrases and you'll never get stuck!", es: "Tres frasecitas para sobrevivir en cualquier ciudad: 'أَيْنَ؟' (ayna? ¿dónde?), 'هَلْ هُناكَ ___؟' (hal hunāka ___? ¿hay?), 'كَمْ تَبْعُدُ؟' (kam tabʿudu? ¿qué tan lejos?). ¡Con estas tres frases en árabe estándar nunca estarás perdido!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ مَحَطّة المِترو؟", answer: "أَيْنَ", options: ["أَيْنَ", "ماذا", "كَيْفَ"], fullSentence: "أَيْنَ مَحَطّة المِترو؟", fullSentenceMeaning: { ko: "지하철역이 어디에 있나요?", en: "Where is the subway station?", es: "¿Dónde está la estación de metro?", id: "Di mana stasiun kereta bawah tanah?" } },
          { type: "select", promptWithBlank: "هَلْ هُناكَ صَيْدَلِيّة ___ مِن هُنا؟", answer: "قَريبة", options: ["قَريبة", "بَعيدة", "هُنا"], fullSentence: "هَلْ هُناكَ صَيْدَلِيّة قَريبة مِن هُنا؟", fullSentenceMeaning: { ko: "근처에 약국이 있나요?", en: "Is there a pharmacy nearby?", es: "¿Hay una farmacia cerca?", id: "Apakah ada apotek di dekat sini?" } },
          { type: "select", promptWithBlank: "المَقْهى ___ المَتْحَف.", answer: "بِجانِب", options: ["بِجانِب", "داخِل", "فَوْقَ"], fullSentence: "المَقْهى بِجانِب المَتْحَف.", fullSentenceMeaning: { ko: "카페가 박물관 근처에 있어요.", en: "The cafe is near the museum.", es: "El café está cerca del museo.", id: "Kafenya dekat museum." } },
          { type: "input", promptWithBlank: "كَمْ ___؟", answer: "تَبْعُدُ", fullSentence: "كَمْ تَبْعُدُ؟", fullSentenceMeaning: { ko: "얼마나 멀어요?", en: "How far is it?", es: "¿A qué distancia está?", id: "Berapa jauh dari sini?" } },
          { type: "input", promptWithBlank: "حَوالي خَمْس دَقائِق ___.", answer: "مَشْيًا", fullSentence: "حَوالي خَمْس دَقائِق مَشْيًا.", fullSentenceMeaning: { ko: "걸어서 5분 정도예요.", en: "It's about five minutes on foot.", es: "Está a unos cinco minutos a pie.", id: "Sekitar lima menit jalan kaki." } },
          { type: "listening", audioText: "حَوالي خَمْس دَقائِق مَشْيًا.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["حَوالي خَمْس دَقائِق مَشْيًا.", "كَمْ تَبْعُدُ؟", "أَيْنَ مَحَطّة المِترو؟", "هَلْ هُناكَ صَيْدَلِيّة قَريبة مِن هُنا؟"], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_20: {
    ...
    arabic: {
      step1Sentences: [
        { text: "اِنْعَطِفْ يَسارًا.", speechLang: "ar-EG", meaning: { ko: "inʿaṭif yasāran · 왼쪽으로 돌아요.", en: "inʿaṭif yasāran · Turn left.", es: "inʿaṭif yasāran · Gira a la izquierda.", id: "inʿaṭif yasāran · Belok kiri." } },
        { text: "اِنْعَطِفْ يَمينًا.", speechLang: "ar-EG", meaning: { ko: "inʿaṭif yamīnan · 오른쪽으로 돌아요.", en: "inʿaṭif yamīnan · Turn right.", es: "inʿaṭif yamīnan · Gira a la derecha.", id: "inʿaṭif yamīnan · Belok kanan." } },
        { text: "اِمْشِ مُسْتَقيمًا.", speechLang: "ar-EG", meaning: { ko: "imshi mustaqīman · 직진하세요.", en: "imshi mustaqīman · Go straight ahead.", es: "imshi mustaqīman · Sigue todo recto.", id: "imshi mustaqīman · Jalan lurus terus." } },
        { text: "هِيَ عَلى يَسارِكَ.", speechLang: "ar-EG", meaning: { ko: "hiya ʿalā yasārika · 왼쪽에 있어요.", en: "hiya ʿalā yasārika · It's on your left.", es: "hiya ʿalā yasārika · Está a tu izquierda.", id: "hiya ʿalā yasārika · Ada di sebelah kiri Anda." }, recallRound: true },
        { text: "خُذْ أوّل شارِع عَلى اليَمين.", speechLang: "ar-EG", meaning: { ko: "khudh awwal shāriʿ ʿalā al-yamīn · 오른쪽 첫 번째 길로 가세요.", en: "khudh awwal shāriʿ ʿalā al-yamīn · Take the first street on the right.", es: "khudh awwal shāriʿ ʿalā al-yamīn · Toma la primera calle a la derecha.", id: "khudh awwal shāriʿ ʿalā al-yamīn · Ambil jalan pertama di sebelah kanan." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "방향 전환: 'اِنْعَطِفْ يَسارًا/يَمينًا'(inʿaṭif yasāran/yamīnan) / 직진: 'اِمْشِ مُسْتَقيمًا'(imshi mustaqīman) / 위치: 'عَلى يَسارِكَ/يَمينِكَ'(ʿalā yasārika/yamīnika) / 길 안내: 'خُذْ أوّل/ثاني شارِع عَلى ___'(khudh awwal/thānī shāriʿ ʿalā ___)", en: "Turn: 'اِنْعَطِفْ يَسارًا/يَمينًا' (inʿaṭif yasāran/yamīnan, 'turn left/right') / Straight: 'اِمْشِ مُسْتَقيمًا' (imshi mustaqīman, 'walk straight') / Position: 'عَلى يَسارِكَ/يَمينِكَ' (ʿalā yasārika/yamīnika) / Directions: 'خُذْ أوّل/ثاني شارِع عَلى ___' (khudh awwal/thānī shāriʿ ʿalā ___, 'take the first/second street on ___')", es: "Girar: 'اِنْعَطِفْ يَسارًا/يَمينًا' (inʿaṭif yasāran/yamīnan, 'gira a la izquierda/derecha') / Recto: 'اِمْشِ مُسْتَقيمًا' (imshi mustaqīman) / Posición: 'عَلى يَسارِكَ/يَمينِكَ' (ʿalā yasārika/yamīnika) / Direcciones: 'خُذْ أوّل/ثاني شارِع عَلى ___' (khudh awwal/thānī shāriʿ ʿalā ___)" },
          examples: { ko: "اِنْعَطِفْ يَمينًا عِنْدَ الإشارة. (inʿaṭif yamīnan ʿinda al-ishāra · 신호등에서 오른쪽으로 도세요.)\nاِمْشِ مُسْتَقيمًا مَسافة مَبْنَيَيْن. (imshi mustaqīman masāfat mabnayayn · 두 블록 직진하세요.)\nالبَنْك عَلى يَسارِكَ. (al-bank ʿalā yasārika · 은행은 왼쪽에 있어요.)", en: "اِنْعَطِفْ يَمينًا عِنْدَ الإشارة. (inʿaṭif yamīnan ʿinda al-ishāra · Turn right at the traffic light.)\nاِمْشِ مُسْتَقيمًا مَسافة مَبْنَيَيْن. (imshi mustaqīman masāfat mabnayayn · Go straight for two blocks.)\nالبَنْك عَلى يَسارِكَ. (al-bank ʿalā yasārika · The bank is on your left.)", es: "اِنْعَطِفْ يَمينًا عِنْدَ الإشارة. (inʿaṭif yamīnan ʿinda al-ishāra · Gira a la derecha en el semáforo.)\nاِمْشِ مُسْتَقيمًا مَسافة مَبْنَيَيْن. (imshi mustaqīman masāfat mabnayayn · Sigue recto dos cuadras.)\nالبَنْك عَلى يَسارِكَ. (al-bank ʿalā yasārika · El banco está a tu izquierda.)" },
          mistakes: { ko: "❌ خُشّ شِمال. (이집트 구어, 표준어 아님)\n✅ اِنْعَطِفْ يَسارًا. (inʿaṭif yasāran — '돌다'는 표준어로 'اِنْعَطِفْ'!)\n💬 이집트 구어로는 'خُشّ شِمال/khosh shemaal' 지만 표준어는 'اِنْعَطِفْ يَسارًا/inʿaṭif yasāran' ✓\n\n❌ امْشي عَلى طول. (이집트 구어 '3ala tool')\n✅ اِمْشِ مُسْتَقيمًا. (imshi mustaqīman — '직진'은 'مُسْتَقيمًا'!)\n💬 이집트 구어로는 'عَلى طول/3ala tool' 지만 표준어는 'مُسْتَقيمًا/mustaqīman' ✓", en: "❌ خُشّ شِمال. (Egyptian dialect, not MSA)\n✅ اِنْعَطِفْ يَسارًا. (inʿaṭif yasāran — 'turn' in MSA is 'اِنْعَطِفْ'!)\n💬 In Egyptian dialect it's 'خُشّ شِمال/khosh shemaal', but MSA is 'اِنْعَطِفْ يَسارًا/inʿaṭif yasāran' ✓\n\n❌ امْشي عَلى طول. (Egyptian '3ala tool')\n✅ اِمْشِ مُسْتَقيمًا. (imshi mustaqīman — 'straight' is 'مُسْتَقيمًا'!)\n💬 In Egyptian dialect it's 'عَلى طول/3ala tool', but MSA is 'مُسْتَقيمًا/mustaqīman' ✓", es: "❌ خُشّ شِمال. (dialecto egipcio, no árabe estándar)\n✅ اِنْعَطِفْ يَسارًا. (inʿaṭif yasāran — 'girar' en árabe estándar es 'اِنْعَطِفْ')\n💬 En dialecto egipcio es 'خُشّ شِمال/khosh shemaal', pero en árabe estándar es 'اِنْعَطِفْ يَسارًا/inʿaṭif yasāran' ✓\n\n❌ امْشي عَلى طول. (egipcio '3ala tool')\n✅ اِمْشِ مُسْتَقيمًا. (imshi mustaqīman — 'recto' es 'مُسْتَقيمًا')\n💬 En dialecto egipcio es 'عَلى طول/3ala tool', pero en árabe estándar es 'مُسْتَقيمًا/mustaqīman' ✓" },
          rudyTip: { ko: "표준어 길 안내는 심플해! 'اِنْعَطِفْ'(inʿaṭif) + 방향, 'مُسْتَقيمًا'(mustaqīman, 직진), 'عَلى ___ِكَ'(ʿalā ___ika, ~쪽에). 이 세 조합이면 어디서든 누구든 안내할 수 있어!", en: "MSA directions are super simple! 'اِنْعَطِفْ' (inʿaṭif) + side, 'مُسْتَقيمًا' (mustaqīman = straight), 'عَلى ___ِكَ' (ʿalā ___ika = on your ___). Mix these three and you can guide anyone anywhere!", es: "Las direcciones en árabe estándar son simples: 'اِنْعَطِفْ' (inʿaṭif) + lado, 'مُسْتَقيمًا' (mustaqīman = recto), 'عَلى ___ِكَ' (ʿalā ___ika = a tu ___). ¡Con estas tres puedes guiar a cualquiera!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "اِنْعَطِفْ ___.", answer: "يَسارًا", options: ["يَسارًا", "فَوْقَ", "تَحْتَ"], fullSentence: "اِنْعَطِفْ يَسارًا.", fullSentenceMeaning: { ko: "왼쪽으로 돌아요.", en: "Turn left.", es: "Gira a la izquierda.", id: "Belok kiri." } },
          { type: "select", promptWithBlank: "اِمْشِ ___.", answer: "مُسْتَقيمًا", options: ["مُسْتَقيمًا", "يَمينًا", "بِسُرْعة"], fullSentence: "اِمْشِ مُسْتَقيمًا.", fullSentenceMeaning: { ko: "직진하세요.", en: "Go straight ahead.", es: "Sigue todo recto.", id: "Jalan lurus terus." } },
          { type: "select", promptWithBlank: "هِيَ عَلى ___ِكَ.", answer: "يَمين", options: ["يَمين", "فَوْق", "وَراء"], fullSentence: "هِيَ عَلى يَمينِكَ.", fullSentenceMeaning: { ko: "오른쪽에 있어요.", en: "It's on your right.", es: "Está a tu derecha.", id: "Ada di sebelah kanan Anda." } },
          { type: "input", promptWithBlank: "اِنْعَطِفْ ___.", answer: "يَمينًا", fullSentence: "اِنْعَطِفْ يَمينًا.", fullSentenceMeaning: { ko: "오른쪽으로 돌아요.", en: "Turn right.", es: "Gira a la derecha.", id: "Belok kanan." } },
          { type: "input", promptWithBlank: "خُذْ ___ شارِع عَلى اليَمين.", answer: "أوّل", fullSentence: "خُذْ أوّل شارِع عَلى اليَمين.", fullSentenceMeaning: { ko: "오른쪽 첫 번째 길로 가세요.", en: "Take the first street on the right.", es: "Toma la primera calle a la derecha.", id: "Ambil jalan pertama di sebelah kanan." } },
          { type: "listening", audioText: "خُذْ أوّل شارِع عَلى اليَمين.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["خُذْ أوّل شارِع عَلى اليَمين.", "هِيَ عَلى يَسارِكَ.", "اِنْعَطِفْ يَمينًا.", "اِمْشِ مُسْتَقيمًا."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_21: {
    ...
    arabic: {
      step1Sentences: [
        { text: "اِعْبُرِ الجِسْر.", speechLang: "ar-EG", meaning: { ko: "iʿburi al-jisr · 다리를 건너세요.", en: "iʿburi al-jisr · Cross the bridge.", es: "iʿburi al-jisr · Cruza el puente.", id: "iʿburi al-jisr · Seberangi jembatan." } },
        { text: "هِيَ بِجانِب البَقّالة.", speechLang: "ar-EG", meaning: { ko: "hiya bijānib al-baqqāla · 편의점 옆에 있어요.", en: "hiya bijānib al-baqqāla · It's next to the convenience store.", es: "hiya bijānib al-baqqāla · Está al lado de la tienda.", id: "hiya bijānib al-baqqāla · Tempatnya di sebelah minimarket." } },
        { text: "أَنْتَ تَجاوَزْتَها — اِرْجِعْ.", speechLang: "ar-EG", meaning: { ko: "anta tajāwaztahā — irjiʿ · 지나쳤어요 — 돌아가세요.", en: "anta tajāwaztahā — irjiʿ · You passed it — go back.", es: "anta tajāwaztahā — irjiʿ · Lo pasaste — vuelve atrás.", id: "anta tajāwaztahā — irjiʿ · Anda sudah melewatinya — kembali lagi." } },
        { text: "عِنْدَ التَّقاطُع، اِنْعَطِفْ يَمينًا.", speechLang: "ar-EG", meaning: { ko: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · 교차로에서 오른쪽으로 도세요.", en: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · At the intersection, turn right.", es: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · En el cruce, gira a la derecha.", id: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · Di persimpangan, belok kanan." }, recallRound: true },
        { text: "اُخْرُجْ مِن مَخْرَج ثَلاثة فِي المِترو.", speechLang: "ar-EG", meaning: { ko: "ukhruj min makhraj thalātha fī al-mitro · 지하철 3번 출구로 나오세요.", en: "ukhruj min makhraj thalātha fī al-mitro · Take exit three from the subway.", es: "ukhruj min makhraj thalātha fī al-mitro · Toma la salida tres del metro.", id: "ukhruj min makhraj thalātha fī al-mitro · Keluar dari pintu keluar tiga di stasiun." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "건너기: 'اِعْبُرْ ___'(iʿbur ___) / 옆: 'بِجانِب ___'(bijānib ___) / 되돌아가기: 'اِرْجِعْ'(irjiʿ) / 교차로: 'عِنْدَ التَّقاطُع، اِنْعَطِفْ ___'(ʿinda al-taqāṭuʿ, inʿaṭif ___) / 출구: 'اُخْرُجْ مِن مَخْرَج ___'(ukhruj min makhraj ___)", en: "Cross: 'اِعْبُرْ ___' (iʿbur ___, 'cross over ___') / Next to: 'بِجانِب ___' (bijānib ___) / Go back: 'اِرْجِعْ' (irjiʿ, 'return') / Intersection: 'عِنْدَ التَّقاطُع، اِنْعَطِفْ ___' (ʿinda al-taqāṭuʿ, inʿaṭif ___) / Exit: 'اُخْرُجْ مِن مَخْرَج ___' (ukhruj min makhraj ___, 'go out exit ___')", es: "Cruzar: 'اِعْبُرْ ___' (iʿbur ___) / Al lado: 'بِجانِب ___' (bijānib ___) / Volver: 'اِرْجِعْ' (irjiʿ) / Cruce: 'عِنْدَ التَّقاطُع، اِنْعَطِفْ ___' (ʿinda al-taqāṭuʿ, inʿaṭif ___) / Salida: 'اُخْرُجْ مِن مَخْرَج ___' (ukhruj min makhraj ___)" },
          examples: { ko: "اِعْبُرِ الشارِع عِنْدَ مَمَرّ المُشاة. (iʿburi al-shāriʿ ʿinda mamarr al-mushāt · 횡단보도에서 길을 건너세요.)\nالمَطْعَم بِجانِب البَنْك. (al-maṭʿam bijānib al-bank · 식당은 은행 옆에 있어요.)\nاُخْرُجْ مِن مَخْرَج خَمْسة فِي المِترو. (ukhruj min makhraj khamsa fī al-mitro · 지하철 5번 출구로 나오세요.)", en: "اِعْبُرِ الشارِع عِنْدَ مَمَرّ المُشاة. (iʿburi al-shāriʿ ʿinda mamarr al-mushāt · Cross the street at the crosswalk.)\nالمَطْعَم بِجانِب البَنْك. (al-maṭʿam bijānib al-bank · The restaurant is next to the bank.)\nاُخْرُجْ مِن مَخْرَج خَمْسة فِي المِترو. (ukhruj min makhraj khamsa fī al-mitro · Take exit five from the subway.)", es: "اِعْبُرِ الشارِع عِنْدَ مَمَرّ المُشاة. (iʿburi al-shāriʿ ʿinda mamarr al-mushāt · Cruza en el paso de peatones.)\nالمَطْعَم بِجانِب البَنْك. (al-maṭʿam bijānib al-bank · El restaurante está al lado del banco.)\nاُخْرُجْ مِن مَخْرَج خَمْسة فِي المِترو. (ukhruj min makhraj khamsa fī al-mitro · Toma la salida cinco del metro.)" },
          mistakes: { ko: "❌ اعْدي الكُوبْري. (이집트 구어, 표준어 아님)\n✅ اِعْبُرِ الجِسْر. (iʿburi al-jisr — '건너다'는 표준어로 'اِعْبُرْ', '다리'는 'الجِسْر'!)\n💬 이집트 구어로는 'اعْدي الكُوبْري/e3dy el-kobry' 지만 표준어는 'اِعْبُرِ الجِسْر/iʿburi al-jisr' ✓\n\n❌ هِيَ جَنْب البَقّالة. (이집트 구어 'ganb')\n✅ هِيَ بِجانِب البَقّالة. (hiya bijānib al-baqqāla — '옆'은 'بِجانِب'!)\n💬 이집트 구어로는 'جَنْب/ganb' 지만 표준어는 'بِجانِب/bijānib' ✓", en: "❌ اعْدي الكُوبْري. (Egyptian dialect, not MSA)\n✅ اِعْبُرِ الجِسْر. (iʿburi al-jisr — 'cross' in MSA is 'اِعْبُرْ' and 'bridge' is 'الجِسْر'!)\n💬 In Egyptian dialect it's 'اعْدي الكُوبْري/e3dy el-kobry', but MSA is 'اِعْبُرِ الجِسْر/iʿburi al-jisr' ✓\n\n❌ هِيَ جَنْب البَقّالة. (Egyptian 'ganb')\n✅ هِيَ بِجانِب البَقّالة. (hiya bijānib al-baqqāla — 'next to' is 'بِجانِب'!)\n💬 In Egyptian dialect it's 'جَنْب/ganb', but MSA is 'بِجانِب/bijānib' ✓", es: "❌ اعْدي الكُوبْري. (dialecto egipcio, no árabe estándar)\n✅ اِعْبُرِ الجِسْر. (iʿburi al-jisr — 'cruzar' en árabe estándar es 'اِعْبُرْ' y 'puente' es 'الجِسْر')\n💬 En dialecto egipcio es 'اعْدي الكُوبْري/e3dy el-kobry', pero en árabe estándar es 'اِعْبُرِ الجِسْر/iʿburi al-jisr' ✓\n\n❌ هِيَ جَنْب البَقّالة. (egipcio 'ganb')\n✅ هِيَ بِجانِب البَقّالة. (hiya bijānib al-baqqāla — 'al lado' es 'بِجانِب')\n💬 En dialecto egipcio es 'جَنْب/ganb', pero en árabe estándar es 'بِجانِب/bijānib' ✓" },
          rudyTip: { ko: "고급 길 안내의 비밀은 랜드마크야! 'اِعْبُرِ الجِسْر'(iʿburi al-jisr, 다리 건너), 'بِجانِب البَنْك'(bijānib al-bank, 은행 옆) — 건물을 기준점으로 쓰면 훨씬 정확해. 표준어로 다리는 'الجِسْر/al-jisr'야!", en: "The secret to advanced directions? Landmarks! 'اِعْبُرِ الجِسْر' (iʿburi al-jisr = cross the bridge), 'بِجانِب البَنْك' (bijānib al-bank = next to the bank). Using buildings as reference makes everything clear — and in MSA 'bridge' is 'الجِسْر' (al-jisr)!", es: "El secreto de las direcciones avanzadas son los puntos de referencia: 'اِعْبُرِ الجِسْر' (iʿburi al-jisr = cruza el puente), 'بِجانِب البَنْك' (bijānib al-bank = al lado del banco). ¡En árabe estándar 'puente' es 'الجِسْر' (al-jisr)!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ الجِسْر.", answer: "اِعْبُرِ", options: ["اِعْبُرِ", "اِنْعَطِفْ", "خُذْ"], fullSentence: "اِعْبُرِ الجِسْر.", fullSentenceMeaning: { ko: "다리를 건너세요.", en: "Cross the bridge.", es: "Cruza el puente.", id: "Seberangi jembatan." } },
          { type: "select", promptWithBlank: "هِيَ ___ البَقّالة.", answer: "بِجانِب", options: ["بِجانِب", "قَريب", "وَراء"], fullSentence: "هِيَ بِجانِب البَقّالة.", fullSentenceMeaning: { ko: "편의점 옆에 있어요.", en: "It's next to the convenience store.", es: "Está al lado de la tienda.", id: "Tempatnya di sebelah minimarket." } },
          { type: "select", promptWithBlank: "أَنْتَ تَجاوَزْتَها — ___.", answer: "اِرْجِعْ", options: ["اِرْجِعْ", "تابِعْ", "اُخْرُجْ"], fullSentence: "أَنْتَ تَجاوَزْتَها — اِرْجِعْ.", fullSentenceMeaning: { ko: "지나쳤어요 — 돌아가세요.", en: "You passed it — go back.", es: "Lo pasaste — vuelve atrás.", id: "Anda sudah melewatinya — kembali lagi." } },
          { type: "input", promptWithBlank: "عِنْدَ ___، اِنْعَطِفْ يَمينًا.", answer: "التَّقاطُع", fullSentence: "عِنْدَ التَّقاطُع، اِنْعَطِفْ يَمينًا.", fullSentenceMeaning: { ko: "교차로에서 오른쪽으로.", en: "At the intersection, turn right.", es: "En el cruce, gira a la derecha.", id: "Di persimpangan, belok kanan." } },
          { type: "input", promptWithBlank: "اُخْرُجْ مِن ___ ثَلاثة فِي المِترو.", answer: "مَخْرَج", fullSentence: "اُخْرُجْ مِن مَخْرَج ثَلاثة فِي المِترو.", fullSentenceMeaning: { ko: "지하철 3번 출구로 나오세요.", en: "Take exit three from the subway.", es: "Toma la salida tres del metro.", id: "Keluar dari pintu keluar tiga di stasiun." } },
          { type: "listening", audioText: "اُخْرُجْ مِن مَخْرَج ثَلاثة فِي المِترو.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["اُخْرُجْ مِن مَخْرَج ثَلاثة فِي المِترو.", "عِنْدَ التَّقاطُع، اِنْعَطِفْ يَمينًا.", "اِعْبُرِ الجِسْر.", "هِيَ بِجانِب البَقّالة."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_22: {
    ...
    arabic: {
      step1Sentences: [
        { text: "هَلْ يُمْكِنُني سَيّارة أُجْرة، لَوْ سَمَحْتَ؟", speechLang: "ar-EG", meaning: { ko: "hal yumkinunī sayyārat ujra, law samaḥta? · 택시 불러주세요.", en: "hal yumkinunī sayyārat ujra, law samaḥta? · Can I get a taxi, please?", es: "hal yumkinunī sayyārat ujra, law samaḥta? · ¿Me puede llamar un taxi?", id: "hal yumkinunī sayyārat ujra, law samaḥta? · Bisakah saya memesan taksi?" } },
        { text: "إلى المَطار، لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "ilā al-maṭār, law samaḥta · 공항으로 가주세요.", en: "ilā al-maṭār, law samaḥta · To the airport, please.", es: "ilā al-maṭār, law samaḥta · Al aeropuerto, por favor.", id: "ilā al-maṭār, law samaḥta · Ke bandara, tolong." } },
        { text: "بِكَمْ إلى وَسَط المَدينة؟", speechLang: "ar-EG", meaning: { ko: "bikam ilā wasaṭ al-madīna? · 시내까지 얼마예요?", en: "bikam ilā wasaṭ al-madīna? · How much to the city center?", es: "bikam ilā wasaṭ al-madīna? · ¿Cuánto cuesta ir al centro?", id: "bikam ilā wasaṭ al-madīna? · Berapa ongkos ke pusat kota?" } },
        { text: "تَذْكَرة واحِدة إلى مَحَطّة سيول، لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · 서울역 표 한 장 주세요.", en: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · One ticket to Seoul Station, please.", es: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · Un billete para la Estación Central, por favor.", id: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · Satu tiket ke Stasiun Seoul, tolong." }, recallRound: true },
        { text: "هَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَتْحَف؟", speechLang: "ar-EG", meaning: { ko: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · 이 버스 박물관에 가나요?", en: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · Does this bus go to the museum?", es: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · ¿Este autobús va al museo?", id: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · Apakah bus ini ke museum?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "택시: 'هَلْ يُمْكِنُني سَيّارة أُجْرة؟'(hal yumkinunī sayyārat ujra?) / 목적지: 'إلى ___، لَوْ سَمَحْتَ'(ilā ___, law samaḥta) / 가격: 'بِكَمْ إلى ___؟'(bikam ilā ___?) / 표: 'تَذْكَرة إلى ___'(tadhkara ilā ___) / 버스 확인: 'هَلْ هٰذِهِ الحافِلة تَذْهَب إلى ___؟'(hal hādhihi al-ḥāfila tadhhab ilā ___?)", en: "Taxi: 'هَلْ يُمْكِنُني سَيّارة أُجْرة؟' (hal yumkinunī sayyārat ujra?, 'can I get a taxi?') / Destination: 'إلى ___، لَوْ سَمَحْتَ' (ilā ___, law samaḥta, 'to ___, please') / Price: 'بِكَمْ إلى ___؟' (bikam ilā ___?, 'how much to ___?') / Ticket: 'تَذْكَرة إلى ___' (tadhkara ilā ___) / Bus: 'هَلْ هٰذِهِ الحافِلة تَذْهَب إلى ___؟' (hal hādhihi al-ḥāfila tadhhab ilā ___?, 'does this bus go to ___?')", es: "Taxi: 'هَلْ يُمْكِنُني سَيّارة أُجْرة؟' (hal yumkinunī sayyārat ujra?) / Destino: 'إلى ___، لَوْ سَمَحْتَ' (ilā ___, law samaḥta) / Precio: 'بِكَمْ إلى ___؟' (bikam ilā ___?) / Billete: 'تَذْكَرة إلى ___' (tadhkara ilā ___) / Autobús: 'هَلْ هٰذِهِ الحافِلة تَذْهَب إلى ___؟' (hal hādhihi al-ḥāfila tadhhab ilā ___?)" },
          examples: { ko: "هَلْ يُمْكِنُني سَيّارة أُجْرة إلى وَسَط المَدينة؟ (hal yumkinunī sayyārat ujra ilā wasaṭ al-madīna? · 시내까지 택시 불러주세요.)\nبِكَمْ إلى المَحَطّة؟ (bikam ilā al-maḥaṭṭa? · 역까지 얼마예요?)\nهَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَطار؟ (hal hādhihi al-ḥāfila tadhhab ilā al-maṭār? · 이 버스 공항에 가나요?)", en: "هَلْ يُمْكِنُني سَيّارة أُجْرة إلى وَسَط المَدينة؟ (hal yumkinunī sayyārat ujra ilā wasaṭ al-madīna? · Can I get a taxi to downtown?)\nبِكَمْ إلى المَحَطّة؟ (bikam ilā al-maḥaṭṭa? · How much to the station?)\nهَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَطار؟ (hal hādhihi al-ḥāfila tadhhab ilā al-maṭār? · Does this bus go to the airport?)", es: "هَلْ يُمْكِنُني سَيّارة أُجْرة إلى وَسَط المَدينة؟ (hal yumkinunī sayyārat ujra ilā wasaṭ al-madīna? · ¿Me puede conseguir un taxi al centro?)\nبِكَمْ إلى المَحَطّة؟ (bikam ilā al-maḥaṭṭa? · ¿Cuánto cuesta ir a la estación?)\nهَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَطار؟ (hal hādhihi al-ḥāfila tadhhab ilā al-maṭār? · ¿Este autobús va al aeropuerto?)" },
          mistakes: { ko: "❌ عَلى المَطار، لو سَمَحْت. (이집트 구어, 'عَلى'는 '~위에')\n✅ إلى المَطار، لَوْ سَمَحْتَ. (ilā al-maṭār — 목적지는 'إلى'!)\n💬 이집트 구어로는 'عَلى/3ala' 지만 표준어는 'إلى/ilā' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (이집트 구어 — 'بـ' 접두사+'ده')\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — 표준어는 'هَلْ'로 묻고 'بـ' 빼요!)\n💬 이집트 구어로는 'أُتوبيس ده بيِروح/otobees da beyrooh' 지만 표준어는 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓", en: "❌ عَلى المَطار، لو سَمَحْت. (Egyptian dialect — 'عَلى' means 'on')\n✅ إلى المَطار، لَوْ سَمَحْتَ. (ilā al-maṭār — destination takes 'إلى'!)\n💬 In Egyptian dialect it's 'عَلى/3ala', but MSA is 'إلى/ilā' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (Egyptian — 'bi-' prefix + 'ده')\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — MSA asks with 'هَلْ' and drops the 'bi-' prefix!)\n💬 In Egyptian dialect it's 'أُتوبيس ده بيِروح/otobees da beyrooh', but MSA is 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓", es: "❌ عَلى المَطار، لو سَمَحْت. (dialecto egipcio — 'عَلى' significa 'sobre')\n✅ إلى المَطار، لَوْ سَمَحْتَ. (ilā al-maṭār — el destino lleva 'إلى')\n💬 En dialecto egipcio es 'عَلى/3ala', pero en árabe estándar es 'إلى/ilā' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (egipcio — prefijo 'bi-' + 'ده')\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — el árabe estándar pregunta con 'هَلْ' y quita el prefijo 'bi-')\n💬 En dialecto egipcio es 'أُتوبيس ده بيِروح/otobees da beyrooh', pero en árabe estándar es 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓" },
          rudyTip: { ko: "교통수단 표준어의 핵심은 'إلى'(ilā, ~로)랑 'بِكَمْ'(bikam, 얼마)야! 'إلى المَطار'(공항으로), 'بِكَمْ؟'(얼마예요?) — 택시든 버스든 이 두 마디면 끝! 'لَوْ سَمَحْتَ'(law samaḥta, 부탁해요)도 꼭 붙여~", en: "The magic words for transport in MSA are 'إلى' (ilā = to) and 'بِكَمْ' (bikam = how much)! 'إلى المَطار' (to the airport), 'بِكَمْ؟' (how much?) — works for taxis and buses alike. And always add 'لَوْ سَمَحْتَ' (law samaḥta = please)!", es: "Las palabras mágicas del transporte en árabe estándar son 'إلى' (ilā = a) y 'بِكَمْ' (bikam = cuánto): 'إلى المَطار' (al aeropuerto), 'بِكَمْ؟' (¿cuánto?). ¡Funciona para taxis y autobuses! Y añade siempre 'لَوْ سَمَحْتَ' (law samaḥta = por favor)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ يُمْكِنُني سَيّارة أُجْرة، لَوْ سَمَحْتَ؟", answer: "هَلْ", options: ["هَلْ", "أَيْنَ", "ماذا"], fullSentence: "هَلْ يُمْكِنُني سَيّارة أُجْرة، لَوْ سَمَحْتَ؟", fullSentenceMeaning: { ko: "택시 불러주세요.", en: "Can I get a taxi?", es: "¿Un taxi, por favor?", id: "Bisakah saya memesan taksi?" } },
          { type: "select", promptWithBlank: "___ المَطار، لَوْ سَمَحْتَ.", answer: "إلى", options: ["إلى", "في", "مِن"], fullSentence: "إلى المَطار، لَوْ سَمَحْتَ.", fullSentenceMeaning: { ko: "공항으로 가주세요.", en: "To the airport, please.", es: "Al aeropuerto, por favor.", id: "Ke bandara, tolong." } },
          { type: "select", promptWithBlank: "هَلْ هٰذِهِ الحافِلة ___ إلى المَتْحَف؟", answer: "تَذْهَب", options: ["تَذْهَب", "تَأْتي", "تَقِف"], fullSentence: "هَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَتْحَف؟", fullSentenceMeaning: { ko: "이 버스 박물관에 가나요?", en: "Does this bus go to the museum?", es: "¿Va al museo este bus?", id: "Apakah bus ini ke museum?" } },
          { type: "input", promptWithBlank: "___ إلى وَسَط المَدينة؟", answer: "بِكَمْ", fullSentence: "بِكَمْ إلى وَسَط المَدينة؟", fullSentenceMeaning: { ko: "시내까지 얼마예요?", en: "How much to the center?", es: "¿Cuánto al centro?", id: "Berapa ongkos ke pusat kota?" } },
          { type: "input", promptWithBlank: "___ واحِدة إلى مَحَطّة سيول، لَوْ سَمَحْتَ.", answer: "تَذْكَرة", fullSentence: "تَذْكَرة واحِدة إلى مَحَطّة سيول، لَوْ سَمَحْتَ.", fullSentenceMeaning: { ko: "서울역 표 한 장 주세요.", en: "One ticket to Seoul Station.", es: "Un billete a la Estación Central.", id: "Satu tiket ke Stasiun Seoul." } },
          { type: "listening", audioText: "هَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَتْحَف؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَتْحَف؟", "تَذْكَرة واحِدة إلى مَحَطّة سيول، لَوْ سَمَحْتَ.", "إلى المَطار، لَوْ سَمَحْتَ.", "بِكَمْ إلى وَسَط المَدينة؟"], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_23: {
    ...
    arabic: {
      step1Sentences: [
        { text: "لَوْ سَمَحْتَ، أَنا تائِه.", speechLang: "ar-EG", meaning: { ko: "law samaḥta, anā tāʾih · 실례합니다, 길을 잃었어요.", en: "law samaḥta, anā tāʾih · Excuse me, I'm lost.", es: "law samaḥta, anā tāʾih · Perdone, estoy perdido.", id: "law samaḥta, anā tāʾih · Permisi, saya tersesat." } },
        { text: "هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", speechLang: "ar-EG", meaning: { ko: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · 지도에서 보여주실 수 있나요?", en: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · Can you show me on the map?", es: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · ¿Me puede señalar en el mapa?", id: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · Bisakah Anda tunjukkan di peta?" } },
        { text: "أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة.", speechLang: "ar-EG", meaning: { ko: "anā lā aʿrifu hādhihi al-manṭiqa · 이 동네를 잘 몰라요.", en: "anā lā aʿrifu hādhihi al-manṭiqa · I don't know this area.", es: "anā lā aʿrifu hādhihi al-manṭiqa · No conozco esta zona.", id: "anā lā aʿrifu hādhihi al-manṭiqa · Saya tidak tahu daerah ini." } },
        { text: "مَحَطّة القِطار مِن أَيِّ ناحِية؟", speechLang: "ar-EG", meaning: { ko: "maḥaṭṭat al-qiṭār min ayyi nāḥiya? · 기차역이 어느 쪽인가요?", en: "maḥaṭṭat al-qiṭār min ayyi nāḥiya? · Which way is the train station?", es: "maḥaṭṭat al-qiṭār min ayyi nāḥiya? · ¿Por dónde está la estación?", id: "maḥaṭṭat al-qiṭār min ayyi nāḥiya? · Ke arah mana stasiun kereta?" }, recallRound: true },
        { text: "هَلْ هٰذا الطَّريق الصَّحيح إلى المَتْحَف؟", speechLang: "ar-EG", meaning: { ko: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · 박물관 가는 길이 맞나요?", en: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · Is this the right way to the museum?", es: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · ¿Voy bien para el museo?", id: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · Apakah ini jalan yang benar ke museum?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "길 잃음: 'أَنا تائِه'(anā tāʾih) / 지도: 'هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟'(hal yumkinu an turiyanī ʿalā al-kharīṭa?) / 방향: '___ مِن أَيِّ ناحِية؟'(___ min ayyi nāḥiya?) / 확인: 'هَلْ هٰذا الطَّريق الصَّحيح إلى ___؟'(hal hādhā al-ṭarīq al-ṣaḥīḥ ilā ___?)", en: "Lost: 'أَنا تائِه' (anā tāʾih, 'I'm lost') / Map: 'هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟' (hal yumkinu an turiyanī ʿalā al-kharīṭa?) / Direction: '___ مِن أَيِّ ناحِية؟' (___ min ayyi nāḥiya?, 'which way is ___?') / Confirm: 'هَلْ هٰذا الطَّريق الصَّحيح إلى ___؟' (hal hādhā al-ṭarīq al-ṣaḥīḥ ilā ___?, 'is this the right way to ___?')", es: "Perdido: 'أَنا تائِه' (anā tāʾih, 'estoy perdido') / Mapa: 'هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟' (hal yumkinu an turiyanī ʿalā al-kharīṭa?) / Dirección: '___ مِن أَيِّ ناحِية؟' (___ min ayyi nāḥiya?) / Confirmar: 'هَلْ هٰذا الطَّريق الصَّحيح إلى ___؟' (hal hādhā al-ṭarīq al-ṣaḥīḥ ilā ___?)" },
          examples: { ko: "لَوْ سَمَحْتَ، أَنا تائِه. أَيْنَ الفُنْدُق؟ (law samaḥta, anā tāʾih. ayna al-funduq? · 실례합니다, 길을 잃었어요. 호텔이 어디예요?)\nهَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (hal yumkinu an turiyanī ʿalā al-kharīṭa? anā lā aʿrifu hādhihi al-manṭiqa · 지도에서 보여주세요. 이 동네를 몰라요.)\nهَلْ هٰذا الطَّريق الصَّحيح إلى الحَديقة؟ (hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-ḥadīqa? · 공원 가는 길이 맞나요?)", en: "لَوْ سَمَحْتَ، أَنا تائِه. أَيْنَ الفُنْدُق؟ (law samaḥta, anā tāʾih. ayna al-funduq? · Excuse me, I'm lost. Where is the hotel?)\nهَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (hal yumkinu an turiyanī ʿalā al-kharīṭa? anā lā aʿrifu hādhihi al-manṭiqa · Can you show me on the map? I don't know this area.)\nهَلْ هٰذا الطَّريق الصَّحيح إلى الحَديقة؟ (hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-ḥadīqa? · Is this the right way to the park?)", es: "لَوْ سَمَحْتَ، أَنا تائِه. أَيْنَ الفُنْدُق؟ (law samaḥta, anā tāʾih. ayna al-funduq? · Disculpe, estoy perdido. ¿Dónde está el hotel?)\nهَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (hal yumkinu an turiyanī ʿalā al-kharīṭa? anā lā aʿrifu hādhihi al-manṭiqa · ¿Me puede señalar en el mapa? No conozco esta zona.)\nهَلْ هٰذا الطَّريق الصَّحيح إلى الحَديقة؟ (hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-ḥadīqa? · ¿Voy bien para el parque?)" },
          mistakes: { ko: "❌ أَنا تُهْت. (이집트 구어, 표준어 아님)\n✅ أَنا تائِه. (anā tāʾih — '길을 잃었다'는 표준어로 'تائِه' 또는 'ضائِع'!)\n💬 이집트 구어로는 'تُهْت/toht' 지만 표준어는 'تائِه/tāʾih' ✓\n\n❌ أَنا مِش عارِف المَنْطِقة دي. (이집트 구어 부정 'mesh 3aaref')\n✅ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (anā lā aʿrifu — 표준어 부정은 'لا أَعْرِف'!)\n💬 이집트 구어로는 'مِش عارِف/mesh 3aaref' 지만 표준어는 'لا أَعْرِف/lā aʿrif' ✓", en: "❌ أَنا تُهْت. (Egyptian dialect, not MSA)\n✅ أَنا تائِه. (anā tāʾih — 'I'm lost' in MSA is 'تائِه' or 'ضائِع'!)\n💬 In Egyptian dialect it's 'تُهْت/toht', but MSA is 'تائِه/tāʾih' ✓\n\n❌ أَنا مِش عارِف المَنْطِقة دي. (Egyptian negation 'mesh 3aaref')\n✅ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (anā lā aʿrifu — MSA negation is 'لا أَعْرِف'!)\n💬 In Egyptian dialect it's 'مِش عارِف/mesh 3aaref', but MSA is 'لا أَعْرِف/lā aʿrif' ✓", es: "❌ أَنا تُهْت. (dialecto egipcio, no árabe estándar)\n✅ أَنا تائِه. (anā tāʾih — 'estoy perdido' en árabe estándar es 'تائِه' o 'ضائِع')\n💬 En dialecto egipcio es 'تُهْت/toht', pero en árabe estándar es 'تائِه/tāʾih' ✓\n\n❌ أَنا مِش عارِف المَنْطِقة دي. (negación egipcia 'mesh 3aaref')\n✅ أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة. (anā lā aʿrifu — la negación en árabe estándar es 'لا أَعْرِف')\n💬 En dialecto egipcio es 'مِش عارِف/mesh 3aaref', pero en árabe estándar es 'لا أَعْرِف/lā aʿrif' ✓" },
          rudyTip: { ko: "낯선 곳에서 당황하지 마! 'لَوْ سَمَحْتَ، أَنا تائِه'(law samaḥta, anā tāʾih) 이 한 마디면 사람들이 바로 도와줘. 웃으면서 말하면 효과 두 배!", en: "Don't panic in a strange place! 'لَوْ سَمَحْتَ، أَنا تائِه' (law samaḥta, anā tāʾih) — this one line gets people helping you right away. Say it with a smile and the help doubles!", es: "No entres en pánico en un lugar extraño. 'لَوْ سَمَحْتَ، أَنا تائِه' (law samaḥta, anā tāʾih) hace que la gente te ayude enseguida. ¡Dilo con una sonrisa y la ayuda se duplica!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "لَوْ سَمَحْتَ، أَنا ___.", answer: "تائِه", options: ["تائِه", "مُتَأَخِّر", "مُتْعَب"], fullSentence: "لَوْ سَمَحْتَ، أَنا تائِه.", fullSentenceMeaning: { ko: "실례합니다, 길을 잃었어요.", en: "Excuse me, I'm lost.", es: "Perdone, estoy perdido.", id: "Permisi, saya tersesat." } },
          { type: "select", promptWithBlank: "هَلْ يُمْكِنُ أَنْ ___ عَلى الخَريطة؟", answer: "تُريَني", options: ["تُريَني", "تُخْبِرَني", "تُعْطيَني"], fullSentence: "هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", fullSentenceMeaning: { ko: "지도에서 보여주실 수 있나요?", en: "Can you show me on the map?", es: "¿Me puede señalar en el mapa?", id: "Bisakah Anda tunjukkan di peta?" } },
          { type: "select", promptWithBlank: "مَحَطّة القِطار مِن أَيِّ ___؟", answer: "ناحِية", options: ["ناحِية", "شَيْء", "مَن"], fullSentence: "مَحَطّة القِطار مِن أَيِّ ناحِية؟", fullSentenceMeaning: { ko: "기차역이 어느 쪽인가요?", en: "Which way is the train station?", es: "¿Por dónde está la estación?", id: "Ke arah mana stasiun kereta?" } },
          { type: "input", promptWithBlank: "أَنا لا ___ هٰذِهِ المَنْطِقة.", answer: "أَعْرِفُ", fullSentence: "أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة.", fullSentenceMeaning: { ko: "이 동네를 잘 몰라요.", en: "I don't know this area.", es: "No conozco esta zona.", id: "Saya tidak tahu daerah ini." } },
          { type: "input", promptWithBlank: "هَلْ هٰذا الطَّريق ___ إلى المَتْحَف؟", answer: "الصَّحيح", fullSentence: "هَلْ هٰذا الطَّريق الصَّحيح إلى المَتْحَف؟", fullSentenceMeaning: { ko: "박물관 가는 길이 맞나요?", en: "Is this the right way to the museum?", es: "¿Voy bien para el museo?", id: "Apakah ini jalan yang benar ke museum?" } },
          { type: "listening", audioText: "هَلْ هٰذا الطَّريق الصَّحيح إلى المَتْحَف؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هَلْ هٰذا الطَّريق الصَّحيح إلى المَتْحَف؟", "مَحَطّة القِطار مِن أَيِّ ناحِية؟", "هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", "لَوْ سَمَحْتَ، أَنا تائِه."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_24: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَيْنَ المِترو؟ اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا.", speechLang: "ar-EG", meaning: { ko: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · 지하철 어디예요? 왼쪽으로 돌아서 직진하세요.", en: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · Where is the subway? Turn left and go straight.", es: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · ¿Dónde está el metro? Gira a la izquierda y sigue recto.", id: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · Di mana stasiun? Belok kiri dan jalan lurus terus." } },
        { text: "لَوْ سَمَحْتَ، أَنا تائِه. هَلْ يُمْكِنُ أَنْ تُساعِدَني؟", speechLang: "ar-EG", meaning: { ko: "law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · 실례합니다, 길을 잃었어요. 도와주시겠어요?", en: "law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · Excuse me, I'm lost. Can you help me?", es: "law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · Perdone, estoy perdido. ¿Me puede ayudar?", id: "law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · Permisi, saya tersesat. Bisa bantu saya?" } },
        { text: "تَذْكَرة إلى المَطار، لَوْ سَمَحْتَ. بِكَمْ؟", speechLang: "ar-EG", meaning: { ko: "tadhkara ilā al-maṭār, law samaḥta. bikam? · 공항행 표 한 장 주세요. 얼마예요?", en: "tadhkara ilā al-maṭār, law samaḥta. bikam? · One ticket to the airport, please. How much?", es: "tadhkara ilā al-maṭār, law samaḥta. bikam? · Un billete al aeropuerto. ¿Cuánto?", id: "tadhkara ilā al-maṭār, law samaḥta. bikam? · Satu tiket ke bandara, tolong. Berapa?" } },
        { text: "اِعْبُرِ الجِسْر وهِيَ عَلى يَمينِكَ.", speechLang: "ar-EG", meaning: { ko: "iʿburi al-jisr wahiya ʿalā yamīnika · 다리를 건너면 오른쪽에 있어요.", en: "iʿburi al-jisr wahiya ʿalā yamīnika · Cross the bridge and it's on your right.", es: "iʿburi al-jisr wahiya ʿalā yamīnika · Cruza el puente y está a tu derecha.", id: "iʿburi al-jisr wahiya ʿalā yamīnika · Seberangi jembatan dan ada di sebelah kanan Anda." }, recallRound: true },
        { text: "هَلْ هُناكَ صَيْدَلِيّة قَريبة؟ حَوالي عَشْر دَقائِق مَشْيًا.", speechLang: "ar-EG", meaning: { ko: "hal hunāka ṣaydaliyya qarība? ḥawālī ʿashr daqāʾiq mashyan · 근처에 약국 있나요? 걸어서 10분 정도예요.", en: "hal hunāka ṣaydaliyya qarība? ḥawālī ʿashr daqāʾiq mashyan · Is there a pharmacy nearby? About ten minutes on foot.", es: "hal hunāka ṣaydaliyya qarība? ḥawālī ʿashr daqāʾiq mashyan · ¿Hay farmacia cerca? Unos diez minutos a pie.", id: "hal hunāka ṣaydaliyya qarība? ḥawālī ʿashr daqāʾiq mashyan · Apakah ada apotek di dekat sini? Sekitar sepuluh menit jalan kaki." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "장소: 'أَيْنَ ___؟'(ayna ___?) / 방향: 'اِنْعَطِفْ يَسارًا/يَمينًا، اِمْشِ مُسْتَقيمًا'(inʿaṭif yasāran/yamīnan, imshi mustaqīman) / 고급 방향: 'اِعْبُرْ ___، بِجانِب ___'(iʿbur ___, bijānib ___) / 교통: 'تَذْكَرة إلى ___'(tadhkara ilā ___) / 도움: 'أَنا تائِه'(anā tāʾih)", en: "Places: 'أَيْنَ ___؟' (ayna ___?) / Directions: 'اِنْعَطِفْ يَسارًا/يَمينًا، اِمْشِ مُسْتَقيمًا' (inʿaṭif yasāran/yamīnan, imshi mustaqīman) / Advanced: 'اِعْبُرْ ___، بِجانِب ___' (iʿbur ___, bijānib ___) / Transport: 'تَذْكَرة إلى ___' (tadhkara ilā ___) / Help: 'أَنا تائِه' (anā tāʾih)", es: "Lugares: 'أَيْنَ ___؟' (ayna ___?) / Direcciones: 'اِنْعَطِفْ يَسارًا/يَمينًا، اِمْشِ مُسْتَقيمًا' (inʿaṭif yasāran/yamīnan, imshi mustaqīman) / Avanzado: 'اِعْبُرْ ___، بِجانِب ___' (iʿbur ___, bijānib ___) / Transporte: 'تَذْكَرة إلى ___' (tadhkara ilā ___) / Ayuda: 'أَنا تائِه' (anā tāʾih)" },
          examples: { ko: "أَيْنَ المِترو؟ اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا. (ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · 지하철 어디예요? 왼쪽으로 돌아서 직진하세요.)\nتَذْكَرة إلى المَطار، لَوْ سَمَحْتَ. بِكَمْ؟ (tadhkara ilā al-maṭār, law samaḥta. bikam? · 공항행 표 한 장 주세요. 얼마예요?)\nلَوْ سَمَحْتَ، أَنا تائِه. هَلْ يُمْكِنُ أَنْ تُساعِدَني؟ (law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · 실례합니다, 길을 잃었어요. 도와주시겠어요?)", en: "أَيْنَ المِترو؟ اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا. (ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · Where is the subway? Turn left and go straight.)\nتَذْكَرة إلى المَطار، لَوْ سَمَحْتَ. بِكَمْ؟ (tadhkara ilā al-maṭār, law samaḥta. bikam? · One ticket to the airport, please. How much?)\nلَوْ سَمَحْتَ، أَنا تائِه. هَلْ يُمْكِنُ أَنْ تُساعِدَني؟ (law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · Excuse me, I'm lost. Can you help me?)", es: "أَيْنَ المِترو؟ اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا. (ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · ¿Dónde está el metro? Gira a la izquierda y sigue recto.)\nتَذْكَرة إلى المَطار، لَوْ سَمَحْتَ. بِكَمْ؟ (tadhkara ilā al-maṭār, law samaḥta. bikam? · Un billete al aeropuerto. ¿Cuánto?)\nلَوْ سَمَحْتَ، أَنا تائِه. هَلْ يُمْكِنُ أَنْ تُساعِدَني؟ (law samaḥta, anā tāʾih. hal yumkinu an tusāʿidanī? · Perdone, estoy perdido. ¿Me puede ayudar?)" },
          mistakes: { ko: "❌ فين المِترو؟ (이집트 구어, 표준어 아님)\n✅ أَيْنَ المِترو؟ (ayna al-mitro — 무조건 'أَيْنَ'!)\n💬 이집트 구어로는 'فين/feen' 지만 표준어는 'أَيْنَ/ayna' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (이집트 구어)\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — 표준어는 'هَلْ'로 묻고 'بـ' 빼요!)\n💬 이집트 구어로는 'أُتوبيس ده بيِروح/otobees da beyrooh' 지만 표준어는 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓", en: "❌ فين المِترو؟ (Egyptian dialect, not MSA)\n✅ أَيْنَ المِترو؟ (ayna al-mitro — always 'أَيْنَ'!)\n💬 In Egyptian dialect it's 'فين/feen', but MSA is 'أَيْنَ/ayna' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (Egyptian dialect)\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — MSA asks with 'هَلْ' and drops the 'bi-' prefix!)\n💬 In Egyptian dialect it's 'أُتوبيس ده بيِروح/otobees da beyrooh', but MSA is 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓", es: "❌ فين المِترو؟ (dialecto egipcio, no árabe estándar)\n✅ أَيْنَ المِترو؟ (ayna al-mitro — siempre 'أَيْنَ')\n💬 En dialecto egipcio es 'فين/feen', pero en árabe estándar es 'أَيْنَ/ayna' ✓\n\n❌ الأُتوبيس ده بيِروح؟ (dialecto egipcio)\n✅ هَلْ هٰذِهِ الحافِلة تَذْهَب؟ (hal hādhihi al-ḥāfila tadhhab? — el árabe estándar pregunta con 'هَلْ' y quita el prefijo 'bi-')\n💬 En dialecto egipcio es 'أُتوبيس ده بيِروح/otobees da beyrooh', pero en árabe estándar es 'الحافِلة تَذْهَب/al-ḥāfila tadhhab' ✓" },
          rudyTip: { ko: "이번 주 표준어를 정리하면 딱 다섯 가지야: 장소 찾기('أَيْنَ؟'/ayna?), 방향('اِنْعَطِفْ'/inʿaṭif + 'مُسْتَقيمًا'/mustaqīman), 고급 안내('اِعْبُرْ'/iʿbur + 'بِجانِب'/bijānib), 교통('بِكَمْ؟'/bikam? + 'إلى'/ilā), 도움('أَنا تائِه'/anā tāʾih). 이 다섯 개면 어디서든 살아남아!", en: "This whole week of MSA boils down to five skills: finding places ('أَيْنَ؟'/ayna?), directions ('اِنْعَطِفْ'/inʿaṭif + 'مُسْتَقيمًا'/mustaqīman), advanced navigation ('اِعْبُرْ'/iʿbur + 'بِجانِب'/bijānib), transport ('بِكَمْ؟'/bikam? + 'إلى'/ilā), and asking for help ('أَنا تائِه'/anā tāʾih). These five let you survive anywhere!", es: "Toda esta semana de árabe estándar se resume en cinco habilidades: lugares ('أَيْنَ؟'/ayna?), direcciones ('اِنْعَطِفْ'/inʿaṭif + 'مُسْتَقيمًا'/mustaqīman), navegación avanzada ('اِعْبُرْ'/iʿbur + 'بِجانِب'/bijānib), transporte ('بِكَمْ؟'/bikam? + 'إلى'/ilā) y pedir ayuda ('أَنا تائِه'/anā tāʾih). ¡Con estas cinco sobrevivirás en cualquier lugar!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "اِنْعَطِفْ يَسارًا وامْشِ ___.", answer: "مُسْتَقيمًا", options: ["مُسْتَقيمًا", "وَراء", "فَوْق"], fullSentence: "اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا.", fullSentenceMeaning: { ko: "왼쪽으로 돌아서 직진.", en: "Turn left and go straight.", es: "Gira a la izquierda y sigue recto.", id: "Belok kiri dan jalan lurus terus." } },
          { type: "select", promptWithBlank: "لَوْ سَمَحْتَ، أَنا ___.", answer: "تائِه", options: ["تائِه", "بِخَيْر", "جائِع"], fullSentence: "لَوْ سَمَحْتَ، أَنا تائِه.", fullSentenceMeaning: { ko: "실례합니다, 길을 잃었어요.", en: "Excuse me, I'm lost.", es: "Perdone, estoy perdido.", id: "Permisi, saya tersesat." } },
          { type: "select", promptWithBlank: "___ إلى المَطار، لَوْ سَمَحْتَ.", answer: "تَذْكَرة", options: ["تَذْكَرة", "سَيّارة", "حافِلة"], fullSentence: "تَذْكَرة إلى المَطار، لَوْ سَمَحْتَ.", fullSentenceMeaning: { ko: "공항행 표 한 장.", en: "One ticket to the airport.", es: "Un billete al aeropuerto.", id: "Satu tiket ke bandara." } },
          { type: "input", promptWithBlank: "___ الجِسْر.", answer: "اِعْبُرِ", fullSentence: "اِعْبُرِ الجِسْر.", fullSentenceMeaning: { ko: "다리를 건너세요.", en: "Cross the bridge.", es: "Cruza el puente.", id: "Seberangi jembatan." } },
          { type: "input", promptWithBlank: "هَلْ هُناكَ صَيْدَلِيّة ___؟", answer: "قَريبة", fullSentence: "هَلْ هُناكَ صَيْدَلِيّة قَريبة؟", fullSentenceMeaning: { ko: "근처에 약국 있나요?", en: "Pharmacy nearby?", es: "¿Farmacia cerca?", id: "Apotek di dekat sini?" } },
          { type: "listening", audioText: "هَلْ هُناكَ صَيْدَلِيّة قَريبة؟ حَوالي عَشْر دَقائِق مَشْيًا.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هَلْ هُناكَ صَيْدَلِيّة قَريبة؟ حَوالي عَشْر دَقائِق مَشْيًا.", "اِعْبُرِ الجِسْر وهِيَ عَلى يَمينِكَ.", "لَوْ سَمَحْتَ، أَنا تائِه.", "تَذْكَرة إلى المَطار، لَوْ سَمَحْتَ."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
...
export const MISSION_CONTENT_UNIT4: Record<string, Partial<Record<LearningLangKey, MissionTalkLangData>>> = {
  ...
  day_19: {
    ...
    arabic: { situation: { ko: "탐정 루디가 정보원이 남긴 암호 지시를 따라 블랙 씨의 은신처를 찾아야 해요!", en: "Detective Rudy follows coded directions to Mr. Black's hideout!", es: "¡Detective Rudy sigue las instrucciones al escondite del Sr. Black!" }, gptPrompt: "You are a local informant helping Detective Rudy find Mr. Black's hideout. Detective/mystery framing throughout. Use simple A1 MODERN STANDARD ARABIC (MSA, pausal — drop final case endings/tanwin: 'أَيْنَ' / ayna for 'where', 'بِجانِب' / bijānib for 'next to', 'قَريب' / qarīb, 'بَعيد' / baʿīd, never Egyptian dialect forms like 'feen' or 'ganb'). Practice: asking where places are ('أَيْنَ ___؟'), near/far ('قَريب/بَعيد'), landmarks (المِترو / metro, المَقْهى / cafe, المَتْحَف / museum), and walking time ('كَمْ يَبْعُدُ؟' / kam yabʿudu?). Keep sentences short and write Arabic with harakat (short vowels).", speechLang: "ar-EG", suggestedAnswers: ["أَيْنَ مَخْبَأ بْلاك؟", "هَلْ هُوَ بَعيد؟", "هَلْ هُناكَ مَحَطّة مِترو قَريبة؟", "كَمْ يَبْعُدُ؟", "بِجانِب المَتْحَف، صَحيح؟", "شُكْرًا!"] },
  },
  ...
  day_20: {
    ...
    arabic: { situation: { ko: "탐정 루디의 서울 연락원이 블랙 씨의 아지트로 가는 길을 알려줘요. 빨리 이해해야 해요!", en: "Seoul contact gives directions to Mr. Black's lair. Hurry!", es: "Contacto de Seúl dando instrucciones al refugio del Sr. Black." }, gptPrompt: "You are Detective Rudy's Seoul contact giving directions to Mr. Black's lair. Detective/mystery framing throughout. Use simple A1 MODERN STANDARD ARABIC (MSA, pausal: 'اِنْعَطِفْ يَسارًا/يَمينًا' / inʿaṭif yasāran/yamīnan for 'turn left/right', 'اِمْشِ مُسْتَقيمًا' / imshi mustaqīman for 'go straight', 'عَلى يَسارِكَ/يَمينِكَ' / ʿalā yasārika/yamīnika, never Egyptian dialect forms like 'khosh' or '3ala tool'). Give step-by-step directions and ask the user to repeat the directions back to you. Keep urgent but friendly, and write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["هَلْ أَنْعَطِفُ يَسارًا؟", "اِمْشِ مُسْتَقيمًا.", "هَلْ هِيَ عَلى يَمينِكَ؟", "هَلْ أَنْعَطِفُ يَمينًا عِنْدَ الزّاوِية؟", "فَهِمْتُ!", "هَلْ يُمْكِنُ أَنْ تُعيدَ؟"] },
  },
  ...
  day_21: {
    ...
    arabic: { situation: { ko: "탐정 루디가 명동에서 용의자를 추적하다 길을 잃었어요. 시간이 없어요!", en: "Detective Rudy lost a suspect and got lost in Myeongdong! No time!", es: "¡Detective Rudy perdido en Myeongdong tras perder al sospechoso!" }, gptPrompt: "You are a helpful stranger in Myeongdong. Detective Rudy (the user) is lost after chasing a suspect. Detective/mystery framing throughout. Use simple A1 MODERN STANDARD ARABIC (MSA, pausal: 'اِعْبُرِ الجِسْر' / iʿburi al-jisr for 'cross the bridge', 'بِجانِب البَقّالة' / bijānib al-baqqāla for 'next to the shop', 'تَجاوَزْتَها' / tajāwaztahā for 'you passed it', 'عِنْدَ التَّقاطُع' / ʿinda al-taqāṭuʿ, 'مَخْرَج' / makhraj for 'exit', never Egyptian dialect forms like 'e3dy' or 'ganb'). Be patient. If they say 'أَنا لا أَفْهَم' / anā lā afham, simplify. Write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["أَنا تائِه!", "هَلْ أَعْبُرُ الجِسْر؟", "بِجانِب البَقّالة؟", "هَلْ تَجاوَزْتُها؟", "مَخْرَج ثَلاثة؟", "شُكْرًا جَزيلًا!"] },
  },
  ...
  day_22: {
    ...
    arabic: { situation: { ko: "카이로 공항! 탐정 루디가 용의자를 잡으러 빨리 시내로 가야 해요!", en: "Cairo Airport! Detective Rudy must get downtown to catch the suspect!", es: "¡Aeropuerto! ¡Detective Rudy al centro a por el sospechoso!" }, gptPrompt: "You are a taxi driver at the airport. Detective Rudy (the user) needs downtown quickly to catch a suspect. Detective/mystery framing throughout. Use simple A1 MODERN STANDARD ARABIC (MSA, pausal: 'هَلْ يُمْكِنُني سَيّارة أُجْرة؟' / hal yumkinunī sayyārat ujra?, 'إلى ___، لَوْ سَمَحْتَ' / ilā ___, law samaḥta for the destination, 'بِكَمْ؟' / bikam? for the price, 'وَسَط المَدينة' / wasaṭ al-madīna for downtown, never Egyptian dialect forms like 'momken taxi' or '3ala'). Then switch to a ticket booth for 'تَذْكَرة' / tadhkara (bus/train). Mix in numbers for prices and write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["هَلْ يُمْكِنُني سَيّارة أُجْرة؟", "إلى وَسَط المَدينة، لَوْ سَمَحْتَ.", "بِكَمْ؟", "هٰذا غالي جِدًّا!", "تَذْكَرة واحِدة، لَوْ سَمَحْتَ.", "هَلْ هٰذِهِ الحافِلة تَذْهَب إلى وَسَط المَدينة؟"] },
  },
  ...
  day_23: {
    ...
    arabic: { situation: { ko: "카이로에서 탐정 루디의 장비가 모두 없어졌어요. 현지인에게 물어서 기차역을 찾아야 해요!", en: "Cairo — Detective Rudy has no equipment! Ask locals to find the station!", es: "¡El Cairo — Sin equipo! ¡Pregunta para encontrar la estación!" }, gptPrompt: "You are a friendly local. Detective Rudy (the user) has lost all his equipment and must reach the train station ('مَحَطّة القِطار' / maḥaṭṭat al-qiṭār). Detective/mystery framing throughout. Use simple A1 MODERN STANDARD ARABIC (MSA, pausal: 'أَنا تائِه' / anā tāʾih for 'I'm lost', 'هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟' / hal yumkinu an turiyanī ʿalā al-kharīṭa? for map help, '___ مِن أَيِّ ناحِية؟' / min ayyi nāḥiya? for 'which way', 'هَلْ هٰذا الطَّريق الصَّحيح؟' / hal hādhā al-ṭarīq al-ṣaḥīḥ? for confirming, never Egyptian dialect forms like 'toht' or 'feen'). Be very patient and encouraging. This is the hardest Mission Talk yet — the user must combine everything from Unit 4. Write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["لَوْ سَمَحْتَ، أَنا تائِه.", "هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", "أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة.", "المَحَطّة مِن أَيِّ ناحِية؟", "هَلْ هٰذا الطَّريق الصَّحيح؟", "شُكْرًا جَزيلًا!"] },
  },
  ...
  day_24: {
    ...
    arabic: { situation: { ko: "탐정 루디의 최종 추격! 공항에서 블랙 씨의 마지막 은신처까지 이동하세요!", en: "Detective Rudy's final chase! Airport to Mr. Black's last hideout!", es: "¡Persecución final! Del aeropuerto al último refugio del Sr. Black." }, gptPrompt: "You are Detective Rudy's handler coordinating the final mission to catch Mr. Black. The user must navigate from the airport to Mr. Black's last hideout. Detective/mystery framing throughout. Test ALL Unit 4 in natural A1 MODERN STANDARD ARABIC (MSA, pausal throughout): 1) get a taxi at the airport ('هَلْ يُمْكِنُني سَيّارة أُجْرة؟' / hal yumkinunī sayyārat ujra?, 'إلى ___، لَوْ سَمَحْتَ' / ilā ___, law samaḥta) 2) ask for directions when the taxi drops them off ('أَيْنَ ___؟' / ayna ___?) 3) navigate on foot ('اِنْعَطِفْ يَسارًا/يَمينًا' / inʿaṭif yasāran/yamīnan, 'اِمْشِ مُسْتَقيمًا' / imshi mustaqīman) 4) ask locals when lost ('أَنا تائِه' / anā tāʾih) 5) find the subway and take the right exit ('مَخْرَج' / makhraj). Create a multi-step navigation scenario. Mix in vocabulary from Units 1-3 naturally. Be urgent but encouraging, and write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["هَلْ يُمْكِنُني سَيّارة أُجْرة؟", "أَيْنَ المِترو؟", "هَلْ أَنْعَطِفُ يَسارًا؟", "أَنا تائِه!", "تَذْكَرة واحِدة، لَوْ سَمَحْتَ.", "هَلْ هٰذا الطَّريق الصَّحيح؟", "شُكْرًا، مَعَ السَّلامة!"] },
  },
};
...
export const REVIEW_CONTENT_UNIT4: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_19: {
    ...
    arabic: [
      { type: "speak", sentence: "أَنْصَح بِالسْتيك. هٰذا لَذيذ جِدًّا!", speechLang: "ar-EG", meaning: { ko: "anṣaḥ bil-istēk. hādhā ladhīdh jiddan! · 스테이크 추천. 맛있어요!", en: "anṣaḥ bil-istēk. hādhā ladhīdh jiddan! · I recommend the steak. Delicious!", es: "anṣaḥ bil-istēk. hādhā ladhīdh jiddan! · Recomiendo el bistec. ¡Delicioso!", id: "anṣaḥ bil-istēk. hādhā ladhīdh jiddan! · Saya merekomendasikan steaknya. Enak sekali!" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَلْ يُمْكِنُني أَنْ أَدْفَعَ بِ___؟", answer: "البِطاقة", options: ["البِطاقة", "النَّقْد", "الشّيك"], fullSentence: "هَلْ يُمْكِنُني أَنْ أَدْفَعَ بِالبِطاقة؟", fullSentenceMeaning: { ko: "hal yumkinunī an adfaʿa bil-biṭāqa? · 카드로 결제?", en: "hal yumkinunī an adfaʿa bil-biṭāqa? · Pay by card?", es: "hal yumkinunī an adfaʿa bil-biṭāqa? · ¿Con tarjeta?", id: "hal yumkinunī an adfaʿa bil-biṭāqa? · Bayar dengan kartu?" }, isYesterdayReview: true },
      { type: "speak", sentence: "أَيْنَ مَحَطّة المِترو؟", speechLang: "ar-EG", meaning: { ko: "ayna maḥaṭṭat al-mitro? · 지하철역이 어디?", en: "ayna maḥaṭṭat al-mitro? · Where is the subway?", es: "ayna maḥaṭṭat al-mitro? · ¿Dónde está el metro?", id: "ayna maḥaṭṭat al-mitro? · Di mana stasiun kereta?" } },
      { type: "fill_blank", promptWithBlank: "هَلْ هُناكَ صَيْدَلِيّة ___ مِن هُنا؟", answer: "قَريبة", options: ["قَريبة", "بَعيدة", "هُنا"], fullSentence: "هَلْ هُناكَ صَيْدَلِيّة قَريبة مِن هُنا؟", fullSentenceMeaning: { ko: "hal hunāka ṣaydaliyya qarība min hunā? · 근처에 약국?", en: "hal hunāka ṣaydaliyya qarība min hunā? · Pharmacy nearby?", es: "hal hunāka ṣaydaliyya qarība min hunā? · ¿Farmacia cerca?", id: "hal hunāka ṣaydaliyya qarība min hunā? · Apotek dekat sini?" } },
      { type: "speak", sentence: "حَوالي خَمْس دَقائِق مَشْيًا.", speechLang: "ar-EG", meaning: { ko: "ḥawālī khams daqāʾiq mashyan · 걸어서 5분.", en: "ḥawālī khams daqāʾiq mashyan · Five minutes on foot.", es: "ḥawālī khams daqāʾiq mashyan · Cinco minutos a pie.", id: "ḥawālī khams daqāʾiq mashyan · Lima menit jalan kaki." } },
    ],
  },
  ...
  day_20: {
    ...
    arabic: [
      { type: "speak", sentence: "أَيْنَ المَحَطّة؟ بِجانِب المَتْحَف.", speechLang: "ar-EG", meaning: { ko: "ayna al-maḥaṭṭa? bijānib al-matḥaf · 지하철역? 박물관 근처.", en: "ayna al-maḥaṭṭa? bijānib al-matḥaf · Subway? Near the museum.", es: "ayna al-maḥaṭṭa? bijānib al-matḥaf · ¿Metro? Cerca del museo.", id: "ayna al-maḥaṭṭa? bijānib al-matḥaf · Stasiun? Dekat museum." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَلْ هِيَ ___؟", answer: "بَعيدة", options: ["بَعيدة", "قَريبة", "غالِية"], fullSentence: "هَلْ هِيَ بَعيدة؟", fullSentenceMeaning: { ko: "hal hiya baʿīda? · 얼마나 멀어요?", en: "hal hiya baʿīda? · How far?", es: "hal hiya baʿīda? · ¿A qué distancia?", id: "hal hiya baʿīda? · Berapa jauh?" }, isYesterdayReview: true },
      { type: "speak", sentence: "اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا.", speechLang: "ar-EG", meaning: { ko: "inʿaṭif yasāran wamshi mustaqīman · 왼쪽으로 돌아서 직진.", en: "inʿaṭif yasāran wamshi mustaqīman · Turn left, go straight.", es: "inʿaṭif yasāran wamshi mustaqīman · Izquierda y recto.", id: "inʿaṭif yasāran wamshi mustaqīman · Belok kiri, jalan lurus." } },
      { type: "fill_blank", promptWithBlank: "هِيَ عَلى ___ِكَ.", answer: "يَمين", options: ["يَمين", "فَوْق", "وَراء"], fullSentence: "هِيَ عَلى يَمينِكَ.", fullSentenceMeaning: { ko: "hiya ʿalā yamīnika · 오른쪽에 있어요.", en: "hiya ʿalā yamīnika · On the right.", es: "hiya ʿalā yamīnika · A la derecha.", id: "hiya ʿalā yamīnika · Di sebelah kanan." } },
      { type: "speak", sentence: "خُذْ أوّل شارِع عَلى اليَمين.", speechLang: "ar-EG", meaning: { ko: "khudh awwal shāriʿ ʿalā al-yamīn · 오른쪽 첫 번째 길.", en: "khudh awwal shāriʿ ʿalā al-yamīn · First street right.", es: "khudh awwal shāriʿ ʿalā al-yamīn · Primera calle derecha.", id: "khudh awwal shāriʿ ʿalā al-yamīn · Jalan pertama kanan." } },
    ],
  },
  ...
  day_21: {
    ...
    arabic: [
      { type: "speak", sentence: "اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا. هِيَ عَلى يَمينِكَ.", speechLang: "ar-EG", meaning: { ko: "inʿaṭif yasāran wamshi mustaqīman. hiya ʿalā yamīnika · 왼쪽, 직진, 오른쪽.", en: "inʿaṭif yasāran wamshi mustaqīman. hiya ʿalā yamīnika · Left, straight, right.", es: "inʿaṭif yasāran wamshi mustaqīman. hiya ʿalā yamīnika · Izquierda, recto, derecha.", id: "inʿaṭif yasāran wamshi mustaqīman. hiya ʿalā yamīnika · Kiri, lurus, kanan." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "اِنْعَطِفْ ___.", answer: "يَمينًا", options: ["يَمينًا", "فَوْقَ", "تَحْتَ"], fullSentence: "اِنْعَطِفْ يَمينًا.", fullSentenceMeaning: { ko: "inʿaṭif yamīnan · 오른쪽으로.", en: "inʿaṭif yamīnan · Turn right.", es: "inʿaṭif yamīnan · Gira a la derecha.", id: "inʿaṭif yamīnan · Belok kanan." }, isYesterdayReview: true },
      { type: "speak", sentence: "اِعْبُرِ الجِسْر وهِيَ بِجانِب البَقّالة.", speechLang: "ar-EG", meaning: { ko: "iʿburi al-jisr wahiya bijānib al-baqqāla · 다리 건너면 가게 옆.", en: "iʿburi al-jisr wahiya bijānib al-baqqāla · Cross bridge, next to store.", es: "iʿburi al-jisr wahiya bijānib al-baqqāla · Cruza, al lado de la tienda.", id: "iʿburi al-jisr wahiya bijānib al-baqqāla · Seberangi jembatan, di sebelah toko." } },
      { type: "fill_blank", promptWithBlank: "أَنْتَ تَجاوَزْتَها — ___.", answer: "اِرْجِعْ", options: ["اِرْجِعْ", "تابِعْ", "اُخْرُجْ"], fullSentence: "أَنْتَ تَجاوَزْتَها — اِرْجِعْ.", fullSentenceMeaning: { ko: "anta tajāwaztahā — irjiʿ · 지나쳤어요 — 돌아가세요.", en: "anta tajāwaztahā — irjiʿ · Passed it, go back.", es: "anta tajāwaztahā — irjiʿ · Lo pasaste, vuelve.", id: "anta tajāwaztahā — irjiʿ · Sudah melewatinya, kembali." } },
      { type: "speak", sentence: "اُخْرُجْ مِن مَخْرَج ثَلاثة فِي المِترو.", speechLang: "ar-EG", meaning: { ko: "ukhruj min makhraj thalātha fī al-mitro · 지하철 3번 출구로.", en: "ukhruj min makhraj thalātha fī al-mitro · Take exit 3.", es: "ukhruj min makhraj thalātha fī al-mitro · Salida 3 del metro.", id: "ukhruj min makhraj thalātha fī al-mitro · Pintu keluar 3." } },
      { type: "speak", sentence: "هَلْ تَتَكَلَّمُ الإِنْجِليزِيّة؟", speechLang: "ar-EG", meaning: { ko: "hal tatakallamu al-injilīziyya? · 영어 할 줄 아세요?", en: "hal tatakallamu al-injilīziyya? · Do you speak English?", es: "hal tatakallamu al-injilīziyya? · ¿Habla inglés?", id: "hal tatakallamu al-injilīziyya? · Apakah Anda bisa bahasa Inggris?" }, isYesterdayReview: true },
      { type: "speak", sentence: "النَّجْدة! ساعِدْني لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "al-najda! sāʿidnī law samaḥta · 도와주세요! 제발 도와주세요.", en: "al-najda! sāʿidnī law samaḥta · Help! Please help me.", es: "al-najda! sāʿidnī law samaḥta · ¡Ayuda! Por favor, ayúdeme.", id: "al-najda! sāʿidnī law samaḥta · Tolong! Tolong bantu saya." }, isYesterdayReview: true },
    ],
  },
  ...
  day_22: {
    ...
    arabic: [
      { type: "speak", sentence: "اِعْبُرِ الجِسْر. هِيَ بِجانِب البَقّالة.", speechLang: "ar-EG", meaning: { ko: "iʿburi al-jisr. hiya bijānib al-baqqāla · 다리 건너서 가게 옆.", en: "iʿburi al-jisr. hiya bijānib al-baqqāla · Cross bridge, next to store.", es: "iʿburi al-jisr. hiya bijānib al-baqqāla · Cruza, al lado de la tienda.", id: "iʿburi al-jisr. hiya bijānib al-baqqāla · Seberangi jembatan, di sebelah toko." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "عِنْدَ التَّقاطُع، اِنْعَطِفْ ___.", answer: "يَمينًا", options: ["يَمينًا", "فَوْقَ", "وَراءَ"], fullSentence: "عِنْدَ التَّقاطُع، اِنْعَطِفْ يَمينًا.", fullSentenceMeaning: { ko: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · 교차로에서 오른쪽.", en: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · Turn right at intersection.", es: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · En el cruce, derecha.", id: "ʿinda al-taqāṭuʿ, inʿaṭif yamīnan · Di persimpangan, kanan." }, isYesterdayReview: true },
      { type: "speak", sentence: "هَلْ يُمْكِنُني سَيّارة أُجْرة؟ إلى المَطار، لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · 택시? 공항으로.", en: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · Taxi? To the airport.", es: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · ¿Taxi? Al aeropuerto.", id: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · Taksi? Ke bandara." } },
      { type: "fill_blank", promptWithBlank: "___ إلى وَسَط المَدينة؟", answer: "بِكَمْ", options: ["بِكَمْ", "أَيْنَ", "مَتى"], fullSentence: "بِكَمْ إلى وَسَط المَدينة؟", fullSentenceMeaning: { ko: "bikam ilā wasaṭ al-madīna? · 시내까지 얼마?", en: "bikam ilā wasaṭ al-madīna? · How much to city?", es: "bikam ilā wasaṭ al-madīna? · ¿Cuánto al centro?", id: "bikam ilā wasaṭ al-madīna? · Berapa ke kota?" } },
      { type: "speak", sentence: "تَذْكَرة واحِدة إلى مَحَطّة سيول، لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · 서울역 표 한 장.", en: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · One ticket to Seoul Station.", es: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · Billete a Seúl.", id: "tadhkara wāḥida ilā maḥaṭṭat Seoul, law samaḥta · Satu tiket ke Stasiun Seoul." } },
    ],
  },
  ...
  day_23: {
    ...
    arabic: [
      { type: "speak", sentence: "هَلْ يُمْكِنُني سَيّارة أُجْرة؟ إلى المَطار، لَوْ سَمَحْتَ.", speechLang: "ar-EG", meaning: { ko: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · 택시? 공항.", en: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · Taxi? Airport.", es: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · ¿Taxi? Aeropuerto.", id: "hal yumkinunī sayyārat ujra? ilā al-maṭār, law samaḥta · Taksi? Bandara." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَلْ هٰذِهِ الحافِلة ___ إلى المَتْحَف؟", answer: "تَذْهَب", options: ["تَذْهَب", "تَأْتي", "تَقِف"], fullSentence: "هَلْ هٰذِهِ الحافِلة تَذْهَب إلى المَتْحَف؟", fullSentenceMeaning: { ko: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · 이 버스 박물관 가나요?", en: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · Does this bus go?", es: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · ¿Va al museo?", id: "hal hādhihi al-ḥāfila tadhhab ilā al-matḥaf? · Apakah bus ini ke museum?" }, isYesterdayReview: true },
      { type: "speak", sentence: "لَوْ سَمَحْتَ، أَنا تائِه. هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", speechLang: "ar-EG", meaning: { ko: "law samaḥta, anā tāʾih. hal yumkinu an turiyanī ʿalā al-kharīṭa? · 길 잃었어요. 지도 보여주세요.", en: "law samaḥta, anā tāʾih. hal yumkinu an turiyanī ʿalā al-kharīṭa? · Lost. Show me on the map?", es: "law samaḥta, anā tāʾih. hal yumkinu an turiyanī ʿalā al-kharīṭa? · Perdido. ¿El mapa?", id: "law samaḥta, anā tāʾih. hal yumkinu an turiyanī ʿalā al-kharīṭa? · Tersesat. Tunjukkan di peta?" } },
      { type: "fill_blank", promptWithBlank: "أَنا لا ___ هٰذِهِ المَنْطِقة.", answer: "أَعْرِفُ", options: ["أَعْرِفُ", "أُريدُ", "أَسْتَطيعُ"], fullSentence: "أَنا لا أَعْرِفُ هٰذِهِ المَنْطِقة.", fullSentenceMeaning: { ko: "anā lā aʿrifu hādhihi al-manṭiqa · 이 동네 몰라요.", en: "anā lā aʿrifu hādhihi al-manṭiqa · Don't know this area.", es: "anā lā aʿrifu hādhihi al-manṭiqa · No conozco esta zona.", id: "anā lā aʿrifu hādhihi al-manṭiqa · Tidak tahu daerah ini." } },
      { type: "speak", sentence: "هَلْ هٰذا الطَّريق الصَّحيح إلى المَتْحَف؟", speechLang: "ar-EG", meaning: { ko: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · 박물관 길 맞나요?", en: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · Right way?", es: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · ¿Voy bien?", id: "hal hādhā al-ṭarīq al-ṣaḥīḥ ilā al-matḥaf? · Jalan yang benar?" } },
    ],
  },
  ...
  day_24: {
    ...
    arabic: [
      { type: "speak", sentence: "لَوْ سَمَحْتَ، أَنا تائِه. المَحَطّة مِن أَيِّ ناحِية؟", speechLang: "ar-EG", meaning: { ko: "law samaḥta, anā tāʾih. al-maḥaṭṭa min ayyi nāḥiya? · 길 잃었어요. 역 어디?", en: "law samaḥta, anā tāʾih. al-maḥaṭṭa min ayyi nāḥiya? · Lost. Which way station?", es: "law samaḥta, anā tāʾih. al-maḥaṭṭa min ayyi nāḥiya? · Perdido. ¿La estación?", id: "law samaḥta, anā tāʾih. al-maḥaṭṭa min ayyi nāḥiya? · Tersesat. Ke arah mana stasiun?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَلْ يُمْكِنُ أَنْ ___ عَلى الخَريطة؟", answer: "تُريَني", options: ["تُريَني", "تُخْبِرَني", "تُعْطيَني"], fullSentence: "هَلْ يُمْكِنُ أَنْ تُريَني عَلى الخَريطة؟", fullSentenceMeaning: { ko: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · 지도에서 보여주세요.", en: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · Show on map?", es: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · ¿Señalar?", id: "hal yumkinu an turiyanī ʿalā al-kharīṭa? · Tunjukkan di peta?" }, isYesterdayReview: true },
      { type: "speak", sentence: "أَيْنَ المِترو؟ اِنْعَطِفْ يَسارًا وامْشِ مُسْتَقيمًا.", speechLang: "ar-EG", meaning: { ko: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · 지하철? 왼쪽 직진.", en: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · Subway? Left, straight.", es: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · ¿Metro? Izquierda, recto.", id: "ayna al-mitro? inʿaṭif yasāran wamshi mustaqīman · Stasiun? Kiri, lurus." } },
      { type: "speak", sentence: "تَذْكَرة إلى المَطار. بِكَمْ؟", speechLang: "ar-EG", meaning: { ko: "tadhkara ilā al-maṭār. bikam? · 공항 표. 얼마?", en: "tadhkara ilā al-maṭār. bikam? · Airport ticket. How much?", es: "tadhkara ilā al-maṭār. bikam? · Billete. ¿Cuánto?", id: "tadhkara ilā al-maṭār. bikam? · Tiket bandara. Berapa?" } },
      { type: "speak", sentence: "اِعْبُرِ الجِسْر وهِيَ عَلى يَمينِكَ. شُكْرًا!", speechLang: "ar-EG", meaning: { ko: "iʿburi al-jisr wahiya ʿalā yamīnika. shukran! · 다리 건너면 오른쪽. 감사!", en: "iʿburi al-jisr wahiya ʿalā yamīnika. shukran! · Cross bridge, right. Thanks!", es: "iʿburi al-jisr wahiya ʿalā yamīnika. shukran! · Cruza, derecha. ¡Gracias!", id: "iʿburi al-jisr wahiya ʿalā yamīnika. shukran! · Seberangi jembatan, kanan. Terima kasih!" } },
    ],
  },
};
