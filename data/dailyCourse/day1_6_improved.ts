...
export const LESSON_CONTENT_IMPROVED: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_1: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَهْلًا، أَنَا اسْمِي رودي.", speechLang: "ar-EG", meaning: { ko: "ahlan, anā ismī Rudy · 안녕하세요, 제 이름은 루디예요.", en: "ahlan, anā ismī Rudy · Hello, my name is Rudy.", es: "ahlan, anā ismī Rudy · Hola, me llamo Rudy.", id: "ahlan, anā ismī Rudy · Halo, nama saya Rudy." } },
        { text: "فُرْصة سَعيدة.", speechLang: "ar-EG", meaning: { ko: "furṣa saʿīda · 만나서 반갑습니다.", en: "furṣa saʿīda · Nice to meet you.", es: "furṣa saʿīda · Mucho gusto.", id: "furṣa saʿīda · Senang bertemu dengan Anda." } },
        { text: "مِنْ أَيْنَ أَنْتَ؟", speechLang: "ar-EG", meaning: { ko: "min ayna anta? · 어디에서 오셨어요?", en: "min ayna anta? · Where are you from?", es: "min ayna anta? · ¿De dónde eres?", id: "min ayna anta? · Anda berasal dari mana?" } },
        { text: "شُكْرًا.", speechLang: "ar-EG", meaning: { ko: "shukran · 감사합니다.", en: "shukran · Thank you.", es: "shukran · Gracias.", id: "shukran · Terima kasih." }, recallRound: false },
        { text: "آسِف، أَنَا لا أَفْهَم.", speechLang: "ar-EG", meaning: { ko: "āsif, anā lā afham · 미안해요, 이해를 못 했어요.", en: "āsif, anā lā afham · Sorry, I don't understand.", es: "āsif, anā lā afham · Lo siento, no entiendo.", id: "āsif, anā lā afham · Maaf, saya tidak mengerti." }, recallRound: false },
        { text: "النَّجْدة! ساعِدْني مِنْ فَضْلِك.", speechLang: "ar-EG", meaning: { ko: "an-najda! sāʿidnī min faḍlik · 도와주세요! 도움이 필요해요.", en: "an-najda! sāʿidnī min faḍlik · Help! Please help me.", es: "an-najda! sāʿidnī min faḍlik · ¡Ayuda! Por favor, ayúdame.", id: "an-najda! sāʿidnī min faḍlik · Tolong! Tolong bantu saya." } },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
  ...
  day_2: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَنَا مِنْ كوريا.", speechLang: "ar-EG", meaning: { ko: "anā min Kūriyā · 저는 한국에서 왔어요.", en: "anā min Kūriyā · I'm from Korea.", es: "anā min Kūriyā · Soy de Corea.", id: "anā min Kūriyā · Saya berasal dari Korea." } },
        { text: "أَنَا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "anā sākin fī Siyūl · 서울에 살고 있어요.", en: "anā sākin fī Siyūl · I live in Seoul.", es: "anā sākin fī Siyūl · Vivo en Seúl.", id: "anā sākin fī Siyūl · Saya tinggal di Seoul." } },
        { text: "كَيْفَ مَدينَتُك؟", speechLang: "ar-EG", meaning: { ko: "kayfa madīnatuk? · 당신의 도시는 어때요?", en: "kayfa madīnatuk? · What's your city like?", es: "kayfa madīnatuk? · ¿Cómo es tu ciudad?", id: "kayfa madīnatuk? · Bagaimana kota Anda?" } },
        { text: "نَعَم، أَنَا فاهِم. شُكْرًا!", speechLang: "ar-EG", meaning: { ko: "naʿam, anā fāhim. shukran! · 네, 이해했어요. 감사합니다!", en: "naʿam, anā fāhim. shukran! · Yes, I understand. Thank you!", es: "naʿam, anā fāhim. shukran! · Sí, entiendo. ¡Gracias!", id: "naʿam, anā fāhim. shukran! · Ya, saya mengerti. Terima kasih!" } },
        { text: "مُمْكِن تَقول مَرّة ثانِية؟", speechLang: "ar-EG", meaning: { ko: "mumkin taqūl marra thāniya? · 다시 한번 말해 주시겠어요?", en: "mumkin taqūl marra thāniya? · Can you say that again, please?", es: "mumkin taqūl marra thāniya? · ¿Puede repetir eso, por favor?", id: "mumkin taqūl marra thāniya? · Bisa tolong ulangi?" }, recallRound: false },
        { text: "مُمْكِن تَتَكَلَّم بِبُطْء؟", speechLang: "ar-EG", meaning: { ko: "mumkin tatakallam bi-buṭʾ? · 더 천천히 말해 주세요?", en: "mumkin tatakallam bi-buṭʾ? · Can you speak more slowly, please?", es: "mumkin tatakallam bi-buṭʾ? · ¿Puede hablar más despacio?", id: "mumkin tatakallam bi-buṭʾ? · Bisa bicara lebih pelan?" }, recallRound: false },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
  ...
  day_3: {
    ...
    arabic: {
      step1Sentences: [
        { text: "ماذا تَعْمَل؟", speechLang: "ar-EG", meaning: { ko: "mādhā taʿmal? · 무슨 일 하세요?", en: "mādhā taʿmal? · What do you do?", es: "mādhā taʿmal? · ¿A qué te dedicas?", id: "mādhā taʿmal? · Apa pekerjaan Anda?" } },
        { text: "أَنَا طالِب.", speechLang: "ar-EG", meaning: { ko: "anā ṭālib · 저는 학생이에요.", en: "anā ṭālib · I'm a student.", es: "anā ṭālib · Soy estudiante.", id: "anā ṭālib · Saya seorang pelajar." } },
        { text: "أَنَا أَعْمَل في شَرِكة.", speechLang: "ar-EG", meaning: { ko: "anā aʿmal fī sharika · 저는 회사에 다녀요.", en: "anā aʿmal fī sharika · I work at a company.", es: "anā aʿmal fī sharika · Trabajo en una empresa.", id: "anā aʿmal fī sharika · Saya bekerja di sebuah perusahaan." } },
        { text: "هَلْ تَتَكَلَّم الإنْجِليزِيّة؟", speechLang: "ar-EG", meaning: { ko: "hal tatakallam al-injilīziyya? · 영어 할 줄 아세요?", en: "hal tatakallam al-injilīziyya? · Do you speak English?", es: "hal tatakallam al-injilīziyya? · ¿Hablas inglés?", id: "hal tatakallam al-injilīziyya? · Apakah kamu bisa bahasa Inggris?" }, recallRound: false },
        { text: "قَليلًا.", speechLang: "ar-EG", meaning: { ko: "qalīlan · 조금이요.", en: "qalīlan · A little bit.", es: "qalīlan · Un poquito.", id: "qalīlan · Sedikit saja." }, recallRound: false },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
  ...
  day_4: {
    ...
    arabic: {
      step1Sentences: [
        { text: "مَعَ السَّلامة! أَراك لاحِقًا.", speechLang: "ar-EG", meaning: { ko: "maʿa s-salāma! arāka lāḥiqan · 안녕히 가세요! 다음에 봐요.", en: "maʿa s-salāma! arāka lāḥiqan · Goodbye! See you later.", es: "maʿa s-salāma! arāka lāḥiqan · ¡Adiós! Hasta luego.", id: "maʿa s-salāma! arāka lāḥiqan · Selamat tinggal! Sampai jumpa nanti." } },
        { text: "اِعْتَنِ بِنَفْسِك!", speechLang: "ar-EG", meaning: { ko: "iʿtani bi-nafsik! · 잘 가요!", en: "iʿtani bi-nafsik! · Take care!", es: "iʿtani bi-nafsik! · ¡Cuídate!", id: "iʿtani bi-nafsik! · Hati-hati!" } },
        { text: "تَشَرَّفْت بِمَعْرِفَتِك.", speechLang: "ar-EG", meaning: { ko: "tasharraft bi-maʿrifatik · 만나서 반가웠어요.", en: "tasharraft bi-maʿrifatik · It was nice meeting you.", es: "tasharraft bi-maʿrifatik · Fue un placer conocerte.", id: "tasharraft bi-maʿrifatik · Senang bertemu dengan Anda tadi." } },
        { text: "أَيْنَ الحَمّام؟", speechLang: "ar-EG", meaning: { ko: "ayna l-ḥammām? · 화장실이 어디예요?", en: "ayna l-ḥammām? · Where is the bathroom?", es: "ayna l-ḥammām? · ¿Dónde está el baño?", id: "ayna l-ḥammām? · Di mana toilet?" }, recallRound: true },
        { text: "لَو سَمَحْت، أَيْنَ المَخْرَج؟", speechLang: "ar-EG", meaning: { ko: "law samaḥt, ayna l-makhraj? · 실례합니다, 출구가 어디예요?", en: "law samaḥt, ayna l-makhraj? · Excuse me, where is the exit?", es: "law samaḥt, ayna l-makhraj? · Disculpe, ¿dónde está la salida?", id: "law samaḥt, ayna l-makhraj? · Permisi, di mana pintu keluar?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
  ...
  day_5: {
    ...
    arabic: {
      step1Sentences: [
        { text: "كَيْفَ حالُك اليَوْم؟", speechLang: "ar-EG", meaning: { ko: "kayfa ḥāluk al-yawm? · 오늘 어떻게 지내요?", en: "kayfa ḥāluk al-yawm? · How are you today?", es: "kayfa ḥāluk al-yawm? · ¿Cómo estás hoy?", id: "kayfa ḥāluk al-yawm? · Apa kabar hari ini?" } },
        { text: "أَنَا بِخَيْر، شُكْرًا.", speechLang: "ar-EG", meaning: { ko: "anā bi-khayr, shukran · 잘 지내요, 감사합니다.", en: "anā bi-khayr, shukran · I'm fine, thank you.", es: "anā bi-khayr, shukran · Estoy bien, gracias.", id: "anā bi-khayr, shukran · Saya baik-baik saja, terima kasih." } },
        { text: "لا بَأْس، وَأَنْتَ؟", speechLang: "ar-EG", meaning: { ko: "lā baʾs, wa-anta? · 괜찮아요, 당신은요?", en: "lā baʾs, wa-anta? · Not bad, how about you?", es: "lā baʾs, wa-anta? · No está mal, ¿y tú?", id: "lā baʾs, wa-anta? · Lumayan, bagaimana dengan Anda?" } },
        { text: "بِكَمْ هٰذَا؟", speechLang: "ar-EG", meaning: { ko: "bikam hādhā? · 이거 얼마예요?", en: "bikam hādhā? · How much is this?", es: "bikam hādhā? · ¿Cuánto cuesta esto?", id: "bikam hādhā? · Ini berapa harganya?" }, recallRound: true },
        { text: "النَّجْدة! أَحْتاج مُساعَدة، لَو سَمَحْت.", speechLang: "ar-EG", meaning: { ko: "an-najda! aḥtāj musāʿada, law samaḥt · 도와주세요! 도움이 필요해요.", en: "an-najda! aḥtāj musāʿada, law samaḥt · Help! I need help, please.", es: "an-najda! aḥtāj musāʿada, law samaḥt · ¡Ayuda! Necesito ayuda, por favor.", id: "an-najda! aḥtāj musāʿada, law samaḥt · Tolong! Saya butuh bantuan." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
  ...
  day_6: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَهْلًا، أَنَا اسْمِي رودي. فُرْصة سَعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, anā ismī Rudy. furṣa saʿīda · 안녕하세요, 제 이름은 루디예요. 만나서 반갑습니다.", en: "ahlan, anā ismī Rudy. furṣa saʿīda · Hello, my name is Rudy. Nice to meet you.", es: "ahlan, anā ismī Rudy. furṣa saʿīda · Hola, me llamo Rudy. Mucho gusto.", id: "ahlan, anā ismī Rudy. furṣa saʿīda · Halo, nama saya Rudy. Senang bertemu dengan Anda." } },
        { text: "أَنَا مِنْ لَنْدَن. أَنَا أَعْمَل مُحَقِّقًا.", speechLang: "ar-EG", meaning: { ko: "anā min Landan. anā aʿmal muḥaqqiqan · 저는 런던에서 왔어요. 탐정으로 일해요.", en: "anā min Landan. anā aʿmal muḥaqqiqan · I'm from London. I work as a detective.", es: "anā min Landan. anā aʿmal muḥaqqiqan · Soy de Londres. Trabajo como detective.", id: "anā min Landan. anā aʿmal muḥaqqiqan · Saya berasal dari London. Saya bekerja sebagai detektif." } },
        { text: "كَيْفَ حالُك؟ أَنَا بِخَيْر، شُكْرًا! أَراك لاحِقًا!", speechLang: "ar-EG", meaning: { ko: "kayfa ḥāluk? anā bi-khayr, shukran! arāka lāḥiqan! · 어떻게 지내세요? 잘 지내요, 감사합니다! 다음에 봐요!", en: "kayfa ḥāluk? anā bi-khayr, shukran! arāka lāḥiqan! · How are you? I'm great, thanks! See you later!", es: "kayfa ḥāluk? anā bi-khayr, shukran! arāka lāḥiqan! · ¿Cómo estás? ¡Estoy genial, gracias! ¡Hasta luego!", id: "kayfa ḥāluk? anā bi-khayr, shukran! arāka lāḥiqan! · Apa kabar? Saya baik-baik saja, terima kasih! Sampai jumpa nanti!" } },
        { text: "آسِف، أَنَا لا أَفْهَم. مُمْكِن تَقول مَرّة ثانِية؟", speechLang: "ar-EG", meaning: { ko: "āsif, anā lā afham. mumkin taqūl marra thāniya? · 미안해요, 이해를 못 했어요. 다시 한번 말해 주시겠어요?", en: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Sorry, I don't understand. Can you say that again?", es: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Lo siento, no entiendo. ¿Puede repetir eso?", id: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Maaf, saya tidak mengerti. Bisa tolong ulangi?" }, recallRound: true },
        { text: "لَو سَمَحْت، أَيْنَ الحَمّام؟ بِكَمْ هٰذَا؟", speechLang: "ar-EG", meaning: { ko: "law samaḥt, ayna l-ḥammām? bikam hādhā? · 실례합니다, 화장실이 어디예요? 이거 얼마예요?", en: "law samaḥt, ayna l-ḥammām? bikam hādhā? · Excuse me, where is the bathroom? How much is this?", es: "law samaḥt, ayna l-ḥammām? bikam hādhā? · Disculpe, ¿dónde está el baño? ¿Cuánto cuesta esto?", id: "law samaḥt, ayna l-ḥammām? bikam hādhā? · Permisi, di mana toilet? Ini berapa harganya?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
...
export const REVIEW_CONTENT_IMPROVED: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_1: {
    ...
    arabic: [
      { type: "speak", sentence: "أَهْلًا، فُرْصة سَعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, furṣa saʿīda · 안녕하세요, 만나서 반갑습니다.", en: "ahlan, furṣa saʿīda · Hello, nice to meet you.", es: "ahlan, furṣa saʿīda · Hola, mucho gusto.", id: "ahlan, furṣa saʿīda · Halo, senang bertemu." } },
      { type: "fill_blank", promptWithBlank: "أَنَا ___ رودي.", answer: "اسْمِي", options: ["اسْمِي", "أَنَا", "أَنْتَ"], fullSentence: "أَنَا اسْمِي رودي.", fullSentenceMeaning: { ko: "anā ismī Rudy · 제 이름은 루디예요.", en: "anā ismī Rudy · My name is Rudy.", es: "anā ismī Rudy · Me llamo Rudy.", id: "anā ismī Rudy · Nama saya Rudy." } },
      { type: "speak", sentence: "آسِف، أَنَا لا أَفْهَم.", speechLang: "ar-EG", meaning: { ko: "āsif, anā lā afham · 미안해요, 이해를 못 했어요.", en: "āsif, anā lā afham · Sorry, I don't understand.", es: "āsif, anā lā afham · Lo siento, no entiendo.", id: "āsif, anā lā afham · Maaf, saya tidak mengerti." } },
      { type: "fill_blank", promptWithBlank: "أَنْتَ ___؟", answer: "مِنْ أَيْنَ", options: ["مِنْ أَيْنَ", "ماذا", "مَنْ"], fullSentence: "مِنْ أَيْنَ أَنْتَ؟", fullSentenceMeaning: { ko: "min ayna anta? · 어디에서 오셨어요?", en: "min ayna anta? · Where are you from?", es: "min ayna anta? · ¿De dónde eres?", id: "min ayna anta? · Anda berasal dari mana?" } },
      { type: "speak", sentence: "شُكْرًا. فُرْصة سَعيدة.", speechLang: "ar-EG", meaning: { ko: "shukran. furṣa saʿīda · 감사합니다. 만나서 반갑습니다.", en: "shukran. furṣa saʿīda · Thank you. Nice to meet you.", es: "shukran. furṣa saʿīda · Gracias. Mucho gusto.", id: "shukran. furṣa saʿīda · Terima kasih. Senang bertemu." } },
    ],
  },
  ...
  day_2: {
    ...
    arabic: [
      { type: "speak", sentence: "أَهْلًا، أَنَا اسْمِي رودي.", speechLang: "ar-EG", meaning: { ko: "ahlan, anā ismī Rudy · 안녕하세요, 제 이름은 루디예요.", en: "ahlan, anā ismī Rudy · Hello, my name is Rudy.", es: "ahlan, anā ismī Rudy · Hola, me llamo Rudy.", id: "ahlan, anā ismī Rudy · Halo, nama saya Rudy." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "آسِف، أَنَا ___ أَفْهَم.", answer: "لا", options: ["لا", "لَيْسَ", "ما"], fullSentence: "آسِف، أَنَا لا أَفْهَم.", fullSentenceMeaning: { ko: "āsif, anā lā afham · 미안해요, 이해를 못 했어요.", en: "āsif, anā lā afham · Sorry, I don't understand.", es: "āsif, anā lā afham · Lo siento, no entiendo.", id: "āsif, anā lā afham · Maaf, saya tidak mengerti." }, isYesterdayReview: true },
      { type: "speak", sentence: "أَنَا مِنْ كوريا. أَنَا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "anā min Kūriyā. anā sākin fī Siyūl · 저는 한국에서 왔어요. 서울에 살아요.", en: "anā min Kūriyā. anā sākin fī Siyūl · I'm from Korea. I live in Seoul.", es: "anā min Kūriyā. anā sākin fī Siyūl · Soy de Corea. Vivo en Seúl.", id: "anā min Kūriyā. anā sākin fī Siyūl · Saya berasal dari Korea. Saya tinggal di Seoul." } },
      { type: "fill_blank", promptWithBlank: "مُمْكِن تَقول ___؟", answer: "مَرّة ثانِية", options: ["مَرّة ثانِية", "بِبُطْء", "كَثيرًا"], fullSentence: "مُمْكِن تَقول مَرّة ثانِية؟", fullSentenceMeaning: { ko: "mumkin taqūl marra thāniya? · 다시 한번 말해 주시겠어요?", en: "mumkin taqūl marra thāniya? · Can you say that again, please?", es: "mumkin taqūl marra thāniya? · ¿Puede repetir eso, por favor?", id: "mumkin taqūl marra thāniya? · Bisa tolong ulangi?" } },
      { type: "speak", sentence: "مُمْكِن تَقول مَرّة ثانِية؟", speechLang: "ar-EG", meaning: { ko: "mumkin taqūl marra thāniya? · 다시 한번 말해 주시겠어요?", en: "mumkin taqūl marra thāniya? · Can you say that again, please?", es: "mumkin taqūl marra thāniya? · ¿Puede repetir eso, por favor?", id: "mumkin taqūl marra thāniya? · Bisa tolong ulangi?" } },
    ],
  },
  ...
  day_3: {
    ...
    arabic: [
      { type: "speak", sentence: "أَنَا مِنْ كوريا. أَنَا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "anā min Kūriyā. anā sākin fī Siyūl · 저는 한국에서 왔어요. 서울에 살아요.", en: "anā min Kūriyā. anā sākin fī Siyūl · I'm from Korea. I live in Seoul.", es: "anā min Kūriyā. anā sākin fī Siyūl · Soy de Corea. Vivo en Seúl.", id: "anā min Kūriyā. anā sākin fī Siyūl · Saya berasal dari Korea. Saya tinggal di Seoul." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "مُمْكِن تَقول ___؟", answer: "مَرّة ثانِية", options: ["مَرّة ثانِية", "بِبُطْء", "كَثيرًا"], fullSentence: "مُمْكِن تَقول مَرّة ثانِية؟", fullSentenceMeaning: { ko: "mumkin taqūl marra thāniya? · 다시 한번 말해 주시겠어요?", en: "mumkin taqūl marra thāniya? · Can you say that again?", es: "mumkin taqūl marra thāniya? · ¿Puede repetir eso?", id: "mumkin taqūl marra thāniya? · Bisa tolong ulangi?" }, isYesterdayReview: true },
      { type: "speak", sentence: "أَنَا طالِب. أَنَا أَعْمَل في مَدْرَسة.", speechLang: "ar-EG", meaning: { ko: "anā ṭālib. anā aʿmal fī madrasa · 저는 학생이에요. 학교에서 일해요.", en: "anā ṭālib. anā aʿmal fī madrasa · I'm a student. I work at a school.", es: "anā ṭālib. anā aʿmal fī madrasa · Soy estudiante. Trabajo en una escuela.", id: "anā ṭālib. anā aʿmal fī madrasa · Saya seorang pelajar. Saya bekerja di sekolah." } },
      { type: "fill_blank", promptWithBlank: "هَلْ تَتَكَلَّم ___؟", answer: "الإنْجِليزِيّة", options: ["الإنْجِليزِيّة", "شَرِكة", "طالِب"], fullSentence: "هَلْ تَتَكَلَّم الإنْجِليزِيّة؟", fullSentenceMeaning: { ko: "hal tatakallam al-injilīziyya? · 영어 할 줄 아세요?", en: "hal tatakallam al-injilīziyya? · Do you speak English?", es: "hal tatakallam al-injilīziyya? · ¿Hablas inglés?", id: "hal tatakallam al-injilīziyya? · Apakah kamu bisa bahasa Inggris?" } },
      { type: "speak", sentence: "هَلْ تَتَكَلَّم الإنْجِليزِيّة؟ قَليلًا.", speechLang: "ar-EG", meaning: { ko: "hal tatakallam al-injilīziyya? qalīlan · 영어 할 줄 아세요? 조금이요.", en: "hal tatakallam al-injilīziyya? qalīlan · Do you speak English? A little bit.", es: "hal tatakallam al-injilīziyya? qalīlan · ¿Hablas inglés? Un poquito.", id: "hal tatakallam al-injilīziyya? qalīlan · Apakah kamu bisa bahasa Inggris? Sedikit saja." } },
    ],
  },
  ...
  day_4: {
    ...
    arabic: [
      { type: "speak", sentence: "أَنَا طالِب. هَلْ تَتَكَلَّم الإنْجِليزِيّة؟", speechLang: "ar-EG", meaning: { ko: "anā ṭālib. hal tatakallam al-injilīziyya? · 저는 학생이에요. 영어 할 줄 아세요?", en: "anā ṭālib. hal tatakallam al-injilīziyya? · I'm a student. Do you speak English?", es: "anā ṭālib. hal tatakallam al-injilīziyya? · Soy estudiante. ¿Hablas inglés?", id: "anā ṭālib. hal tatakallam al-injilīziyya? · Saya seorang pelajar. Apakah kamu bisa bahasa Inggris?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "___ تَعْمَل؟", answer: "ماذا", options: ["ماذا", "مَنْ", "أَيْنَ"], fullSentence: "ماذا تَعْمَل؟", fullSentenceMeaning: { ko: "mādhā taʿmal? · 무슨 일 하세요?", en: "mādhā taʿmal? · What do you do?", es: "mādhā taʿmal? · ¿A qué te dedicas?", id: "mādhā taʿmal? · Apa pekerjaan Anda?" }, isYesterdayReview: true },
      { type: "speak", sentence: "مَعَ السَّلامة! أَراك لاحِقًا! اِعْتَنِ بِنَفْسِك!", speechLang: "ar-EG", meaning: { ko: "maʿa s-salāma! arāka lāḥiqan! iʿtani bi-nafsik! · 안녕히 가세요! 다음에 봐요! 잘 가요!", en: "maʿa s-salāma! arāka lāḥiqan! iʿtani bi-nafsik! · Goodbye! See you later! Take care!", es: "maʿa s-salāma! arāka lāḥiqan! iʿtani bi-nafsik! · ¡Adiós! ¡Hasta luego! ¡Cuídate!", id: "maʿa s-salāma! arāka lāḥiqan! iʿtani bi-nafsik! · Selamat tinggal! Sampai jumpa nanti! Hati-hati!" } },
      { type: "fill_blank", promptWithBlank: "___ الحَمّام؟", answer: "أَيْنَ", options: ["أَيْنَ", "ماذا", "مَتى"], fullSentence: "أَيْنَ الحَمّام؟", fullSentenceMeaning: { ko: "ayna l-ḥammām? · 화장실이 어디예요?", en: "ayna l-ḥammām? · Where is the bathroom?", es: "ayna l-ḥammām? · ¿Dónde está el baño?", id: "ayna l-ḥammām? · Di mana toilet?" } },
      { type: "speak", sentence: "لَو سَمَحْت، أَيْنَ المَخْرَج؟", speechLang: "ar-EG", meaning: { ko: "law samaḥt, ayna l-makhraj? · 실례합니다, 출구가 어디예요?", en: "law samaḥt, ayna l-makhraj? · Excuse me, where is the exit?", es: "law samaḥt, ayna l-makhraj? · Disculpe, ¿dónde está la salida?", id: "law samaḥt, ayna l-makhraj? · Permisi, di mana pintu keluar?" } },
    ],
  },
  ...
  day_5: {
    ...
    arabic: [
      { type: "speak", sentence: "مَعَ السَّلامة! اِعْتَنِ بِنَفْسِك! أَيْنَ المَخْرَج؟", speechLang: "ar-EG", meaning: { ko: "maʿa s-salāma! iʿtani bi-nafsik! ayna l-makhraj? · 안녕히 가세요! 잘 가요! 출구가 어디예요?", en: "maʿa s-salāma! iʿtani bi-nafsik! ayna l-makhraj? · Goodbye! Take care! Where is the exit?", es: "maʿa s-salāma! iʿtani bi-nafsik! ayna l-makhraj? · ¡Adiós! ¡Cuídate! ¿Dónde está la salida?", id: "maʿa s-salāma! iʿtani bi-nafsik! ayna l-makhraj? · Selamat tinggal! Hati-hati! Di mana pintu keluar?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "مَعَ ___! أَراك لاحِقًا.", answer: "السَّلامة", options: ["السَّلامة", "الخَيْر", "النَّجْدة"], fullSentence: "مَعَ السَّلامة! أَراك لاحِقًا.", fullSentenceMeaning: { ko: "maʿa s-salāma! arāka lāḥiqan · 안녕히 가세요! 다음에 봐요!", en: "maʿa s-salāma! arāka lāḥiqan · Goodbye! See you later!", es: "maʿa s-salāma! arāka lāḥiqan · ¡Adiós! ¡Hasta luego!", id: "maʿa s-salāma! arāka lāḥiqan · Selamat tinggal! Sampai jumpa nanti!" }, isYesterdayReview: true },
      { type: "speak", sentence: "أَنَا بِخَيْر، شُكْرًا. وَأَنْتَ؟", speechLang: "ar-EG", meaning: { ko: "anā bi-khayr, shukran. wa-anta? · 잘 지내요, 감사합니다. 당신은요?", en: "anā bi-khayr, shukran. wa-anta? · I'm fine, thank you. And you?", es: "anā bi-khayr, shukran. wa-anta? · Estoy bien, gracias. ¿Y tú?", id: "anā bi-khayr, shukran. wa-anta? · Saya baik-baik saja, terima kasih. Bagaimana dengan Anda?" } },
      { type: "fill_blank", promptWithBlank: "___ هٰذَا؟", answer: "بِكَمْ", options: ["بِكَمْ", "أَيْنَ", "كَيْفَ حالُك"], fullSentence: "بِكَمْ هٰذَا؟", fullSentenceMeaning: { ko: "bikam hādhā? · 이거 얼마예요?", en: "bikam hādhā? · How much is this?", es: "bikam hādhā? · ¿Cuánto cuesta esto?", id: "bikam hādhā? · Ini berapa harganya?" } },
      { type: "speak", sentence: "النَّجْدة! أَحْتاج مُساعَدة، لَو سَمَحْت.", speechLang: "ar-EG", meaning: { ko: "an-najda! aḥtāj musāʿada, law samaḥt · 도와주세요! 도움이 필요해요.", en: "an-najda! aḥtāj musāʿada, law samaḥt · Help! I need help, please.", es: "an-najda! aḥtāj musāʿada, law samaḥt · ¡Ayuda! Necesito ayuda, por favor.", id: "an-najda! aḥtāj musāʿada, law samaḥt · Tolong! Saya butuh bantuan." } },
    ],
  },
  ...
  day_6: {
    ...
    arabic: [
      { type: "speak", sentence: "أَهْلًا، أَنَا اسْمِي رودي. فُرْصة سَعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, anā ismī Rudy. furṣa saʿīda · 안녕하세요, 제 이름은 루디예요. 반갑습니다.", en: "ahlan, anā ismī Rudy. furṣa saʿīda · Hello, my name is Rudy. Nice to meet you.", es: "ahlan, anā ismī Rudy. furṣa saʿīda · Hola, me llamo Rudy. Mucho gusto.", id: "ahlan, anā ismī Rudy. furṣa saʿīda · Halo, nama saya Rudy. Senang bertemu dengan Anda." } },
      { type: "speak", sentence: "أَنَا مِنْ كوريا. أَنَا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "anā min Kūriyā. anā sākin fī Siyūl · 한국에서 왔어요. 서울에 살아요.", en: "anā min Kūriyā. anā sākin fī Siyūl · I'm from Korea. I live in Seoul.", es: "anā min Kūriyā. anā sākin fī Siyūl · Soy de Corea. Vivo en Seúl.", id: "anā min Kūriyā. anā sākin fī Siyūl · Saya berasal dari Korea. Saya tinggal di Seoul." } },
      { type: "speak", sentence: "آسِف، أَنَا لا أَفْهَم. مُمْكِن تَقول مَرّة ثانِية؟", speechLang: "ar-EG", meaning: { ko: "āsif, anā lā afham. mumkin taqūl marra thāniya? · 미안해요, 이해를 못 했어요. 다시 한번 말해 주시겠어요?", en: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Sorry, I don't understand. Can you say that again?", es: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Lo siento, no entiendo. ¿Puede repetir eso?", id: "āsif, anā lā afham. mumkin taqūl marra thāniya? · Maaf, saya tidak mengerti. Bisa tolong ulangi?" } },
      { type: "speak", sentence: "أَيْنَ الحَمّام؟ بِكَمْ هٰذَا؟", speechLang: "ar-EG", meaning: { ko: "ayna l-ḥammām? bikam hādhā? · 화장실이 어디예요? 이거 얼마예요?", en: "ayna l-ḥammām? bikam hādhā? · Where is the bathroom? How much is this?", es: "ayna l-ḥammām? bikam hādhā? · ¿Dónde está el baño? ¿Cuánto cuesta esto?", id: "ayna l-ḥammām? bikam hādhā? · Di mana toilet? Ini berapa harganya?" } },
      { type: "speak", sentence: "مَعَ السَّلامة! اِعْتَنِ بِنَفْسِك! أَراك غَدًا!", speechLang: "ar-EG", meaning: { ko: "maʿa s-salāma! iʿtani bi-nafsik! arāka ghadan! · 안녕히 가세요! 잘 가요! 내일 봐요!", en: "maʿa s-salāma! iʿtani bi-nafsik! arāka ghadan! · Goodbye! Take care! See you tomorrow!", es: "maʿa s-salāma! iʿtani bi-nafsik! arāka ghadan! · ¡Adiós! ¡Cuídate! ¡Hasta mañana!", id: "maʿa s-salāma! iʿtani bi-nafsik! arāka ghadan! · Selamat tinggal! Hati-hati! Sampai jumpa besok!" } },
    ],
  },
};
