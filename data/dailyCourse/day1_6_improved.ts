...
export const LESSON_CONTENT_IMPROVED: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_1: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أهلاً، أنا اسمي رودي.", speechLang: "ar-EG", meaning: { ko: "ahlan, ana esmi Rudy · 안녕하세요, 제 이름은 루디예요.", en: "ahlan, ana esmi Rudy · Hello, my name is Rudy.", es: "ahlan, ana esmi Rudy · Hola, me llamo Rudy.", id: "ahlan, ana esmi Rudy · Halo, nama saya Rudy." } },
        { text: "فُرْصة سعيدة.", speechLang: "ar-EG", meaning: { ko: "forsa sa3ida · 만나서 반갑습니다.", en: "forsa sa3ida · Nice to meet you.", es: "forsa sa3ida · Mucho gusto.", id: "forsa sa3ida · Senang bertemu dengan Anda." } },
        { text: "إنْت مِنين؟", speechLang: "ar-EG", meaning: { ko: "enta minein? · 어디에서 오셨어요?", en: "enta minein? · Where are you from?", es: "enta minein? · ¿De dónde eres?", id: "enta minein? · Anda berasal dari mana?" } },
        { text: "شُكْراً.", speechLang: "ar-EG", meaning: { ko: "shokran · 감사합니다.", en: "shokran · Thank you.", es: "shokran · Gracias.", id: "shokran · Terima kasih." }, recallRound: false },
        { text: "آسِف، أنا مِش فاهِم.", speechLang: "ar-EG", meaning: { ko: "aasef, ana mesh fahem · 미안해요, 이해를 못 했어요.", en: "aasef, ana mesh fahem · Sorry, I don't understand.", es: "aasef, ana mesh fahem · Lo siento, no entiendo.", id: "aasef, ana mesh fahem · Maaf, saya tidak mengerti." }, recallRound: false },
        { text: "النَّجْدة! ساعِدني مِن فَضْلَك.", speechLang: "ar-EG", meaning: { ko: "el-nagda! sa3edni men fadlak · 도와주세요! 도움이 필요해요.", en: "el-nagda! sa3edni men fadlak · Help! Please help me.", es: "el-nagda! sa3edni men fadlak · ¡Ayuda! Por favor, ayúdame.", id: "el-nagda! sa3edni men fadlak · Tolong! Tolong bantu saya." } },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
      step2: {
        explanation: {
          pattern: { ko: "이집트 구어체로 자기소개할 때는 'أنا اسمي ___'(ana esmi ___, 제 이름은 ___예요)라고 해요. 'ana'는 '저', 'esmi'는 '제 이름'이에요. 출신을 물을 땐 표준어 'من أين'이 아니라 그냥 'مِنين؟'(minein?)라고 해요. 못 알아들으면 'أنا مِش فاهِم'(ana mesh fahem) — 'مِش'(mesh)가 이집트식 부정이에요. 위급하면 'النَّجْدة!'(el-nagda!)!", en: "To introduce yourself in Egyptian Arabic, say 'أنا اسمي ___' (ana esmi ___) — 'ana' is 'I', 'esmi' is 'my name'. To ask where someone's from, Egyptians don't use the textbook 'min ayn' — they just say 'مِنين؟' (minein?). Can't follow? Say 'أنا مِش فاهِم' (ana mesh fahem); 'مِش' (mesh) is the everyday Egyptian 'not'. Emergency? Shout 'النَّجْدة!' (el-nagda!).", es: "Para presentarte en árabe egipcio, di 'أنا اسمي ___' (ana esmi ___) — 'ana' es 'yo', 'esmi' es 'mi nombre'. Para preguntar de dónde es alguien, los egipcios no usan el 'min ayn' de los libros: dicen simplemente 'مِنين؟' (minein?). ¿No entiendes? Di 'أنا مِش فاهِم' (ana mesh fahem); 'مِش' (mesh) es el 'no' egipcio de cada día. ¿Emergencia? Grita 'النَّجْدة!' (el-nagda!)." },
          examples: { ko: "أنا اسمي رودي. (ana esmi Rudy · 제 이름은 루디예요.)\nفُرْصة سعيدة. (forsa sa3ida · 만나서 반갑습니다.)\nأنا مِش فاهِم. (ana mesh fahem · 이해를 못 했어요.)", en: "أنا اسمي رودي. (ana esmi Rudy · My name is Rudy.)\nفُرْصة سعيدة. (forsa sa3ida · Nice to meet you.)\nالنَّجْدة! ساعِدني مِن فَضْلَك. (el-nagda! sa3edni men fadlak · Help! Please help me.)", es: "أنا اسمي رودي. (ana esmi Rudy · Me llamo Rudy.)\nفُرْصة سعيدة. (forsa sa3ida · Mucho gusto.)\nالنَّجْدة! (el-nagda · ¡Ayuda!)" },
          mistakes: { ko: "❌ من أين أنت؟ (책에 나오는 표준어 — 이집트 사람은 이렇게 말 안 해요)\n✅ إنْت مِنين؟ (enta minein? — 이게 진짜 이집트식이에요!)\n❌ أنا لا أفهم. (표준어 부정)\n✅ أنا مِش فاهِم. (ana mesh fahem — 이집트에선 'مِش'를 써요!)", en: "❌ من أين أنت؟ (that's textbook MSA — Egyptians don't say it)\n✅ إنْت مِنين؟ (enta minein? — this is what's actually said!)\n❌ أنا لا أفهم. (MSA negation)\n✅ أنا مِش فاهِم. (ana mesh fahem — Egyptians use 'مِش' / mesh!)", es: "❌ من أين أنت؟ (es árabe estándar de libro — los egipcios no lo dicen)\n✅ إنْت مِنين؟ (enta minein? — ¡esto es lo que se dice de verdad!)\n❌ أنا لا أفهم. (negación del estándar)\n✅ أنا مِش فاهِم. (ana mesh fahem — los egipcios usan 'مِش' / mesh)" },
          rudyTip: { ko: "'أنا اسمي ___'(ana esmi)만 외워도 절반은 성공! 'مِنين؟'(minein?)랑 'مِش'(mesh)만 알면 벌써 이집트 사람처럼 들려~ 표준어보다 훨씬 짧고 쉬워!", en: "Just remember 'أنا اسمي ___' (ana esmi) and you're halfway there! Learn 'مِنين؟' (minein?) and 'مِش' (mesh) and you already sound Egyptian — way shorter and easier than the textbook stuff.", es: "Solo recuerda 'أنا اسمي ___' (ana esmi) y ya tienes la mitad. Aprende 'مِنين؟' (minein?) y 'مِش' (mesh) y ya suenas egipcio: mucho más corto y fácil que el árabe de libro." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "أنا ___ رودي.", answer: "اسمي", options: ["اسمي", "أنا", "إنْت"], fullSentence: "أنا اسمي رودي.", fullSentenceMeaning: { ko: "제 이름은 루디예요.", en: "My name is Rudy.", es: "Me llamo Rudy.", id: "Nama saya Rudy." } },
          { type: "select", promptWithBlank: "إنْت ___؟", answer: "مِنين", options: ["مِنين", "إيه", "مين"], fullSentence: "إنْت مِنين؟", fullSentenceMeaning: { ko: "어디에서 오셨어요?", en: "Where are you from?", es: "¿De dónde eres?", id: "Anda berasal dari mana?" } },
          { type: "select", promptWithBlank: "آسِف، أنا ___ فاهِم.", answer: "مِش", options: ["مِش", "لا", "مو"], fullSentence: "آسِف، أنا مِش فاهِم.", fullSentenceMeaning: { ko: "미안해요, 이해를 못 했어요.", en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", id: "Maaf, saya tidak mengerti." } },
          { type: "input", promptWithBlank: "___.", answer: "شُكْراً", fullSentence: "شُكْراً.", fullSentenceMeaning: { ko: "감사합니다.", en: "Thank you.", es: "Gracias.", id: "Terima kasih." } },
          { type: "listening", audioText: "أهلاً، أنا اسمي رودي.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["أهلاً، أنا اسمي رودي.", "فُرْصة سعيدة.", "إنْت مِنين؟", "شُكْراً."], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_2: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أنا مِن كوريا.", speechLang: "ar-EG", meaning: { ko: "ana men Korea · 저는 한국에서 왔어요.", en: "ana men Korea · I'm from Korea.", es: "ana men Korea · Soy de Corea.", id: "ana men Korea · Saya berasal dari Korea." } },
        { text: "أنا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "ana saken fi Seoul · 서울에 살고 있어요.", en: "ana saken fi Seoul · I live in Seoul.", es: "ana saken fi Seoul · Vivo en Seúl.", id: "ana saken fi Seoul · Saya tinggal di Seoul." } },
        { text: "مَدينْتَك عامْلة إيه؟", speechLang: "ar-EG", meaning: { ko: "madinetak 3amla eh? · 당신의 도시는 어때요?", en: "madinetak 3amla eh? · What's your city like?", es: "madinetak 3amla eh? · ¿Cómo es tu ciudad?", id: "madinetak 3amla eh? · Bagaimana kota Anda?" } },
        { text: "آه، أنا فاهِم. شُكْراً!", speechLang: "ar-EG", meaning: { ko: "aah, ana fahem. shokran! · 네, 이해했어요. 감사합니다!", en: "aah, ana fahem. shokran! · Yes, I understand. Thank you!", es: "aah, ana fahem. shokran! · Sí, entiendo. ¡Gracias!", id: "aah, ana fahem. shokran! · Ya, saya mengerti. Terima kasih!" } },
        { text: "مُمْكِن تِقول تاني؟", speechLang: "ar-EG", meaning: { ko: "momken te'ool tani? · 다시 한번 말해 주시겠어요?", en: "momken te'ool tani? · Can you say that again, please?", es: "momken te'ool tani? · ¿Puede repetir eso, por favor?", id: "momken te'ool tani? · Bisa tolong ulangi?" }, recallRound: false },
        { text: "مُمْكِن تِتْكَلِّم بِراحة؟", speechLang: "ar-EG", meaning: { ko: "momken tetkallem be-raaha? · 더 천천히 말해 주세요?", en: "momken tetkallem be-raaha? · Can you speak more slowly, please?", es: "momken tetkallem be-raaha? · ¿Puede hablar más despacio?", id: "momken tetkallem be-raaha? · Bisa bicara lebih pelan?" }, recallRound: false },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
      step2: {
        explanation: {
          pattern: { ko: "출신을 말할 땐 'أنا مِن ___'(ana men ___, 저는 ___에서 왔어요)라고 해요. 사는 곳은 'أنا ساكِن في ___'(ana saken fi ___) — 'ساكِن'(saken)이 '살다/거주하다'예요. 못 알아들으면 'مُمْكِن تِقول تاني؟'(momken te'ool tani?, 다시 말해 주실래요?), 너무 빠르면 'مُمْكِن تِتْكَلِّم بِراحة؟'(be-raaha = 천천히)라고 하세요. 'مُمْكِن'(momken)은 정중한 부탁의 만능 단어예요!", en: "To say where you're from, use 'أنا مِن ___' (ana men ___). For where you live: 'أنا ساكِن في ___' (ana saken fi ___) — 'ساكِن' (saken) means 'living/residing'. Lost? 'مُمْكِن تِقول تاني؟' (momken te'ool tani? — can you say it again?). Too fast? 'مُمْكِن تِتْكَلِّم بِراحة؟' ('be-raaha' literally 'with ease' = slowly). 'مُمْكِن' (momken) is your magic word for any polite request!", es: "Para decir de dónde eres, usa 'أنا مِن ___' (ana men ___). Para dónde vives: 'أنا ساكِن في ___' (ana saken fi ___) — 'ساكِن' (saken) significa 'que vive/reside'. ¿Perdido? 'مُمْكِن تِقول تاني؟' (momken te'ool tani? — ¿puede repetir?). ¿Muy rápido? 'مُمْكِن تِتْكَلِّم بِراحة؟' ('be-raaha' literalmente 'con calma' = despacio). '¡مُمْكِن' (momken) es tu palabra mágica para cualquier petición educada!" },
          examples: { ko: "أنا مِن كوريا. (ana men Korea · 저는 한국에서 왔어요.)\nأنا ساكِن في سيول. (ana saken fi Seoul · 서울에 살고 있어요.)\nمُمْكِن تِتْكَلِّم بِراحة؟ (momken tetkallem be-raaha? · 더 천천히 말해 주세요.)", en: "أنا مِن كوريا. (ana men Korea · I'm from Korea.)\nأنا ساكِن في سيول. (ana saken fi Seoul · I live in Seoul.)\nمُمْكِن تِقول تاني؟ (momken te'ool tani? · Can you say that again?)", es: "أنا مِن كوريا. (ana men Korea · Soy de Corea.)\nأنا ساكِن في سيول. (ana saken fi Seoul · Vivo en Seúl.)\nمُمْكِن تِقول تاني؟ (momken te'ool tani? · ¿Puede repetir eso?)" },
          mistakes: { ko: "❌ أنا أعيش في سيول. (표준어 'أعيش' — 일상 대화엔 딱딱해요)\n✅ أنا ساكِن في سيول. (ana saken — 이집트 사람은 'ساكِن'을 써요!)\n❌ مُمْكِن تِقول مَرّة ثانية؟ (표준어 'مَرّة ثانية')\n✅ مُمْكِن تِقول تاني؟ (그냥 'تاني'(tani)면 충분해요!)", en: "❌ أنا أعيش في سيول. (MSA 'a3eesh' — stiff in everyday talk)\n✅ أنا ساكِن في سيول. (ana saken — Egyptians say 'ساكِن'!)\n❌ مُمْكِن تِقول مَرّة ثانية؟ (MSA 'marra thaniya')\n✅ مُمْكِن تِقول تاني؟ (just 'تاني' / tani is enough!)", es: "❌ أنا أعيش في سيول. (MSA 'a3eesh' — rígido en el habla diaria)\n✅ أنا ساكِن في سيول. (ana saken — ¡los egipcios dicen 'ساكِن'!)\n❌ مُمْكِن تِقول مَرّة ثانية؟ (MSA 'marra thaniya')\n✅ مُمْكِن تِقول تاني؟ (¡basta con 'تاني' / tani!)" },
          rudyTip: { ko: "'مُمْكِن ___؟'(momken ___?)는 정중하게 부탁할 때 만능이야! 'تاني'(tani, 다시)랑 'بِراحة'(be-raaha, 천천히)만 붙이면 대화가 술술 풀려~", en: "'مُمْكِن ___؟' (momken ___?) is your all-purpose polite request! Just add 'تاني' (tani — again) or 'بِراحة' (be-raaha — slowly) and conversations flow.", es: "'مُمْكِن ___؟' (momken ___?) es tu petición educada para todo. Añade 'تاني' (tani — otra vez) o 'بِراحة' (be-raaha — despacio) y la conversación fluye." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "أنا ___ كوريا.", answer: "مِن", options: ["مِن", "في", "على"], fullSentence: "أنا مِن كوريا.", fullSentenceMeaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea.", id: "Saya berasal dari Korea." } },
          { type: "select", promptWithBlank: "أنا ___ في سيول.", answer: "ساكِن", options: ["ساكِن", "مِن", "رايِح"], fullSentence: "أنا ساكِن في سيول.", fullSentenceMeaning: { ko: "서울에 살고 있어요.", en: "I live in Seoul.", es: "Vivo en Seúl.", id: "Saya tinggal di Seoul." } },
          { type: "select", promptWithBlank: "مُمْكِن تِقول ___؟", answer: "تاني", options: ["تاني", "بِراحة", "كِتير"], fullSentence: "مُمْكِن تِقول تاني؟", fullSentenceMeaning: { ko: "다시 한번 말해 주시겠어요?", en: "Can you say that again, please?", es: "¿Puede repetir eso, por favor?", id: "Bisa tolong ulangi?" } },
          { type: "input", promptWithBlank: "أنا ___ كوريا.", answer: "مِن", fullSentence: "أنا مِن كوريا.", fullSentenceMeaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea.", id: "Saya berasal dari Korea." } },
          { type: "listening", audioText: "مُمْكِن تِتْكَلِّم بِراحة؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["مُمْكِن تِتْكَلِّم بِراحة؟", "مُمْكِن تِقول تاني؟", "أنا مِن كوريا.", "آه. / لأ."], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_3: {
    ...
    arabic: {
      step1Sentences: [
        { text: "بِتِشْتَغَل إيه؟", speechLang: "ar-EG", meaning: { ko: "beteshtaghal eh? · 무슨 일 하세요?", en: "beteshtaghal eh? · What do you do?", es: "beteshtaghal eh? · ¿A qué te dedicas?", id: "beteshtaghal eh? · Apa pekerjaan Anda?" } },
        { text: "أنا طالِب.", speechLang: "ar-EG", meaning: { ko: "ana taleb · 저는 학생이에요.", en: "ana taleb · I'm a student.", es: "ana taleb · Soy estudiante.", id: "ana taleb · Saya seorang pelajar." } },
        { text: "أنا بَشْتَغَل في شِرْكة.", speechLang: "ar-EG", meaning: { ko: "ana bashtaghal fi sherka · 저는 회사에 다녀요.", en: "ana bashtaghal fi sherka · I work at a company.", es: "ana bashtaghal fi sherka · Trabajo en una empresa.", id: "ana bashtaghal fi sherka · Saya bekerja di sebuah perusahaan." } },
        { text: "بِتِتْكَلِّم إنجِليزي؟", speechLang: "ar-EG", meaning: { ko: "beteklem engelizi? · 영어 할 줄 아세요?", en: "beteklem engelizi? · Do you speak English?", es: "beteklem engelizi? · ¿Hablas inglés?", id: "beteklem engelizi? · Apakah kamu bisa bahasa Inggris?" }, recallRound: false },
        { text: "شْوَيّة.", speechLang: "ar-EG", meaning: { ko: "shwaya · 조금이요.", en: "shwaya · A little bit.", es: "shwaya · Un poquito.", id: "shwaya · Sedikit saja." }, recallRound: false },
      ],
      step1Config: {
        hasAudioOnlyRound: false,
      },
      step2: {
        explanation: {
          pattern: { ko: "직업을 물을 땐 'بِتِشْتَغَل إيه؟'(beteshtaghal eh?, 무슨 일 해요?)라고 해요 — 'إيه؟'(eh?)가 이집트식 '뭐?'예요(표준어 'ماذا'가 아니에요!). 직업은 'أنا ___'(ana ___, 저는 ___예요), 일하는 곳은 'بَشْتَغَل في ___'(bashtaghal fi ___). 언어를 물을 땐 'بِتِتْكَلِّم ___؟'(beteklem ___?), 대답은 'شْوَيّة'(shwaya, 조금)!", en: "To ask about jobs, say 'بِتِشْتَغَل إيه؟' (beteshtaghal eh? — what do you do?). 'إيه؟' (eh?) is the Egyptian 'what?' (not the textbook 'maatha'!). Your job: 'أنا ___' (ana ___). Where you work: 'بَشْتَغَل في ___' (bashtaghal fi ___). Ask about languages with 'بِتِتْكَلِّم ___؟' (beteklem ___?) and answer 'شْوَيّة' (shwaya — a little)!", es: "Para preguntar por el trabajo, di 'بِتِشْتَغَل إيه؟' (beteshtaghal eh? — ¿a qué te dedicas?). 'إيه؟' (eh?) es el '¿qué?' egipcio (¡no el 'maatha' de los libros!). Tu trabajo: 'أنا ___' (ana ___). Dónde trabajas: 'بَشْتَغَل في ___' (bashtaghal fi ___). Pregunta por idiomas con 'بِتِتْكَلِّم ___؟' (beteklem ___?) y responde 'شْوَيّة' (shwaya — un poco)." },
          examples: { ko: "أنا طالِب. (ana taleb · 저는 학생이에요.)\nأنا بَشْتَغَل في شِرْكة. (ana bashtaghal fi sherka · 저는 회사에 다녀요.)\nبِتِتْكَلِّم إنجِليزي؟ — شْوَيّة. (beteklem engelizi? — shwaya · 영어 하세요? — 조금이요.)", en: "أنا طالِب. (ana taleb · I'm a student.)\nأنا بَشْتَغَل في شِرْكة. (ana bashtaghal fi sherka · I work at a company.)\nبِتِتْكَلِّم إنجِليزي؟ — شْوَيّة. (beteklem engelizi? — shwaya · Do you speak English? — A little.)", es: "أنا طالِب. (ana taleb · Soy estudiante.)\nأنا بَشْتَغَل في شِرْكة. (ana bashtaghal fi sherka · Trabajo en una empresa.)\nبِتِتْكَلِّم إنجِليزي؟ — شْوَيّة. (beteklem engelizi? — shwaya · ¿Hablas inglés? — Un poquito.)" },
          mistakes: { ko: "❌ ماذا تعمل؟ (책 표준어 — 이집트에선 안 써요)\n✅ بِتِشْتَغَل إيه؟ (beteshtaghal eh? — 'إيه؟'가 이집트식 '뭐?'!)\n❌ أنا أتكلم قليلاً. (표준어)\n✅ شْوَيّة. (shwaya — 그냥 한 단어면 충분해요!)", en: "❌ ماذا تعمل؟ (textbook MSA — not used in Egypt)\n✅ بِتِشْتَغَل إيه؟ (beteshtaghal eh? — 'إيه؟' is the Egyptian 'what?'!)\n❌ أنا أتكلم قليلاً. (MSA)\n✅ شْوَيّة. (shwaya — just one word does it!)", es: "❌ ماذا تعمل؟ (MSA de libro — no se usa en Egipto)\n✅ بِتِشْتَغَل إيه؟ (beteshtaghal eh? — '¡إيه؟' es el '¿qué?' egipcio!)\n❌ أنا أتكلم قليلاً. (MSA)\n✅ شْوَيّة. (shwaya — ¡basta una palabra!)" },
          rudyTip: { ko: "'إيه؟'(eh?)만 알면 이집트에서 질문 절반은 끝! 'بِتِشْتَغَل إيه؟'처럼 동사 뒤에 'إيه'를 붙이면 돼~ 'شْوَيّة'(shwaya)는 진짜 매일 쓰는 단어야!", en: "Learn 'إيه؟' (eh?) and half your Egyptian questions are done! Just tack 'إيه' onto the verb, like 'بِتِشْتَغَل إيه؟'. And 'شْوَيّة' (shwaya) is a word you'll use every single day!", es: "Aprende 'إيه؟' (eh?) y la mitad de tus preguntas en egipcio están listas. Solo pega 'إيه' al verbo, como 'بِتِشْتَغَل إيه؟'. ¡Y 'شْوَيّة' (shwaya) la usarás todos los días!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "بِتِشْتَغَل ___؟", answer: "إيه", options: ["إيه", "مين", "فين"], fullSentence: "بِتِشْتَغَل إيه؟", fullSentenceMeaning: { ko: "무슨 일 하세요?", en: "What do you do?", es: "¿A qué te dedicas?", id: "Apa pekerjaan Anda?" } },
          { type: "select", promptWithBlank: "أنا بَشْتَغَل ___ شِرْكة.", answer: "في", options: ["في", "مِن", "على"], fullSentence: "أنا بَشْتَغَل في شِرْكة.", fullSentenceMeaning: { ko: "저는 회사에 다녀요.", en: "I work at a company.", es: "Trabajo en una empresa.", id: "Saya bekerja di sebuah perusahaan." } },
          { type: "select", promptWithBlank: "بِتِتْكَلِّم ___؟", answer: "إنجِليزي", options: ["إنجِليزي", "شِرْكة", "طالِب"], fullSentence: "بِتِتْكَلِّم إنجِليزي؟", fullSentenceMeaning: { ko: "영어 할 줄 아세요?", en: "Do you speak English?", es: "¿Hablas inglés?", id: "Apakah kamu bisa bahasa Inggris?" } },
          { type: "input", promptWithBlank: "___.", answer: "شْوَيّة", fullSentence: "شْوَيّة.", fullSentenceMeaning: { ko: "조금이요.", en: "A little bit.", es: "Un poquito.", id: "Sedikit saja." } },
          { type: "input", promptWithBlank: "أنا ___.", answer: "طالِب", fullSentence: "أنا طالِب.", fullSentenceMeaning: { ko: "저는 학생이에요.", en: "I'm a student.", es: "Soy estudiante.", id: "Saya seorang pelajar." } },
          { type: "listening", audioText: "بِتِتْكَلِّم إنجِليزي؟ شْوَيّة.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["بِتِتْكَلِّم إنجِليزي؟ شْوَيّة.", "بِتِشْتَغَل إيه؟", "أنا طالِب.", "أنا بَشْتَغَل في شِرْكة."], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_4: {
    ...
    arabic: {
      step1Sentences: [
        { text: "مع السَّلامة! أشوفَك بَعْدين.", speechLang: "ar-EG", meaning: { ko: "ma3a el-salama! ashoofak ba3dein · 안녕히 가세요! 다음에 봐요.", en: "ma3a el-salama! ashoofak ba3dein · Goodbye! See you later.", es: "ma3a el-salama! ashoofak ba3dein · ¡Adiós! Hasta luego.", id: "ma3a el-salama! ashoofak ba3dein · Selamat tinggal! Sampai jumpa nanti." } },
        { text: "خَلّي بالَك مِن نَفْسَك!", speechLang: "ar-EG", meaning: { ko: "khalli balak men nafsak! · 잘 가요!", en: "khalli balak men nafsak! · Take care!", es: "khalli balak men nafsak! · ¡Cuídate!", id: "khalli balak men nafsak! · Hati-hati!" } },
        { text: "أنا اِتْشَرِّفْت بِمَعْرِفْتَك.", speechLang: "ar-EG", meaning: { ko: "ana etsharreft be-ma3reftak · 만나서 반가웠어요.", en: "ana etsharreft be-ma3reftak · It was nice meeting you.", es: "ana etsharreft be-ma3reftak · Fue un placer conocerte.", id: "ana etsharreft be-ma3reftak · Senang bertemu dengan Anda tadi." } },
        { text: "فين الحَمّام؟", speechLang: "ar-EG", meaning: { ko: "fein el-hammam? · 화장실이 어디예요?", en: "fein el-hammam? · Where is the bathroom?", es: "fein el-hammam? · ¿Dónde está el baño?", id: "fein el-hammam? · Di mana toilet?" }, recallRound: true },
        { text: "لو سَمَحْت، فين الخُروج؟", speechLang: "ar-EG", meaning: { ko: "law samaht, fein el-khoroog? · 실례합니다, 출구가 어디예요?", en: "law samaht, fein el-khoroog? · Excuse me, where is the exit?", es: "law samaht, fein el-khoroog? · Disculpe, ¿dónde está la salida?", id: "law samaht, fein el-khoroog? · Permisi, di mana pintu keluar?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
      ...
      step2: {
        explanation: {
          pattern: { ko: "작별 인사는 'مع السَّلامة'(ma3a el-salama, 잘 가요)와 'أشوفَك بَعْدين'(ashoofak ba3dein, 나중에 봐요)가 있어요. '조심해'는 'خَلّي بالَك'(khalli balak). 장소를 물을 땐 'فين ___؟'(fein ___?)를 써요 — 표준어 'أين'이 아니라 'فين'(fein)이 이집트식이에요! 앞에 'لو سَمَحْت'(law samaht, 실례합니다)를 붙이면 훨씬 공손해져요.", en: "Egyptian farewells: 'مع السَّلامة' (ma3a el-salama — goodbye / go in peace) and 'أشوفَك بَعْدين' (ashoofak ba3dein — see you later). 'Take care' is 'خَلّي بالَك' (khalli balak). To ask for places, use 'فين ___؟' (fein ___?) — it's 'فين' (fein), NOT the textbook 'ayn'! Start with 'لو سَمَحْت' (law samaht — excuse me/please) and you instantly sound polite.", es: "Despedidas egipcias: 'مع السَّلامة' (ma3a el-salama — adiós / ve en paz) y 'أشوفَك بَعْدين' (ashoofak ba3dein — hasta luego). 'Cuídate' es 'خَلّي بالَك' (khalli balak). Para lugares, usa 'فين ___؟' (fein ___?) — ¡es 'فين' (fein), NO el 'ayn' de los libros! Empieza con 'لو سَمَحْت' (law samaht — disculpe) y suenas educado al instante." },
          examples: { ko: "مع السَّلامة! أشوفَك بَعْدين. (ma3a el-salama! ashoofak ba3dein · 안녕히 가세요! 다음에 봐요.)\nفين الحَمّام؟ (fein el-hammam? · 화장실이 어디예요?)\nلو سَمَحْت، فين الخُروج؟ (law samaht, fein el-khoroog? · 실례합니다, 출구가 어디예요?)", en: "مع السَّلامة! أشوفَك بَعْدين. (ma3a el-salama! ashoofak ba3dein · Goodbye! See you later.)\nفين الحَمّام؟ (fein el-hammam? · Where is the bathroom?)\nلو سَمَحْت، فين الخُروج؟ (law samaht, fein el-khoroog? · Excuse me, where is the exit?)", es: "مع السَّلامة! أشوفَك بَعْدين. (ma3a el-salama! ashoofak ba3dein · ¡Adiós! Hasta luego.)\nفين الحَمّام؟ (fein el-hammam? · ¿Dónde está el baño?)\nلو سَمَحْت، فين الخُروج؟ (law samaht, fein el-khoroog? · Disculpe, ¿dónde está la salida?)" },
          mistakes: { ko: "❌ أين الحَمّام؟ (책 표준어 'أين')\n✅ فين الحَمّام؟ (fein el-hammam? — 이집트에선 'فين'!)\n❌ من فضلك أين المخرج؟ (딱딱한 표준어)\n✅ لو سَمَحْت، فين الخُروج؟ (law samaht — 이게 자연스러운 이집트식이에요!)", en: "❌ أين الحَمّام؟ (textbook 'ayn')\n✅ فين الحَمّام؟ (fein el-hammam? — Egyptians say 'فين'!)\n❌ من فضلك أين المخرج؟ (stiff MSA)\n✅ لو سَمَحْت، فين الخُروج؟ (law samaht — this is the natural Egyptian way!)", es: "❌ أين الحَمّام؟ ('ayn' de libro)\n✅ فين الحَمّام؟ (fein el-hammam? — ¡los egipcios dicen 'فين'!)\n❌ من فضلك أين المخرج؟ (MSA rígido)\n✅ لو سَمَحْت، فين الخُروج؟ (law samaht — ¡así es natural en egipcio!)" },
          rudyTip: { ko: "'لو سَمَحْت، فين ___؟'(law samaht, fein ___?)는 여행할 때 제일 많이 쓰는 문장이야! 'فين'(fein)만 알면 이집트 어디서든 길을 찾을 수 있어~", en: "'لو سَمَحْت، فين ___؟' (law samaht, fein ___?) is THE travel phrase. Learn 'فين' (fein) and you can find anything, anywhere in Egypt!", es: "'لو سَمَحْت، فين ___؟' (law samaht, fein ___?) es LA frase de viaje. ¡Aprende 'فين' (fein) y encontrarás todo en Egipto!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "مع ___! أشوفَك بَعْدين.", answer: "السَّلامة", options: ["السَّلامة", "الخير", "النَّجْدة"], fullSentence: "مع السَّلامة! أشوفَك بَعْدين.", fullSentenceMeaning: { ko: "안녕히 가세요! 다음에 봐요.", en: "Goodbye! See you later.", es: "¡Adiós! Hasta luego.", id: "Selamat tinggal! Sampai jumpa nanti." } },
          { type: "select", promptWithBlank: "أنا ___ بِمَعْرِفْتَك.", answer: "اِتْشَرِّفْت", options: ["اِتْشَرِّفْت", "رُحْت", "أكَلْت"], fullSentence: "أنا اِتْشَرِّفْت بِمَعْرِفْتَك.", fullSentenceMeaning: { ko: "만나서 반가웠어요.", en: "It was nice meeting you.", es: "Fue un placer conocerte.", id: "Senang bertemu dengan Anda tadi." } },
          { type: "select", promptWithBlank: "___ الحَمّام؟", answer: "فين", options: ["فين", "إيه", "إمْتى"], fullSentence: "فين الحَمّام؟", fullSentenceMeaning: { ko: "화장실이 어디예요?", en: "Where is the bathroom?", es: "¿Dónde está el baño?", id: "Di mana toilet?" } },
          { type: "input", promptWithBlank: "لو ___، فين الخُروج؟", answer: "سَمَحْت", fullSentence: "لو سَمَحْت، فين الخُروج؟", fullSentenceMeaning: { ko: "실례합니다, 출구가 어디예요?", en: "Excuse me, where is the exit?", es: "Disculpe, ¿dónde está la salida?", id: "Permisi, di mana pintu keluar?" } },
          { type: "input", promptWithBlank: "خَلّي ___ مِن نَفْسَك!", answer: "بالَك", fullSentence: "خَلّي بالَك مِن نَفْسَك!", fullSentenceMeaning: { ko: "잘 가요!", en: "Take care!", es: "¡Cuídate!", id: "Hati-hati!" } },
          { type: "listening", audioText: "لو سَمَحْت، فين الخُروج؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["لو سَمَحْت، فين الخُروج؟", "فين الحَمّام؟", "مع السَّلامة! أشوفَك بَعْدين.", "خَلّي بالَك مِن نَفْسَك!"], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_5: {
    ...
    arabic: {
      step1Sentences: [
        { text: "إزَّيَّك النَّهارْده؟", speechLang: "ar-EG", meaning: { ko: "ezzayyak el-naharda? · 오늘 어떻게 지내요?", en: "ezzayyak el-naharda? · How are you today?", es: "ezzayyak el-naharda? · ¿Cómo estás hoy?", id: "ezzayyak el-naharda? · Apa kabar hari ini?" } },
        { text: "أنا كُوَيِّس، شُكْراً.", speechLang: "ar-EG", meaning: { ko: "ana kwayyes, shokran · 잘 지내요, 감사합니다.", en: "ana kwayyes, shokran · I'm fine, thank you.", es: "ana kwayyes, shokran · Estoy bien, gracias.", id: "ana kwayyes, shokran · Saya baik-baik saja, terima kasih." } },
        { text: "مِش بَطّال، وإنْت؟", speechLang: "ar-EG", meaning: { ko: "mesh battal, wenta? · 괜찮아요, 당신은요?", en: "mesh battal, wenta? · Not bad, how about you?", es: "mesh battal, wenta? · No está mal, ¿y tú?", id: "mesh battal, wenta? · Lumayan, bagaimana dengan Anda?" } },
        { text: "بِكام ده؟", speechLang: "ar-EG", meaning: { ko: "bekam da? · 이거 얼마예요?", en: "bekam da? · How much is this?", es: "bekam da? · ¿Cuánto cuesta esto?", id: "bekam da? · Ini berapa harganya?" }, recallRound: true },
        { text: "النَّجْدة! مُحْتاج مُساعْدة، لو سَمَحْت.", speechLang: "ar-EG", meaning: { ko: "el-nagda! mehtaag mosa3da, law samaht · 도와주세요! 도움이 필요해요.", en: "el-nagda! mehtaag mosa3da, law samaht · Help! I need help, please.", es: "el-nagda! mehtaag mosa3da, law samaht · ¡Ayuda! Necesito ayuda, por favor.", id: "el-nagda! mehtaag mosa3da, law samaht · Tolong! Saya butuh bantuan." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
      ...
      step2: {
        explanation: {
          pattern: { ko: "안부를 물을 땐 'إزَّيَّك؟'(ezzayyak?, 어떻게 지내요?)라고 해요 — 표준어 'كيف حالك'가 아니라 'إزَّيَّك'가 이집트식이에요! '오늘'도 'اليوم'이 아니라 'النَّهارْده'(el-naharda)예요. 대답은 'كُوَيِّس'(kwayyes, 좋아요), 'مِش بَطّال'(mesh battal, 나쁘지 않아요). 가격은 'بِكام ده؟'(bekam da?, 이거 얼마?), 위급하면 'النَّجْدة!'(el-nagda!).", en: "To ask how someone is, say 'إزَّيَّك؟' (ezzayyak?) — it's 'إزَّيَّك', NOT the textbook 'kayfa haaluk'! Even 'today' is 'النَّهارْده' (el-naharda), not 'al-yawm'. Reply with 'كُوَيِّس' (kwayyes — good) or 'مِش بَطّال' (mesh battal — not bad). Prices: 'بِكام ده؟' (bekam da? — how much is this?). Emergency: 'النَّجْدة!' (el-nagda!).", es: "Para preguntar cómo está alguien, di 'إزَّيَّك؟' (ezzayyak?) — ¡es 'إزَّيَّك', NO el 'kayfa haaluk' de los libros! Incluso 'hoy' es 'النَّهارْده' (el-naharda), no 'al-yawm'. Responde 'كُوَيِّس' (kwayyes — bien) o 'مِش بَطّال' (mesh battal — no está mal). Precios: 'بِكام ده؟' (bekam da? — ¿cuánto es esto?). Emergencia: 'النَّجْدة!' (el-nagda!)." },
          examples: { ko: "إزَّيَّك؟ — أنا كُوَيِّس! (ezzayyak? — ana kwayyes · 어떻게 지내요? — 잘 지내요!)\nبِكام ده؟ — بِعَشَرة جِنيه. (bekam da? — be-3ashara gineh · 이거 얼마예요? — 10파운드예요.)\nالنَّجْدة! مُحْتاج مُساعْدة. (el-nagda! mehtaag mosa3da · 도와주세요! 도움이 필요해요.)", en: "إزَّيَّك؟ — أنا كُوَيِّس! (ezzayyak? — ana kwayyes · How are you? — I'm good!)\nمِش بَطّال، وإنْت؟ (mesh battal, wenta? · Not bad, how about you?)\nبِكام ده؟ (bekam da? · How much is this? — point and ask!)", es: "إزَّيَّك؟ — أنا كُوَيِّس! (ezzayyak? — ana kwayyes · ¿Cómo estás? — ¡Bien!)\nمِش بَطّال، وإنْت؟ (mesh battal, wenta? · No está mal, ¿y tú?)\nبِكام ده؟ (bekam da? · ¿Cuánto cuesta esto?)" },
          mistakes: { ko: "❌ كيف حالك؟ (책 표준어 — 이집트 사람은 안 써요)\n✅ إزَّيَّك؟ (ezzayyak? — 이게 진짜 이집트식!)\n❌ كم ثمن هذا؟ (딱딱한 표준어)\n✅ بِكام ده؟ (bekam da? — 시장에서 매일 듣는 말이에요!)", en: "❌ كيف حالك؟ (textbook MSA — Egyptians don't say it)\n✅ إزَّيَّك؟ (ezzayyak? — this is the real Egyptian way!)\n❌ كم ثمن هذا؟ (stiff MSA)\n✅ بِكام ده؟ (bekam da? — what you hear in markets every day!)", es: "❌ كيف حالك؟ (MSA de libro — los egipcios no lo dicen)\n✅ إزَّيَّك؟ (ezzayyak? — ¡así es de verdad en egipcio!)\n❌ كم ثمن هذا؟ (MSA rígido)\n✅ بِكام ده؟ (bekam da? — ¡lo que oyes en los mercados cada día!)" },
          rudyTip: { ko: "'إزَّيَّك؟'(ezzayyak?)랑 'بِكام؟'(bekam?) 이 두 개만 알면 이집트 일상이 다 돼! 'كُوَيِّس'(kwayyes)는 '좋아요'고 어디서나 써~", en: "Master just 'إزَّيَّك؟' (ezzayyak?) and 'بِكام؟' (bekam?) and you've got daily Egyptian life covered! 'كُوَيِّس' (kwayyes — good) works everywhere too.", es: "Domina solo 'إزَّيَّك؟' (ezzayyak?) y 'بِكام؟' (bekam?) y ya tienes cubierta la vida diaria en Egipto. 'كُوَيِّس' (kwayyes — bien) sirve en todas partes." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ النَّهارْده؟", answer: "إزَّيَّك", options: ["إزَّيَّك", "فين", "بِكام"], fullSentence: "إزَّيَّك النَّهارْده؟", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?", id: "Apa kabar hari ini?" } },
          { type: "select", promptWithBlank: "أنا ___، شُكْراً.", answer: "كُوَيِّس", options: ["كُوَيِّس", "بَطّال", "تَعْبان"], fullSentence: "أنا كُوَيِّس، شُكْراً.", fullSentenceMeaning: { ko: "잘 지내요, 감사합니다.", en: "I'm fine, thank you.", es: "Estoy bien, gracias.", id: "Saya baik-baik saja, terima kasih." } },
          { type: "select", promptWithBlank: "___ ده؟", answer: "بِكام", options: ["بِكام", "فين", "إزَّيَّك"], fullSentence: "بِكام ده؟", fullSentenceMeaning: { ko: "이거 얼마예요?", en: "How much is this?", es: "¿Cuánto cuesta esto?", id: "Ini berapa harganya?" } },
          { type: "input", promptWithBlank: "مِش ___، وإنْت؟", answer: "بَطّال", fullSentence: "مِش بَطّال، وإنْت؟", fullSentenceMeaning: { ko: "괜찮아요, 당신은요?", en: "Not bad, how about you?", es: "No está mal, ¿y tú?", id: "Lumayan, bagaimana dengan Anda?" } },
          { type: "input", promptWithBlank: "مُحْتاج ___، لو سَمَحْت.", answer: "مُساعْدة", fullSentence: "مُحْتاج مُساعْدة، لو سَمَحْت.", fullSentenceMeaning: { ko: "도움이 필요해요.", en: "I need help, please.", es: "Necesito ayuda, por favor.", id: "Saya butuh bantuan." } },
          { type: "listening", audioText: "بِكام ده؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["بِكام ده؟", "إزَّيَّك النَّهارْده؟", "النَّجْدة! مُحْتاج مُساعْدة.", "مِش بَطّال، وإنْت؟"], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_6: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أهلاً، أنا اسمي رودي. فُرْصة سعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, ana esmi Rudy. forsa sa3ida · 안녕하세요, 제 이름은 루디예요. 만나서 반갑습니다.", en: "ahlan, ana esmi Rudy. forsa sa3ida · Hello, my name is Rudy. Nice to meet you.", es: "ahlan, ana esmi Rudy. forsa sa3ida · Hola, me llamo Rudy. Mucho gusto.", id: "ahlan, ana esmi Rudy. forsa sa3ida · Halo, nama saya Rudy. Senang bertemu dengan Anda." } },
        { text: "أنا مِن لَنْدَن. أنا بَشْتَغَل مُحَقِّق.", speechLang: "ar-EG", meaning: { ko: "ana men Landan. ana bashtaghal mohaqqeq · 저는 런던에서 왔어요. 탐정으로 일해요.", en: "ana men Landan. ana bashtaghal mohaqqeq · I'm from London. I work as a detective.", es: "ana men Landan. ana bashtaghal mohaqqeq · Soy de Londres. Trabajo como detective.", id: "ana men Landan. ana bashtaghal mohaqqeq · Saya berasal dari London. Saya bekerja sebagai detektif." } },
        { text: "إزَّيَّك؟ أنا تَمام، شُكْراً! أشوفَك بَعْدين!", speechLang: "ar-EG", meaning: { ko: "ezzayyak? ana tamam, shokran! ashoofak ba3dein! · 어떻게 지내세요? 잘 지내요, 감사합니다! 다음에 봐요!", en: "ezzayyak? ana tamam, shokran! ashoofak ba3dein! · How are you? I'm great, thanks! See you later!", es: "ezzayyak? ana tamam, shokran! ashoofak ba3dein! · ¿Cómo estás? ¡Estoy genial, gracias! ¡Hasta luego!", id: "ezzayyak? ana tamam, shokran! ashoofak ba3dein! · Apa kabar? Saya baik-baik saja, terima kasih! Sampai jumpa nanti!" } },
        { text: "آسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟", speechLang: "ar-EG", meaning: { ko: "aasef, ana mesh fahem. momken te'ool tani? · 미안해요, 이해를 못 했어요. 다시 한번 말해 주시겠어요?", en: "aasef, ana mesh fahem. momken te'ool tani? · Sorry, I don't understand. Can you say that again?", es: "aasef, ana mesh fahem. momken te'ool tani? · Lo siento, no entiendo. ¿Puede repetir eso?", id: "aasef, ana mesh fahem. momken te'ool tani? · Maaf, saya tidak mengerti. Bisa tolong ulangi?" }, recallRound: true },
        { text: "لو سَمَحْت، فين الحَمّام؟ بِكام ده؟", speechLang: "ar-EG", meaning: { ko: "law samaht, fein el-hammam? bekam da? · 실례합니다, 화장실이 어디예요? 이거 얼마예요?", en: "law samaht, fein el-hammam? bekam da? · Excuse me, where is the bathroom? How much is this?", es: "law samaht, fein el-hammam? bekam da? · Disculpe, ¿dónde está el baño? ¿Cuánto cuesta esto?", id: "law samaht, fein el-hammam? bekam da? · Permisi, di mana toilet? Ini berapa harganya?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 1,
      ...
      step2: {
        explanation: {
          pattern: { ko: "이번 주 이집트 구어체를 총정리해요! 자기소개(أنا اسمي / أنا مِن / أنا ___), 인사(إزَّيَّك؟ / مع السَّلامة), 생존 표현(أنا مِش فاهِم / فين ___؟ / بِكام؟ / النَّجْدة!)을 자연스럽게 이어서 말해보세요!", en: "Let's review all your Egyptian Arabic! Introductions (أنا اسمي / أنا مِن / أنا ___), greetings (إزَّيَّك؟ / مع السَّلامة), and survival phrases (أنا مِش فاهِم / فين ___؟ / بِكام؟ / النَّجْدة!). Time to connect them all!", es: "Repasemos todo tu árabe egipcio. Presentaciones (أنا اسمي / أنا مِن / أنا ___), saludos (إزَّيَّك؟ / مع السَّلامة) y frases de supervivencia (أنا مِش فاهِم / فين ___؟ / بِكام؟ / النَّجْدة!). Conectemos todo." },
          examples: { ko: "أهلاً، أنا اسمي رودي. أنا مِن كوريا. (ahlan, ana esmi Rudy. ana men Korea · 자기소개 콤보!)\nإزَّيَّك؟ — أنا تَمام! أشوفَك بَعْدين! (ezzayyak? — ana tamam! ashoofak ba3dein · 인사 + 작별 콤보!)\nلو سَمَحْت، فين الحَمّام؟ بِكام ده؟ (law samaht, fein el-hammam? bekam da? · 생존 콤보!)", en: "أهلاً، أنا اسمي رودي. أنا مِن كوريا. (ahlan, ana esmi Rudy. ana men Korea · Introduction combo!)\nإزَّيَّك؟ — أنا تَمام! أشوفَك بَعْدين! (ezzayyak? — ana tamam! ashoofak ba3dein · Greeting + farewell combo!)\nآسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟ (aasef, ana mesh fahem. momken te'ool tani? · Survival combo!)", es: "أهلاً، أنا اسمي رودي. أنا مِن كوريا. (ahlan, ana esmi Rudy. ana men Korea · ¡Combo de presentación!)\nإزَّيَّك؟ — أنا تَمام! أشوفَك بَعْدين! (ezzayyak? — ana tamam! ashoofak ba3dein · ¡Combo de saludo + despedida!)\nآسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟ (aasef, ana mesh fahem. momken te'ool tani? · ¡Combo de supervivencia!)" },
          mistakes: { ko: "❌ 문장을 따로따로만 외우기\n✅ 실제 대화처럼 문장을 연결해서 말해보세요! 자기소개→안부→질문→작별 흐름으로! 그리고 표준어 말고 이집트식(مِنين/فين/إزَّيَّك/مِش)으로요~", en: "❌ Only memorizing isolated phrases\n✅ Connect them like a real conversation! Introduction, greeting, questions, goodbye — and keep it Egyptian (minein/fein/ezzayyak/mesh), not textbook MSA.", es: "❌ Solo memorizar frases aisladas\n✅ Conéctalas como una conversación real. Presentación, saludo, preguntas, despedida — ¡y mantenlo egipcio (minein/fein/ezzayyak/mesh), no MSA de libro!" },
          rudyTip: { ko: "이번 주에 배운 이집트 구어체만으로도 진짜 대화가 돼! 자기소개부터 작별까지 한 세트로 연습해보자~ 넌 이미 잘하고 있어!", en: "With just this week's Egyptian Arabic, you can hold a real conversation! From hello to goodbye — that's real progress. You're doing amazing!", es: "Solo con el árabe egipcio de esta semana puedes tener una conversación real. Desde hola hasta adiós: eso es progreso real. ¡Increíble!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "أنا ___ رودي.", answer: "اسمي", options: ["اسمي", "إنْت", "مِن"], fullSentence: "أنا اسمي رودي.", fullSentenceMeaning: { ko: "제 이름은 루디예요.", en: "My name is Rudy.", es: "Me llamo Rudy.", id: "Nama saya Rudy." } },
          { type: "select", promptWithBlank: "___ النَّهارْده؟", answer: "إزَّيَّك", options: ["إزَّيَّك", "بِكام", "فين"], fullSentence: "إزَّيَّك النَّهارْده؟", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?", id: "Apa kabar hari ini?" } },
          { type: "input", promptWithBlank: "آسِف، أنا ___ فاهِم.", answer: "مِش", fullSentence: "آسِف، أنا مِش فاهِم.", fullSentenceMeaning: { ko: "미안해요, 이해를 못 했어요.", en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", id: "Maaf, saya tidak mengerti." } },
          { type: "input", promptWithBlank: "___ الحَمّام؟", answer: "فين", fullSentence: "فين الحَمّام؟", fullSentenceMeaning: { ko: "화장실이 어디예요?", en: "Where is the bathroom?", es: "¿Dónde está el baño?", id: "Di mana toilet?" } },
          { type: "input", promptWithBlank: "___ ده؟", answer: "بِكام", fullSentence: "بِكام ده؟", fullSentenceMeaning: { ko: "이거 얼마예요?", en: "How much is this?", es: "¿Cuánto cuesta esto?", id: "Ini berapa harganya?" } },
          { type: "listening", audioText: "آسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["آسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟", "بِكام ده؟", "فين الحَمّام؟", "أنا اسمي رودي."], correct: 0, audioOnly: true },
        ],
      },
    },
  },
...
export const MISSION_CONTENT_IMPROVED: Record<string, Partial<Record<LearningLangKey, MissionTalkLangData>>> = {
  ...
  day_2: {
    ...
    arabic: { situation: { ko: "루디가 다른 나라에서 온 동료들과 이야기하고 있습니다.", en: "Rudy is chatting with colleagues from different countries.", es: "Rudy habla con colegas de diferentes países." }, gptPrompt: "You are Rudy chatting with your new partner about where you're both from. Simple A1 conversation in EGYPTIAN COLLOQUIAL Arabic (NOT MSA — use spoken Egyptian: 'إنْت مِنين', 'أنا ساكِن في', 'مَدينْتَك عامْلة إيه', never textbook forms). Ask about: 1) their country 2) their city 3) what it's like there 4) if they like it. Share that you're from London (لَنْدَن). At one point, speak slightly fast so the user can practice 'مُمْكِن تِقول تاني؟' or 'مُمْكِن تِتْكَلِّم بِراحة؟' Reinforce آه/لأ (yes/no) practice. Keep simple and write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["أنا مِن كوريا.", "أنا ساكِن في سيول.", "آه!", "لأ.", "مُمْكِن تِقول تاني؟", "دي مَدينة كبيرة."] },
  },
  ...
  day_3: {
    ...
    arabic: { situation: { ko: "박물관에서 여러 직업의 사람들을 만나고 있습니다.", en: "Meeting people with different jobs at the museum.", es: "Conociendo personas con diferentes trabajos." }, gptPrompt: "You are Rudy at a museum event meeting your new partner. Talk about jobs in simple A1 EGYPTIAN COLLOQUIAL Arabic (NOT MSA — use 'بِتِشْتَغَل إيه؟', 'بِتِتْكَلِّم إنجِليزي؟', the question word 'إيه', never the textbook 'ماذا'). Ask about: 1) what they do 2) where they work 3) what languages they speak. Practice 'بِتِتْكَلِّم ___؟' and 'شْوَيّة.' Keep very simple and write Arabic with harakat.", speechLang: "ar-EG", suggestedAnswers: ["أنا طالِب.", "أنا بَشْتَغَل في مَدْرَسة.", "بِتِتْكَلِّم إنجِليزي؟", "شْوَيّة.", "ده حاجة حِلْوة!", "آه، أنا بَحِبّه."] },
  },
...
export const REVIEW_CONTENT_IMPROVED: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_1: {
    ...
    arabic: [
      { type: "speak", sentence: "أهلاً، فُرْصة سعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, forsa sa3ida · 안녕하세요, 만나서 반갑습니다.", en: "ahlan, forsa sa3ida · Hello, nice to meet you.", es: "ahlan, forsa sa3ida · Hola, mucho gusto.", id: "ahlan, forsa sa3ida · Halo, senang bertemu." } },
      { type: "fill_blank", promptWithBlank: "أنا ___ رودي.", answer: "اسمي", options: ["اسمي", "أنا", "إنْت"], fullSentence: "أنا اسمي رودي.", fullSentenceMeaning: { ko: "ana esmi Rudy · 제 이름은 루디예요.", en: "ana esmi Rudy · My name is Rudy.", es: "ana esmi Rudy · Me llamo Rudy.", id: "ana esmi Rudy · Nama saya Rudy." } },
      { type: "speak", sentence: "آسِف، أنا مِش فاهِم.", speechLang: "ar-EG", meaning: { ko: "aasef, ana mesh fahem · 미안해요, 이해를 못 했어요.", en: "aasef, ana mesh fahem · Sorry, I don't understand.", es: "aasef, ana mesh fahem · Lo siento, no entiendo.", id: "aasef, ana mesh fahem · Maaf, saya tidak mengerti." } },
      { type: "fill_blank", promptWithBlank: "إنْت ___؟", answer: "مِنين", options: ["مِنين", "إيه", "مين"], fullSentence: "إنْت مِنين؟", fullSentenceMeaning: { ko: "enta minein? · 어디에서 오셨어요?", en: "enta minein? · Where are you from?", es: "enta minein? · ¿De dónde eres?", id: "enta minein? · Anda berasal dari mana?" } },
      { type: "speak", sentence: "شُكْراً. فُرْصة سعيدة.", speechLang: "ar-EG", meaning: { ko: "shokran. forsa sa3ida · 감사합니다. 만나서 반갑습니다.", en: "shokran. forsa sa3ida · Thank you. Nice to meet you.", es: "shokran. forsa sa3ida · Gracias. Mucho gusto.", id: "shokran. forsa sa3ida · Terima kasih. Senang bertemu." } },
    ],
  },
  ...
  day_2: {
    ...
    arabic: [
      { type: "speak", sentence: "أهلاً، أنا اسمي رودي.", speechLang: "ar-EG", meaning: { ko: "ahlan, ana esmi Rudy · 안녕하세요, 제 이름은 루디예요.", en: "ahlan, ana esmi Rudy · Hello, my name is Rudy.", es: "ahlan, ana esmi Rudy · Hola, me llamo Rudy.", id: "ahlan, ana esmi Rudy · Halo, nama saya Rudy." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "آسِف، أنا ___ فاهِم.", answer: "مِش", options: ["مِش", "لا", "مو"], fullSentence: "آسِف، أنا مِش فاهِم.", fullSentenceMeaning: { ko: "aasef, ana mesh fahem · 미안해요, 이해를 못 했어요.", en: "aasef, ana mesh fahem · Sorry, I don't understand.", es: "aasef, ana mesh fahem · Lo siento, no entiendo.", id: "aasef, ana mesh fahem · Maaf, saya tidak mengerti." }, isYesterdayReview: true },
      { type: "speak", sentence: "أنا مِن كوريا. أنا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "ana men Korea. ana saken fi Seoul · 저는 한국에서 왔어요. 서울에 살아요.", en: "ana men Korea. ana saken fi Seoul · I'm from Korea. I live in Seoul.", es: "ana men Korea. ana saken fi Seoul · Soy de Corea. Vivo en Seúl.", id: "ana men Korea. ana saken fi Seoul · Saya berasal dari Korea. Saya tinggal di Seoul." } },
      { type: "fill_blank", promptWithBlank: "مُمْكِن تِقول ___؟", answer: "تاني", options: ["تاني", "بِراحة", "كِتير"], fullSentence: "مُمْكِن تِقول تاني؟", fullSentenceMeaning: { ko: "momken te'ool tani? · 다시 한번 말해 주시겠어요?", en: "momken te'ool tani? · Can you say that again, please?", es: "momken te'ool tani? · ¿Puede repetir eso, por favor?", id: "momken te'ool tani? · Bisa tolong ulangi?" } },
      { type: "speak", sentence: "مُمْكِن تِقول تاني؟", speechLang: "ar-EG", meaning: { ko: "momken te'ool tani? · 다시 한번 말해 주시겠어요?", en: "momken te'ool tani? · Can you say that again, please?", es: "momken te'ool tani? · ¿Puede repetir eso, por favor?", id: "momken te'ool tani? · Bisa tolong ulangi?" } },
    ],
  },
  ...
  day_3: {
    ...
    arabic: [
      ...
      { type: "speak", sentence: "أنا طالِب. أنا بَشْتَغَل في مَدْرَسة.", speechLang: "ar-EG", meaning: { ko: "ana taleb. ana bashtaghal fi madrasa · 저는 학생이에요. 학교에서 일해요.", en: "ana taleb. ana bashtaghal fi madrasa · I'm a student. I work at a school.", es: "ana taleb. ana bashtaghal fi madrasa · Soy estudiante. Trabajo en una escuela.", id: "ana taleb. ana bashtaghal fi madrasa · Saya seorang pelajar. Saya bekerja di sekolah." } },
      { type: "fill_blank", promptWithBlank: "بِتِتْكَلِّم ___؟", answer: "إنجِليزي", options: ["إنجِليزي", "شِرْكة", "طالِب"], fullSentence: "بِتِتْكَلِّم إنجِليزي؟", fullSentenceMeaning: { ko: "beteklem engelizi? · 영어 할 줄 아세요?", en: "beteklem engelizi? · Do you speak English?", es: "beteklem engelizi? · ¿Hablas inglés?", id: "beteklem engelizi? · Apakah kamu bisa bahasa Inggris?" } },
      { type: "speak", sentence: "بِتِتْكَلِّم إنجِليزي؟ شْوَيّة.", speechLang: "ar-EG", meaning: { ko: "beteklem engelizi? shwaya · 영어 할 줄 아세요? 조금이요.", en: "beteklem engelizi? shwaya · Do you speak English? A little bit.", es: "beteklem engelizi? shwaya · ¿Hablas inglés? Un poquito.", id: "beteklem engelizi? shwaya · Apakah kamu bisa bahasa Inggris? Sedikit saja." } },
    ],
  },
  ...
  day_4: {
    ...
    arabic: [
      { type: "speak", sentence: "أنا طالِب. بِتِتْكَلِّم إنجِليزي؟", speechLang: "ar-EG", meaning: { ko: "ana taleb. beteklem engelizi? · 저는 학생이에요. 영어 할 줄 아세요?", en: "ana taleb. beteklem engelizi? · I'm a student. Do you speak English?", es: "ana taleb. beteklem engelizi? · Soy estudiante. ¿Hablas inglés?", id: "ana taleb. beteklem engelizi? · Saya seorang pelajar. Apakah kamu bisa bahasa Inggris?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "بِتِشْتَغَل ___؟", answer: "إيه", options: ["إيه", "مين", "فين"], fullSentence: "بِتِشْتَغَل إيه؟", fullSentenceMeaning: { ko: "beteshtaghal eh? · 무슨 일 하세요?", en: "beteshtaghal eh? · What do you do?", es: "beteshtaghal eh? · ¿A qué te dedicas?", id: "beteshtaghal eh? · Apa pekerjaan Anda?" }, isYesterdayReview: true },
      { type: "speak", sentence: "مع السَّلامة! أشوفَك بَعْدين! خَلّي بالَك!", speechLang: "ar-EG", meaning: { ko: "ma3a el-salama! ashoofak ba3dein! khalli balak! · 안녕히 가세요! 다음에 봐요! 잘 가요!", en: "ma3a el-salama! ashoofak ba3dein! khalli balak! · Goodbye! See you later! Take care!", es: "ma3a el-salama! ashoofak ba3dein! khalli balak! · ¡Adiós! ¡Hasta luego! ¡Cuídate!", id: "ma3a el-salama! ashoofak ba3dein! khalli balak! · Selamat tinggal! Sampai jumpa nanti! Hati-hati!" } },
      { type: "fill_blank", promptWithBlank: "___ الحَمّام؟", answer: "فين", options: ["فين", "إيه", "إمْتى"], fullSentence: "فين الحَمّام؟", fullSentenceMeaning: { ko: "fein el-hammam? · 화장실이 어디예요?", en: "fein el-hammam? · Where is the bathroom?", es: "fein el-hammam? · ¿Dónde está el baño?", id: "fein el-hammam? · Di mana toilet?" } },
      { type: "speak", sentence: "لو سَمَحْت، فين الخُروج؟", speechLang: "ar-EG", meaning: { ko: "law samaht, fein el-khoroog? · 실례합니다, 출구가 어디예요?", en: "law samaht, fein el-khoroog? · Excuse me, where is the exit?", es: "law samaht, fein el-khoroog? · Disculpe, ¿dónde está la salida?", id: "law samaht, fein el-khoroog? · Permisi, di mana pintu keluar?" } },
    ],
  },
  ...
  day_5: {
    ...
    arabic: [
      { type: "speak", sentence: "مع السَّلامة! خَلّي بالَك! فين الخُروج؟", speechLang: "ar-EG", meaning: { ko: "ma3a el-salama! khalli balak! fein el-khoroog? · 안녕히 가세요! 잘 가요! 출구가 어디예요?", en: "ma3a el-salama! khalli balak! fein el-khoroog? · Goodbye! Take care! Where is the exit?", es: "ma3a el-salama! khalli balak! fein el-khoroog? · ¡Adiós! ¡Cuídate! ¿Dónde está la salida?", id: "ma3a el-salama! khalli balak! fein el-khoroog? · Selamat tinggal! Hati-hati! Di mana pintu keluar?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "مع ___! أشوفَك بَعْدين.", answer: "السَّلامة", options: ["السَّلامة", "الخير", "النَّجْدة"], fullSentence: "مع السَّلامة! أشوفَك بَعْدين.", fullSentenceMeaning: { ko: "ma3a el-salama! ashoofak ba3dein · 안녕히 가세요! 다음에 봐요!", en: "ma3a el-salama! ashoofak ba3dein · Goodbye! See you later!", es: "ma3a el-salama! ashoofak ba3dein · ¡Adiós! ¡Hasta luego!", id: "ma3a el-salama! ashoofak ba3dein · Selamat tinggal! Sampai jumpa nanti!" }, isYesterdayReview: true },
      { type: "speak", sentence: "أنا كُوَيِّس، شُكْراً. وإنْت؟", speechLang: "ar-EG", meaning: { ko: "ana kwayyes, shokran. wenta? · 잘 지내요, 감사합니다. 당신은요?", en: "ana kwayyes, shokran. wenta? · I'm fine, thank you. And you?", es: "ana kwayyes, shokran. wenta? · Estoy bien, gracias. ¿Y tú?", id: "ana kwayyes, shokran. wenta? · Saya baik-baik saja, terima kasih. Bagaimana dengan Anda?" } },
      { type: "fill_blank", promptWithBlank: "___ ده؟", answer: "بِكام", options: ["بِكام", "فين", "إزَّيَّك"], fullSentence: "بِكام ده؟", fullSentenceMeaning: { ko: "bekam da? · 이거 얼마예요?", en: "bekam da? · How much is this?", es: "bekam da? · ¿Cuánto cuesta esto?", id: "bekam da? · Ini berapa harganya?" } },
      { type: "speak", sentence: "النَّجْدة! مُحْتاج مُساعْدة، لو سَمَحْت.", speechLang: "ar-EG", meaning: { ko: "el-nagda! mehtaag mosa3da, law samaht · 도와주세요! 도움이 필요해요.", en: "el-nagda! mehtaag mosa3da, law samaht · Help! I need help, please.", es: "el-nagda! mehtaag mosa3da, law samaht · ¡Ayuda! Necesito ayuda, por favor.", id: "el-nagda! mehtaag mosa3da, law samaht · Tolong! Saya butuh bantuan." } },
    ],
  },
  ...
  day_6: {
    ...
    arabic: [
      { type: "speak", sentence: "أهلاً، أنا اسمي رودي. فُرْصة سعيدة.", speechLang: "ar-EG", meaning: { ko: "ahlan, ana esmi Rudy. forsa sa3ida · 안녕하세요, 제 이름은 루디예요. 반갑습니다.", en: "ahlan, ana esmi Rudy. forsa sa3ida · Hello, my name is Rudy. Nice to meet you.", es: "ahlan, ana esmi Rudy. forsa sa3ida · Hola, me llamo Rudy. Mucho gusto.", id: "ahlan, ana esmi Rudy. forsa sa3ida · Halo, nama saya Rudy. Senang bertemu dengan Anda." } },
      { type: "speak", sentence: "أنا مِن كوريا. أنا ساكِن في سيول.", speechLang: "ar-EG", meaning: { ko: "ana men Korea. ana saken fi Seoul · 한국에서 왔어요. 서울에 살아요.", en: "ana men Korea. ana saken fi Seoul · I'm from Korea. I live in Seoul.", es: "ana men Korea. ana saken fi Seoul · Soy de Corea. Vivo en Seúl.", id: "ana men Korea. ana saken fi Seoul · Saya berasal dari Korea. Saya tinggal di Seoul." } },
      { type: "speak", sentence: "آسِف، أنا مِش فاهِم. مُمْكِن تِقول تاني؟", speechLang: "ar-EG", meaning: { ko: "aasef, ana mesh fahem. momken te'ool tani? · 미안해요, 이해를 못 했어요. 다시 한번 말해 주시겠어요?", en: "aasef, ana mesh fahem. momken te'ool tani? · Sorry, I don't understand. Can you say that again?", es: "aasef, ana mesh fahem. momken te'ool tani? · Lo siento, no entiendo. ¿Puede repetir eso?", id: "aasef, ana mesh fahem. momken te'ool tani? · Maaf, saya tidak mengerti. Bisa tolong ulangi?" } },
      { type: "speak", sentence: "فين الحَمّام؟ بِكام ده؟", speechLang: "ar-EG", meaning: { ko: "fein el-hammam? bekam da? · 화장실이 어디예요? 이거 얼마예요?", en: "fein el-hammam? bekam da? · Where is the bathroom? How much is this?", es: "fein el-hammam? bekam da? · ¿Dónde está el baño? ¿Cuánto cuesta esto?", id: "fein el-hammam? bekam da? · Di mana toilet? Ini berapa harganya?" } },
      { type: "speak", sentence: "مع السَّلامة! خَلّي بالَك! أشوفَك بُكْرة!", speechLang: "ar-EG", meaning: { ko: "ma3a el-salama! khalli balak! ashoofak bokra! · 안녕히 가세요! 잘 가요! 내일 봐요!", en: "ma3a el-salama! khalli balak! ashoofak bokra! · Goodbye! Take care! See you tomorrow!", es: "ma3a el-salama! khalli balak! ashoofak bokra! · ¡Adiós! ¡Cuídate! ¡Hasta mañana!", id: "ma3a el-salama! khalli balak! ashoofak bokra! · Selamat tinggal! Hati-hati! Sampai jumpa besok!" } },
    ],
  },
};
