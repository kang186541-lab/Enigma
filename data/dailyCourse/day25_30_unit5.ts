...
export const LESSON_CONTENT_UNIT5: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_25: {
    ...
    arabic: {
      step1Sentences: [
        { text: "هٰذِهِ عائِلَتي. (hādhihi ‘ā’ilatī)", speechLang: "ar-EG", meaning: { ko: "이것은 제 가족이에요.", en: "This is my family.", es: "Esta es mi familia." } },
        { text: "عِنْدي أَخَوانِ وأُخْت واحِدة. (‘indī akhawāni wa-ukht wāḥida)", speechLang: "ar-EG", meaning: { ko: "저는 형제 둘과 자매 하나가 있어요.", en: "I have two brothers and one sister.", es: "Tengo dos hermanos y una hermana." } },
        { text: "أُمّي مُدَرِّسة. (ummī mudarrisa)", speechLang: "ar-EG", meaning: { ko: "어머니는 선생님.", en: "My mother is a teacher.", es: "Mi madre es profesora." } },
        { text: "أبي يَعْمَل في مُسْتَشْفى. (abī ya‘mal fī mustashfā)", speechLang: "ar-EG", meaning: { ko: "아버지는 병원에서 일해요.", en: "My father works at a hospital.", es: "Mi padre trabaja en un hospital." }, recallRound: true },
        { text: "عِنْدَكَ أَطْفال؟ (‘indaka aṭfāl?)", speechLang: "ar-EG", meaning: { ko: "자녀가 있으세요?", en: "Do you have any children?", es: "¿Tienes hijos?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "가족 소개: 'هٰذِهِ/هٰذا ___' / 소유: '___ + ي (제 ___)' / 가족 수: 'عِنْدي ___' / 직업: '___ + 직업' 또는 'يَعْمَل في ___'", en: "'هٰذِهِ/هٰذا ___' → introduce family / noun + ي → 'my ___' / 'عِنْدي ___' → count / job goes straight after, or 'يَعْمَل في ___' → works at", es: "'هٰذِهِ/هٰذا ___' → presentar familia / sustantivo + ي → 'mi ___' / 'عِنْدي ___' → contar / el trabajo va después, o 'يَعْمَل في ___' → trabaja en" },
          examples: { ko: "هٰذِهِ أُمّي. / عِنْدي أُخْت وأَخَوان. / أبي يَعْمَل في بَنْك. (hādhihi ummī / ‘indī ukht wa-akhawān / abī ya‘mal fī bank)", en: "هٰذِهِ أُمّي. / عِنْدي أُخْت وأَخَوان. / أبي يَعْمَل في بَنْك. (hādhihi ummī / ‘indī ukht wa-akhawān / abī ya‘mal fī bank)", es: "هٰذِهِ أُمّي. / عِنْدي أُخْت وأَخَوان. / أبي يَعْمَل في بَنْك. (hādhihi ummī / ‘indī ukht wa-akhawān / abī ya‘mal fī bank)" },
          mistakes: { ko: "💬 이집트 구어로는 'دي عيلتي' 지만 표준어는 'هٰذِهِ عائِلَتي' ✓\n\n❌ عِنْدي أَخ اِثْنان.\n✅ عِنْدي أَخَوان. (둘은 쌍수 أَخَوان 으로)", en: "💬 In Egyptian dialect it's 'دي عيلتي' but MSA is 'هٰذِهِ عائِلَتي' ✓\n\n❌ عِنْدي أَخ اِثْنان.\n✅ عِنْدي أَخَوان. (use the dual أَخَوان, not أَخ + اِثْنان)", es: "💬 En dialecto egipcio es 'دي عيلتي' pero en árabe estándar es 'هٰذِهِ عائِلَتي' ✓\n\n❌ عِنْدي أَخ اِثْنان.\n✅ عِنْدي أَخَوان. (usa el dual أَخَوان, no أَخ + اِثْنان)" },
          rudyTip: { ko: "표준어(MSA)에서 '제 ___'는 명사 끝에 ي만 붙여! عائِلة(가족) → عائِلَتي(제 가족), أُمّ(엄마) → أُمّي(우리 엄마). '~가 있어요'는 'عِنْدي'(‘indī) 하나면 끝!", en: "In MSA, 'my ___' is just adding ي to the end! عائِلة (family) → عائِلَتي (my family), أُمّ (mom) → أُمّي (my mom). And 'I have' is one word: 'عِنْدي' (‘indī)!", es: "¡En árabe estándar, 'mi ___' es solo añadir ي al final! عائِلة (familia) → عائِلَتي, أُمّ (mamá) → أُمّي. Y 'tengo' es una palabra: 'عِنْدي' (‘indī)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "هٰذِهِ ___.", answer: "عائِلَتي", options: ["عائِلَتي", "صَديقي", "بَيْتي"], fullSentence: "هٰذِهِ عائِلَتي.", fullSentenceMeaning: { ko: "이것은 제 가족.", en: "This is my family.", es: "Esta es mi familia." } },
          { type: "select", promptWithBlank: "عِنْدي ___ وأُخْت واحِدة.", answer: "أَخَوان", options: ["أَخَوان", "أَصْدِقاء", "مُدَرِّسون"], fullSentence: "عِنْدي أَخَوان وأُخْت واحِدة.", fullSentenceMeaning: { ko: "형제 둘, 자매 하나.", en: "Two brothers, one sister.", es: "Dos hermanos, una hermana." } },
          { type: "select", promptWithBlank: "أُمّي ___.", answer: "مُدَرِّسة", options: ["مُدَرِّسة", "طالِبة", "طَبيبة"], fullSentence: "أُمّي مُدَرِّسة.", fullSentenceMeaning: { ko: "어머니는 선생님.", en: "My mother is a teacher.", es: "Mi madre es profesora." } },
          { type: "input", promptWithBlank: "أبي ___ في مُسْتَشْفى.", answer: "يَعْمَل", fullSentence: "أبي يَعْمَل في مُسْتَشْفى.", fullSentenceMeaning: { ko: "아버지는 병원에서 일해요.", en: "Father works at hospital.", es: "Padre trabaja en hospital." } },
          { type: "input", promptWithBlank: "عِنْدَكَ ___؟", answer: "أَطْفال", fullSentence: "عِنْدَكَ أَطْفال؟", fullSentenceMeaning: { ko: "자녀가 있으세요?", en: "Do you have children?", es: "¿Tienes hijos?" } },
          { type: "listening", audioText: "عِنْدَكَ أَطْفال؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["عِنْدَكَ أَطْفال؟", "هٰذِهِ عائِلَتي.", "عِنْدي أَخَوان وأُخْت واحِدة.", "أُمّي مُدَرِّسة."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "My name is Rudy.", es: "Mi nombre es Rudy.", ko: "제 이름은 루디예요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_26: {
    ...
    arabic: {
      step1Sentences: [
        { text: "هِيَ طَويلة وشَعْرُها طَويل. (hiya ṭawīla wa-sha‘ruhā ṭawīl)", speechLang: "ar-EG", meaning: { ko: "그녀는 키가 크고 머리카락이 길어요.", en: "She is tall and has long hair.", es: "Ella es alta y tiene el pelo largo." } },
        { text: "هُوَ يَرْتَدي سُتْرة زَرْقاء. (huwa yartadī sutra zarqā’)", speechLang: "ar-EG", meaning: { ko: "그는 파란색 재킷을 입고 있어요.", en: "He is wearing a blue jacket.", es: "Él lleva una chaqueta azul." } },
        { text: "صَديقي طَيِّب جِدًّا. (ṣadīqī ṭayyib jiddan)", speechLang: "ar-EG", meaning: { ko: "제 친구는 매우 친절해요.", en: "My friend is very kind.", es: "Mi amigo es muy amable." } },
        { text: "الرَّجُل الَّذي يَرْتَدي نَظّارة هو مُدَرِّسي. (ar-rajul alladhī yartadī naẓẓāra huwa mudarrisī)", speechLang: "ar-EG", meaning: { ko: "안경 쓴 남자가 선생님.", en: "Man with glasses is my teacher.", es: "Hombre con gafas es mi profesor." }, recallRound: true },
        { text: "هِيَ طَويلة جِدًّا وشَعْرُها طَويل. (hiya ṭawīla jiddan wa-sha‘ruhā ṭawīl)", speechLang: "ar-EG", meaning: { ko: "그녀는 키가 크고 머리가 길어요.", en: "She is very tall and has long hair.", es: "Ella es muy alta y tiene el pelo largo." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "외모: 'هُوَ/هِيَ + 형용사' (طَويل/قَصير) / 옷: 'يَرْتَدي ___' / 특징: 'الَّذي يَرْتَدي ___' / 성격: '___ جِدًّا (매우 ___)'", en: "'هُوَ/هِيَ + adjective' (طَويل/قَصير) → appearance / 'يَرْتَدي ___' → wearing / 'الَّذي يَرْتَدي ___' → the one wearing → identify / '___ جِدًّا' → very ___", es: "'هُوَ/هِيَ + adjetivo' (طَويل/قَصير) → apariencia / 'يَرْتَدي ___' → llevar puesto / 'الَّذي يَرْتَدي ___' → identificar / '___ جِدًّا' → muy ___" },
          examples: { ko: "هِيَ طَويلة وشَعْرُها بُنّي. / هُوَ يَرْتَدي قَميصًا أَحْمَر. / المَرْأة الَّتي تَرْتَدي قُبَّعة هي صَديقَتي. (hiya ṭawīla wa-sha‘ruhā bunnī / huwa yartadī qamīṣan aḥmar / al-mar’a allatī tartadī qubba‘a hiya ṣadīqatī)", en: "هِيَ طَويلة وشَعْرُها بُنّي. / هُوَ يَرْتَدي قَميصًا أَحْمَر. / المَرْأة الَّتي تَرْتَدي قُبَّعة هي صَديقَتي. (hiya ṭawīla wa-sha‘ruhā bunnī / huwa yartadī qamīṣan aḥmar / al-mar’a allatī tartadī qubba‘a hiya ṣadīqatī)", es: "هِيَ طَويلة وشَعْرُها بُنّي. / هُوَ يَرْتَدي قَميصًا أَحْمَر. / المَرْأة الَّتي تَرْتَدي قُبَّعة هي صَديقَتي. (hiya ṭawīla wa-sha‘ruhā bunnī / huwa yartadī qamīṣan aḥmar / al-mar’a allatī tartadī qubba‘a hiya ṣadīqatī)" },
          mistakes: { ko: "❌ هُوَ طَويلة.\n✅ هُوَ طَويل. (형용사는 성별 일치)\n\n💬 이집트 구어로는 'لابس' 지만 표준어 동사는 'يَرْتَدي' ✓", en: "❌ هُوَ طَويلة.\n✅ هُوَ طَويل. (adjective must match gender)\n\n💬 In Egyptian dialect 'wearing' is the participle 'لابس', but the MSA verb is 'يَرْتَدي' ✓", es: "❌ هُوَ طَويلة.\n✅ هُوَ طَويل. (el adjetivo concuerda en género)\n\n💬 En dialecto egipcio 'llevar puesto' es el participio 'لابس', pero el verbo en árabe estándar es 'يَرْتَدي' ✓" },
          rudyTip: { ko: "표준어(MSA)에서 '입고 있다'는 동사 'يَرْتَدي'(yartadī)! 남자는 يَرْتَدي, 여자는 تَرْتَدي. 그리고 '매우'는 형용사 뒤에 'جِدًّا'(jiddan)를 붙여 — 'طَويل جِدًّا'(키 엄청 커)!", en: "In MSA, 'is wearing' is the verb 'يَرْتَدي' (yartadī)! Man = يَرْتَدي, woman = تَرْتَدي. And 'very' goes AFTER: 'جِدًّا' (jiddan) — 'طَويل جِدًّا' (super tall)!", es: "En árabe estándar, 'llevar puesto' es el verbo 'يَرْتَدي' (yartadī). Hombre = يَرْتَدي, mujer = تَرْتَدي. Y 'muy' va DESPUÉS: 'جِدًّا' (jiddan) — 'طَويل جِدًّا'." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "هِيَ طَويلة و___ طَويل.", answer: "شَعْرُها", options: ["شَعْرُها", "عَيْنُها", "يَدُها"], fullSentence: "هِيَ طَويلة وشَعْرُها طَويل.", fullSentenceMeaning: { ko: "키 크고 머리 길어요.", en: "Tall with long hair.", es: "Alta con pelo largo." } },
          { type: "select", promptWithBlank: "هُوَ ___ سُتْرة زَرْقاء.", answer: "يَرْتَدي", options: ["يَرْتَدي", "عِنْدَهُ", "يَفْعَل"], fullSentence: "هُوَ يَرْتَدي سُتْرة زَرْقاء.", fullSentenceMeaning: { ko: "파란 재킷 입고 있어요.", en: "Wearing a blue jacket.", es: "Lleva chaqueta azul." } },
          { type: "select", promptWithBlank: "صَديقي طَيِّب ___.", answer: "جِدًّا", options: ["جِدًّا", "طَويل", "أَزْرَق"], fullSentence: "صَديقي طَيِّب جِدًّا.", fullSentenceMeaning: { ko: "친구는 매우 친절해요.", en: "My friend is very kind.", es: "Mi amigo es muy amable." } },
          { type: "input", promptWithBlank: "الرَّجُل الَّذي يَرْتَدي ___ هو مُدَرِّسي.", answer: "نَظّارة", fullSentence: "الرَّجُل الَّذي يَرْتَدي نَظّارة هو مُدَرِّسي.", fullSentenceMeaning: { ko: "안경 쓴 남자가 선생님.", en: "Man with glasses is teacher.", es: "Hombre con gafas es profesor." } },
          { type: "input", promptWithBlank: "هِيَ طَويلة ___ وشَعْرُها طَويل.", answer: "جِدًّا", fullSentence: "هِيَ طَويلة جِدًّا وشَعْرُها طَويل.", fullSentenceMeaning: { ko: "그녀는 키가 크고 머리가 길어요.", en: "She is very tall and has long hair.", es: "Ella es muy alta y tiene el pelo largo." } },
          { type: "listening", audioText: "هِيَ طَويلة جِدًّا وشَعْرُها طَويل.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هِيَ طَويلة جِدًّا وشَعْرُها طَويل.", "هُوَ يَرْتَدي سُتْرة زَرْقاء.", "صَديقي طَيِّب جِدًّا.", "الرَّجُل الَّذي يَرْتَدي نَظّارة هو مُدَرِّسي."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "That's fifteen dollars, please.", es: "Son quince dólares, por favor.", ko: "15달러예요." }, fromDay: 6, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_27: {
    ...
    arabic: {
      step1Sentences: [
        { text: "ماذا تُحِبّ أَنْ تَفْعَل في وَقْت فَراغِك؟ (mādhā tuḥibb an taf‘al fī waqt farāghik?)", speechLang: "ar-EG", meaning: { ko: "여가 시간에 뭘 좋아하세요?", en: "What do you like to do in your free time?", es: "¿Qué te gusta hacer en tu tiempo libre?" } },
        { text: "أُحِبّ أَنْ أَقْرَأ كُتُبًا وأُشاهِد أَفْلامًا. (uḥibb an aqra’ kutuban wa-ushāhid aflāman)", speechLang: "ar-EG", meaning: { ko: "저는 책 읽기와 영화 보기를 좋아해요.", en: "I like reading books and watching movies.", es: "Me gusta leer libros y ver películas." } },
        { text: "هَل تُمارِس رِياضة؟ (hal tumāris riyāḍa?)", speechLang: "ar-EG", meaning: { ko: "스포츠를 하세요?", en: "Do you play any sports?", es: "¿Practicas algún deporte?" } },
        { text: "أَلْعَب كُرة القَدَم كُلّ نِهاية أُسْبوع. (al‘ab kurat al-qadam kull nihāyat usbū‘)", speechLang: "ar-EG", meaning: { ko: "매주 주말 축구해요.", en: "I play football every weekend.", es: "Juego al fútbol cada fin de semana." }, recallRound: true },
        { text: "هِوايَتي الطَّبْخ. (hiwāyatī aṭ-ṭabkh)", speechLang: "ar-EG", meaning: { ko: "취미는 요리.", en: "My hobby is cooking.", es: "Mi hobby es cocinar." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "취미 질문: 'ماذا تُحِبّ أَنْ تَفْعَل؟' / 대답: 'أُحِبّ أَنْ + 동사 (أَقْرَأ/أُشاهِد)' / 스포츠: 'أُمارِس/أَلْعَب ___' / 취미: 'هِوايَتي ___'", en: "'ماذا تُحِبّ أَنْ تَفْعَل؟' → ask hobbies / 'أُحِبّ أَنْ + verb' (أَقْرَأ/أُشاهِد) → answer / 'أُمارِس/أَلْعَب ___' → sports / 'هِوايَتي ___' → hobby", es: "'ماذا تُحِبّ أَنْ تَفْعَل؟' → preguntar hobbies / 'أُحِبّ أَنْ + verbo' (أَقْرَأ/أُشاهِد) → responder / 'أُمارِس/أَلْعَب ___' → deportes / 'هِوايَتي ___' → hobby" },
          examples: { ko: "أُحِبّ أَنْ أَسْبَح في الصَّيْف. / أَلْعَب التِّنِس يَوْم السَّبْت. / هِوايَتي الرَّسْم. (uḥibb an asbaḥ fī aṣ-ṣayf / al‘ab at-tinis yawm as-sabt / hiwāyatī ar-rasm)", en: "أُحِبّ أَنْ أَسْبَح في الصَّيْف. / أَلْعَب التِّنِس يَوْم السَّبْت. / هِوايَتي الرَّسْم. (uḥibb an asbaḥ fī aṣ-ṣayf / al‘ab at-tinis yawm as-sabt / hiwāyatī ar-rasm)", es: "أُحِبّ أَنْ أَسْبَح في الصَّيْف. / أَلْعَب التِّنِس يَوْم السَّبْت. / هِوايَتي الرَّسْم. (uḥibb an asbaḥ fī aṣ-ṣayf / al‘ab at-tinis yawm as-sabt / hiwāyatī ar-rasm)" },
          mistakes: { ko: "💬 이집트 구어로는 'بحب أقرا' 지만 표준어는 'أُحِبّ أَنْ أَقْرَأ' ✓ (أَنْ 뒤 동사는 접속법)\n\n❌ أَلْعَب الطَّبْخ.\n✅ هِوايَتي الطَّبْخ. ('لعب'은 운동에만 쓰여요)", en: "💬 In Egyptian dialect it's 'بحب أقرا' but MSA is 'أُحِبّ أَنْ أَقْرَأ' ✓ (verb after أَنْ takes the subjunctive)\n\n❌ أَلْعَب الطَّبْخ.\n✅ هِوايَتي الطَّبْخ. ('لعب' is only for sports, not cooking)", es: "💬 En dialecto egipcio es 'بحب أقرا' pero en árabe estándar es 'أُحِبّ أَنْ أَقْرَأ' ✓ (el verbo tras أَنْ va en subjuntivo)\n\n❌ أَلْعَب الطَّبْخ.\n✅ هِوايَتي الطَّبْخ. ('لعب' es solo para deportes, no cocinar)" },
          rudyTip: { ko: "표준어(MSA)는 '좋아하다 + أَنْ + 동사'로 말해! 'أُحِبّ أَنْ أَقْرَأ'(읽는 거 좋아해). 운동은 'أُمارِس/أَلْعَب', 취미는 'هِوايَتي'(hiwāyatī)로~", en: "MSA uses 'like + أَنْ + verb'! 'أُحِبّ أَنْ أَقْرَأ' (I like to read). Sports = 'أُمارِس/أَلْعَب', hobbies = 'هِوايَتي' (hiwāyatī)!", es: "¡El árabe estándar usa 'gustar + أَنْ + verbo'! 'أُحِبّ أَنْ أَقْرَأ' (me gusta leer). Deportes = 'أُمارِس/أَلْعَب', hobbies = 'هِوايَتي' (hiwāyatī)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "ماذا تُحِبّ أَنْ ___ في وَقْت فَراغِك؟", answer: "تَفْعَل", options: ["تَفْعَل", "تَذْهَب", "تُحْضِر"], fullSentence: "ماذا تُحِبّ أَنْ تَفْعَل في وَقْت فَراغِك؟", fullSentenceMeaning: { ko: "여가에 뭘 좋아하세요?", en: "What do you like to do?", es: "¿Qué te gusta hacer?" } },
          { type: "select", promptWithBlank: "أُحِبّ أَنْ ___ كُتُبًا.", answer: "أَقْرَأ", options: ["أَقْرَأ", "أَلْعَب", "أَلْبَس"], fullSentence: "أُحِبّ أَنْ أَقْرَأ كُتُبًا.", fullSentenceMeaning: { ko: "책 읽기를 좋아해요.", en: "I like reading books.", es: "Me gusta leer libros." } },
          { type: "select", promptWithBlank: "أَلْعَب ___ كُلّ نِهاية أُسْبوع.", answer: "كُرة القَدَم", options: ["كُرة القَدَم", "كُتُب", "طَعام"], fullSentence: "أَلْعَب كُرة القَدَم كُلّ نِهاية أُسْبوع.", fullSentenceMeaning: { ko: "매주 주말 축구해요.", en: "I play football every weekend.", es: "Juego al fútbol cada fin de semana." } },
          { type: "input", promptWithBlank: "هَل تُمارِس ___؟", answer: "رِياضة", fullSentence: "هَل تُمارِس رِياضة؟", fullSentenceMeaning: { ko: "스포츠 하세요?", en: "Do you play sports?", es: "¿Practicas deportes?" } },
          { type: "input", promptWithBlank: "___ الطَّبْخ.", answer: "هِوايَتي", fullSentence: "هِوايَتي الطَّبْخ.", fullSentenceMeaning: { ko: "취미는 요리.", en: "My hobby is cooking.", es: "Mi hobby es cocinar." } },
          { type: "listening", audioText: "هِوايَتي الطَّبْخ.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هِوايَتي الطَّبْخ.", "ماذا تُحِبّ أَنْ تَفْعَل في وَقْت فَراغِك؟", "أُحِبّ أَنْ أَقْرَأ كُتُبًا وأُشاهِد أَفْلامًا.", "هَل تُمارِس رِياضة؟"], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "I would like to order, please.", es: "Quisiera pedir, por favor.", ko: "주문할게요." }, fromDay: 11, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_28: {
    ...
    arabic: {
      step1Sentences: [
        { text: "كَيْفَ تَشْعُر اليَوْم؟ (kayfa tash‘ur al-yawm?)", speechLang: "ar-EG", meaning: { ko: "오늘 기분이 어떠세요?", en: "How are you feeling today?", es: "¿Cómo te sientes hoy?" } },
        { text: "أنا سَعيد جِدًّا اليَوْم. (anā sa‘īd jiddan al-yawm)", speechLang: "ar-EG", meaning: { ko: "오늘 매우 행복해요.", en: "I am very happy today.", es: "Estoy muy feliz hoy." } },
        { text: "أنا مُتْعَب لِأَنّي عَمِلْت طَوال اليَوْم. (anā mut‘ab li-annī ‘amilt ṭawāl al-yawm)", speechLang: "ar-EG", meaning: { ko: "하루 종일 일해서 피곤해요.", en: "I am tired because I worked all day.", es: "Estoy cansado porque trabajé todo el día." } },
        { text: "هَل أَنْتَ بِخَيْر؟ تَبْدو قَلِقًا. (hal anta bi-khayr? tabdū qaliqan)", speechLang: "ar-EG", meaning: { ko: "괜찮아요? 걱정돼 보여요.", en: "Are you okay? You look worried.", es: "¿Estás bien? Pareces preocupado." }, recallRound: true },
        { text: "أنا مُتَحَمِّس جِدًّا لِلرِّحْلة! (anā mutaḥammis jiddan lir-riḥla!)", speechLang: "ar-EG", meaning: { ko: "여행이 기대돼요!", en: "I am excited about the trip!", es: "¡Estoy emocionado por el viaje!" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "감정 질문: 'كَيْفَ تَشْعُر؟' / 대답: 'أنا ___' (سَعيد/مُتْعَب) / 이유: 'لِأَنّ ___' / 상대 감정: 'تَبْدو ___'", en: "'كَيْفَ تَشْعُر؟' → ask feelings / 'أنا ___' (سَعيد/مُتْعَب) → express / 'لِأَنّ ___' → give reason / 'تَبْدو ___' → observe others (you look ___)", es: "'كَيْفَ تَشْعُر؟' → preguntar / 'أنا ___' (سَعيد/مُتْعَب) → expresar / 'لِأَنّ ___' → razón / 'تَبْدو ___' → observar (pareces ___)" },
          examples: { ko: "أنا مُتْعَب لِأَنّي لَمْ أَنَمْ جَيِّدًا. / تَبْدو سَعيدًا اليَوْم! / أنا مُتَحَمِّس لِلْحَفْلة. (anā mut‘ab li-annī lam anam jayyidan / tabdū sa‘īdan al-yawm / anā mutaḥammis lil-ḥafla)", en: "أنا مُتْعَب لِأَنّي لَمْ أَنَمْ جَيِّدًا. / تَبْدو سَعيدًا اليَوْم! / أنا مُتَحَمِّس لِلْحَفْلة. (anā mut‘ab li-annī lam anam jayyidan / tabdū sa‘īdan al-yawm / anā mutaḥammis lil-ḥafla)", es: "أنا مُتْعَب لِأَنّي لَمْ أَنَمْ جَيِّدًا. / تَبْدو سَعيدًا اليَوْم! / أنا مُتَحَمِّس لِلْحَفْلة. (anā mut‘ab li-annī lam anam jayyidan / tabdū sa‘īdan al-yawm / anā mutaḥammis lil-ḥafla)" },
          mistakes: { ko: "💬 이집트 구어로는 'مبسوط' 지만 표준어는 'سَعيد' ✓\n\n❌ أنا مُتْعَب بِسَبَب لِأَنّي عَمِلْت. (이유 중복)\n✅ أنا مُتْعَب لِأَنّي عَمِلْت. ('لِأَنّ' 하나면 충분)", en: "💬 In Egyptian dialect 'happy' is 'مبسوط', but in MSA it's 'سَعيد' ✓\n\n❌ أنا مُتْعَب بِسَبَب لِأَنّي عَمِلْت. (doubled 'because')\n✅ أنا مُتْعَب لِأَنّي عَمِلْت. ('لِأَنّ' alone = because)", es: "💬 En dialecto egipcio 'feliz' es 'مبسوط', pero en árabe estándar es 'سَعيد' ✓\n\n❌ أنا مُتْعَب بِسَبَب لِأَنّي عَمِلْت. ('porque' doblado)\n✅ أنا مُتْعَب لِأَنّي عَمِلْت. ('لِأَنّ' solo = porque)" },
          rudyTip: { ko: "표준어(MSA)에서 '행복해'는 'سَعيد'(sa‘īd)! 이유는 'لِأَنّ'(li-anna)로 잇고, 상대 기분은 'تَبْدو'(tabdū, 너 ~해 보여)로 물어봐~", en: "In MSA, 'happy' is 'سَعيد' (sa‘īd)! Link the reason with 'لِأَنّ' (li-anna), and check on others with 'تَبْدو' (tabdū = you look ___)!", es: "¡En árabe estándar, 'feliz' es 'سَعيد' (sa‘īd)! Enlaza la razón con 'لِأَنّ' (li-anna), y observa a otros con 'تَبْدو' (tabdū = pareces ___)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ تَشْعُر اليَوْم؟", answer: "كَيْفَ", options: ["كَيْفَ", "أَيْنَ", "مَتى"], fullSentence: "كَيْفَ تَشْعُر اليَوْم؟", fullSentenceMeaning: { ko: "오늘 기분 어때?", en: "How are you feeling?", es: "¿Cómo te sientes?" } },
          { type: "select", promptWithBlank: "أنا ___ جِدًّا اليَوْم.", answer: "سَعيد", options: ["سَعيد", "طَويل", "أَزْرَق"], fullSentence: "أنا سَعيد جِدًّا اليَوْم.", fullSentenceMeaning: { ko: "오늘 매우 행복해요.", en: "I am very happy.", es: "Estoy muy feliz." } },
          { type: "select", promptWithBlank: "أنا مُتْعَب ___ عَمِلْت طَوال اليَوْم.", answer: "لِأَنّي", options: ["لِأَنّي", "لٰكِنّ", "و"], fullSentence: "أنا مُتْعَب لِأَنّي عَمِلْت طَوال اليَوْم.", fullSentenceMeaning: { ko: "일해서 피곤해요.", en: "Tired because I worked.", es: "Cansado porque trabajé." } },
          { type: "input", promptWithBlank: "هَل أَنْتَ بِخَيْر؟ ___ قَلِقًا.", answer: "تَبْدو", fullSentence: "هَل أَنْتَ بِخَيْر؟ تَبْدو قَلِقًا.", fullSentenceMeaning: { ko: "괜찮아요? 걱정돼 보여요.", en: "OK? You look worried.", es: "¿Bien? Pareces preocupado." } },
          { type: "input", promptWithBlank: "أنا ___ جِدًّا لِلرِّحْلة!", answer: "مُتَحَمِّس", fullSentence: "أنا مُتَحَمِّس جِدًّا لِلرِّحْلة!", fullSentenceMeaning: { ko: "여행이 기대돼요!", en: "Excited about the trip!", es: "¡Emocionado por el viaje!" } },
          { type: "listening", audioText: "أنا مُتَحَمِّس جِدًّا لِلرِّحْلة!", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["أنا مُتَحَمِّس جِدًّا لِلرِّحْلة!", "كَيْفَ تَشْعُر اليَوْم؟", "أنا سَعيد جِدًّا اليَوْم.", "أنا مُتْعَب لِأَنّي عَمِلْت طَوال اليَوْم."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Where is the subway station?", es: "¿Dónde está la estación de metro?", ko: "지하철역이 어디에 있나요?" }, fromDay: 19, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_29: {
    ...
    arabic: {
      step1Sentences: [
        { text: "هَل أَنْتَ مُتَفَرِّغ نِهاية هٰذا الأُسْبوع؟ (hal anta mutafarrigh nihāyat hādhā al-usbū‘?)", speechLang: "ar-EG", meaning: { ko: "이번 주말에 시간 있어요?", en: "Are you free this weekend?", es: "¿Estás libre este fin de semana?" } },
        { text: "تَعالَ نَلْتَقي في المَقْهى السّاعة الثّالِثة. (ta‘āla naltaqī fī al-maqhā as-sā‘a ath-thālitha)", speechLang: "ar-EG", meaning: { ko: "3시에 카페에서 만나요.", en: "Let's meet at the cafe at three o'clock.", es: "Encontrémonos en el café a las tres." } },
        { text: "هَل تُحِبّ أَنْ نَذْهَب إلى السّينَما؟ (hal tuḥibb an nadhhab ilā as-sīnamā?)", speechLang: "ar-EG", meaning: { ko: "영화관에 갈래요?", en: "Would you like to go to the cinema?", es: "¿Te gustaría ir al cine?" } },
        { text: "آسِف، لا يُمْكِن. عِنْدي ارْتِباط. (āsif, lā yumkin. ‘indī irtibāṭ)", speechLang: "ar-EG", meaning: { ko: "미안, 안 돼요. 약속 있어요.", en: "Sorry, I can't. I have plans.", es: "Lo siento, no puedo. Tengo planes." }, recallRound: true },
        { text: "فِكْرة رائِعة! أَراكَ هُناك. (fikra rā’i‘a! arāka hunāka)", speechLang: "ar-EG", meaning: { ko: "좋아요! 거기서 봐요.", en: "That sounds great! See you there.", es: "¡Suena genial! Nos vemos allí." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "시간 확인: 'هَل أَنْتَ مُتَفَرِّغ ___؟' / 제안: 'تَعالَ نـ___' 또는 'هَل تُحِبّ أَنْ نـ___؟' / 거절: 'آسِف، لا يُمْكِن' / 수락: 'فِكْرة رائِعة!'", en: "'هَل أَنْتَ مُتَفَرِّغ ___؟' → check availability / 'تَعالَ نـ___' or 'هَل تُحِبّ أَنْ نـ___؟' → suggest (let's / would you like to) / 'آسِف، لا يُمْكِن' → decline / 'فِكْرة رائِعة!' → accept (great idea!)", es: "'هَل أَنْتَ مُتَفَرِّغ ___؟' → disponibilidad / 'تَعالَ نـ___' o 'هَل تُحِبّ أَنْ نـ___؟' → sugerir / 'آسِف، لا يُمْكِن' → rechazar / 'فِكْرة رائِعة!' → aceptar" },
          examples: { ko: "هَل أَنْتَ مُتَفَرِّغ يَوْم السَّبْت؟ / تَعالَ نَذْهَب إلى الحَديقة. / هَل تُحِبّ أَنْ نَتَغَدّى مَعًا؟ (hal anta mutafarrigh yawm as-sabt / ta‘āla nadhhab ilā al-ḥadīqa / hal tuḥibb an nataghaddā ma‘an?)", en: "هَل أَنْتَ مُتَفَرِّغ يَوْم السَّبْت؟ / تَعالَ نَذْهَب إلى الحَديقة. / هَل تُحِبّ أَنْ نَتَغَدّى مَعًا؟ (hal anta mutafarrigh yawm as-sabt / ta‘āla nadhhab ilā al-ḥadīqa / hal tuḥibb an nataghaddā ma‘an?)", es: "هَل أَنْتَ مُتَفَرِّغ يَوْم السَّبْت؟ / تَعالَ نَذْهَب إلى الحَديقة. / هَل تُحِبّ أَنْ نَتَغَدّى مَعًا؟ (hal anta mutafarrigh yawm as-sabt / ta‘āla nadhhab ilā al-ḥadīqa / hal tuḥibb an nataghaddā ma‘an?)" },
          mistakes: { ko: "💬 이집트 구어로는 'إنت فاضي؟' 지만 표준어는 'هَل أَنْتَ مُتَفَرِّغ؟' ✓\n\n💬 거절도 구어 'مش هينفع' 대신 표준어는 'لا يُمْكِن' 또는 'لا أَسْتَطيع' ✓", en: "💬 In Egyptian dialect it's 'إنت فاضي؟' but MSA is 'هَل أَنْتَ مُتَفَرِّغ؟' ✓\n\n💬 To decline, dialect 'مش هينفع' becomes MSA 'لا يُمْكِن' or 'لا أَسْتَطيع' ✓", es: "💬 En dialecto egipcio es 'إنت فاضي؟' pero en árabe estándar es 'هَل أَنْتَ مُتَفَرِّغ؟' ✓\n\n💬 Para rechazar, el dialectal 'مش هينفع' pasa a 'لا يُمْكِن' o 'لا أَسْتَطيع' en árabe estándar ✓" },
          rudyTip: { ko: "약속 잡기 표준어(MSA)! '시간 있어?'는 'هَل أَنْتَ مُتَفَرِّغ؟'(mutafarrigh). 제안할 땐 'تَعالَ'(ta‘āla, 와서~하자) 붙여. 거절은 'لا يُمْكِن'(안 돼요), 수락은 'فِكْرة رائِعة!'(좋은 생각!)~", en: "MSA plan-making! 'Free?' = 'هَل أَنْتَ مُتَفَرِّغ؟' (mutafarrigh). To suggest, lead with 'تَعالَ' (ta‘āla = come, let's). Decline = 'لا يُمْكِن' (it's not possible), accept = 'فِكْرة رائِعة!' (great idea!)", es: "¡Planes en árabe estándar! '¿Libre?' = 'هَل أَنْتَ مُتَفَرِّغ؟' (mutafarrigh). Para sugerir, empieza con 'تَعالَ' (ta‘āla = ven, vamos). Rechazar = 'لا يُمْكِن', aceptar = 'فِكْرة رائِعة!'" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "هَل أَنْتَ ___ نِهاية هٰذا الأُسْبوع؟", answer: "مُتَفَرِّغ", options: ["مُتَفَرِّغ", "مَشْغول", "هُنا"], fullSentence: "هَل أَنْتَ مُتَفَرِّغ نِهاية هٰذا الأُسْبوع؟", fullSentenceMeaning: { ko: "이번 주말 시간 있어?", en: "Free this weekend?", es: "¿Libre este fin de semana?" } },
          { type: "select", promptWithBlank: "___ نَلْتَقي في المَقْهى.", answer: "تَعالَ", options: ["تَعالَ", "أنا", "أَنْتَ"], fullSentence: "تَعالَ نَلْتَقي في المَقْهى.", fullSentenceMeaning: { ko: "카페에서 만나요.", en: "Let's meet at the cafe.", es: "Encontrémonos en el café." } },
          { type: "select", promptWithBlank: "هَل تُحِبّ أَنْ ___ إلى السّينَما؟", answer: "نَذْهَب", options: ["نَذْهَب", "نَأْكُل", "نَنام"], fullSentence: "هَل تُحِبّ أَنْ نَذْهَب إلى السّينَما؟", fullSentenceMeaning: { ko: "영화관에 갈래요?", en: "Like to go to the cinema?", es: "¿Ir al cine?" } },
          { type: "input", promptWithBlank: "آسِف، لا ___. عِنْدي ارْتِباط.", answer: "يُمْكِن", fullSentence: "آسِف، لا يُمْكِن. عِنْدي ارْتِباط.", fullSentenceMeaning: { ko: "미안, 안 돼. 약속 있어.", en: "Sorry, can't. Have plans.", es: "Lo siento, no puedo." } },
          { type: "input", promptWithBlank: "___ رائِعة! أَراكَ هُناك.", answer: "فِكْرة", fullSentence: "فِكْرة رائِعة! أَراكَ هُناك.", fullSentenceMeaning: { ko: "좋아! 거기서 봐.", en: "Great idea! See you.", es: "¡Buena idea! Nos vemos." } },
          { type: "listening", audioText: "فِكْرة رائِعة! أَراكَ هُناك.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["فِكْرة رائِعة! أَراكَ هُناك.", "هَل أَنْتَ مُتَفَرِّغ نِهاية هٰذا الأُسْبوع؟", "تَعالَ نَلْتَقي في المَقْهى السّاعة الثّالِثة.", "هَل تُحِبّ أَنْ نَذْهَب إلى السّينَما؟"], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Sorry, I don't understand.", es: "Lo siento, no entiendo.", ko: "죄송해요, 이해를 못 했어요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_30: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَهْلًا، أنا اِسْمي رودي. أنا مِن كورِيا. (ahlan, anā ismī Rudy. anā min Kūriyā)", speechLang: "ar-EG", meaning: { ko: "안녕, 이름은 루디. 한국 출신.", en: "Hello, I'm Rudy. From Korea.", es: "Hola, soy Rudy. De Corea." } },
        { text: "عِنْدي أَخَوان. أُمّي مُدَرِّسة. (‘indī akhawān. ummī mudarrisa)", speechLang: "ar-EG", meaning: { ko: "형제 둘. 어머니는 선생님.", en: "Two brothers. Mother is teacher.", es: "Dos hermanos. Madre profesora." } },
        { text: "أنا سَعيد لِأَنّي أَنْهَيْت كُلّ الدُّروس! (anā sa‘īd li-annī anhayt kull ad-durūs!)", speechLang: "ar-EG", meaning: { ko: "수업 끝내서 행복!", en: "Happy I finished lessons!", es: "¡Feliz por terminar!" } },
        { text: "هَل أَنْتَ مُتَفَرِّغ غَدًا؟ تَعالَ نَحْتَفِل! (hal anta mutafarrigh ghadan? ta‘āla naḥtafil!)", speechLang: "ar-EG", meaning: { ko: "내일 시간 있어? 축하!", en: "Free tomorrow? Let's celebrate!", es: "¿Libre mañana? ¡Felicidades!" }, recallRound: true },
        { text: "شُكْرًا عَلى كُلّ شَيْء. أَراكَ مَرّة أُخْرى! (shukran ‘alā kull shay’. arāka marra ukhrā!)", speechLang: "ar-EG", meaning: { ko: "모든 것에 감사. 다음에!", en: "Thanks for everything. See you!", es: "Gracias por todo. ¡Nos vemos!" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "A1 종합 복습: 자기소개 + 가족 + 묘사 + 취미 + 감정 + 약속 — 30일 표준어(MSA) 패턴 총정리!", en: "A1 Full Review: introductions + family + descriptions + hobbies + feelings + plans — all 30 days of Modern Standard Arabic patterns!", es: "Repaso A1: presentaciones + familia + descripciones + hobbies + sentimientos + planes — todos los patrones de 30 días de árabe estándar." },
          examples: { ko: "أنا اِسْمي رودي. عِنْدي أَخَوان. / أنا سَعيد لِأَنّي أَنْهَيْت! / هَل أَنْتَ مُتَفَرِّغ غَدًا؟ تَعالَ نَحْتَفِل! (anā ismī Rudy. ‘indī akhawān / anā sa‘īd li-annī anhayt / hal anta mutafarrigh ghadan? ta‘āla naḥtafil)", en: "أنا اِسْمي رودي. عِنْدي أَخَوان. / أنا سَعيد لِأَنّي أَنْهَيْت! / هَل أَنْتَ مُتَفَرِّغ غَدًا؟ تَعالَ نَحْتَفِل! (anā ismī Rudy. ‘indī akhawān / anā sa‘īd li-annī anhayt / hal anta mutafarrigh ghadan? ta‘āla naḥtafil)", es: "أنا اِسْمي رودي. عِنْدي أَخَوان. / أنا سَعيد لِأَنّي أَنْهَيْت! / هَل أَنْتَ مُتَفَرِّغ غَدًا؟ تَعالَ نَحْتَفِل! (anā ismī Rudy. ‘indī akhawān / anā sa‘īd li-annī anhayt / hal anta mutafarrigh ghadan? ta‘āla naḥtafil)" },
          mistakes: { ko: "❌ اِسْمي هو رودي.\n✅ أنا اِسْمي رودي. (여기엔 'هو' 안 붙여요)\n\n💬 이집트 구어로는 'مبسوط علشان' 지만 표준어는 'سَعيد لِأَنّ' ✓", en: "❌ اِسْمي هو رودي. (don't add 'هو' here)\n✅ أنا اِسْمي رودي.\n\n💬 In Egyptian dialect it's 'مبسوط علشان' but MSA is 'سَعيد لِأَنّ' ✓", es: "❌ اِسْمي هو رودي.\n✅ أنا اِسْمي رودي. (no añadas 'هو' aquí)\n\n💬 En dialecto egipcio es 'مبسوط علشان' pero en árabe estándar es 'سَعيد لِأَنّ' ✓" },
          rudyTip: { ko: "30일 표준어(MSA) 완주, مَبْروك(mabrūk, 축하)! '좋아하다 + أَنْ + 동사', 'عِنْدي'(가지다), 'لِأَنّ'(왜냐하면), 명사+ي(제 ___) — 이게 표준어의 기둥이야. 계속 말하면 더 쉬워져!", en: "30 days of MSA done — مَبْروك (mabrūk, congrats)! The 'like + أَنْ + verb' pattern, 'عِنْدي' (I have), 'لِأَنّ' (because), noun+ي (my ___) — these are the pillars. Keep talking and it gets easier!", es: "30 días de árabe estándar — ¡مَبْروك (mabrūk, felicidades)! El patrón 'gustar + أَنْ + verbo', 'عِنْدي' (tengo), 'لِأَنّ' (porque), sustantivo+ي (mi ___): esos son los pilares. Sigue hablando y será más fácil." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "أنا ___ رودي.", answer: "اِسْمي", options: ["اِسْمي", "عِنْدي", "أنا"], fullSentence: "أنا اِسْمي رودي.", fullSentenceMeaning: { ko: "이름은 루디.", en: "My name is Rudy.", es: "Me llamo Rudy." } },
          { type: "select", promptWithBlank: "أنا ___ لِأَنّي أَنْهَيْت!", answer: "سَعيد", options: ["سَعيد", "مُتْعَب", "قَلِق"], fullSentence: "أنا سَعيد لِأَنّي أَنْهَيْت!", fullSentenceMeaning: { ko: "끝내서 행복!", en: "Happy because finished!", es: "¡Feliz porque terminé!" } },
          { type: "select", promptWithBlank: "هَل أَنْتَ ___ غَدًا؟", answer: "مُتَفَرِّغ", options: ["مُتَفَرِّغ", "بِخَيْر", "جَميل"], fullSentence: "هَل أَنْتَ مُتَفَرِّغ غَدًا؟", fullSentenceMeaning: { ko: "내일 시간 있어?", en: "Free tomorrow?", es: "¿Libre mañana?" } },
          { type: "input", promptWithBlank: "شُكْرًا عَلى كُلّ ___.", answer: "شَيْء", fullSentence: "شُكْرًا عَلى كُلّ شَيْء.", fullSentenceMeaning: { ko: "모든 것에 감사.", en: "Thanks for everything.", es: "Gracias por todo." } },
          { type: "input", promptWithBlank: "أَراكَ ___!", answer: "مَرّة أُخْرى", fullSentence: "أَراكَ مَرّة أُخْرى!", fullSentenceMeaning: { ko: "다음에 봐요!", en: "See you again!", es: "¡Hasta la próxima!" } },
          { type: "listening", audioText: "شُكْرًا عَلى كُلّ شَيْء. أَراكَ مَرّة أُخْرى!", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["شُكْرًا عَلى كُلّ شَيْء. أَراكَ مَرّة أُخْرى!", "أَهْلًا، أنا اِسْمي رودي. أنا مِن كورِيا.", "عِنْدي أَخَوان. أُمّي مُدَرِّسة.", "هَل أَنْتَ مُتَفَرِّغ غَدًا؟ تَعالَ نَحْتَفِل!"], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Hello, nice to meet you.", es: "Hola, encantado de conocerle.", ko: "안녕하세요, 만나서 반가워요." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
...
export const MISSION_CONTENT_UNIT5: Record<string, Partial<Record<LearningLangKey, MissionTalkLangData>>> = {
  ...
  day_25: {
    ...
    arabic: { situation: { ko: "바벨탑에서 다른 요원과 가족 이야기를 하며 신뢰를 쌓으세요!", en: "Babel Tower: build trust through family talk!", es: "Torre de Babel: confianza a través de familia." }, gptPrompt: "You are a fellow agent at Babel Tower. Build trust through family talk. Simple A1 Modern Standard Arabic (MSA). Practice: introducing family (عائِلة), jobs (عَمَل), numbers. Use markers like عِنْدي/أبي/أُمّي/هٰذا. Share your own family. Be friendly.", speechLang: "ar-EG", suggestedAnswers: ["هٰذِهِ عائِلَتي.", "عِنْدي أَخَوان.", "أُمّي مُدَرِّسة.", "عِنْدَكَ أَطْفال؟", "ماذا يَعْمَل أَبوكَ؟", "تَشَرَّفْت بِعائِلَتِك!"] },
  },
  ...
  day_26: {
    ...
    arabic: { situation: { ko: "용의자를 정확하게 묘사해야 해요!", en: "Describe the suspect!", es: "¡Describe al sospechoso!" }, gptPrompt: "You are Rudy's handler. User must describe a suspect in A1 Modern Standard Arabic (MSA). Practice: height (طَويل/قَصير), hair (شَعْر), clothes (يَرْتَدي), glasses (نَظّارة), age (عُمْر). Use markers like هٰذا/هٰذِهِ/الَّذي/جِدًّا. Ask follow-ups. Correct gently.", speechLang: "ar-EG", suggestedAnswers: ["هُوَ طَويل.", "شَعْرُهُ طَويل.", "هُوَ يَرْتَدي سُتْرة زَرْقاء.", "الرَّجُل الَّذي يَرْتَدي نَظّارة.", "يَبْدو صَغيرًا.", "عُمْرُهُ حَوالي ثَلاثين سَنة."] },
  },
  ...
  day_27: {
    ...
    arabic: { situation: { ko: "바벨탑 파티에서 취미로 친구를 사귀세요!", en: "Babel party: hobbies and friends!", es: "Fiesta Babel: hobbies y amigos." }, gptPrompt: "You are a friendly guest at Babel Tower party. Simple A1 Modern Standard Arabic (MSA). Talk about hobbies (هِواية), sports (رِياضة), free time (وَقْت الفَراغ). Use the 'أُحِبّ أَنْ + verb' structure (أُحِبّ/أَلْعَب) and markers like جِدًّا. Find common interests. Mix in food (طَعام) from Unit 3.", speechLang: "ar-EG", suggestedAnswers: ["ماذا تُحِبّ أَنْ تَفْعَل؟", "أُحِبّ أَنْ أَقْرَأ كُتُبًا.", "هَل تُمارِس رِياضة؟", "أَلْعَب كُرة القَدَم.", "هِوايَتي الطَّبْخ.", "هٰذا رائِع جِدًّا!"] },
  },
  ...
  day_28: {
    ...
    arabic: { situation: { ko: "팀원이 힘들어하고 있어요. 감정을 물어보고 격려하세요!", en: "Teammate struggling. Ask and encourage!", es: "Compañero mal. ¡Pregunta y anima!" }, gptPrompt: "You are a teammate feeling down. Simple A1 Modern Standard Arabic (MSA). User asks about feelings and encourages. Express: tired (مُتْعَب), worried (قَلِق), then happy (سَعيد). Use markers like تَبْدو/لِأَنّ/جِدًّا. End positive.", speechLang: "ar-EG", suggestedAnswers: ["كَيْفَ تَشْعُر؟", "هَل أَنْتَ بِخَيْر؟", "تَبْدو مُتْعَبًا.", "لا تَقْلَق!", "أنا مُتَحَمِّس جِدًّا لِلْغَد!", "هٰذا رائِع جِدًّا!"] },
  },
  ...
  day_29: {
    ...
    arabic: { situation: { ko: "미션 성공! 팀원들과 축하 파티를 계획하세요!", en: "Mission success! Plan the party!", es: "¡Misión! ¡Planea la fiesta!" }, gptPrompt: "You are Rudy's teammate planning a celebration. Simple A1 Modern Standard Arabic (MSA). Practice: time (وَقْت/ساعة), activities, agree/decline, place (مَكان). Use markers like مُتَفَرِّغ/تَعالَ/تُحِبّ/فِكْرة رائِعة. Mix ALL units. Fun conversation.", speechLang: "ar-EG", suggestedAnswers: ["هَل أَنْتَ مُتَفَرِّغ نِهاية هٰذا الأُسْبوع؟", "تَعالَ نَلْتَقي في المَقْهى.", "هَل تُحِبّ أَنْ نَذْهَب إلى السّينَما؟", "فِكْرة رائِعة!", "آسِف، لا يُمْكِن.", "أَراكَ السّاعة الثّالِثة!"] },
  },
  ...
  day_30: {
    ...
    arabic: { situation: { ko: "A1 마지막 미션! 30일 동안 배운 모든 것을 사용하세요!", en: "Final A1 mission! Use everything!", es: "¡Misión final! ¡Usa todo!" }, gptPrompt: "You are the final mission coordinator. A1 graduation. Simple A1 Modern Standard Arabic (MSA). Test ALL 30 days: introductions (تَعارُف), family (عائِلة), describing (وَصْف), hobbies (هِواية), feelings (مَشاعِر), plans (مَواعيد). Use markers like عِنْدي/سَعيد/مُتَفَرِّغ/تَعالَ. Celebrate! Victory lap.", speechLang: "ar-EG", suggestedAnswers: ["أَهْلًا، أنا اِسْمي رودي.", "عِنْدي أَخَوان.", "أنا سَعيد اليَوْم!", "هِوايَتي الطَّبْخ.", "هَل أَنْتَ مُتَفَرِّغ غَدًا؟", "شُكْرًا عَلى كُلّ شَيْء!"] },
  },
};
...
export const REVIEW_CONTENT_UNIT5: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_25: {
    ...
    arabic: [
      { type: "speak", sentence: "لَو سَمَحْت، أنا تُهْت. هَل يُمْكِن أَنْ تُريَني عَلى الخَريطة؟ (law samaḥt, anā tuht. hal yumkin an turiyanī ‘alā al-kharīṭa?)", speechLang: "ar-EG", meaning: { ko: "길 잃었어요. 지도에서 보여주세요.", en: "Lost. Show me on the map?", es: "Perdido. ¿Mapa?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "اُخْرُج مِن مَخْرَج رَقَم ___ في المَحَطّة.", answer: "ثَلاثة", options: ["ثَلاثة", "يَسار", "بَعيد"], fullSentence: "اُخْرُج مِن مَخْرَج رَقَم ثَلاثة في المَحَطّة.", fullSentenceMeaning: { ko: "지하철 3번 출구.", en: "Subway exit three.", es: "Metro salida tres." }, isYesterdayReview: true },
      { type: "speak", sentence: "هٰذِهِ عائِلَتي. عِنْدي أَخَوان. (hādhihi ‘ā’ilatī. ‘indī akhawān)", speechLang: "ar-EG", meaning: { ko: "제 가족이에요. 형제가 둘.", en: "My family. Two brothers.", es: "Mi familia. Dos hermanos." } },
      { type: "fill_blank", promptWithBlank: "أُمّي ___.", answer: "مُدَرِّسة", options: ["مُدَرِّسة", "أُخْت", "بِنْت"], fullSentence: "أُمّي مُدَرِّسة.", fullSentenceMeaning: { ko: "어머니는 선생님.", en: "Mother is a teacher.", es: "Madre es profesora." } },
      { type: "speak", sentence: "عِنْدَكَ أَطْفال؟ (‘indaka aṭfāl?)", speechLang: "ar-EG", meaning: { ko: "자녀가 있으세요?", en: "Have children?", es: "¿Tienes hijos?" } },
    ],
  },
  ...
  day_26: {
    ...
    arabic: [
      { type: "speak", sentence: "هٰذِهِ عائِلَتي. أبي يَعْمَل في مُسْتَشْفى. (hādhihi ‘ā’ilatī. abī ya‘mal fī mustashfā)", speechLang: "ar-EG", meaning: { ko: "제 가족. 아버지는 병원에서 일해요.", en: "My family. Father works at hospital.", es: "Mi familia. Padre trabaja en hospital." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "عِنْدي ___ وأُخْت واحِدة.", answer: "أَخَوان", options: ["أَخَوان", "أُمّ", "مُدَرِّس"], fullSentence: "عِنْدي أَخَوان وأُخْت واحِدة.", fullSentenceMeaning: { ko: "형제 둘, 자매 하나.", en: "Two brothers, one sister.", es: "Dos hermanos, una hermana." }, isYesterdayReview: true },
      { type: "speak", sentence: "هِيَ طَويلة وشَعْرُها طَويل. (hiya ṭawīla wa-sha‘ruhā ṭawīl)", speechLang: "ar-EG", meaning: { ko: "키 크고 머리 길어요.", en: "Tall, long hair.", es: "Alta, pelo largo." } },
      { type: "fill_blank", promptWithBlank: "هُوَ ___ سُتْرة زَرْقاء.", answer: "يَرْتَدي", options: ["يَرْتَدي", "يَأْكُل", "يَقْرَأ"], fullSentence: "هُوَ يَرْتَدي سُتْرة زَرْقاء.", fullSentenceMeaning: { ko: "파란 재킷 입고 있어요.", en: "Wearing blue jacket.", es: "Lleva chaqueta azul." } },
      { type: "speak", sentence: "الرَّجُل الَّذي يَرْتَدي نَظّارة هو مُدَرِّسي. (ar-rajul alladhī yartadī naẓẓāra huwa mudarrisī)", speechLang: "ar-EG", meaning: { ko: "안경 쓴 남자가 선생님.", en: "Man with glasses is teacher.", es: "Hombre con gafas es profesor." } },
    ],
  },
  ...
  day_27: {
    ...
    arabic: [
      { type: "speak", sentence: "هِيَ طَويلة وشَعْرُها طَويل. هِيَ تَرْتَدي سُتْرة زَرْقاء. (hiya ṭawīla wa-sha‘ruhā ṭawīl. hiya tartadī sutra zarqā’)", speechLang: "ar-EG", meaning: { ko: "키 크고 머리 길어요. 파란 재킷.", en: "Tall, long hair. Blue jacket.", es: "Alta, pelo largo. Chaqueta azul." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "الرَّجُل الَّذي يَرْتَدي ___ هو مُدَرِّسي.", answer: "نَظّارة", options: ["نَظّارة", "شَعْر", "سُتْرة"], fullSentence: "الرَّجُل الَّذي يَرْتَدي نَظّارة هو مُدَرِّسي.", fullSentenceMeaning: { ko: "안경 쓴 남자가 선생님.", en: "Man with glasses, teacher.", es: "Hombre con gafas, profesor." }, isYesterdayReview: true },
      { type: "speak", sentence: "أُحِبّ أَنْ أَقْرَأ كُتُبًا وأُشاهِد أَفْلامًا. (uḥibb an aqra’ kutuban wa-ushāhid aflāman)", speechLang: "ar-EG", meaning: { ko: "책 읽기와 영화 보기를 좋아해요.", en: "Like reading and movies.", es: "Leer y ver películas." } },
      { type: "fill_blank", promptWithBlank: "أَلْعَب ___ كُلّ نِهاية أُسْبوع.", answer: "كُرة القَدَم", options: ["كُرة القَدَم", "كُتُب", "طَعام"], fullSentence: "أَلْعَب كُرة القَدَم كُلّ نِهاية أُسْبوع.", fullSentenceMeaning: { ko: "매주 주말 축구.", en: "Football every weekend.", es: "Fútbol cada fin de semana." } },
      { type: "speak", sentence: "هِوايَتي الطَّبْخ. ماذا تُحِبّ أَنْ تَفْعَل؟ (hiwāyatī aṭ-ṭabkh. mādhā tuḥibb an taf‘al?)", speechLang: "ar-EG", meaning: { ko: "취미는 요리. 뭘 좋아해요?", en: "Hobby: cooking. What do you like?", es: "Hobby: cocinar. ¿Qué te gusta?" } },
      { type: "speak", sentence: "أَيْنَ الحَمّام؟ (ayna al-ḥammām?)", speechLang: "ar-EG", meaning: { ko: "화장실이 어디에요?", en: "Where is the bathroom?", es: "¿Dónde está el baño?" }, isYesterdayReview: true },
      { type: "speak", sentence: "بِكَمْ هٰذا؟ (bikam hādhā?)", speechLang: "ar-EG", meaning: { ko: "이거 얼마예요?", en: "How much is this?", es: "¿Cuánto cuesta esto?" }, isYesterdayReview: true },
    ],
  },
  ...
  day_28: {
    ...
    arabic: [
      { type: "speak", sentence: "أُحِبّ أَنْ أَقْرَأ كُتُبًا. هِوايَتي الطَّبْخ. (uḥibb an aqra’ kutuban. hiwāyatī aṭ-ṭabkh)", speechLang: "ar-EG", meaning: { ko: "책 읽기 좋아해요. 취미는 요리.", en: "Like reading. Hobby: cooking.", es: "Leer. Hobby: cocinar." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَل تُمارِس ___؟", answer: "رِياضة", options: ["رِياضة", "كُتُب", "طَعام"], fullSentence: "هَل تُمارِس رِياضة؟", fullSentenceMeaning: { ko: "스포츠 하세요?", en: "Play sports?", es: "¿Practicas deporte?" }, isYesterdayReview: true },
      { type: "speak", sentence: "أنا سَعيد جِدًّا اليَوْم. أنا مُتَحَمِّس جِدًّا لِلرِّحْلة! (anā sa‘īd jiddan al-yawm. anā mutaḥammis jiddan lir-riḥla!)", speechLang: "ar-EG", meaning: { ko: "오늘 행복해요. 여행이 기대돼!", en: "Happy today. Excited about trip!", es: "Feliz hoy. ¡Emocionado por el viaje!" } },
      { type: "fill_blank", promptWithBlank: "أنا مُتْعَب ___ عَمِلْت طَوال اليَوْم.", answer: "لِأَنّي", options: ["لِأَنّي", "لٰكِنّ", "و"], fullSentence: "أنا مُتْعَب لِأَنّي عَمِلْت طَوال اليَوْم.", fullSentenceMeaning: { ko: "일해서 피곤해요.", en: "Tired because worked.", es: "Cansado porque trabajé." } },
      { type: "speak", sentence: "هَل أَنْتَ بِخَيْر؟ تَبْدو قَلِقًا. (hal anta bi-khayr? tabdū qaliqan)", speechLang: "ar-EG", meaning: { ko: "괜찮아요? 걱정돼 보여요.", en: "OK? Look worried.", es: "¿Bien? Preocupado." } },
    ],
  },
  ...
  day_29: {
    ...
    arabic: [
      { type: "speak", sentence: "أنا سَعيد اليَوْم! أنا مُتَحَمِّس جِدًّا لِنِهاية الأُسْبوع. (anā sa‘īd al-yawm! anā mutaḥammis jiddan li-nihāyat al-usbū‘)", speechLang: "ar-EG", meaning: { ko: "오늘 행복! 주말이 기대돼.", en: "Happy! Excited for weekend.", es: "¡Feliz! ¡Emocionado por el fin de semana!" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "هَل أَنْتَ بِخَيْر؟ تَبْدو ___.", answer: "قَلِقًا", options: ["قَلِقًا", "سَعيدًا", "طَويلًا"], fullSentence: "هَل أَنْتَ بِخَيْر؟ تَبْدو قَلِقًا.", fullSentenceMeaning: { ko: "괜찮아? 걱정돼 보여.", en: "OK? Worried?", es: "¿Bien? ¿Preocupado?" }, isYesterdayReview: true },
      { type: "speak", sentence: "هَل أَنْتَ مُتَفَرِّغ نِهاية هٰذا الأُسْبوع؟ تَعالَ نَلْتَقي في المَقْهى. (hal anta mutafarrigh nihāyat hādhā al-usbū‘? ta‘āla naltaqī fī al-maqhā)", speechLang: "ar-EG", meaning: { ko: "주말에 시간 있어? 카페에서 만나요.", en: "Free? Meet at cafe.", es: "¿Libre? Café." } },
      { type: "fill_blank", promptWithBlank: "هَل تُحِبّ أَنْ ___ إلى السّينَما؟", answer: "نَذْهَب", options: ["نَذْهَب", "نَأْكُل", "نَنام"], fullSentence: "هَل تُحِبّ أَنْ نَذْهَب إلى السّينَما؟", fullSentenceMeaning: { ko: "영화관 갈래요?", en: "Cinema?", es: "¿Cine?" } },
      { type: "speak", sentence: "فِكْرة رائِعة! أَراكَ السّاعة الثّالِثة. (fikra rā’i‘a! arāka as-sā‘a ath-thālitha)", speechLang: "ar-EG", meaning: { ko: "좋아요! 3시에 봐요.", en: "Great! See you at three.", es: "¡Genial! A las tres." } },
    ],
  },
  ...
  day_30: {
    ...
    arabic: [
      { type: "speak", sentence: "هَل أَنْتَ مُتَفَرِّغ؟ تَعالَ نَلْتَقي في المَقْهى السّاعة الثّالِثة. (hal anta mutafarrigh? ta‘āla naltaqī fī al-maqhā as-sā‘a ath-thālitha)", speechLang: "ar-EG", meaning: { ko: "시간 있어? 3시에 카페.", en: "Free? Cafe at three.", es: "¿Libre? Café a las tres." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "آسِف، لا ___. عِنْدي ارْتِباط.", answer: "يُمْكِن", options: ["يُمْكِن", "أُريد", "سَأَذْهَب"], fullSentence: "آسِف، لا يُمْكِن. عِنْدي ارْتِباط.", fullSentenceMeaning: { ko: "미안, 안 돼. 약속 있어.", en: "Sorry, can't. Plans.", es: "Lo siento, no puedo." }, isYesterdayReview: true },
      { type: "speak", sentence: "أَهْلًا، أنا اِسْمي رودي. أنا مِن كورِيا. عِنْدي أَخَوان. (ahlan, anā ismī Rudy. anā min Kūriyā. ‘indī akhawān)", speechLang: "ar-EG", meaning: { ko: "안녕, 루디예요. 한국. 형제 둘.", en: "Hi, Rudy. Korea. Two brothers.", es: "Hola, Rudy. Corea. Dos hermanos." } },
      { type: "fill_blank", promptWithBlank: "أنا ___ لِأَنّي أَنْهَيْت كُلّ الدُّروس!", answer: "سَعيد", options: ["سَعيد", "مُتْعَب", "قَلِق"], fullSentence: "أنا سَعيد لِأَنّي أَنْهَيْت كُلّ الدُّروس!", fullSentenceMeaning: { ko: "수업 다 끝내서 행복!", en: "Happy, finished lessons!", es: "¡Feliz, terminé lecciones!" } },
      { type: "speak", sentence: "شُكْرًا عَلى كُلّ شَيْء. أَراكَ مَرّة أُخْرى! (shukran ‘alā kull shay’. arāka marra ukhrā!)", speechLang: "ar-EG", meaning: { ko: "모든 것에 감사. 다음에!", en: "Thanks! See you!", es: "¡Gracias! ¡Nos vemos!" } },
    ],
  },
};
