...
export const LESSON_CONTENT_UNIT2: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_7: {
    ...
    arabic: {
      step1Sentences: [
        { text: "عِنْدِي كَلْبانِ وَثَلاثُ قِطَطٍ فِي الْبَيْت. (ʿindī kalbāni wa-thalāthu qiṭaṭin fī l-bayt.)", speechLang: "ar-EG", meaning: { ko: "집에 강아지 두 마리, 고양이 세 마리가 있어요.", en: "I have two dogs and three cats at home.", es: "Tengo dos perros y tres gatos en casa." } },
        { text: "هُناكَ خَمْسَةَ عَشَرَ شَخْصًا فِي الطَّابُور. هٰذَا كَثِير! (hunāka khamsata ʿashara shakhṣan fī ṭ-ṭābūr. hādhā kathīr!)", speechLang: "ar-EG", meaning: { ko: "줄에 열다섯 명이 있어요. 정말 많다!", en: "There are fifteen people in line. That's a lot!", es: "Hay quince personas en la fila. ¡Son muchas!" } },
        { text: "عِشْرُونَ، ثَلاثُونَ، أَرْبَعُونَ، خَمْسُونَ، سِتُّونَ، سَبْعُونَ، ثَمانُونَ، تِسْعُونَ، مِئَة. (ʿishrūn, thalāthūn, arbaʿūn, khamsūn, sittūn, sabʿūn, thamānūn, tisʿūn, miʾa.)", speechLang: "ar-EG", meaning: { ko: "20, 30, 40, 50, 60, 70, 80, 90, 100.", en: "Tens: twenty to one hundred.", es: "Decenas: veinte a cien." } },
        { text: "كَمْ عُمْرُكَ؟ عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. (kam ʿumruka? ʿumrī khamsatun wa-ʿishrūna ʿāman.)", speechLang: "ar-EG", meaning: { ko: "몇 살이에요? 저는 스물다섯 살이에요.", en: "How old are you? I'm twenty-five years old.", es: "¿Cuántos años tienes? Tengo veinticinco años." }, recallRound: true },
        { text: "هٰذَا بِخَمْسَةَ عَشَرَ دُولارًا. (hādhā bi-khamsata ʿashara dūlāran.)", speechLang: "ar-EG", meaning: { ko: "15달러입니다.", en: "That's fifteen dollars, please.", es: "Son quince dólares, por favor." }, recallRound: true },
        { text: "السَّاعَةُ الثَّالِثَةُ وَالنِّصْف. (as-sāʿatu th-thālithatu wa-n-niṣf.)", speechLang: "ar-EG", meaning: { ko: "세 시 삼십 분이에요.", en: "It's three thirty.", es: "Son las tres y treinta." } },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: كَمْ عُمْرُكَ؟ (kam ʿumruka?) → عُمْرِي ___ عامًا. / 나이는 'عُمْرِي'(ʿumrī=내 나이)로 표현해요. 11-19는 '-ata ʿashara'(khamsata ʿashara=15), 십 단위는 '-ūn'(ʿishrūn=20), 100은 'miʾa'.", en: "Pattern: kam ʿumruka? → ʿumrī ___ ʿāman. MSA uses 'ʿumrī' (my age) for age. 11-19 use '-ata ʿashara' (khamsata ʿashara=15), tens end in '-ūn' (ʿishrūn=20), and 100 is 'miʾa'.", es: "Patrón: kam ʿumruka? → ʿumrī ___ ʿāman. El árabe estándar usa 'ʿumrī' (mi edad) para la edad. 11-19 usan '-ata ʿashara' (khamsata ʿashara=15), las decenas en '-ūn' (ʿishrūn=20), y 100 es 'miʾa'." },
          examples: { ko: "كَمْ عُمْرُكَ؟ عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. (몇 살이에요? 25살이에요.)\nهٰذَا بِخَمْسَةَ عَشَرَ دُولارًا. (15달러입니다.)\nهُناكَ ثَلاثُونَ طالِبًا فِي صَفِّي. (우리 반에 학생이 30명이에요.)", en: "kam ʿumruka? ʿumrī khamsatun wa-ʿishrūna ʿāman. (Asking and telling age.)\nhādhā bi-khamsata ʿashara dūlāran. (Using numbers for prices.)\nhunāka thalāthūna ṭāliban fī ṣaffī. (Counting people with numbers.)", es: "kam ʿumruka? ʿumrī khamsatun wa-ʿishrūna ʿāman. (Preguntando y diciendo la edad.)\nhādhā bi-khamsata ʿashara dūlāran. (Usando números para precios.)\nhunāka thalāthūna ṭāliban fī ṣaffī. (Contando personas.)" },
          mistakes: { ko: "❌ أَنَا خَمْسَةٌ وَعِشْرُونَ عامًا.\n✅ عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. (나이는 'عُمْرِي'(ʿumrī=내 나이)를 써요!)\n💬 이집트 구어로는 'أَنَا عَنْدِي ... سَنَة' 지만 표준어는 'عُمْرِي ... عامًا' ✓\n\n❌ خَمْسُونَ (khamsūn=50) ↔ خَمْسَةَ عَشَرَ (khamsata ʿashara=15)\n✅ khamsata ʿashara=15, khamsūn=50 ('-ata ʿashara'와 '-ūn'을 헷갈리지 마세요!)", en: "❌ ana khamsatun wa-ʿishrūna ʿāman.\n✅ ʿumrī khamsatun wa-ʿishrūna ʿāman. (Use 'ʿumrī' (my age) for age!)\n💬 Egyptian dialect says 'ana ʿandi ... sana', but MSA is 'ʿumrī ... ʿāman' ✓\n\n❌ Mixing khamsata ʿashara (15) and khamsūn (50)\n✅ khamsata ʿashara=15, khamsūn=50 ('-ata ʿashara'=teen, '-ūn'=ty — don't swap them!)", es: "❌ ana khamsatun wa-ʿishrūna ʿāman.\n✅ ʿumrī khamsatun wa-ʿishrūna ʿāman. (Usa 'ʿumrī' (mi edad) para la edad.)\n💬 El egipcio dice 'ana ʿandi ... sana', pero el estándar es 'ʿumrī ... ʿāman' ✓\n\n❌ Confundir khamsata ʿashara (15) y khamsūn (50)\n✅ khamsata ʿashara=15, khamsūn=50 ('-ata ʿashara'=teen, '-ūn'=ty — ¡no los cambies!)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어 숫자도 레고 블록이야! '-ata ʿashara'(11-19)랑 '-ūn'(십 단위)만 알면 100까지 조립 끝. 그리고 나이엔 항상 'عُمْرِي'(ʿumrī=내 나이)를 써~", en: "Detective Rudy's tip: MSA numbers are like Lego blocks too! Learn '-ata ʿashara' (11-19) and '-ūn' (tens) and you can build up to 100. And for age, always say 'ʿumrī' (my age)!", es: "Consejo del detective Rudy: ¡Los números del árabe estándar también son como bloques de Lego! Aprende '-ata ʿashara' (11-19) y '-ūn' (decenas) y construyes hasta 100. Y para la edad, siempre di 'ʿumrī' (mi edad)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "كَمْ ___؟", answer: "عُمْرُكَ", options: ["عُمْرُكَ", "اسْمُكَ", "بَلَدُكَ"], fullSentence: "كَمْ عُمْرُكَ؟", fullSentenceMeaning: { ko: "몇 살이에요?", en: "How old are you?", es: "¿Cuántos años tienes?" } },
          { type: "select", promptWithBlank: "___ خَمْسَةٌ وَعِشْرُونَ عامًا.", answer: "عُمْرِي", options: ["عُمْرِي", "أَنَا", "سِنِّي"], fullSentence: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا.", fullSentenceMeaning: { ko: "저는 스물다섯 살이에요.", en: "I'm twenty-five years old.", es: "Tengo veinticinco años." } },
          { type: "select", promptWithBlank: "عَشَرَة، ___، اثْنا عَشَرَ، ثَلاثَةَ عَشَرَ...", answer: "أَحَدَ عَشَرَ", options: ["أَحَدَ عَشَرَ", "عَشَرَة وَاحِد", "وَاحِد عَشَرَة"], fullSentence: "عَشَرَة، أَحَدَ عَشَرَ، اثْنا عَشَرَ، ثَلاثَةَ عَشَرَ.", fullSentenceMeaning: { ko: "10, 11, 12, 13.", en: "Ten, eleven, twelve, thirteen.", es: "Diez, once, doce, trece." } },
          { type: "fill_blank", promptWithBlank: "هٰذَا ___ دُولارًا.", answer: "بِخَمْسَةَ عَشَرَ", options: ["بِخَمْسَةَ عَشَرَ", "بِخَمْسِينَ", "بِأَرْبَعَةَ عَشَرَ"], fullSentence: "هٰذَا بِخَمْسَةَ عَشَرَ دُولارًا.", fullSentenceMeaning: { ko: "15달러입니다.", en: "Fifteen dollars.", es: "Quince dólares." } },
          { type: "input", promptWithBlank: "عِشْرُونَ، ثَلاثُونَ، أَرْبَعُونَ، ___.", answer: "خَمْسُونَ", fullSentence: "عِشْرُونَ، ثَلاثُونَ، أَرْبَعُونَ، خَمْسُونَ.", fullSentenceMeaning: { ko: "20, 30, 40, 50.", en: "Twenty, thirty, forty, fifty.", es: "Veinte, treinta, cuarenta, cincuenta." } },
          { type: "listening", audioText: "هٰذَا بِخَمْسَةَ عَشَرَ دُولارًا.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["هٰذَا بِخَمْسَةَ عَشَرَ دُولارًا.", "كَمْ عُمْرُكَ؟", "السَّاعَةُ الثَّالِثَةُ وَالنِّصْف.", "هٰذَا بِمِئَةِ دُولار."], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_8: {
    ...
    arabic: {
      step1Sentences: [
        { text: "أَيُّ يَوْمٍ الْيَوْم؟ (ayyu yawmin al-yawm?)", speechLang: "ar-EG", meaning: { ko: "오늘 무슨 요일이에요?", en: "What day is it today?", es: "¿Qué día es hoy?" } },
        { text: "الْيَوْمُ الِاثْنَيْن. (al-yawmu l-ithnayn.)", speechLang: "ar-EG", meaning: { ko: "오늘은 월요일이에요.", en: "Today is Monday.", es: "Hoy es lunes." } },
        { text: "أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة. (aʿmalu mina l-ithnayni ilā l-jumuʿa.)", speechLang: "ar-EG", meaning: { ko: "월요일부터 금요일까지 일해요.", en: "I work from Monday to Friday.", es: "Trabajo de lunes a viernes." } },
        { text: "ماذا سَتَفْعَلُ فِي نِهايَةِ الأُسْبُوع؟ (mādhā sa-tafʿalu fī nihāyati l-usbūʿ?)", speechLang: "ar-EG", meaning: { ko: "이번 주말에 뭐 해?", en: "What are you doing this weekend?", es: "¿Qué haces este fin de semana?" }, recallRound: true },
        { text: "أَراكَ يَوْمَ الأَرْبِعاء! (arāka yawma l-arbiʿāʾ!)", speechLang: "ar-EG", meaning: { ko: "수요일에 봐요!", en: "See you on Wednesday!", es: "¡Te veo el miércoles!" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: أَيُّ يَوْمٍ الْيَوْم؟ (ayyu yawmin al-yawm?) → الْيَوْمُ ___. / 요일: al-ithnayn(월)~al-jumuʿa(금)~as-sabt(토)~al-aḥad(일). 범위: 'min A ilā B'. 특정 요일: 'yawma + 요일'.", en: "Pattern: ayyu yawmin al-yawm? → al-yawmu ___. Days: al-ithnayn(Mon), ath-thulāthāʾ(Tue), al-arbiʿāʾ(Wed), al-khamīs(Thu), al-jumuʿa(Fri), as-sabt(Sat), al-aḥad(Sun). Range: 'min A ilā B'. Specific day: 'yawma + day'.", es: "Patrón: ayyu yawmin al-yawm? → al-yawmu ___. Días: al-ithnayn(lun), ath-thulāthāʾ(mar), al-arbiʿāʾ(mié), al-khamīs(jue), al-jumuʿa(vie), as-sabt(sáb), al-aḥad(dom). Rango: 'min A ilā B'. Día específico: 'yawma + día'." },
          examples: { ko: "أَيُّ يَوْمٍ الْيَوْم؟ الْيَوْمُ الِاثْنَيْن. (오늘 무슨 요일? 월요일이에요.)\nأَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة. (월요일부터 금요일까지 일해요.)\nأَراكَ يَوْمَ الأَرْبِعاء! (수요일에 봐요!)", en: "ayyu yawmin al-yawm? al-yawmu l-ithnayn. (Asking about the day.)\naʿmalu mina l-ithnayni ilā l-jumuʿa. (Describing your work week.)\narāka yawma l-arbiʿāʾ! (Making plans for a specific day.)", es: "ayyu yawmin al-yawm? al-yawmu l-ithnayn. (Preguntando por el día.)\naʿmalu mina l-ithnayni ilā l-jumuʿa. (Describiendo la semana laboral.)\narāka yawma l-arbiʿāʾ! (Haciendo planes para un día.)" },
          mistakes: { ko: "❌ أَراكَ فِي الأَرْبِعاء.\n✅ أَراكَ يَوْمَ الأَرْبِعاء. (요일 앞엔 'yawma'(날)을 붙이면 자연스러워요!)\n💬 이집트 구어로는 'أَشُوفَك يَوْم الأَرْبَع' 지만 표준어는 'أَراكَ يَوْمَ الأَرْبِعاء' ✓\n\n❌ مِنَ الِاثْنَيْنِ فِي الْجُمُعَة.\n✅ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة. (범위는 'min...ilā...' 짝으로 써요!)", en: "❌ arāka fī l-arbiʿāʾ.\n✅ arāka yawma l-arbiʿāʾ. (Put 'yawma' (day) before the weekday — it sounds natural!)\n💬 Egyptian dialect says 'ashoofak yoom el-arba3', but MSA is 'arāka yawma l-arbiʿāʾ' ✓\n\n❌ mina l-ithnayni fī l-jumuʿa.\n✅ mina l-ithnayni ilā l-jumuʿa. (For a range, pair 'min...ilā...'!)", es: "❌ arāka fī l-arbiʿāʾ.\n✅ arāka yawma l-arbiʿāʾ. (Pon 'yawma' (día) antes del día — ¡suena natural!)\n💬 El egipcio dice 'ashoofak yoom el-arba3', pero el estándar es 'arāka yawma l-arbiʿāʾ' ✓\n\n❌ mina l-ithnayni fī l-jumuʿa.\n✅ mina l-ithnayni ilā l-jumuʿa. (Para un rango, usa el par 'min...ilā...'.)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어 요일도 쉬워! 대부분 숫자에서 왔어 — ath-thulāthāʾ(화)=3, al-arbiʿāʾ(수)=4, al-khamīs(목)=5! 특정 요일 앞에 'yawma'만 붙이면 끝~", en: "Detective Rudy's tip: MSA weekdays are easy — most come from numbers! ath-thulāthāʾ (Tue)=3rd, al-arbiʿāʾ (Wed)=4th, al-khamīs (Thu)=5th! Just add 'yawma' before a specific day. Case solved!", es: "Consejo del detective Rudy: ¡Los días en árabe estándar son fáciles — la mayoría vienen de números! ath-thulāthāʾ (mar)=3º, al-arbiʿāʾ (mié)=4º, al-khamīs (jue)=5º. ¡Solo añade 'yawma' antes de un día específico!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ يَوْمٍ الْيَوْم؟", answer: "أَيُّ", options: ["أَيُّ", "أَيْنَ", "مَنْ"], fullSentence: "أَيُّ يَوْمٍ الْيَوْم؟", fullSentenceMeaning: { ko: "오늘 무슨 요일이에요?", en: "What day is it today?", es: "¿Qué día es hoy?" } },
          { type: "select", promptWithBlank: "أَعْمَلُ ___ الِاثْنَيْنِ إِلَى الْجُمُعَة.", answer: "مِنَ", options: ["مِنَ", "فِي", "عَلَى"], fullSentence: "أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة.", fullSentenceMeaning: { ko: "월요일부터 금요일까지 일해요.", en: "I work from Monday to Friday.", es: "Trabajo de lunes a viernes." } },
          { type: "select", promptWithBlank: "أَراكَ ___ الأَرْبِعاء!", answer: "يَوْمَ", options: ["يَوْمَ", "فِي", "عَلَى"], fullSentence: "أَراكَ يَوْمَ الأَرْبِعاء!", fullSentenceMeaning: { ko: "수요일에 봐요!", en: "See you on Wednesday!", es: "¡Te veo el miércoles!" } },
          { type: "input", promptWithBlank: "الْيَوْمُ ___.", answer: "الِاثْنَيْن", fullSentence: "الْيَوْمُ الِاثْنَيْن.", fullSentenceMeaning: { ko: "오늘은 월요일이에요.", en: "Today is Monday.", es: "Hoy es lunes." } },
          { type: "listening", audioText: "ماذا سَتَفْعَلُ فِي نِهايَةِ الأُسْبُوع؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["ماذا سَتَفْعَلُ فِي نِهايَةِ الأُسْبُوع؟", "الْيَوْمُ الِاثْنَيْن.", "أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة.", "أَراكَ يَوْمَ الأَرْبِعاء!"], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_9: {
    ...
    arabic: {
      step1Sentences: [
        { text: "كَمِ السَّاعَة؟ (kami s-sāʿa?)", speechLang: "ar-EG", meaning: { ko: "지금 몇 시예요?", en: "What time is it?", es: "¿Qué hora es?" } },
        { text: "السَّاعَةُ الثَّالِثَة. (as-sāʿatu th-thālitha.)", speechLang: "ar-EG", meaning: { ko: "세 시예요.", en: "It's three o'clock.", es: "Son las tres." } },
        { text: "السَّاعَةُ السَّابِعَةُ وَالنِّصْف. (as-sāʿatu s-sābiʿatu wa-n-niṣf.)", speechLang: "ar-EG", meaning: { ko: "일곱 시 반이에요.", en: "It's half past seven.", es: "Son las siete y media." } },
        { text: "الِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ صَباحًا. (al-ijtimāʿu s-sāʿata l-ʿāshirata ṣabāḥan.)", speechLang: "ar-EG", meaning: { ko: "회의는 아침 열 시예요.", en: "The meeting is at ten in the morning.", es: "La reunión es a las diez de la mañana." }, recallRound: true },
        { text: "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَةَ كُلَّ يَوْم. (astayqiẓu s-sāʿata s-sābiʿata kulla yawm.)", speechLang: "ar-EG", meaning: { ko: "매일 일곱 시에 일어나요.", en: "I wake up at seven every day.", es: "Me despierto a las siete todos los días." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: كَمِ السَّاعَة؟ (kami s-sāʿa?) → السَّاعَةُ ___. / 'as-sāʿa'는 '시'이고 시각은 서수(ath-thālitha=3시). 30분: 'wa-n-niṣf'(와 알니쓰프, 반). 오전: 'ṣabāḥan', 오후: 'baʿda ẓ-ẓuhr'.", en: "Pattern: kami s-sāʿa? → as-sāʿatu ___. 'as-sāʿa' means 'o'clock' and the hour is an ordinal (ath-thālitha=3rd). Half hour: 'wa-n-niṣf' (and a half). AM: 'ṣabāḥan', PM: 'baʿda ẓ-ẓuhr'.", es: "Patrón: kami s-sāʿa? → as-sāʿatu ___. 'as-sāʿa' significa 'hora' y la hora es un ordinal (ath-thālitha=3ª). Media hora: 'wa-n-niṣf' (y media). AM: 'ṣabāḥan', PM: 'baʿda ẓ-ẓuhr'." },
          examples: { ko: "كَمِ السَّاعَة؟ السَّاعَةُ الثَّالِثَة. (몇 시? 세 시예요.)\nالسَّاعَةُ السَّابِعَةُ وَالنِّصْف. (7시 반이에요.)\nالِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ صَباحًا. (회의는 오전 10시예요.)", en: "kami s-sāʿa? as-sāʿatu th-thālitha. (Asking and telling the time.)\nas-sāʿatu s-sābiʿatu wa-n-niṣf. (Saying it's 7:30.)\nal-ijtimāʿu s-sāʿata l-ʿāshirata ṣabāḥan. (Specifying a morning appointment.)", es: "kami s-sāʿa? as-sāʿatu th-thālitha. (Preguntando y diciendo la hora.)\nas-sāʿatu s-sābiʿatu wa-n-niṣf. (Son las 7:30.)\nal-ijtimāʿu s-sāʿata l-ʿāshirata ṣabāḥan. (Especificando una cita por la mañana.)" },
          mistakes: { ko: "❌ السَّاعَةُ السَّابِعَةُ نِصْف.\n✅ السَّاعَةُ السَّابِعَةُ وَالنِّصْف. (반을 말할 땐 'wa-'(와)를 꼭 붙여요!)\n💬 이집트 구어로는 'سَبْعَة وْنُص' 지만 표준어는 'السَّابِعَةُ وَالنِّصْف' ✓\n\n❌ الِاجْتِماعُ عَلَى الْعاشِرَة.\n✅ الِاجْتِماعُ السَّاعَةَ الْعاشِرَة. (시각엔 'as-sāʿa'를 써요, 'ʿalā' 같은 전치사 필요 없어요!)", en: "❌ as-sāʿatu s-sābiʿatu niṣf.\n✅ as-sāʿatu s-sābiʿatu wa-n-niṣf. (For half, always add 'wa-' (and)!)\n💬 Egyptian dialect says 'sab3a we-noṣ', but MSA is 'as-sābiʿatu wa-n-niṣf' ✓\n\n❌ al-ijtimāʿu ʿalā l-ʿāshira.\n✅ al-ijtimāʿu s-sāʿata l-ʿāshira. (Use 'as-sāʿa' for time — no preposition like 'ʿalā' needed!)", es: "❌ as-sāʿatu s-sābiʿatu niṣf.\n✅ as-sāʿatu s-sābiʿatu wa-n-niṣf. (Para la media, ¡siempre añade 'wa-' (y)!)\n💬 El egipcio dice 'sab3a we-noṣ', pero el estándar es 'as-sābiʿatu wa-n-niṣf' ✓\n\n❌ al-ijtimāʿu ʿalā l-ʿāshira.\n✅ al-ijtimāʿu s-sāʿata l-ʿāshira. (Usa 'as-sāʿa' para la hora — ¡sin preposición como 'ʿalā'!)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어 시각은 'as-sāʿa + 서수'면 끝! 30분은 'wa-n-niṣf'(와 알니쓰프)만 붙여. 15분은 'wa-r-rubʿ', 45분은 'illā rubʿ'(빼기 1/4). 이 단서들이면 시계 완전 정복~", en: "Detective Rudy's tip: In MSA, time is just 'as-sāʿa + ordinal'! For :30 add 'wa-n-niṣf' (and a half). :15 is 'wa-r-rubʿ', :45 is 'illā rubʿ' (minus a quarter). Crack these clues and you'll never be late!", es: "Consejo del detective Rudy: ¡En árabe estándar, la hora es solo 'as-sāʿa + ordinal'! Para :30 añade 'wa-n-niṣf' (y media). :15 es 'wa-r-rubʿ', :45 es 'illā rubʿ' (menos cuarto). ¡Descifra estas pistas!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ السَّاعَة؟", answer: "كَمِ", options: ["كَمِ", "ماذا", "أَيْنَ"], fullSentence: "كَمِ السَّاعَة؟", fullSentenceMeaning: { ko: "지금 몇 시예요?", en: "What time is it?", es: "¿Qué hora es?" } },
          { type: "select", promptWithBlank: "___ الثَّالِثَة.", answer: "السَّاعَةُ", options: ["السَّاعَةُ", "الْيَوْمُ", "السَّنَةُ"], fullSentence: "السَّاعَةُ الثَّالِثَة.", fullSentenceMeaning: { ko: "세 시예요.", en: "It's three o'clock.", es: "Son las tres." } },
          { type: "select", promptWithBlank: "الِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ ___.", answer: "صَباحًا", options: ["صَباحًا", "لَيْلًا", "السَّنَة"], fullSentence: "الِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ صَباحًا.", fullSentenceMeaning: { ko: "회의는 열 시예요.", en: "The meeting is at ten.", es: "La reunión es a las diez." } },
          { type: "input", promptWithBlank: "السَّاعَةُ السَّابِعَةُ ___.", answer: "وَالنِّصْف", fullSentence: "السَّاعَةُ السَّابِعَةُ وَالنِّصْف.", fullSentenceMeaning: { ko: "일곱 시 반이에요.", en: "It's half past seven.", es: "Son las siete y media." } },
          { type: "input", promptWithBlank: "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَةَ كُلَّ ___.", answer: "يَوْم", fullSentence: "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَةَ كُلَّ يَوْم.", fullSentenceMeaning: { ko: "매일 일곱 시에 일어나요.", en: "I wake up at seven every day.", es: "Me despierto a las siete todos los días." } },
          { type: "listening", audioText: "الِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ صَباحًا.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["الِاجْتِماعُ السَّاعَةَ الْعاشِرَةَ صَباحًا.", "كَمِ السَّاعَة؟", "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَة.", "السَّاعَةُ السَّابِعَةُ وَالنِّصْف."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Thank you.", es: "Gracias.", ko: "감사합니다." }, fromDay: 1, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_10: {
    ...
    arabic: {
      step1Sentences: [
        { text: "كَيْفَ الطَّقْسُ الْيَوْم؟ (kayfa ṭ-ṭaqsu l-yawm?)", speechLang: "ar-EG", meaning: { ko: "오늘 날씨 어때요?", en: "How's the weather today?", es: "¿Cómo está el clima hoy?" } },
        { text: "الجَوُّ مُشْمِسٌ وَدافِئ. (al-jawwu mushmisun wa-dāfiʾ.)", speechLang: "ar-EG", meaning: { ko: "맑고 따뜻해요.", en: "It's sunny and warm.", es: "Está soleado y cálido." } },
        { text: "الْيَوْمَ تُمْطِر. (al-yawma tumṭir.)", speechLang: "ar-EG", meaning: { ko: "오늘 비가 와요.", en: "It's raining today.", es: "Hoy está lloviendo." } },
        { text: "الجَوُّ بارِدٌ بِالخارِج. خُذْ سُتْرَة! (al-jawwu bāridun bi-l-khārij. khudh sutra!)", speechLang: "ar-EG", meaning: { ko: "밖이 추워요. 재킷 가져가세요!", en: "It's cold outside. Bring a jacket!", es: "Hace frío afuera. ¡Trae una chaqueta!" }, recallRound: true },
        { text: "أُحِبُّ الطَّقْسَ الْحارّ. (uḥibbu ṭ-ṭaqsa l-ḥārr.)", speechLang: "ar-EG", meaning: { ko: "더운 날씨를 좋아해요.", en: "I like hot weather.", es: "Me gusta el clima caliente." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: كَيْفَ الطَّقْس؟ (kayfa ṭ-ṭaqs?) → الجَوُّ ___. / 'al-jaww'(날씨/공기)로 시작해요. 상태: mushmis(맑음), ghāʾim(흐림), bārid(추움), ḥārr(더움), dāfiʾ(따뜻함). 비: 'tumṭir'(비 온다).", en: "Pattern: kayfa ṭ-ṭaqs? → al-jawwu ___. In MSA you start with 'al-jaww' (the weather/air). Conditions: mushmis(sunny), ghāʾim(cloudy), bārid(cold), ḥārr(hot), dāfiʾ(warm). Rain: 'tumṭir' (it's raining).", es: "Patrón: kayfa ṭ-ṭaqs? → al-jawwu ___. En árabe estándar empiezas con 'al-jaww' (el clima/aire). Condiciones: mushmis(soleado), ghāʾim(nublado), bārid(frío), ḥārr(caliente), dāfiʾ(cálido). Lluvia: 'tumṭir'." },
          examples: { ko: "كَيْفَ الطَّقْسُ الْيَوْم؟ الجَوُّ مُشْمِسٌ وَدافِئ. (오늘 날씨 어때? 맑고 따뜻해.)\nالْيَوْمَ تُمْطِر. (오늘 비가 와요.)\nالجَوُّ بارِدٌ بِالخارِج. خُذْ سُتْرَة! (밖이 추워요. 재킷 가져가!)", en: "kayfa ṭ-ṭaqsu l-yawm? al-jawwu mushmisun wa-dāfiʾ. (Asking about and describing weather.)\nal-yawma tumṭir. (Describing ongoing weather.)\nal-jawwu bāridun bi-l-khārij. khudh sutra! (Giving weather-based advice.)", es: "kayfa ṭ-ṭaqsu l-yawm? al-jawwu mushmisun wa-dāfiʾ. (Preguntando y describiendo el clima.)\nal-yawma tumṭir. (Describiendo clima en curso.)\nal-jawwu bāridun bi-l-khārij. khudh sutra! (Dando consejo basado en el clima.)" },
          mistakes: { ko: "❌ الجَوُّ هُوَ بارِد.\n✅ الجَوُّ بارِد. (날씨는 단순하게! 명사문이라 be동사(huwa) 필요 없어요)\n💬 이집트 구어로는 'الدُّنْيَا بَرْد' 지만 표준어는 'الجَوُّ بارِد' ✓\n\n❌ الْيَوْمَ مَطَر. (오늘 비, 명사)\n✅ الْيَوْمَ تُمْطِر. ('비가 온다'는 동사 'tumṭir'를 써요!)", en: "❌ al-jawwu huwa bārid.\n✅ al-jawwu bārid. (Keep weather simple — it's a nominal sentence, no 'to be' (huwa) needed!)\n💬 Egyptian dialect says 'ed-donya bard', but MSA is 'al-jawwu bārid' ✓\n\n❌ al-yawma maṭar. (= today rain, noun)\n✅ al-yawma tumṭir. (Use the verb 'tumṭir' for 'it's raining'!)", es: "❌ al-jawwu huwa bārid.\n✅ al-jawwu bārid. (¡Mantén el clima simple — es una oración nominal, sin 'ser' (huwa)!)\n💬 El egipcio dice 'ed-donya bard', pero el estándar es 'al-jawwu bārid' ✓\n\n❌ al-yawma maṭar. (= hoy lluvia, sustantivo)\n✅ al-yawma tumṭir. (Usa el verbo 'tumṭir' para 'está lloviendo'.)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어 날씨의 단서는 'al-jaww'(الجَوّ)야! '날씨가 추워, 날씨가 더워'처럼 말해. al-jawwu bārid, al-jawwu ḥārr... 형용사만 툭 던지면 끝~", en: "Detective Rudy's tip: The clue to MSA weather is 'al-jaww' (the air/weather)! You say 'the weather is cold/hot.' al-jawwu bārid, al-jawwu ḥārr... just drop the adjective and case solved!", es: "Consejo del detective Rudy: ¡La pista del clima en árabe estándar es 'al-jaww' (el aire/clima)! Dices 'el clima está frío/caliente.' al-jawwu bārid, al-jawwu ḥārr... ¡solo suelta el adjetivo!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "___ الطَّقْسُ الْيَوْم؟", answer: "كَيْفَ", options: ["كَيْفَ", "أَيْنَ", "كَمْ"], fullSentence: "كَيْفَ الطَّقْسُ الْيَوْم؟", fullSentenceMeaning: { ko: "오늘 날씨 어때요?", en: "How's the weather today?", es: "¿Cómo está el clima hoy?" } },
          { type: "select", promptWithBlank: "الجَوُّ مُشْمِسٌ ___.", answer: "وَدافِئ", options: ["وَدافِئ", "الْيَوْم", "صَباحًا"], fullSentence: "الجَوُّ مُشْمِسٌ وَدافِئ.", fullSentenceMeaning: { ko: "맑고 따뜻해요.", en: "It's sunny and warm.", es: "Está soleado y cálido." } },
          { type: "select", promptWithBlank: "الْيَوْمَ ___.", answer: "تُمْطِر", options: ["تُمْطِر", "الجَوُّ", "السَّاعَةُ"], fullSentence: "الْيَوْمَ تُمْطِر.", fullSentenceMeaning: { ko: "오늘 비가 와요.", en: "It's raining today.", es: "Hoy está lloviendo." } },
          { type: "input", promptWithBlank: "الجَوُّ ___ بِالخارِج. خُذْ سُتْرَة!", answer: "بارِدٌ", fullSentence: "الجَوُّ بارِدٌ بِالخارِج. خُذْ سُتْرَة!", fullSentenceMeaning: { ko: "밖이 추워요. 재킷 가져가세요!", en: "It's cold outside. Bring a jacket!", es: "Hace frío afuera. ¡Trae una chaqueta!" } },
          { type: "listening", audioText: "الْيَوْمَ تُمْطِر.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["الْيَوْمَ تُمْطِر.", "الجَوُّ مُشْمِسٌ وَدافِئ.", "أُحِبُّ الطَّقْسَ الْحارّ.", "الجَوُّ بارِدٌ بِالخارِج."], correct: 0, audioOnly: true },
        ],
      },
      crossUnitReview: [
        { sentence: { en: "Where is the bathroom?", es: "¿Dónde está el baño?", ko: "화장실이 어디에요?" }, fromDay: 2, context: { ko: "생존 표현 복습", en: "Survival phrase review", es: "Repaso de supervivencia" } },
  ...
  day_11: {
    ...
    arabic: {
      step1Sentences: [
        { text: "ما لَوْنُ هٰذَا؟ (mā lawnu hādhā?)", speechLang: "ar-EG", meaning: { ko: "이건 무슨 색이에요?", en: "What colour is this?", es: "¿De qué color es esto?" } },
        { text: "هٰذَا أَحْمَر. أُحِبُّ الأَزْرَق. (hādhā aḥmar. uḥibbu l-azraq.)", speechLang: "ar-EG", meaning: { ko: "빨간색이에요. 저는 파란색을 좋아해요.", en: "It's red. I like blue.", es: "Es rojo. Me gusta el azul." } },
        { text: "هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ (hal yūjadu maqāsun akbar?)", speechLang: "ar-EG", meaning: { ko: "이거 더 큰 사이즈 있어요?", en: "Do you have this in a bigger size?", es: "¿Tiene esto en una talla más grande?" } },
        { text: "هٰذَا صَغِيرٌ جِدًّا. أُرِيدُ واحِدًا أَكْبَر. (hādhā ṣaghīrun jiddan. urīdu wāḥidan akbar.)", speechLang: "ar-EG", meaning: { ko: "이건 너무 작아요. 더 큰 거 필요해요.", en: "This is too small. I need a larger one.", es: "Esto es muy pequeño. Necesito uno más grande." }, recallRound: true },
        { text: "سَآخُذُ الأَسْوَد. (sa-ākhudhu l-aswad.)", speechLang: "ar-EG", meaning: { ko: "검은색 걸로 할게요.", en: "I'll take the black one, please.", es: "Me llevo el negro, por favor." }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: ما لَوْنُ هٰذَا؟ (mā lawnu hādhā?) → هٰذَا ___. / 색상: aḥmar(빨강), azraq(파랑), akhḍar(초록), aswad(검정), abyaḍ(흰색), aṣfar(노랑). 비교급: 'akbar'(더 큰), 'aṣghar'(더 작은). 'jiddan'=너무/아주. 쇼핑: 'sa-ākhudhu ___'(이거 살게요).", en: "Pattern: mā lawnu hādhā? → hādhā ___. Colours: aḥmar(red), azraq(blue), akhḍar(green), aswad(black), abyaḍ(white), aṣfar(yellow). Comparative: 'akbar'(bigger), 'aṣghar'(smaller). 'jiddan'=too/very. Shopping: 'sa-ākhudhu ___'(I'll take ___).", es: "Patrón: mā lawnu hādhā? → hādhā ___. Colores: aḥmar(rojo), azraq(azul), akhḍar(verde), aswad(negro), abyaḍ(blanco), aṣfar(amarillo). Comparativo: 'akbar'(más grande), 'aṣghar'(más pequeño). 'jiddan'=demasiado/muy. Compras: 'sa-ākhudhu ___'(me llevo ___)." },
          examples: { ko: "ما لَوْنُ هٰذَا؟ هٰذَا أَحْمَر. (이건 무슨 색? 빨간색이에요.)\nهَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ (더 큰 사이즈 있어요?)\nسَآخُذُ الأَسْوَد. (검은색 걸로 할게요.)", en: "mā lawnu hādhā? hādhā aḥmar. (Asking about colour.)\nhal yūjadu maqāsun akbar? (Requesting a larger size.)\nsa-ākhudhu l-aswad. (Making a purchase decision.)", es: "mā lawnu hādhā? hādhā aḥmar. (Preguntando por el color.)\nhal yūjadu maqāsun akbar? (Pidiendo una talla más grande.)\nsa-ākhudhu l-aswad. (Tomando una decisión de compra.)" },
          mistakes: { ko: "❌ هٰذَا كَبِيرٌ أَكْثَر.\n✅ هٰذَا أَكْبَر. (비교급은 한 단어로 'akbar'! 'more big'처럼 두 단어로 쓰지 마세요)\n💬 이집트 구어로는 'عَايِز' 지만 표준어는 'أُرِيد' ✓\n\n❌ سَآخُذُ لَوْنًا أَسْوَدَ هٰذَا.\n✅ سَآخُذُ الأَسْوَد. (그냥 'al-aswad'(그 검은 거)면 충분해요!)", en: "❌ hādhā kabīrun akthar.\n✅ hādhā akbar. (Comparative is ONE word — 'akbar'! Don't say it like 'more big'.)\n💬 Egyptian dialect says 'ʿaayez', but MSA is 'urīd' (I want) ✓\n\n❌ sa-ākhudhu lawnan aswada hādhā.\n✅ sa-ākhudhu l-aswad. (Just 'al-aswad' (the black one) is enough!)", es: "❌ hādhā kabīrun akthar.\n✅ hādhā akbar. (¡El comparativo es UNA palabra — 'akbar'! No lo digas como 'más grande'.)\n💬 El egipcio dice 'ʿaayez', pero el estándar es 'urīd' (quiero) ✓\n\n❌ sa-ākhudhu lawnan aswada hādhā.\n✅ sa-ākhudhu l-aswad. (¡Solo 'al-aswad' (el negro) es suficiente!)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어로 쇼핑할 땐 'sa-ākhudhu ___'(살게요)만 알면 끝! sa-ākhudhu l-aswad, sa-ākhudhu l-azraq... 색만 넣어. 비교는 'akbar'(더 큰), 'aṣghar'(더 작은) 한 단어면 OK~", en: "Detective Rudy's tip: For shopping in MSA, just learn 'sa-ākhudhu ___' (I'll take ___)! sa-ākhudhu l-aswad, sa-ākhudhu l-azraq... just add a colour. And comparing is one word: 'akbar' (bigger), 'aṣghar' (smaller)!", es: "Consejo del detective Rudy: Para comprar en árabe estándar, ¡solo aprende 'sa-ākhudhu ___' (me llevo ___)! sa-ākhudhu l-aswad, sa-ākhudhu l-azraq... solo añade un color. Y comparar es una palabra: 'akbar' (más grande), 'aṣghar' (más pequeño)." },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "ما ___ هٰذَا؟", answer: "لَوْنُ", options: ["لَوْنُ", "مَقاسُ", "نَوْعُ"], fullSentence: "ما لَوْنُ هٰذَا؟", fullSentenceMeaning: { ko: "이건 무슨 색이에요?", en: "What colour is this?", es: "¿De qué color es esto?" } },
          { type: "select", promptWithBlank: "هٰذَا صَغِيرٌ ___.", answer: "جِدًّا", options: ["جِدًّا", "أَكْبَر", "كَثِيرًا"], fullSentence: "هٰذَا صَغِيرٌ جِدًّا.", fullSentenceMeaning: { ko: "이건 너무 작아요.", en: "This is too small.", es: "Esto es muy pequeño." } },
          { type: "select", promptWithBlank: "هَلْ يُوجَدُ مَقاسٌ ___؟", answer: "أَكْبَر", options: ["أَكْبَر", "جِدًّا", "كَثِير"], fullSentence: "هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟", fullSentenceMeaning: { ko: "이거 더 큰 사이즈 있어요?", en: "Do you have this in a bigger size?", es: "¿Tiene esto en una talla más grande?" } },
          { type: "input", promptWithBlank: "سَآخُذُ ___.", answer: "الأَسْوَد", fullSentence: "سَآخُذُ الأَسْوَد.", fullSentenceMeaning: { ko: "검은색 걸로 할게요.", en: "I'll take the black one.", es: "Me llevo el negro." } },
          { type: "input", promptWithBlank: "أُحِبُّ ___.", answer: "الأَزْرَق", fullSentence: "أُحِبُّ الأَزْرَق.", fullSentenceMeaning: { ko: "파란색을 좋아해요.", en: "I like blue.", es: "Me gusta el azul." } },
          { type: "listening", audioText: "سَآخُذُ الأَسْوَد.", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["سَآخُذُ الأَسْوَد.", "هٰذَا صَغِيرٌ جِدًّا. أُرِيدُ واحِدًا أَكْبَر.", "هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟", "ما لَوْنُ هٰذَا؟"], correct: 0, audioOnly: true },
        ],
      },
    },
  },
  ...
  day_12: {
    ...
    arabic: {
      step1Sentences: [
        { text: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. رَقَمُ هاتِفِي ٠١٠-١٢٣٤-٥٦٧٨. (ʿumrī khamsatun wa-ʿishrūna ʿāman. raqamu hātifī ṣifr-wāḥid-ṣifr...)", speechLang: "ar-EG", meaning: { ko: "저는 스물다섯 살이에요. 전화번호는 010-1234-5678이에요.", en: "I'm twenty-five years old. My phone number is 010-1234-5678.", es: "Tengo veinticinco años. Mi número es 010-1234-5678." } },
        { text: "الْيَوْمُ الْجُمُعَة. أَراكَ يَوْمَ الِاثْنَيْن! (al-yawmu l-jumuʿa. arāka yawma l-ithnayn!)", speechLang: "ar-EG", meaning: { ko: "오늘은 금요일이에요. 월요일에 봐요!", en: "Today is Friday. See you on Monday!", es: "Hoy es viernes. ¡Te veo el lunes!" } },
        { text: "السَّاعَةُ الثَّالِثَةُ وَالنِّصْف. الِاجْتِماعُ السَّاعَةَ الرَّابِعَة. (as-sāʿatu th-thālithatu wa-n-niṣf. al-ijtimāʿu s-sāʿata r-rābiʿa.)", speechLang: "ar-EG", meaning: { ko: "세 시 반이에요. 회의는 네 시예요.", en: "It's half past three. The meeting is at four.", es: "Son las tres y media. La reunión es a las cuatro." } },
        { text: "الْيَوْمَ تُمْطِر. الجَوُّ بارِد. خُذْ سُتْرَة! (al-yawma tumṭir. al-jawwu bārid. khudh sutra!)", speechLang: "ar-EG", meaning: { ko: "오늘 비가 와요. 추워요. 재킷 가져가세요!", en: "It's raining today. It's cold. Bring a jacket!", es: "Hoy llueve. Hace frío. ¡Trae una chaqueta!" }, recallRound: true },
        { text: "أُحِبُّ الأَزْرَق. هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ (uḥibbu l-azraq. hal yūjadu maqāsun akbar?)", speechLang: "ar-EG", meaning: { ko: "파란색이 좋아요. 더 큰 사이즈 있어요?", en: "I like the blue one. Do you have a bigger size?", es: "Me gusta el azul. ¿Tiene una talla más grande?" }, recallRound: true },
      ],
      step1Config: {
        hasAudioOnlyRound: true,
        audioOnlyCount: 2,
      ...
      step2: {
        explanation: {
          pattern: { ko: "패턴: Unit 2 표준 아랍어 총복습! 숫자/나이(kam ʿumruka?), 요일(ayyu yawmin al-yawm?), 시간(kami s-sāʿa?), 날씨(kayfa ṭ-ṭaqs?), 색상/크기(mā lawnu hādhā? maqās?).", en: "Pattern: Unit 2 MSA review! Numbers/age (kam ʿumruka?), days (ayyu yawmin al-yawm?), time (kami s-sāʿa?), weather (kayfa ṭ-ṭaqs?), colours/sizes (mā lawnu hādhā? maqās?).", es: "Patrón: Repaso completo de Unidad 2 en árabe estándar. Números/edad (kam ʿumruka?), días (ayyu yawmin al-yawm?), hora (kami s-sāʿa?), clima (kayfa ṭ-ṭaqs?), colores/tallas (mā lawnu hādhā?)." },
          examples: { ko: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. الْيَوْمُ الْجُمُعَة. (나이+요일 연결)\nالسَّاعَةُ الثَّالِثَةُ وَالنِّصْف. الْيَوْمَ تُمْطِر. (시간+날씨 연결)\nأُحِبُّ الأَزْرَق. هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ (색상+크기 연결)", en: "ʿumrī khamsatun wa-ʿishrūna ʿāman. al-yawmu l-jumuʿa. (Connecting age + day.)\nas-sāʿatu th-thālithatu wa-n-niṣf. al-yawma tumṭir. (Connecting time + weather.)\nuḥibbu l-azraq. hal yūjadu maqāsun akbar? (Connecting colour + size.)", es: "ʿumrī khamsatun wa-ʿishrūna ʿāman. al-yawmu l-jumuʿa. (Conectando edad + día.)\nas-sāʿatu th-thālithatu wa-n-niṣf. al-yawma tumṭir. (Conectando hora + clima.)\nuḥibbu l-azraq. hal yūjadu maqāsun akbar? (Conectando color + talla.)" },
          mistakes: { ko: "❌ أَنَا خَمْسَةٌ وَعِشْرُونَ عامًا. (ʿumrī 빠짐)\n✅ عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا.\n💬 이집트 구어로는 'أَنَا عَنْدِي ... سَنَة' 지만 표준어는 'عُمْرِي ... عامًا' ✓\n\n❌ السَّاعَةُ السَّابِعَةُ نِصْف. ↔ السَّاعَةُ السَّابِعَةُ وَالنِّصْف.\n✅ 반은 'wa-n-niṣf'(와 알니쓰프), 비교는 'akbar' 한 단어!", en: "❌ ana khamsatun wa-ʿishrūna ʿāman. (missing ʿumrī)\n✅ ʿumrī khamsatun wa-ʿishrūna ʿāman.\n💬 Egyptian dialect says 'ana ʿandi ... sana', but MSA is 'ʿumrī ... ʿāman' ✓\n\n❌ as-sāʿatu s-sābiʿatu niṣf.\n✅ as-sāʿatu s-sābiʿatu wa-n-niṣf. (Half = 'wa-n-niṣf' with 'and'; comparative = one word 'akbar'!)", es: "❌ ana khamsatun wa-ʿishrūna ʿāman. (falta ʿumrī)\n✅ ʿumrī khamsatun wa-ʿishrūna ʿāman.\n💬 El egipcio dice 'ana ʿandi ... sana', pero el estándar es 'ʿumrī ... ʿāman' ✓\n\n❌ as-sāʿatu s-sābiʿatu niṣf.\n✅ as-sāʿatu s-sābiʿatu wa-n-niṣf. (Media = 'wa-n-niṣf' con 'y'; comparativo = una palabra 'akbar'.)" },
          rudyTip: { ko: "탐정 루디의 팁: 표준 아랍어 핵심 정리! 숫자는 '-ata ʿashara/-ūn' 블록, 나이엔 'عُمْرِي'(ʿumrī), 요일엔 'yawma', 시간은 'as-sāʿa + wa-n-niṣf', 날씨는 'al-jaww + 형용사', 비교는 'akbar'. 이 단서들이면 Unit 2 완벽 클리어!", en: "Detective Rudy's tip: MSA cheat sheet! Numbers = '-ata ʿashara/-ūn' blocks, age = 'ʿumrī', days = 'yawma', time = 'as-sāʿa + wa-n-niṣf', weather = 'al-jaww + adjective', compare = 'akbar'. These clues solve Unit 2!", es: "Consejo del detective Rudy: Resumen del árabe estándar. Números = bloques '-ata ʿashara/-ūn', edad = 'ʿumrī', días = 'yawma', hora = 'as-sāʿa + wa-n-niṣf', clima = 'al-jaww + adjetivo', comparar = 'akbar'. ¡Estas pistas resuelven la Unidad 2!" },
        } as GrammarExplanation,
        quizzes: [
          { type: "select", promptWithBlank: "كَمْ ___؟", answer: "عُمْرُكَ", options: ["عُمْرُكَ", "اسْمُكَ", "بَلَدُكَ"], fullSentence: "كَمْ عُمْرُكَ؟", fullSentenceMeaning: { ko: "몇 살이에요?", en: "How old are you?", es: "¿Cuántos años tienes?" } },
          { type: "select", promptWithBlank: "___ السَّاعَة؟", answer: "كَمِ", options: ["كَمِ", "ماذا", "أَيْنَ"], fullSentence: "كَمِ السَّاعَة؟", fullSentenceMeaning: { ko: "지금 몇 시예요?", en: "What time is it?", es: "¿Qué hora es?" } },
          { type: "input", promptWithBlank: "___ الطَّقْسُ الْيَوْم؟", answer: "كَيْفَ", fullSentence: "كَيْفَ الطَّقْسُ الْيَوْم؟", fullSentenceMeaning: { ko: "오늘 날씨 어때요?", en: "How's the weather?", es: "¿Cómo está el clima?" } },
          { type: "input", promptWithBlank: "___ يَوْمٍ الْيَوْم؟", answer: "أَيُّ", fullSentence: "أَيُّ يَوْمٍ الْيَوْم؟", fullSentenceMeaning: { ko: "오늘 무슨 요일이에요?", en: "What day is it?", es: "¿Qué día es hoy?" } },
          { type: "input", promptWithBlank: "هَلْ يُوجَدُ مَقاسٌ ___؟", answer: "أَكْبَر", fullSentence: "هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟", fullSentenceMeaning: { ko: "이거 더 큰 사이즈 있어요?", en: "Do you have a bigger size?", es: "¿Tiene una talla más grande?" } },
          { type: "listening", audioText: "أُحِبُّ الأَزْرَق. هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟", question: { ko: "방금 뭐라고 했나요?", en: "What was just said?", es: "¿Qué se acaba de decir?" }, options: ["أُحِبُّ الأَزْرَق. هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟", "الْيَوْمَ تُمْطِر. الجَوُّ بارِد.", "كَمِ السَّاعَة؟", "كَمْ عُمْرُكَ؟"], correct: 0, audioOnly: true },
        ],
      },
    },
  },
...
export const MISSION_CONTENT_UNIT2: Record<string, Partial<Record<LearningLangKey, MissionTalkLangData>>> = {
  ...
  day_7: {
    ...
    arabic: { situation: { ko: "박물관 입구에서 새 동료의 연락처를 교환하고 있습니다.", en: "Exchanging contact info at the museum.", es: "Intercambiando información de contacto." }, gptPrompt: "You are Rudy exchanging contact information with your partner. Simple A1 Modern Standard Arabic (MSA). Practice: 1) ask their age ('kam ʿumruka?') 2) exchange phone numbers (spell out each digit: ṣifr, wāḥid, ithnān...) 3) count items together. Keep very simple.", speechLang: "ar-EG", suggestedAnswers: ["عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. (ʿumrī khamsatun wa-ʿishrūna ʿāman.)", "رَقَمُ هاتِفِي ___. (raqamu hātifī ___.)", "كَمْ عُمْرُكَ؟ (kam ʿumruka?)", "واحِد، اثْنانِ، ثَلاثَة... (wāḥid, ithnān, thalātha...)", "هُناكَ خَمْسُ لَوْحات. (hunāka khamsu lawḥāt.)"] },
  },
  ...
  day_8: {
    ...
    arabic: { situation: { ko: "루디와 한 주의 일정을 계획하고 있습니다.", en: "Planning the week with Rudy.", es: "Planificando la semana con Rudy." }, gptPrompt: "You are Rudy planning the week with your partner. Simple A1 Modern Standard Arabic (MSA). Practice: days of the week (al-ithnayn, ath-thulāthāʾ, al-arbiʿāʾ...), work schedule (mina l-ithnayni ilā l-jumuʿa), weekend plans, setting meeting days ('yawma l-arbiʿāʾ'). Keep simple.", speechLang: "ar-EG", suggestedAnswers: ["الْيَوْمُ الِاثْنَيْن. (al-yawmu l-ithnayn.)", "أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة. (aʿmalu mina l-ithnayni ilā l-jumuʿa.)", "ماذا سَتَفْعَلُ فِي نِهايَةِ الأُسْبُوع؟ (mādhā sa-tafʿalu fī nihāyati l-usbūʿ?)", "أَراكَ يَوْمَ الأَرْبِعاء! (arāka yawma l-arbiʿāʾ!)", "أَيُّ يَوْمٍ الْيَوْم؟ (ayyu yawmin al-yawm?)"] },
  },
  ...
  day_9: {
    ...
    arabic: { situation: { ko: "박물관에서 투어 시간을 확인하고 있습니다.", en: "Checking tour times at the museum.", es: "Verificando horarios de tours." }, gptPrompt: "You are Rudy at the museum coordinating tour times. Simple A1 Modern Standard Arabic (MSA). Practice: asking time ('kami s-sāʿa?'), tour times (as-sāʿatu th-thāniya, as-sāʿatu th-thālithatu wa-n-niṣf), daily routine. Keep simple.", speechLang: "ar-EG", suggestedAnswers: ["كَمِ السَّاعَة؟ (kami s-sāʿa?)", "السَّاعَةُ الثَّالِثَة. (as-sāʿatu th-thālitha.)", "الْجَوْلَةُ السَّاعَةَ الثَّانِيَةَ وَالنِّصْف. (al-jawlatu s-sāʿata th-thāniyata wa-n-niṣf.)", "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَة. (astayqiẓu s-sāʿata s-sābiʿa.)", "الْمَتْحَفُ يُغْلِقُ السَّاعَةَ الْخامِسَة. (al-matḥafu yughliqu s-sāʿata l-khāmisa.)"] },
  },
  ...
  day_10: {
    ...
    arabic: { situation: { ko: "야외 조사 전에 날씨를 확인하고 있습니다.", en: "Checking weather before investigation.", es: "Verificando el clima." }, gptPrompt: "You are Rudy planning an outdoor investigation. Simple A1 Modern Standard Arabic (MSA). Practice: weather (mushmis, tumṭir, bārid, ḥārr), clothing, preferences. Keep simple.", speechLang: "ar-EG", suggestedAnswers: ["كَيْفَ الطَّقْسُ الْيَوْم؟ (kayfa ṭ-ṭaqsu l-yawm?)", "الجَوُّ مُشْمِسٌ وَدافِئ. (al-jawwu mushmisun wa-dāfiʾ.)", "تُمْطِر! خُذْ مِظَلَّة. (tumṭir! khudh miẓalla.)", "الجَوُّ بارِدٌ بِالخارِج. (al-jawwu bāridun bi-l-khārij.)", "أُحِبُّ الطَّقْسَ الْحارّ. (uḥibbu ṭ-ṭaqsa l-ḥārr.)"] },
  },
  ...
  day_11: {
    ...
    arabic: { situation: { ko: "박물관 기념품 가게에서 선물을 고르고 있습니다.", en: "Shopping at the museum gift shop.", es: "Comprando en la tienda." }, gptPrompt: "You are Rudy at the gift shop helping choose souvenirs. Simple A1 Modern Standard Arabic (MSA). Practice: colours (aḥmar, azraq, aswad), sizes (akbar, ṣaghīr jiddan), choosing items ('sa-ākhudhu l-___'). Make it like real shopping.", speechLang: "ar-EG", suggestedAnswers: ["ما لَوْنُ هٰذَا؟ (mā lawnu hādhā?)", "أُحِبُّ الأَزْرَق. (uḥibbu l-azraq.)", "هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ (hal yūjadu maqāsun akbar?)", "هٰذَا صَغِيرٌ جِدًّا. (hādhā ṣaghīrun jiddan.)", "سَآخُذُ الأَسْوَد. (sa-ākhudhu l-aswad.)", "بِكَمْ هٰذَا؟ (bi-kam hādhā?)"] },
  },
  ...
  day_12: {
    ...
    arabic: { situation: { ko: "박물관 주간 마무리 파티입니다! 이번 주 배운 모든 표현을 사용해보세요!", en: "End-of-week party! Use everything!", es: "¡Fiesta! ¡Usa todo!" }, gptPrompt: "You are Rudy hosting an end-of-week gathering. Test ALL of Unit 2 in A1 Modern Standard Arabic (MSA): numbers/age, days, time, weather, colours/sizes. Also reinforce Unit 1 survival phrases naturally (kayfa ḥāluka? ayna l-ḥammām?). Create 2-3 mini-scenarios. Be encouraging.", speechLang: "ar-EG", suggestedAnswers: ["عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. (ʿumrī khamsatun wa-ʿishrūna ʿāman.)", "الْيَوْمُ الْجُمُعَة! (al-yawmu l-jumuʿa!)", "السَّاعَةُ الثَّالِثَةُ وَالنِّصْف. (as-sāʿatu th-thālithatu wa-n-niṣf.)", "الجَوُّ مُشْمِسٌ وَدافِئ. (al-jawwu mushmisun wa-dāfiʾ.)", "أُحِبُّ الأَزْرَق. (uḥibbu l-azraq.)", "بِكَمْ هٰذَا؟ (bi-kam hādhā?)", "أَيْنَ الْحَمَّام؟ (ayna l-ḥammām?)"] },
  },
};
...
export const REVIEW_CONTENT_UNIT2: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_7: {
    ...
    arabic: [
      { type: "speak", sentence: "عَفْوًا، أَنَا لا أَفْهَم. هَلْ يُمْكِنُكَ أَنْ تُعِيدَ؟ (ʿafwan, anā lā afham. hal yumkinuka an tuʿīda?)", speechLang: "ar-EG", meaning: { ko: "이해를 못 했어요. 다시 한번 말해주세요.", en: "Sorry, I don't understand. Can you say that again?", es: "No entiendo. ¿Puede repetir?" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "___ هٰذَا؟", answer: "بِكَمْ", options: ["بِكَمْ", "ماذا", "أَيْنَ"], fullSentence: "بِكَمْ هٰذَا؟", fullSentenceMeaning: { ko: "이거 얼마예요?", en: "How much is this?", es: "¿Cuánto cuesta?" }, isYesterdayReview: true },
      { type: "speak", sentence: "عِنْدِي كَلْبانِ وَثَلاثُ قِطَطٍ فِي الْبَيْت.", speechLang: "ar-EG", meaning: { ko: "집에 강아지 두 마리, 고양이 세 마리가 있어요.", en: "I have two dogs and three cats at home.", es: "Tengo dos perros y tres gatos en casa." } },
      { type: "fill_blank", promptWithBlank: "كَمْ ___؟", answer: "عُمْرُكَ", options: ["عُمْرُكَ", "اسْمُكَ", "بَلَدُكَ"], fullSentence: "كَمْ عُمْرُكَ؟", fullSentenceMeaning: { ko: "몇 살이에요?", en: "How old are you?", es: "¿Cuántos años tienes?" } },
      { type: "speak", sentence: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا.", speechLang: "ar-EG", meaning: { ko: "저는 스물다섯 살이에요.", en: "I'm 25 years old.", es: "Tengo 25 años." } },
    ],
  },
  ...
  day_8: {
    ...
    arabic: [
      { type: "speak", sentence: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا.", speechLang: "ar-EG", meaning: { ko: "저는 스물다섯 살이에요.", en: "I'm 25.", es: "Tengo 25 años." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "كَمْ ___؟", answer: "عُمْرُكَ", options: ["عُمْرُكَ", "اسْمُكَ", "بَلَدُكَ"], fullSentence: "كَمْ عُمْرُكَ؟", fullSentenceMeaning: { ko: "몇 살이에요?", en: "How old are you?", es: "¿Cuántos años tienes?" }, isYesterdayReview: true },
      { type: "speak", sentence: "الْيَوْمُ الِاثْنَيْن. أَراكَ يَوْمَ الْجُمُعَة!", speechLang: "ar-EG", meaning: { ko: "오늘은 월요일. 금요일에 봐요!", en: "Today is Monday. See you Friday!", es: "Hoy es lunes. ¡Nos vemos el viernes!" } },
      { type: "fill_blank", promptWithBlank: "أَعْمَلُ ___ الِاثْنَيْنِ إِلَى الْجُمُعَة.", answer: "مِنَ", options: ["مِنَ", "فِي", "عَلَى"], fullSentence: "أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة.", fullSentenceMeaning: { ko: "월~금 일해요.", en: "I work Mon-Fri.", es: "Trabajo lunes a viernes." } },
      { type: "speak", sentence: "ماذا سَتَفْعَلُ فِي نِهايَةِ الأُسْبُوع؟", speechLang: "ar-EG", meaning: { ko: "이번 주말에 뭐 해?", en: "What are you doing this weekend?", es: "¿Qué haces este fin de semana?" } },
    ],
  },
  ...
  day_9: {
    ...
    arabic: [
      { type: "speak", sentence: "الْيَوْمُ الأَرْبِعاء. أَراكَ يَوْمَ الْجُمُعَة!", speechLang: "ar-EG", meaning: { ko: "오늘은 수요일. 금요일에 봐요!", en: "Wednesday. See you Friday!", es: "Miércoles. ¡Nos vemos el viernes!" }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "___ يَوْمٍ الْيَوْم؟", answer: "أَيُّ", options: ["أَيُّ", "أَيْنَ", "مَنْ"], fullSentence: "أَيُّ يَوْمٍ الْيَوْم؟", fullSentenceMeaning: { ko: "오늘 무슨 요일?", en: "What day?", es: "¿Qué día?" }, isYesterdayReview: true },
      { type: "speak", sentence: "كَمِ السَّاعَة؟ السَّاعَةُ الثَّالِثَة.", speechLang: "ar-EG", meaning: { ko: "몇 시예요? 세 시예요.", en: "What time? 3 o'clock.", es: "¿Qué hora? Las tres." } },
      { type: "fill_blank", promptWithBlank: "السَّاعَةُ السَّابِعَةُ ___.", answer: "وَالنِّصْف", options: ["وَالنِّصْف", "وَالرُّبْع", "وَالثُّلْث"], fullSentence: "السَّاعَةُ السَّابِعَةُ وَالنِّصْف.", fullSentenceMeaning: { ko: "일곱 시 반이에요.", en: "It's 7:30.", es: "Son las 7 y media." } },
      { type: "speak", sentence: "أَسْتَيْقِظُ السَّاعَةَ السَّابِعَةَ كُلَّ يَوْم.", speechLang: "ar-EG", meaning: { ko: "매일 일곱 시에 일어나요.", en: "I wake up at 7.", es: "Me despierto a las 7." } },
    ],
  },
  ...
  day_10: {
    ...
    arabic: [
      { type: "speak", sentence: "السَّاعَةُ الثَّالِثَة. الِاجْتِماعُ السَّاعَةَ الرَّابِعَة.", speechLang: "ar-EG", meaning: { ko: "세 시. 회의는 네 시.", en: "It's 3. Meeting at 4.", es: "Las 3. Reunión a las 4." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "___ السَّاعَة؟", answer: "كَمِ", options: ["كَمِ", "ماذا", "أَيْنَ"], fullSentence: "كَمِ السَّاعَة؟", fullSentenceMeaning: { ko: "몇 시예요?", en: "What time?", es: "¿Qué hora?" }, isYesterdayReview: true },
      { type: "speak", sentence: "الجَوُّ مُشْمِسٌ وَدافِئٌ الْيَوْم.", speechLang: "ar-EG", meaning: { ko: "오늘 맑고 따뜻해요.", en: "Sunny and warm.", es: "Soleado y cálido." } },
      { type: "fill_blank", promptWithBlank: "الْيَوْمَ ___.", answer: "تُمْطِر", options: ["تُمْطِر", "الجَوُّ", "السَّاعَةُ"], fullSentence: "الْيَوْمَ تُمْطِر.", fullSentenceMeaning: { ko: "비가 와요.", en: "It's raining.", es: "Está lloviendo." } },
      { type: "speak", sentence: "الجَوُّ بارِدٌ بِالخارِج. خُذْ سُتْرَة!", speechLang: "ar-EG", meaning: { ko: "밖이 추워요. 재킷!", en: "Cold outside. Jacket!", es: "Frío afuera. ¡Chaqueta!" } },
    ],
  },
  ...
  day_11: {
    ...
    arabic: [
      { type: "speak", sentence: "الجَوُّ مُشْمِس. أُحِبُّ الطَّقْسَ الْحارّ.", speechLang: "ar-EG", meaning: { ko: "맑아요. 더운 날씨 좋아해요.", en: "Sunny. I like hot weather.", es: "Soleado. Me gusta el clima caliente." }, isYesterdayReview: true },
      { type: "fill_blank", promptWithBlank: "___ الطَّقْسُ الْيَوْم؟", answer: "كَيْفَ", options: ["كَيْفَ", "أَيْنَ", "كَمْ"], fullSentence: "كَيْفَ الطَّقْسُ الْيَوْم؟", fullSentenceMeaning: { ko: "날씨 어때요?", en: "How's the weather?", es: "¿Cómo está el clima?" }, isYesterdayReview: true },
      { type: "speak", sentence: "ما لَوْنُ هٰذَا؟ أُحِبُّ الأَزْرَق.", speechLang: "ar-EG", meaning: { ko: "무슨 색? 파란색 좋아요.", en: "What colour? I like blue.", es: "¿Qué color? Me gusta azul." } },
      { type: "fill_blank", promptWithBlank: "هٰذَا ___ كَبِيرًا.", answer: "لَيْسَ", options: ["لَيْسَ", "أَكْبَر", "جِدًّا"], fullSentence: "هٰذَا لَيْسَ كَبِيرًا.", fullSentenceMeaning: { ko: "너무 작아요.", en: "Too small.", es: "Muy pequeño." } },
      { type: "speak", sentence: "سَآخُذُ الأَسْوَد.", speechLang: "ar-EG", meaning: { ko: "검은색 걸로.", en: "I'll take the black one.", es: "Me llevo el negro." } },
    ],
  },
  ...
  day_12: {
    ...
    arabic: [
      { type: "speak", sentence: "عُمْرِي خَمْسَةٌ وَعِشْرُونَ عامًا. كَمْ عُمْرُكَ؟", speechLang: "ar-EG", meaning: { ko: "스물다섯 살이에요. 당신은?", en: "I'm 25. You?", es: "Tengo 25. ¿Y tú?" } },
      { type: "speak", sentence: "الْيَوْمُ الْجُمُعَة. أَعْمَلُ مِنَ الِاثْنَيْنِ إِلَى الْجُمُعَة.", speechLang: "ar-EG", meaning: { ko: "금요일. 월~금 일해요.", en: "Friday. Mon-Fri work.", es: "Viernes. Lunes a viernes." } },
      { type: "speak", sentence: "السَّاعَةُ الثَّالِثَةُ وَالنِّصْف. الِاجْتِماعُ السَّاعَةَ الرَّابِعَة.", speechLang: "ar-EG", meaning: { ko: "세 시 반. 회의 네 시.", en: "3:30. Meeting 4.", es: "3:30. Reunión 4." } },
      { type: "speak", sentence: "الْيَوْمَ تُمْطِر. الجَوُّ بارِد. خُذْ سُتْرَة!", speechLang: "ar-EG", meaning: { ko: "비 와요. 추워요. 재킷!", en: "Rain. Cold. Jacket!", es: "Lluvia. Frío. ¡Chaqueta!" } },
      { type: "speak", sentence: "أُحِبُّ الأَزْرَق. هَلْ يُوجَدُ مَقاسٌ أَكْبَر؟ بِكَمْ هٰذَا؟", speechLang: "ar-EG", meaning: { ko: "파란색 좋아요. 큰 사이즈? 얼마?", en: "Like blue. Bigger? How much?", es: "Azul. ¿Más grande? ¿Cuánto?" } },
    ],
  },
};
