...
const DAILY_SPEAKING_PACKS: Partial<Record<DailySpeakingLanguage, Partial<Record<LearningGoal | "default", RawDailyPhrase[]>>>> = {
  ...
  indonesian: {
    default: [
      ...
      { word: "Nama saya Alex.", ipa: "/ˈna.ma ˈsa.ja ˈa.leks/", meaning: "제 이름은 알렉스예요.", meaningEn: "My name is Alex.", meaningEs: "Me llamo Alex.", meaningId: "Nama saya Alex.", speechLang: "id-ID", tip: "nama = name. Swap Alex for your own name." },
    ],
    travel: [
    ...
    study: [
      { word: "Saya tidak mengerti.", ipa: "/ˈsa.ja ˈti.daʔ məˈŋər.ti/", meaning: "이해 못 했어요.", meaningEn: "I don't understand.", meaningEs: "No entiendo.", meaningId: "Saya tidak mengerti.", speechLang: "id-ID", tip: "A classroom survival sentence. Say it without fear." },
      { word: "Tolong ulangi.", ipa: "/ˈto.loŋ uˈla.ŋi/", meaning: "다시 말해 주세요.", meaningEn: "Please repeat that.", meaningEs: "Repítelo, por favor.", meaningId: "Tolong ulangi.", speechLang: "id-ID", tip: "ulangi = repeat. Ask before you fall behind." },
      { word: "Apa arti kata ini?", ipa: "/ˈa.pa ˈar.ti ˈka.ta ˈi.ni/", meaning: "이 단어 무슨 뜻이에요?", meaningEn: "What does this word mean?", meaningEs: "¿Qué significa esta palabra?", meaningId: "Apa arti kata ini?", speechLang: "id-ID", tip: "arti = meaning. A real learner question." },
      { word: "Tolong jelaskan lagi.", ipa: "/ˈto.loŋ dʒəˈlas.kan ˈla.gi/", meaning: "다시 설명해 주세요.", meaningEn: "Please explain again.", meaningEs: "Explícalo otra vez, por favor.", meaningId: "Tolong jelaskan lagi.", speechLang: "id-ID", tip: "jelaskan = explain. Ask for another explanation." },
      { word: "Saya mau belajar.", ipa: "/ˈsa.ja ˈmau bəˈla.dʒar/", meaning: "공부하고 싶어요.", meaningEn: "I want to study.", meaningEs: "Quiero estudiar.", meaningId: "Saya mau belajar.", speechLang: "id-ID", tip: "belajar = study. A direct learning sentence." },
      { word: "Terima kasih, Bu.", ipa: "/təˈri.ma ˈka.sih bu/", meaning: "감사합니다, 선생님.", meaningEn: "Thank you, ma'am.", meaningEs: "Gracias, señora.", meaningId: "Terima kasih, Bu.", speechLang: "id-ID", tip: "Bu = ma'am/teacher. End the lesson politely." },
      { word: "Tolong bicara pelan-pelan.", ipa: "/ˈto.loŋ biˈtʃa.ra ˈpə.lan ˈpə.lan/", meaning: "천천히 말해 주세요.", meaningEn: "Please speak slowly.", meaningEs: "Habla despacio, por favor.", meaningId: "Tolong bicara pelan-pelan.", speechLang: "id-ID", tip: "pelan-pelan = slowly. Useful during a lesson." },
    ],
    hobby: [
      { word: "Saya suka musik.", ipa: "/ˈsa.ja ˈsu.ka ˈmu.sik/", meaning: "저는 음악을 좋아해요.", meaningEn: "I like music.", meaningEs: "Me gusta la música.", meaningId: "Saya suka musik.", speechLang: "id-ID", tip: "suka = like. A short, useful opinion." },
      { word: "Saya suka ini.", ipa: "/ˈsa.ja ˈsu.ka ˈi.ni/", meaning: "마음에 들어요.", meaningEn: "I like it.", meaningEs: "Me gusta.", meaningId: "Saya suka ini.", speechLang: "id-ID", tip: "A tiny opinion sentence you can use anywhere." },
      { word: "Hobi saya membaca.", ipa: "/ˈho.bi ˈsa.ja məmˈba.tʃa/", meaning: "제 취미는 독서예요.", meaningEn: "My hobby is reading.", meaningEs: "Mi pasatiempo es leer.", meaningId: "Hobi saya membaca.", speechLang: "id-ID", tip: "membaca = reading. Swap in your own hobby." },
      { word: "Ini menyenangkan.", ipa: "/ˈi.ni mə.ɲəˈnaŋ.kan/", meaning: "재미있어요.", meaningEn: "This is fun.", meaningEs: "Esto es divertido.", meaningId: "Ini menyenangkan.", speechLang: "id-ID", tip: "A tiny reaction sentence. senang = happy." },
      { word: "Mari kita lakukan bersama.", ipa: "/ˈma.ri ˈki.ta laˈku.kan bərˈsa.ma/", meaning: "같이 해요.", meaningEn: "Let's do it together.", meaningEs: "Hagámoslo juntos.", meaningId: "Mari kita lakukan bersama.", speechLang: "id-ID", tip: "bersama = together. Invite someone naturally." },
      { word: "Tolong rekomendasikan sesuatu.", ipa: "/ˈto.loŋ re.ko.men.daˈsi.kan səsuˈa.tu/", meaning: "추천해 주세요.", meaningEn: "Please recommend something.", meaningEs: "Recomiéndame algo, por favor.", meaningId: "Tolong rekomendasikan sesuatu.", speechLang: "id-ID", tip: "Ask for a song, show, or place." },
      { word: "Saya tidak mengerti.", ipa: "/ˈsa.ja ˈti.daʔ məˈŋər.ti/", meaning: "이해 못 했어요.", meaningEn: "I don't understand.", meaningEs: "No entiendo.", meaningId: "Saya tidak mengerti.", speechLang: "id-ID", tip: "Useful when lyrics or dialogue are too fast." },
    ],
    exam: [
      { word: "Kapan ujiannya?", ipa: "/ˈka.pan uˈdʒi.an.ɲa/", meaning: "시험이 언제예요?", meaningEn: "When is the exam?", meaningEs: "¿Cuándo es el examen?", meaningId: "Kapan ujiannya?", speechLang: "id-ID", tip: "kapan = when. ujian = exam. A real test-day question." },
      { word: "Saya punya pertanyaan.", ipa: "/ˈsa.ja ˈpu.ɲa pər.taˈɲa.an/", meaning: "질문 있어요.", meaningEn: "I have a question.", meaningEs: "Tengo una pregunta.", meaningId: "Saya punya pertanyaan.", speechLang: "id-ID", tip: "Say it before you freeze. punya = have." },
      { word: "Tolong jelaskan lagi.", ipa: "/ˈto.loŋ dʒəˈlas.kan ˈla.gi/", meaning: "다시 설명해 주세요.", meaningEn: "Please explain again.", meaningEs: "Explícalo otra vez, por favor.", meaningId: "Tolong jelaskan lagi.", speechLang: "id-ID", tip: "jelaskan = explain. Ask for a clearer version." },
      { word: "Saya butuh waktu lagi.", ipa: "/ˈsa.ja ˈbu.tuh ˈwak.tu ˈla.gi/", meaning: "시간이 더 필요해요.", meaningEn: "I need more time.", meaningEs: "Necesito más tiempo.", meaningId: "Saya butuh waktu lagi.", speechLang: "id-ID", tip: "butuh = need. A real request under pressure." },
  ...
  arabic: {
    default: [
      { word: "أَهْلًا", ipa: "ahlan", meaning: "안녕하세요", meaningEn: "Hi / Welcome", meaningEs: "Hola", meaningId: "Halo", speechLang: "ar-EG", tip: "ahlan = a warm everyday hello, understood across the Arab world. One word." },
      { word: "كَيْفَ حالُك؟", ipa: "kayfa ḥāluk?", meaning: "잘 지내요?", meaningEn: "How are you?", meaningEs: "¿Cómo estás?", meaningId: "Apa kabar?", speechLang: "ar-EG", tip: "kayfa ḥāluk = how are you (to a man) in MSA, understood everywhere (in Egyptian dialect you'll hear izzayyak)." },
      { word: "شُكْرًا", ipa: "shukran", meaning: "감사합니다", meaningEn: "Thank you", meaningEs: "Gracias", meaningId: "Terima kasih", speechLang: "ar-EG", tip: "shukran = thank you. Stress the first syllable: SHUK-ran." },
      { word: "لا أَفْهَم", ipa: "lā afham", meaning: "이해 못 했어요.", meaningEn: "I don't understand.", meaningEs: "No entiendo.", meaningId: "Saya tidak mengerti.", speechLang: "ar-EG", tip: "lā afham = I don't understand in MSA. A clear repair phrase you can use anywhere." },
      { word: "مَرّة ثانِية، مِن فَضْلِك", ipa: "marra thāniya, min faḍlik", meaning: "다시 말해 주세요.", meaningEn: "Again, please.", meaningEs: "Otra vez, por favor.", meaningId: "Tolong ulangi.", speechLang: "ar-EG", tip: "marra thāniya = once more, in MSA. min faḍlik = please." },
      { word: "بِبُطْء، مِن فَضْلِك", ipa: "bi-buṭʼ, min faḍlik", meaning: "천천히 말해 주세요.", meaningEn: "Slowly, please.", meaningEs: "Despacio, por favor.", meaningId: "Tolong bicara pelan-pelan.", speechLang: "ar-EG", tip: "bi-buṭʼ = slowly, in MSA. min faḍlik softens the request." },
      ...
      { word: "مَعَ السَّلامَة", ipa: "maʿa s-salāma", meaning: "안녕히 가세요.", meaningEn: "Goodbye.", meaningEs: "Adiós.", meaningId: "Sampai jumpa.", speechLang: "ar-EG", tip: "maʿa s-salāma = goodbye (literally 'with safety'). The ʿ is the deep ع." },
      { word: "آسِف", ipa: "āsif", meaning: "미안해요.", meaningEn: "Sorry.", meaningEs: "Lo siento.", meaningId: "Maaf.", speechLang: "ar-EG", tip: "āsif = sorry (said by a man). Short and sincere." },
      { word: "اِسْمي أليكس", ipa: "ismī Alex", meaning: "제 이름은 알렉스예요.", meaningEn: "My name is Alex.", meaningEs: "Me llamo Alex.", meaningId: "Nama saya Alex.", speechLang: "ar-EG", tip: "ismī = my name. Swap Alex for your own name." },
    ],
    travel: [
      { word: "أَيْنَ الحَمّام؟", ipa: "ayna l-ḥammām?", meaning: "화장실이 어디예요?", meaningEn: "Where is the bathroom?", meaningEs: "¿Dónde está el baño?", meaningId: "Di mana toilet?", speechLang: "ar-EG", tip: "ayna = where in MSA, understood across the Arab world. A real travel question." },
      { word: "بِكَمْ هٰذَا؟", ipa: "bikam hādhā?", meaning: "얼마예요?", meaningEn: "How much is this?", meaningEs: "¿Cuánto cuesta esto?", meaningId: "Berapa harganya?", speechLang: "ar-EG", tip: "bikam = how much, hādhā = this, both MSA. A daily shopping question." },
      { word: "ساعِدْني، مِن فَضْلِك", ipa: "sāʿidnī, min faḍlik", meaning: "도와주세요.", meaningEn: "Please help me.", meaningEs: "Ayúdame, por favor.", meaningId: "Tolong bantu saya.", speechLang: "ar-EG", tip: "sāʿidnī = help me. Slow and clear is enough in an emergency." },
      { word: "أُريد ماء", ipa: "urīd māʼ", meaning: "물 주세요.", meaningEn: "I want water.", meaningEs: "Quiero agua.", meaningId: "Saya mau air.", speechLang: "ar-EG", tip: "urīd = I want, māʼ = water, both MSA (in Egyptian dialect you'll hear mayya)." },
      { word: "قِفْ هُنا، مِن فَضْلِك", ipa: "qif hunā, min faḍlik", meaning: "여기 세워 주세요.", meaningEn: "Stop here, please.", meaningEs: "Pare aquí, por favor.", meaningId: "Berhenti di sini.", speechLang: "ar-EG", tip: "qif = stop, hunā = here, both MSA. Taxi survival." },
      { word: "أنا تائِه", ipa: "anā tāʼih", meaning: "길을 잃었어요.", meaningEn: "I am lost.", meaningEs: "Estoy perdido.", meaningId: "Saya tersesat.", speechLang: "ar-EG", tip: "anā tāʼih = I am lost, in MSA. Say it calmly when you need directions." },
      { word: "أُريد سَيّارة أُجْرة", ipa: "urīd sayyārat ujra", meaning: "택시 불러 주세요.", meaningEn: "I want a taxi.", meaningEs: "Quiero un taxi.", meaningId: "Tolong panggil taksi.", speechLang: "ar-EG", tip: "sayyārat ujra = taxi (lit. 'hire car') in MSA. A practical street request." },
    ],
    relationship: [
      { word: "مَا اسْمُك؟", ipa: "mā smuk?", meaning: "이름이 뭐예요?", meaningEn: "What is your name?", meaningEs: "¿Cómo te llamas?", meaningId: "Siapa nama kamu?", speechLang: "ar-EG", tip: "mā = what in MSA, understood everywhere. Asking a man his name." },
      { word: "اِسْمي أليكس", ipa: "ismī Alex", meaning: "제 이름은 알렉스예요.", meaningEn: "My name is Alex.", meaningEs: "Me llamo Alex.", meaningId: "Nama saya Alex.", speechLang: "ar-EG", tip: "Swap Alex for your name when you practice." },
      { word: "فُرْصة سَعيدة", ipa: "furṣa saʿīda", meaning: "만나서 반가워요.", meaningEn: "Nice to meet you.", meaningEs: "Mucho gusto.", meaningId: "Senang bertemu kamu.", speechLang: "ar-EG", tip: "furṣa saʿīda = nice to meet you (literally 'happy chance')." },
      { word: "كَيْفَ حالُك؟", ipa: "kayfa ḥāluk?", meaning: "잘 지내요?", meaningEn: "How are you?", meaningEs: "¿Cómo estás?", meaningId: "Apa kabar?", speechLang: "ar-EG", tip: "kayfa ḥāluk = how are you (to a man) in MSA. A warm everyday check-in." },
      { word: "أَراك لاحِقًا", ipa: "arāka lāḥiqan", meaning: "나중에 봐요.", meaningEn: "See you later.", meaningEs: "Hasta luego.", meaningId: "Sampai nanti.", speechLang: "ar-EG", tip: "arāka = I'll see you, lāḥiqan = later, both MSA. A friendly goodbye." },
      { word: "شُكْرًا جَزيلًا", ipa: "shukran jazīlan", meaning: "정말 고마워요.", meaningEn: "Thank you very much.", meaningEs: "Muchas gracias.", meaningId: "Terima kasih banyak.", speechLang: "ar-EG", tip: "jazīlan = a lot. Warm gratitude in MSA — note the standard j sound." },
      { word: "آسِف، لَقَدْ تَأَخَّرْت", ipa: "āsif, laqad taʼakhkhart", meaning: "늦어서 미안해요.", meaningEn: "Sorry, I am late.", meaningEs: "Perdón por llegar tarde.", meaningId: "Maaf, saya terlambat.", speechLang: "ar-EG", tip: "laqad taʼakhkhart = I was late, in MSA. A gentle, honest apology." },
    ],
    work: [
      { word: "مَرّة ثانِية، مِن فَضْلِك", ipa: "marra thāniya, min faḍlik", meaning: "다시 말해 주세요.", meaningEn: "Again, please.", meaningEs: "Otra vez, por favor.", meaningId: "Tolong ulangi.", speechLang: "ar-EG", tip: "A useful meeting repair phrase. Say it calmly." },
      { word: "لا أَفْهَم", ipa: "lā afham", meaning: "이해 못 했어요.", meaningEn: "I don't understand.", meaningEs: "No entiendo.", meaningId: "Saya tidak mengerti.", speechLang: "ar-EG", tip: "It is okay to ask. lā afham = I don't understand, in MSA." },
      { word: "عِنْدي سُؤال", ipa: "ʿindī suʼāl", meaning: "질문 있어요.", meaningEn: "I have a question.", meaningEs: "Tengo una pregunta.", meaningId: "Saya punya pertanyaan.", speechLang: "ar-EG", tip: "ʿindī = I have, suʼāl = question, both MSA. Say it before you get stuck." },
      { word: "اِنْتَظِرْ قَليلًا، مِن فَضْلِك", ipa: "intaẓir qalīlan, min faḍlik", meaning: "잠시만 기다려 주세요.", meaningEn: "Wait a moment, please.", meaningEs: "Espere un momento, por favor.", meaningId: "Tolong tunggu sebentar.", speechLang: "ar-EG", tip: "intaẓir qalīlan = wait a little, in MSA. A polite pause at work." },
      { word: "شُكْرًا", ipa: "shukran", meaning: "감사합니다.", meaningEn: "Thank you.", meaningEs: "Gracias.", meaningId: "Terima kasih.", speechLang: "ar-EG", tip: "End politely and clearly." },
      { word: "سَأُرْسِل بَريدًا إِلِكْترونِيًّا", ipa: "saʼursil barīdan iliktrūniyyan", meaning: "이메일 보낼게요.", meaningEn: "I'll send an email.", meaningEs: "Enviaré un correo.", meaningId: "Saya akan kirim email.", speechLang: "ar-EG", tip: "sa- = will (MSA future). saʼursil barīdan = I'll send an email." },
      { word: "اُنْظُرْ إِلى هٰذَا، مِن فَضْلِك", ipa: "unẓur ilā hādhā, min faḍlik", meaning: "확인해 주세요.", meaningEn: "Please check this.", meaningEs: "Revísalo, por favor.", meaningId: "Tolong periksa ini.", speechLang: "ar-EG", tip: "unẓur = look, hādhā = this, both MSA. Useful for documents." },
    ],
    study: [
      { word: "لا أَفْهَم", ipa: "lā afham", meaning: "이해 못 했어요.", meaningEn: "I don't understand.", meaningEs: "No entiendo.", meaningId: "Saya tidak mengerti.", speechLang: "ar-EG", tip: "A classroom survival phrase. Say it without fear." },
      { word: "مَرّة ثانِية، مِن فَضْلِك", ipa: "marra thāniya, min faḍlik", meaning: "다시 말해 주세요.", meaningEn: "Again, please.", meaningEs: "Otra vez, por favor.", meaningId: "Tolong ulangi.", speechLang: "ar-EG", tip: "marra thāniya = once more, in MSA. Ask before you fall behind." },
      { word: "مَا مَعْنى هٰذِهِ الكَلِمة؟", ipa: "mā maʿnā hādhihi l-kalima?", meaning: "이 단어 무슨 뜻이에요?", meaningEn: "What does this word mean?", meaningEs: "¿Qué significa esta palabra?", meaningId: "Apa arti kata ini?", speechLang: "ar-EG", tip: "kalima = word, hādhihi = this (feminine), both MSA. A real learner question." },
      { word: "اِشْرَحْها مَرّة ثانِية، مِن فَضْلِك", ipa: "ishraḥhā marra thāniya, min faḍlik", meaning: "다시 설명해 주세요.", meaningEn: "Please explain it again.", meaningEs: "Explícalo otra vez, por favor.", meaningId: "Tolong jelaskan lagi.", speechLang: "ar-EG", tip: "ishraḥ = explain, in MSA. Ask for another explanation." },
      { word: "أُريد أَنْ أَتَعَلَّم", ipa: "urīd an ataʿallam", meaning: "공부하고 싶어요.", meaningEn: "I want to learn.", meaningEs: "Quiero aprender.", meaningId: "Saya mau belajar.", speechLang: "ar-EG", tip: "urīd an ataʿallam = I want to learn, in MSA. A direct learning sentence." },
      { word: "شُكْرًا يا أُسْتاذ", ipa: "shukran yā ustādh", meaning: "감사합니다, 선생님.", meaningEn: "Thank you, teacher.", meaningEs: "Gracias, profesor.", meaningId: "Terima kasih, Pak.", speechLang: "ar-EG", tip: "yā = O (address), ustādh = teacher/sir, both MSA. End the lesson politely." },
    ],
    hobby: [
      { word: "أنا أُحِبّ المُوسيقى", ipa: "anā uḥibb al-mūsīqā", meaning: "저는 음악을 좋아해요.", meaningEn: "I like music.", meaningEs: "Me gusta la música.", meaningId: "Saya suka musik.", speechLang: "ar-EG", tip: "uḥibb = I love/like, in MSA. A short, useful opinion." },
      { word: "هٰذَا أَعْجَبَني", ipa: "hādhā aʿjabanī", meaning: "마음에 들어요.", meaningEn: "I like it.", meaningEs: "Me gusta.", meaningId: "Saya suka ini.", speechLang: "ar-EG", tip: "aʿjabanī = it pleased me, hādhā = this, both MSA. A tiny opinion you can use anywhere." },
      { word: "هِوايَتي القِراءة", ipa: "hiwāyatī l-qirāʼa", meaning: "제 취미는 독서예요.", meaningEn: "My hobby is reading.", meaningEs: "Mi pasatiempo es leer.", meaningId: "Hobi saya membaca.", speechLang: "ar-EG", tip: "hiwāya = hobby, qirāʼa = reading, both MSA. Swap in your own hobby." },
      { word: "هٰذَا جَميل جِدًّا", ipa: "hādhā jamīl jiddan", meaning: "재미있어요.", meaningEn: "This is really nice.", meaningEs: "Esto es muy bueno.", meaningId: "Ini menyenangkan.", speechLang: "ar-EG", tip: "jamīl = nice, jiddan = very, both MSA. A tiny reaction." },
      { word: "هَيّا نَفْعَلْها مَعًا", ipa: "hayyā nafʿalhā maʿan", meaning: "같이 해요.", meaningEn: "Let's do it together.", meaningEs: "Hagámoslo juntos.", meaningId: "Mari kita lakukan bersama.", speechLang: "ar-EG", tip: "hayyā = come on, maʿan = together, both MSA. Invite someone naturally." },
      { word: "اِقْتَرِحْ لي شَيْئًا، مِن فَضْلِك", ipa: "iqtariḥ lī shayʼan, min faḍlik", meaning: "추천해 주세요.", meaningEn: "Recommend me something, please.", meaningEs: "Recomiéndame algo, por favor.", meaningId: "Tolong rekomendasikan sesuatu.", speechLang: "ar-EG", tip: "shayʼan = something, iqtariḥ = recommend, both MSA. Ask for a song, show, or place." },
    ],
    exam: [
      { word: "مَتى الاِمْتِحان؟", ipa: "matā l-imtiḥān?", meaning: "시험이 언제예요?", meaningEn: "When is the exam?", meaningEs: "¿Cuándo es el examen?", meaningId: "Kapan ujiannya?", speechLang: "ar-EG", tip: "matā = when, imtiḥān = exam, both MSA. A real test-day question." },
      { word: "عِنْدي سُؤال", ipa: "ʿindī suʼāl", meaning: "질문 있어요.", meaningEn: "I have a question.", meaningEs: "Tengo una pregunta.", meaningId: "Saya punya pertanyaan.", speechLang: "ar-EG", tip: "ʿindī suʼāl = I have a question, in MSA. Say it before you freeze." },
      { word: "اِشْرَحْها مَرّة ثانِية، مِن فَضْلِك", ipa: "ishraḥhā marra thāniya, min faḍlik", meaning: "다시 설명해 주세요.", meaningEn: "Please explain it again.", meaningEs: "Explícalo otra vez, por favor.", meaningId: "Tolong jelaskan lagi.", speechLang: "ar-EG", tip: "ishraḥ = explain, in MSA. Ask for a clearer version." },
      { word: "أُريد وَقْتًا إِضافِيًّا", ipa: "urīd waqtan iḍāfiyyan", meaning: "시간이 더 필요해요.", meaningEn: "I need more time.", meaningEs: "Necesito más tiempo.", meaningId: "Saya butuh waktu lagi.", speechLang: "ar-EG", tip: "waqt = time, iḍāfī = extra, both MSA. A real request under pressure." },
      { word: "أنا جاهِز", ipa: "anā jāhiz", meaning: "준비됐어요.", meaningEn: "I am ready.", meaningEs: "Estoy listo.", meaningId: "Saya sudah siap.", speechLang: "ar-EG", tip: "jāhiz = ready (a man), in MSA with a standard j. A confidence line." },
      { word: "لا أَعْرِف الإِجابة", ipa: "lā aʿrif al-ijāba", meaning: "답을 모르겠어요.", meaningEn: "I don't know the answer.", meaningEs: "No sé la respuesta.", meaningId: "Saya tidak tahu jawabannya.", speechLang: "ar-EG", tip: "lā aʿrif = I don't know, ijāba = answer, both MSA." },
    ],
  },
};
...
const DAILY_SPEAKING_STARTERS: Partial<Record<DailySpeakingLanguage, RawDailyPhrase[]>> = {
  ...
  arabic: [
    { word: "نَعَم", ipa: "naʿam", meaning: "네.", meaningEn: "Yes.", meaningEs: "Sí.", meaningId: "Ya.", speechLang: "ar-EG", tip: "naʿam = yes in MSA, understood across the Arab world (in Egyptian dialect you'll hear aah)." },
    { word: "لا", ipa: "lā", meaning: "아니요.", meaningEn: "No.", meaningEs: "No.", meaningId: "Tidak.", speechLang: "ar-EG", tip: "lā = no in MSA. One clear, open syllable." },
    { word: "حَسَنًا", ipa: "ḥasanan", meaning: "괜찮아요.", meaningEn: "Okay / All good.", meaningEs: "Está bien.", meaningId: "Oke / Baik.", speechLang: "ar-EG", tip: "ḥasanan = okay/fine in MSA — a tiny all-purpose 'all good' (in Egyptian dialect you'll hear tamaam)." },
    { word: "مِن فَضْلِك", ipa: "min faḍlik", meaning: "부탁합니다.", meaningEn: "Please.", meaningEs: "Por favor.", meaningId: "Tolong / Silakan.", speechLang: "ar-EG", tip: "min faḍlik = please (to a man) in MSA. Softens any request." },
    { word: "هَلْ تَتَكَلَّم الإنْجِليزِيّة؟", ipa: "hal tatakallam al-injilīziyya?", meaning: "영어 할 줄 아세요?", meaningEn: "Do you speak English?", meaningEs: "¿Hablas inglés?", meaningId: "Apakah kamu bisa bahasa Inggris?", speechLang: "ar-EG", tip: "hal tatakallam = do you speak (to a man) in MSA. Useful when you need a bridge language." },
    { word: "أنا مُبْتَدِئ", ipa: "anā mubtadiʼ", meaning: "저는 초보자예요.", meaningEn: "I am a beginner.", meaningEs: "Soy principiante.", meaningId: "Saya pemula.", speechLang: "ar-EG", tip: "anā mubtadiʼ = I'm a beginner. Say it without apology — it helps people help you." },
    { word: "أَيْنَ الحَمّام؟", ipa: "ayna l-ḥammām?", meaning: "화장실이 어디예요?", meaningEn: "Where is the bathroom?", meaningEs: "¿Dónde está el baño?", meaningId: "Di mana toilet?", speechLang: "ar-EG", tip: "ayna = where in MSA, understood across the Arab world. A real travel question." },
    { word: "بِكَمْ هٰذَا؟", ipa: "bikam hādhā?", meaning: "얼마예요?", meaningEn: "How much is this?", meaningEs: "¿Cuánto cuesta esto?", meaningId: "Berapa harganya?", speechLang: "ar-EG", tip: "bikam = how much, hādhā = this, both MSA. A daily shopping question." },
    { word: "ساعِدْني، مِن فَضْلِك", ipa: "sāʿidnī, min faḍlik", meaning: "도와주세요.", meaningEn: "Please help me.", meaningEs: "Ayúdame, por favor.", meaningId: "Tolong bantu saya.", speechLang: "ar-EG", tip: "sāʿidnī = help me. Slow and clear is enough in an emergency." },
    { word: "مَا اسْمُك؟", ipa: "mā smuk?", meaning: "이름이 뭐예요?", meaningEn: "What is your name?", meaningEs: "¿Cómo te llamas?", meaningId: "Siapa nama kamu?", speechLang: "ar-EG", tip: "mā = what in MSA, understood everywhere. Asking a man his name." },
    { word: "أنا مِن كوريا", ipa: "anā min Korea", meaning: "저는 한국에서 왔어요.", meaningEn: "I'm from Korea.", meaningEs: "Soy de Corea.", meaningId: "Saya dari Korea.", speechLang: "ar-EG", tip: "anā min = I'm from. Swap Korea for your own country." },
    { word: "أَيْنَ المَحَطّة؟", ipa: "ayna l-maḥaṭṭa?", meaning: "역이 어디예요?", meaningEn: "Where is the station?", meaningEs: "¿Dónde está la estación?", meaningId: "Di mana stasiun?", speechLang: "ar-EG", tip: "maḥaṭṭa = station. Pair ayna with any place you need." },
    { word: "ماء، مِن فَضْلِك", ipa: "māʼ, min faḍlik", meaning: "물 주세요.", meaningEn: "Water, please.", meaningEs: "Agua, por favor.", meaningId: "Air, tolong.", speechLang: "ar-EG", tip: "māʼ = water in MSA (in Egyptian dialect you'll hear mayya). A real café/restaurant request." },
  ],
};
