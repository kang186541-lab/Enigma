...
export const LESSON_CONTENT: Record<string, Partial<Record<LearningLangKey, DayLessonData>>> = {
  ...
  day_1: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "스페인어로 자기소개할 때 'Me llamo ___'를 써요. '무초 구스토(Mucho gusto)'는 만나서 반갑다는 표현이에요.", en: "In Spanish, use 'Me llamo ___' to introduce yourself. 'Mucho gusto' means nice to meet you.", es: "Para presentarte en español, usa 'Me llamo ___'. 'Mucho gusto' significa encantado de conocerte." },
        quizzes: [
    ...
    korean: {
      ...
      step2: {
        explanation: { ko: "한국어로 자기소개할 때 '제 이름은 ___예요'를 써요. '만나서 반갑습니다'는 처음 만날 때 쓰는 정중한 표현이에요.", en: "In Korean, say '제 이름은 ___예요' (my name is ___). '만나서 반갑습니다' means nice to meet you.", es: "En coreano, di '제 이름은 ___예요' (me llamo ___). '만나서 반갑습니다' significa mucho gusto." },
        quizzes: [
  ...
  day_2: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "스페인어로 출신을 말할 때 'Soy de ___'를 써요. 영어의 'from' 대신 'de'를 써요. 사는 곳은 'Vivo en ___'으로 표현해요.", en: "In Spanish, use 'Soy de ___' for origin (not 'from' but 'de'). 'Vivo en ___' for where you live.", es: "Usa 'Soy de ___' para el origen. 'Vivo en ___' para donde vives actualmente." },
        quizzes: [
    ...
    korean: {
      ...
      step2: {
        explanation: { ko: "한국어로 출신을 말할 때 '___에서 왔어요'를 써요. 조사 '에서'가 영어의 'from'에 해당해요. 사는 곳은 '___에 살고 있어요'로 표현해요.", en: "In Korean, use '___에서 왔어요' for where you're from. '에서' works like 'from'. '___에 살고 있어요' for where you live.", es: "En coreano, usa '___에서 왔어요' para tu origen. '에서' es como 'de'. '___에 살고 있어요' para donde vives." },
        quizzes: [
  ...
  day_3: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "스페인어로 직업을 말할 때 'Soy ___'를 써요. 영어의 a/an이 필요 없어요! 일하는 곳은 'Trabajo en ___'로 표현해요.", en: "In Spanish, say 'Soy ___' for jobs (no article needed!). 'Trabajo en ___' for workplace.", es: "Para el trabajo, di 'Soy ___' (sin artículo a/an). 'Trabajo en ___' para el lugar de trabajo." },
        quizzes: [
          ...
          { type: "select", promptWithBlank: "Trabajo ___ un museo.", answer: "en", options: ["en", "a", "de"], fullSentence: "Trabajo en un museo.", fullSentenceMeaning: { ko: "박물관에서 일해요.", en: "I work at a museum.", es: "Trabajo en un museo." } },
        ],
      },
    },
    korean: {
      ...
      step2: {
        explanation: { ko: "한국어로 직업을 말할 때 '저는 ___이에요/예요'를 써요. 모음으로 끝나면 '예요', 자음으로 끝나면 '이에요'. 일하는 곳은 '___에서 일해요'로 표현해요.", en: "In Korean, say '저는 ___이에요' for jobs. Ends with vowel: '___예요', consonant: '___이에요'. '___에서 일해요' for workplace.", es: "En coreano, di '저는 ___이에요' para el trabajo. Si termina en vocal: '___예요'. '___에서 일해요' para el lugar de trabajo." },
        quizzes: [
          ...
          { type: "select", promptWithBlank: "박물관___ 일해요.", answer: "에서", options: ["에서", "에", "이"], fullSentence: "박물관에서 일해요.", fullSentenceMeaning: { ko: "박물관에서 일해요.", en: "I work at a museum.", es: "Trabajo en un museo." } },
        ],
      },
    },
  },
  ...
  day_4: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "'Adiós'는 정식 작별인사, 'Hasta luego'는 곧 다시 볼 때 써요. '¡Cuídate!'는 잘 가라는 따뜻한 표현이에요.", en: "'Adiós' is formal goodbye, 'Hasta luego' for see you later. '¡Cuídate!' is a warm farewell meaning take care.", es: "'Adiós' es formal, 'Hasta luego' para cuando te verás de nuevo. '¡Cuídate!' es una despedida cálida." },
        quizzes: [
    ...
    korean: {
      ...
      step2: {
        explanation: { ko: "'안녕히 가세요'는 공손한 작별 인사예요. '잘 가요'는 더 캐주얼하고, '다음에 봐요'는 또 만날 때 써요.", en: "'안녕히 가세요' is polite farewell. '잘 가요' is casual. '다음에 봐요' means see you next time.", es: "'안녕히 가세요' es una despedida formal. '잘 가요' es casual. '다음에 봐요' significa hasta la próxima." },
        quizzes: [
  ...
  day_5: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "'¿Cómo estás?'에 'Estoy bien' 말고도 다양한 대답이 있어요: '¡Estoy genial!', 'Más o menos', 'Estoy cansado/a'. 되물을 때 '¿Y tú?'를 붙여요.", en: "Besides 'Estoy bien', say: '¡Estoy genial!', 'Más o menos', 'Estoy cansado/a'. Add '¿Y tú?' to ask back.", es: "Además de 'Estoy bien', puedes decir: '¡Estoy genial!', 'Más o menos'. Agrega '¿Y tú?' para preguntar de vuelta." },
        quizzes: [
    ...
    korean: {
      ...
      step2: {
        explanation: { ko: "'어떻게 지내요?'에는 '잘 지내요', '괜찮아요', '조금 피곤해요' 등으로 대답해요. 상대에게 되물을 때 '당신은요?'를 붙여요.", en: "Answer '어떻게 지내요?' with '잘 지내요' (fine), '괜찮아요' (okay), '조금 피곤해요' (a bit tired). Add '당신은요?' to ask back.", es: "Responde '어떻게 지내요?' con '잘 지내요' (bien), '괜찮아요' (regular). Agrega '당신은요?' para preguntar de vuelta." },
        quizzes: [
  ...
  day_6: {
    ...
    spanish: {
      ...
      step2: {
        explanation: { ko: "이번 주 스페인어 표현을 복습해요! 자기소개(Me llamo, Soy de, Trabajo en)와 인사(Mucho gusto, ¿Cómo estás?, Hasta luego)를 자연스럽게 연결해 보세요.", en: "Let's review this week's Spanish! Connect introductions (Me llamo, Soy de, Trabajo en) with greetings (Mucho gusto, ¿Cómo estás?, Hasta luego) naturally.", es: "¡Repasemos todo el español! Conecta presentaciones (Me llamo, Soy de, Trabajo en) con saludos (Mucho gusto, ¿Cómo estás?, Hasta luego) de forma natural." },
        quizzes: [
          { type: "select", promptWithBlank: "Me ___ Rudy.", answer: "llamo", options: ["llamo", "llamas", "llaman"], fullSentence: "Me llamo Rudy.", fullSentenceMeaning: { ko: "제 이름은 루디예요.", en: "My name is Rudy.", es: "Me llamo Rudy." } },
          { type: "select", promptWithBlank: "¿Cómo ___ hoy?", answer: "estás", options: ["estás", "eres", "tienes"], fullSentence: "¿Cómo estás hoy?", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?" } },
        ],
    ...
    korean: {
      ...
      step2: {
        explanation: { ko: "이번 주 한국어 표현을 복습해요! 자기소개(이름은, 에서 왔어요, 에서 일해요)와 인사(반갑습니다, 어떻게 지내요?, 다음에 봐요)를 자연스럽게 연결해 보세요.", en: "Let's review this week's Korean! Connect introductions (이름은, 에서 왔어요, 에서 일해요) with greetings (반갑습니다, 어떻게 지내요?, 다음에 봐요) naturally.", es: "¡Repasemos el coreano! Conecta presentaciones (이름은, 에서 왔어요, 에서 일해요) con saludos (반갑습니다, 어떻게 지내요?, 다음에 봐요) de forma natural." },
        quizzes: [
          { type: "select", promptWithBlank: "제 이름___ 루디예요.", answer: "은", options: ["은", "이", "가"], fullSentence: "제 이름은 루디예요.", fullSentenceMeaning: { ko: "제 이름은 루디예요.", en: "My name is Rudy.", es: "Me llamo Rudy." } },
          { type: "select", promptWithBlank: "오늘 어떻게 ___요?", answer: "지내", options: ["지내", "있어", "해"], fullSentence: "오늘 어떻게 지내요?", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?" } },
        ],
...
export const REVIEW_CONTENT: Record<string, Partial<Record<LearningLangKey, ReviewQuestion[]>>> = {
  ...
  day_2: {
    ...
    spanish: [
      ...
      { type: "fill_blank", promptWithBlank: "Mucho ___.", answer: "gusto", options: ["gusto", "bueno", "bien"], fullSentence: "Mucho gusto.", fullSentenceMeaning: { ko: "만나서 반갑습니다.", en: "Nice to meet you.", es: "Mucho gusto." }, isYesterdayReview: true },
      { type: "speak", sentence: "Soy de Corea.", speechLang: "es-ES", meaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea." } },
      { type: "fill_blank", promptWithBlank: "___ en Seúl.", answer: "Vivo", options: ["Vivo", "Soy", "Estoy"], fullSentence: "Vivo en Seúl.", fullSentenceMeaning: { ko: "서울에 살고 있어요.", en: "I live in Seoul.", es: "Vivo en Seúl." } },
    ...
    korean: [
      ...
      { type: "fill_blank", promptWithBlank: "만나서 ___습니다.", answer: "반갑", options: ["반갑", "고맙", "감사"], fullSentence: "만나서 반갑습니다.", fullSentenceMeaning: { ko: "만나서 반갑습니다.", en: "Nice to meet you.", es: "Mucho gusto." }, isYesterdayReview: true },
      { type: "speak", sentence: "저는 한국에서 왔어요.", speechLang: "ko-KR", meaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea." } },
      { type: "fill_blank", promptWithBlank: "서울에 ___ 있어요.", answer: "살고", options: ["살고", "있고", "가고"], fullSentence: "서울에 살고 있어요.", fullSentenceMeaning: { ko: "서울에 살고 있어요.", en: "I live in Seoul.", es: "Vivo en Seúl." } },
  ...
  day_3: {
    ...
    spanish: [
      ...
      { type: "fill_blank", promptWithBlank: "Soy ___ Corea.", answer: "de", options: ["de", "en", "a"], fullSentence: "Soy de Corea.", fullSentenceMeaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea." }, isYesterdayReview: true },
      { type: "speak", sentence: "Soy estudiante.", speechLang: "es-ES", meaning: { ko: "저는 학생이에요.", en: "I'm a student.", es: "Soy estudiante." } },
      { type: "fill_blank", promptWithBlank: "Trabajo ___ un museo.", answer: "en", options: ["en", "a", "de"], fullSentence: "Trabajo en un museo.", fullSentenceMeaning: { ko: "박물관에서 일해요.", en: "I work at a museum.", es: "Trabajo en un museo." } },
    ...
    korean: [
      ...
      { type: "fill_blank", promptWithBlank: "저는 한국___ 왔어요.", answer: "에서", options: ["에서", "에", "을"], fullSentence: "저는 한국에서 왔어요.", fullSentenceMeaning: { ko: "저는 한국에서 왔어요.", en: "I'm from Korea.", es: "Soy de Corea." }, isYesterdayReview: true },
      { type: "speak", sentence: "저는 학생이에요.", speechLang: "ko-KR", meaning: { ko: "저는 학생이에요.", en: "I'm a student.", es: "Soy estudiante." } },
      { type: "fill_blank", promptWithBlank: "박물관___ 일해요.", answer: "에서", options: ["에서", "에", "이"], fullSentence: "박물관에서 일해요.", fullSentenceMeaning: { ko: "박물관에서 일해요.", en: "I work at a museum.", es: "Trabajo en un museo." } },
  ...
  day_4: {
    ...
    spanish: [
      ...
      { type: "fill_blank", promptWithBlank: "Fue ___ placer conocerte.", answer: "un", options: ["un", "el", "una"], fullSentence: "Fue un placer conocerte.", fullSentenceMeaning: { ko: "만나서 반가웠어요.", en: "It was nice meeting you.", es: "Fue un placer conocerte." } },
    ...
    korean: [
      ...
      { type: "fill_blank", promptWithBlank: "만나서 ___어요.", answer: "반가웠", options: ["반가웠", "고마웠", "즐거웠"], fullSentence: "만나서 반가웠어요.", fullSentenceMeaning: { ko: "만나서 반가웠어요.", en: "It was nice meeting you.", es: "Fue un placer conocerte." } },
  ...
  day_5: {
    ...
    spanish: [
      ...
      { type: "fill_blank", promptWithBlank: "¿Cómo ___ hoy?", answer: "estás", options: ["estás", "eres", "tienes"], fullSentence: "¿Cómo estás hoy?", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?" } },
    ...
    korean: [
      ...
      { type: "fill_blank", promptWithBlank: "오늘 어떻게 ___요?", answer: "지내", options: ["지내", "있어", "해"], fullSentence: "오늘 어떻게 지내요?", fullSentenceMeaning: { ko: "오늘 어떻게 지내요?", en: "How are you today?", es: "¿Cómo estás hoy?" } },
