...
export type SpeakMissionTargetLanguage = "korean" | "english" | "spanish" | "indonesian" | "arabic";
...
function normalizeTargetLanguage(value: string): SpeakMissionTargetLanguage {
  return value === "korean" || value === "spanish" || value === "indonesian" || value === "arabic" ? value : "english";
}
